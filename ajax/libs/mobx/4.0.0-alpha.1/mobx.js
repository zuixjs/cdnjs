...
var ComputedValue = /** @class */ (function () {
     ...
     */
    function ComputedValue(derivation, options) {
        ...
        if (options.setter)
            this.setter = createAction(name + "-setter", options.setter);
        this.equals =
...
function defineObservablePropertyFromDescriptor(adm, propName, descriptor, defaultEnhancer) {
    ...
    var existingObservable = adm.values[propName];
...
function defineComputedProperty(adm, propName, getter, options, asInstanceProperty) {
...
var observableFactories = {
    ...
    object: function (props, name) {
        ...
        // add properties
        return extendObservable(res, props);
    },
    shallowObject: function (props, name) {
        ...
        return extendShallowObservable(res, props);
    },
    ref: function () {
        if (arguments.length < 2) {
...
function createModifierDescriptor(enhancer, initialValue) {
    if (isModifierDescriptor(initialValue))
        fail$1("Modifiers cannot be nested");
    return {
...
var ObservableMap = /** @class */ (function () {
    ...
    ObservableMap.prototype._addValue = function (key, newValue) {
        var _this = this;
        transaction(function () {
            var observable = (_this._data[key] = new ObservableValue(newValue, _this.enhancer, _this.name + "." + key, false));
...
function createComputedDecorator(options) {
    return createClassPropertyDecorator(function (target, name, _, __, originalDescriptor) {
        ...
        var adm = asObservableObject(target, "");
        defineComputedProperty(adm, name, originalDescriptor.get, __assign({}, options, { setter: originalDescriptor.set }), false);
    }, function (name) {
        var observable = this.$mobx.values[name];
        if (observable === undefined // See #505
        )
