...
function spy(listener) {
    if (process.env.NODE_ENV === "production") {
        return fail$1("[mobx.spy] can not be used in production builds");
    }
    else {
...
var ObservableObjectAdministration = /** @class */ (function () {
    ...
    ObservableObjectAdministration.prototype.waitForKey = function (key) {
    ...
    ObservableObjectAdministration.prototype.addObservableProp = function (propName, newValue, enhancer) {
        ...
        var observable = new ObservableValue(newValue, enhancer, this.name + "." + propName, false);
...
function asObservableObject(target, name, defaultEnhancer) {
    ...
    var adm = new ObservableObjectAdministration(target, new Map(), name, defaultEnhancer);
...
var computedDecorator = createPropDecorator(false, function (instance, propertyName, descriptor, decoratorTarget, decoratorArgs) {
    ...
    asObservableObject(instance).addComputedProp(decoratorTarget, propertyName, __assign({ get: get,
        set: set }, options));
});
...
var observableFactories = {
    ...
    object: function (props, decorators, options) {
        ...
        var o = asCreateObservableOptions(options);
        var base = extendObservable({}, props, decorators, o);
        if (o.proxy === false) {
            return base;
        }
...
var ObservableMap = /** @class */ (function () {
    ...
    ObservableMap.prototype.clear = function () {
        ...
        transaction(function () {
            untracked(function () {
                try {
                    for (var _a = __values(_this.keys()), _b = _a.next(); !_b.done; _b = _a.next()) {
                        var key = _b.value;
                        _this.delete(key);
                    }
                }
    ...
    ObservableMap.prototype.toString = function () {
        ...
        return (this.name +
            "[{ " +
            Array.from(this.keys()).map(function (key) { return key + ": " + ("" + _this.get(key)); }).join(", ") +
            " }]");
    };
    /**
     * Observes this object. Triggers for the events 'add', 'update' and 'delete'.
...
var ObservableArrayAdministration = /** @class */ (function () {
    ...
    ObservableArrayAdministration.prototype.dehanceValues = function (values, forceClone) {
...
var arrayExtensions = {
    ...
    remove: function (value) {
        var adm = this[$mobx];
        var idx = adm.dehanceValues(adm.values, false).indexOf(value);
        if (idx > -1) {
            this.splice(idx, 1);
            return true;
        }
...
function propagateChanged(observable) {
    ...
    try {
        for (var _a = __values(observable.observers), _b = _a.next(); !_b.done; _b = _a.next()) {
            var d = _b.value;
...
if (typeof Proxy === "undefined") {
    throw new Error("[mobx] MobX 15+ requires Proxy objects. If your environment doesn't support Proxy objects, please downgrade to MobX 4.");
}
try {
