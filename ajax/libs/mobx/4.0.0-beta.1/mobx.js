...
var ComputedValue = /** @class */ (function () {
    ...
    function ComputedValue(options) {
        ...
        if (options.set)
            this.setter = createAction(name + "-setter", options.set);
        this.equals =
            options.equals ||
...
var ObservableObjectAdministration = /** @class */ (function () {
    ...
    ObservableObjectAdministration.prototype.getKeys = function () {
        if (this.keys === undefined) {
            this.keys = new ObservableArray(Object.keys(this.values), referenceEnhancer, "keys(" + this.name + ")", true);
        }
...
function defineComputedProperty(valueOwner, // which objects holds the observable and provides `this` context?
propertyOwner, // where is the property declared?
propName, options) {
    var adm = asObservableObject(valueOwner);
...
var computedDecorator = createPropDecorator(false, function (instance, propertyName, descriptor, decoratorTarget, decoratorArgs) {
    ...
    defineComputedProperty(instance, decoratorTarget, propertyName, __assign({}, options, { get: get, set: set }));
});
...
var observableFactories = {
    ...
    shallowMap: function (initialValues, options) {
        if (arguments.length > 2)
...
var Reaction = /** @class */ (function () {
    ...
    Reaction.prototype.onError = function (handler) {
        if (process.env.NODE_ENV !== "production") {
...
function flow(arg1, arg2) {
    // decorator
    if (typeof arguments[1] === "string")
        return flowDecorator.apply(null, arguments);
    // direct invocation
...
var generatorId = 0;
function createFlowGenerator(name, generator) {
...
function flowDecorator(target, propertyName, descriptor) {
    return {
        configurable: true,
        enumerable: false,
        get: function () {
            addHiddenFinalProp(this, propertyName, flow(propertyName, descriptor.initializer ? descriptor.initializer.call(this) : descriptor.value));
            return this[propertyName];
        },
        set: function (v) {
