(function (global, factory) {
     ...
     */
    function h(_tag, _props, _children, noNormalize) {
        ...
        if (isElement) {
            return inferno.createVNode(inferno.getFlagsForElementVnode(tag), tag, className, noNormalize === true ? (_children || children) : inferno.normalize(_children || children), props, key, ref);
        }
        else {
