(function (global, factory) {
    ...
    function h(_tag, _props, _children) {
        ...
        if (isElement) {
            return inferno.normalizeChildren(inferno.createVNode(inferno.getFlagsForElementVnode(tag), tag, className, null, 1 /* HasInvalidChildren */, props, key, ref), _children || children);
        }
        else {
