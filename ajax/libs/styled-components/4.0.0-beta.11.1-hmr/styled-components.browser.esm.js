...
var makeStyleTag = function makeStyleTag(target, tagEl, insertBefore) {
  ...
  el.setAttribute(SC_VERSION_ATTR, "4.0.0-beta.11.1-hmr");
...
var wrapAsHtmlTag = function wrapAsHtmlTag(css, names) {
  return function (additionalAttrs) {
    var nonce = getNonce();
    var attrs = [nonce && 'nonce="' + nonce + '"', SC_ATTR + '="' + stringifyNames(names) + '"', SC_VERSION_ATTR + '="' + "4.0.0-beta.11.1-hmr" + '"', additionalAttrs];
...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    var props = (_props = {}, _props[SC_ATTR] = stringifyNames(names), _props[SC_VERSION_ATTR] = "4.0.0-beta.11.1-hmr", _props);
...
var StyleSheet = function () {
  ...
  StyleSheet.prototype.rehydrate = function rehydrate() {
    ...
    var nodes = document.querySelectorAll('style[' + SC_ATTR + '][' + SC_VERSION_ATTR + '="' + "4.0.0-beta.11.1-hmr" + '"]');
...
function createGlobalStyle(strings) {
  ...
  var GlobalStyleComponent = function (_React$Component) {
    ...
    GlobalStyleComponent.prototype.componentDidMount = function componentDidMount() {
      if (process.env.NODE_ENV !== 'production' && IS_BROWSER && instances.length > 1) {
    ...
    GlobalStyleComponent.prototype.componentWillUnmount = function componentWillUnmount() {
      if (instances.includes(this)) instances.splice(instances.indexOf(this), 1);
       ...
       * not be immediate.
       */
      if (instances.length === 0) this.state.globalStyle.removeStyles(this.styleSheet);
    };
