 ...
 * */
var DISABLE_SPEEDY = typeof false === 'boolean' && false || "development" === 'development';
...
if (!DISABLE_SPEEDY) {
  BrowserTag = function (_BaseBrowserTag) {
    ...
    function SpeedyBrowserTag(el, isLocal, existingSource) {
      ...
      _this.ready = false;
      _this.names = el.getAttribute(SC_ATTR) || '';
    ...
    SpeedyBrowserTag.prototype.isFull = function isFull() {
    ...
    SpeedyBrowserTag.prototype.toRawCSS = function toRawCSS() {
      ...
      return Object.keys(this.components).reduce(function (acc, componentId) {
        var css = _this3.components[componentId].css;
    ...
    SpeedyBrowserTag.prototype.toHTML = function toHTML() {
      var attrs = ['type="text/css"', SC_ATTR + '="' + this.names + '"', LOCAL_ATTR + '="' + (this.isLocal ? 'true' : 'false') + '"'];
  ...
  BrowserTag = function (_BaseBrowserTag2) {
    ...
    function TextNodeBrowserTag(el, isLocal) {
      ...
      var _this4 = possibleConstructorReturn(this, _BaseBrowserTag2.call(this));
      ...
      _this4.el = el;
      _this4.isLocal = isLocal;
      _this4.ready = false;
      _this4.size = extractedComps.length;
      _this4.components = extractedComps.reduce(function (acc, obj) {
        acc[obj.componentId] = obj; // eslint-disable-line no-param-reassign
        return acc;
      }, {});
      return _this4;
    ...
    TextNodeBrowserTag.prototype.getComponentIds = function getComponentIds() {
      return Object.keys(this.components);
    };

    TextNodeBrowserTag.prototype.isFull = function isFull() {
    ...
    TextNodeBrowserTag.prototype.replaceElement = function replaceElement() {
      ...
      Object.keys(this.components).forEach(function (key) {
        var comp = _this5.components[key];
...
StyleSheetManager.propTypes = {
  sheet: index$4.oneOfType([index$4.instanceOf(StyleSheet), index$4.instanceOf(ServerStyleSheet)]).isRequired
};
...
var compressSymbols = function compressSymbols(code) {
  return code.split(symbolRegex).reduce(function (str, fragment, index) {
    ...
    if (countOccurences(str, "'") % 2 === 0 && countOccurences(str, '"') % 2 === 0 // eslint-disable-line no-useless-escape
    ) {
...
var minify = function minify(code) {
  var newCode = code.split(linebreakRegex) // Split at newlines
...
var ServerTag = function () {
  ...
  ServerTag.prototype.toHTML = function toHTML() {
    ...
    var nonce = getNonce();
    var outputCSS = this.concatenateCSS();
