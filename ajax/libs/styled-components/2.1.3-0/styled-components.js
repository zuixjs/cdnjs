...
var BrowserTag = function () {
  function BrowserTag(el) {
    var _this = this;

    var existingSource = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    ...
    this.textNodes = {};
    extractedComps.forEach(function (obj) {
      _this.textNodes[obj.componentId] = document.createTextNode(obj.cssFromDOM);
    });
  }

  BrowserTag.prototype.getComponentNode = function getComponentNode(componentId) {
    if (!this.ready) this.replaceElement();
    var existingTextNode = this.textNodes[componentId];
  ...
  BrowserTag.prototype.appendCSS = function appendCSS(componentId, css) {
    var textNode = this.getComponentNode(componentId);
    textNode.appendData(css);
  };

  BrowserTag.prototype.updateNames = function updateNames(names) {
  ...
  BrowserTag.prototype.replaceElement = function replaceElement() {
    ...
    var componentIds = Object.keys(this.textNodes);
    ...
    componentIds.forEach(function (componentId) {
      var textNode = _this2.textNodes[componentId];
...
var InMemoryTag = function () {
  function InMemoryTag(onBrowser, isLocal, names, browserTag) {
     ...
     * to 1. */
    if (browserTag) {
      var browserComps = browserTag.textNodes;
      var componentIds = Object.keys(browserComps);
      this.size = componentIds.length;
      this.components = componentIds.reduce(function (accum, componentId) {
        var _babelHelpers$extends;

        var cssFromDOM = browserComps[componentId].wholeText;
        return _extends({}, accum, (_babelHelpers$extends = {}, _babelHelpers$extends[componentId] = { componentId: componentId, css: [cssFromDOM], index: 1 }, _babelHelpers$extends));
      }, {});
    } else {
      this.components = {};
    }
  ...
  InMemoryTag.prototype.addComponent = function addComponent(componentId) {
    ...
    this.components[componentId] = { componentId: componentId, css: [], index: 0 };
    this.size += 1;
  };
  ...
  InMemoryTag.prototype.flush = function flush() {
    ...
    var browserTag = this.browserTag;
  ...
  InMemoryTag.prototype.concatenateCSS = function concatenateCSS() {
    var _this2 = this;

    return Object.keys(this.components).reduce(function (styles, k) {
      return styles + _this2.components[k].css.join('');
    }, '');
  };
  ...
  InMemoryTag.prototype.clone = function clone() {
    ...
    var copy = new InMemoryTag(this.onBrowser, this.isLocal, [].concat(this.names));
    copy.size = this.size;
...
var BrowserStyleSheet = {
  create: function create() {
    ...
    for (var i = 0; i < nodesLength; i += 1) {
      ...
      var existingNames = (el.getAttribute(SC_ATTR) || '').trim().split(/\s+/);
