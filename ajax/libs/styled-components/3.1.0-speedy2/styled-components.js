...
var SpeedyBrowserTag = function () {
  ...
  SpeedyBrowserTag.prototype.replaceElement = function replaceElement() {
    ...
    Object.keys(this.components).forEach(function (componentId) {
      ...
      comp.componentIndex = _this.componentSizes.length;
      comp.css = rules.join(' ');
      _this.componentSizes.push(injectedRules);
    });
  };

  SpeedyBrowserTag.prototype.getComponentIds = function getComponentIds() {
  ...
  SpeedyBrowserTag.prototype.toRawCSS = function toRawCSS() {
    ...
    return Object.keys(this.components).reduce(function (acc, componentId) {
      var css = _this2.components[componentId].css;
  ...
  SpeedyBrowserTag.prototype.toReactElement = function toReactElement() {
    throw new Error("BrowserTag doesn't implement toReactElement!");
  };

  SpeedyBrowserTag.prototype.clone = function clone() {
...
var TextNodeBrowserTag = function () {
  ...
  TextNodeBrowserTag.prototype.replaceElement = function replaceElement() {
    ...
    Object.keys(this.components).forEach(function (key) {
      var comp = _this3.components[key];
...
var BrowserTag = DISABLE_SPEEDY ? TextNodeBrowserTag : SpeedyBrowserTag;
