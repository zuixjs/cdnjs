var styled = (function (React) {
  ...
  var makeStyleTag = function makeStyleTag(target, tagEl, insertBefore) {
    ...
    el.setAttribute(SC_VERSION_ATTR, "4.0.0-beta.4-hmr");
  ...
  var wrapAsHtmlTag = function wrapAsHtmlTag(css, names) {
    return function (additionalAttrs) {
      var nonce = getNonce();
      var attrs = [nonce && 'nonce="' + nonce + '"', SC_ATTR + '="' + stringifyNames(names) + '"', SC_VERSION_ATTR + '="' + "4.0.0-beta.4-hmr" + '"', additionalAttrs];
  ...
  var wrapAsElement = function wrapAsElement(css, names) {
    return function () {
      ...
      var props = (_props = {}, _props[SC_ATTR] = stringifyNames(names), _props[SC_VERSION_ATTR] = "4.0.0-beta.4-hmr", _props);
  ...
  var StyleSheet = function () {
    ...
    StyleSheet.prototype.rehydrate = function rehydrate() {
      ...
      var nodes = document.querySelectorAll('style[' + SC_ATTR + '][' + SC_VERSION_ATTR + '="' + "4.0.0-beta.4-hmr" + '"]');
  ...
  */
    ...
    var GlobalStyleComponent = function (_React$PureComponent) {
      ...
      GlobalStyleComponent.prototype.componentWillUnmount = function componentWillUnmount() {
        ...
        var _state = this.state,
            globalStyle = _state.globalStyle,
            styledComponentId = _state.styledComponentId;
        ...
        if (count === 0) globalStyle.removeStyles(this.styleSheet);else if (IS_BROWSER && count > 1) {
          console.warn('The global style component ' + styledComponentId + ' was composed and rendered multiple times in your React component tree. Only the last-rendered copy will have its styles remain in <head>.');
        }
      };
  ...
  function keyframes(strings) {
    ...
    var rules = css(strings, interpolations);
  ...
  var reactIs_production_min_3$1 = reactIs_production_min$2.ContextConsumer;
  var reactIs_production_min_4$1 = reactIs_production_min$2.ContextProvider;
  var reactIs_production_min_5$1 = reactIs_production_min$2.Element;
  var reactIs_production_min_6$1 = reactIs_production_min$2.ForwardRef;
  var reactIs_production_min_7$1 = reactIs_production_min$2.Fragment;
  var reactIs_production_min_8$1 = reactIs_production_min$2.Profiler;
  var reactIs_production_min_9$1 = reactIs_production_min$2.Portal;
  var reactIs_production_min_10$1 = reactIs_production_min$2.StrictMode;
  var reactIs_production_min_11$1 = reactIs_production_min$2.isValidElementType;
  var reactIs_production_min_12$1 = reactIs_production_min$2.isAsyncMode;
  var reactIs_production_min_13$1 = reactIs_production_min$2.isContextConsumer;
  var reactIs_production_min_14$1 = reactIs_production_min$2.isContextProvider;
  var reactIs_production_min_15$1 = reactIs_production_min$2.isElement;
  var reactIs_production_min_16$1 = reactIs_production_min$2.isForwardRef;
  var reactIs_production_min_17$1 = reactIs_production_min$2.isFragment;
  var reactIs_production_min_18$1 = reactIs_production_min$2.isProfiler;
  var reactIs_production_min_19$1 = reactIs_production_min$2.isPortal;
  var reactIs_production_min_20$1 = reactIs_production_min$2.isStrictMode;
  ...
  var reactIs_development_3$1 = reactIs_development$2.ContextConsumer;
  var reactIs_development_4$1 = reactIs_development$2.ContextProvider;
  var reactIs_development_5$1 = reactIs_development$2.Element;
  var reactIs_development_6$1 = reactIs_development$2.ForwardRef;
  var reactIs_development_7$1 = reactIs_development$2.Fragment;
  var reactIs_development_8$1 = reactIs_development$2.Profiler;
  var reactIs_development_9$1 = reactIs_development$2.Portal;
  var reactIs_development_10$1 = reactIs_development$2.StrictMode;
  var reactIs_development_11$1 = reactIs_development$2.isValidElementType;
  var reactIs_development_12$1 = reactIs_development$2.isAsyncMode;
  var reactIs_development_13$1 = reactIs_development$2.isContextConsumer;
  var reactIs_development_14$1 = reactIs_development$2.isContextProvider;
  var reactIs_development_15$1 = reactIs_development$2.isElement;
  var reactIs_development_16$1 = reactIs_development$2.isForwardRef;
  var reactIs_development_17$1 = reactIs_development$2.isFragment;
  var reactIs_development_18$1 = reactIs_development$2.isProfiler;
  var reactIs_development_19$1 = reactIs_development$2.isPortal;
  var reactIs_development_20$1 = reactIs_development$2.isStrictMode;
  ...
  function generateId(componentStyleInstance, _displayName, parentComponentId) {
    ...
    var componentId = displayName + '-' + componentStyleInstance.generateName(displayName + nr);
  ...
  var BaseStyledComponent = function (_PureComponent) {
    inherits(BaseStyledComponent, _PureComponent);
    ...
    BaseStyledComponent.prototype.renderInner = function renderInner(theme) {
      ...
      for (key in this.props) {
        if (key === 'forwardedClass' || key === 'as') continue;else if (key === 'innerRef') {
          warnInnerRef();
        } else if (key === 'forwardedRef') propsForElement.ref = this.props[key];
        // Don't pass through non HTML tags through to HTML elements
        else if (!isTargetTag || index$1(key)) {
      ...
      return React.createElement(this.props.as || target, propsForElement);
    };
  ...
  function createStyledComponent(target, options, rules) {
     ...
     */
    var StyledComponent = React__default.forwardRef(function (props, ref) {
