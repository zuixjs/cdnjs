...
var makeStyleTag = function makeStyleTag(target, tagEl, insertBefore) {
  ...
  el.setAttribute(SC_VERSION_ATTR, "4.0.0-beta.11.1-hmr2");
...
var wrapAsHtmlTag = function wrapAsHtmlTag(css, names) {
  return function (additionalAttrs) {
    var nonce = getNonce();
    var attrs = [nonce && 'nonce="' + nonce + '"', SC_ATTR + '="' + stringifyNames(names) + '"', SC_VERSION_ATTR + '="' + "4.0.0-beta.11.1-hmr2" + '"', additionalAttrs];
...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    var props = (_props = {}, _props[SC_ATTR] = stringifyNames(names), _props[SC_VERSION_ATTR] = "4.0.0-beta.11.1-hmr2", _props);
...
var StyleSheet = function () {
  ...
  StyleSheet.prototype.rehydrate = function rehydrate() {
    ...
    var nodes = document.querySelectorAll('style[' + SC_ATTR + '][' + SC_VERSION_ATTR + '="' + "4.0.0-beta.11.1-hmr2" + '"]');
...
var classNameUseCheckInjector = (function (target) {
  ...
  target.componentDidMount = function componentDidMount() {
    ...
    var classNames = elementClassName.split(' ');
...
function createGlobalStyle(strings) {
  ...
  var GlobalStyleComponent = function (_React$Component) {
    ...
    function GlobalStyleComponent() {
      ...
      var styledComponentId = _this.constructor.styledComponentId;
    ...
    GlobalStyleComponent.prototype.componentDidMount = function componentDidMount() {
      if (process.env.NODE_ENV !== 'production' && IS_BROWSER && window.scCGSHMRCache[this.state.styledComponentId] > 1) {
    ...
    GlobalStyleComponent.prototype.componentWillUnmount = function componentWillUnmount() {
      if (window.scCGSHMRCache[this.state.styledComponentId]) window.scCGSHMRCache[this.state.styledComponentId] -= 1;
      /**
       * Depending on the order "render" is called this can cause the styles to be lost
       * until the next render pass of the remaining instance, which may
       * not be immediate.
       */
      if (window.scCGSHMRCache[this.state.styledComponentId] === 0) this.state.globalStyle.removeStyles(this.styleSheet);
    };
