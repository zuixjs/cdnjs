...
var BaseStyledNativeComponent = function (_Component) {
  ...
  function BaseStyledNativeComponent() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.attrs = {}, _temp), possibleConstructorReturn(_this, _ret);
  }
    ...
    return React__default.createElement(
      ...
      function (theme) {
        var _props = _this2.props,
            renderAs = _props.as,
            forwardedClass = _props.forwardedClass,
            forwardedRef = _props.forwardedRef,
            innerRef = _props.innerRef,
            _props$style = _props.style,
            style = _props$style === undefined ? [] : _props$style,
            props = objectWithoutProperties(_props, ['as', 'forwardedClass', 'forwardedRef', 'innerRef', 'style']);
        var defaultProps = forwardedClass.defaultProps,
            target = forwardedClass.target;
  ...
  BaseStyledNativeComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props, attrs) {
  ...
  BaseStyledNativeComponent.prototype.generateAndInjectStyles = function generateAndInjectStyles(theme, props) {
    var inlineStyle = props.forwardedClass.inlineStyle;
...
var _StyledNativeComponent = (function (InlineStyle) {
  var createStyledNativeComponent = function createStyledNativeComponent(target, options, rules) {
    ...
    var StyledNativeComponent = React__default.forwardRef(function (props, ref) {
