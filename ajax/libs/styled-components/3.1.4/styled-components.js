 ...
 * */
var DISABLE_SPEEDY = typeof false === 'boolean' && false || "development" !== 'production' || detectMicrosoftBrowser(); // IE and Edge have inconsistent behavior with the insertRule API
