...
var wrapAsHtmlTag = function wrapAsHtmlTag(css, names) {
  return function () {
    var nonce = getNonce();
    var nonceProp = nonce ? 'nonce="' + nonce + '" ' : '';
    var attr = SC_ATTR + '="' + names.join(' ') + '"';
...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    var props = (_props = {
      type: 'text/css'
    }, _props[SC_ATTR] = names.join(' '), _props);
...
var makeSpeedyTag = function makeSpeedyTag(el) {
  ...
  var insertRules = function insertRules(id, cssRules) {
...
var makeBrowserTag = function makeBrowserTag(el) {
  ...
  var insertMarker = function insertMarker(id) {
    ...
    var marker = markers[id] = document.createTextNode(makeTextMarker(id));
...
var makeRehydrationTag = function makeRehydrationTag(tag, els, extracted, names) {
  var isReady = false;

  /* rehydration function that adds all rules to the new tag */
  var rehydrate = function rehydrate() {
    /* only rehydrate once */
    if (isReady) {
      return;
    } else {
  ...
  return _extends({}, tag, {
    ...
    insertRules: function insertRules(id, cssRules) {
      rehydrate();
...
var StyleSheet = function () {
  ...
  StyleSheet.prototype.rehydrate = function rehydrate() {
    ...
    var rehydrationTag = makeRehydrationTag(tag, els, extracted, names);
  ...
  StyleSheet.reset = function reset() {
    ...
    global$1 = new StyleSheet(undefined, forceServer).rehydrate();
  };
  ...
  StyleSheet.prototype.clone = function clone() {
    ...
    sheet.hashes = _extends({}, this.hashes);
  ...
  StyleSheet.prototype.getNameForHash = function getNameForHash(hash) {
  ...
  StyleSheet.prototype.hasInjectedComponent = function hasInjectedComponent(id) {
  ...
  StyleSheet.prototype.inject = function inject(id, cssRules, hash, name) {
    var clones = this.clones;
  ...
  createClass(StyleSheet, null, [{
    key: 'global',
    get: function get$$1() {
      return global$1 || (global$1 = new StyleSheet().rehydrate());
    }
...
var _StyledComponent = (function (ComponentStyle, constructWithOptions) {
  ...
  var BaseStyledComponent = function (_Component) {
    ...
    BaseStyledComponent.prototype.generateAndInjectStyles = function generateAndInjectStyles(theme, props) {
      ...
      var styleSheet = this.context[CONTEXT_KEY] || StyleSheet.global;
...
var _ComponentStyle = (function (nameGenerator, flatten, stringifyRules) {
  var ComponentStyle = function () {
    ...
    ComponentStyle.prototype.generateAndInjectStyles = function generateAndInjectStyles(executionContext, styleSheet) {
      ...
      var existingName = styleSheet.getNameForHash(hash);
...
var _keyframes = (function (nameGenerator, stringifyRules, css) {
  return function (strings) {
    ...
    var existingName = StyleSheet.global.getNameForHash(hash);
    if (existingName !== undefined) {
      return existingName;
    }
    ...
    StyleSheet.global.inject('sc-keyframes-' + name, stringifyRules(rules, name, '@keyframes'), hash, name);
