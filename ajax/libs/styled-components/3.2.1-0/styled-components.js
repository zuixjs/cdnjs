...
var makeSpeedyTag = function makeSpeedyTag(el, makeExtraTag) {
  var names = Object.create(null);
  var markers = Object.create(null);
  var sizes = [];
  var extractImport = makeExtraTag !== undefined;
  var extraTag = void 0;

  var getExtraTag = function getExtraTag() {
...
var makeBrowserTag = function makeBrowserTag(el, makeExtraTag) {
  var names = Object.create(null);
  var markers = Object.create(null);
  var extractImport = makeExtraTag !== undefined;
  var extraTag = void 0;
...
var makeTag = function makeTag(target, lastEl, forceServer) {
  if (IS_BROWSER && !forceServer) {
    ...
    if (DISABLE_SPEEDY) {
      var makeExtraTag = function makeExtraTag() {
        return makeBrowserTag(makeStyleTag(target, el));
      };
      return makeBrowserTag(el, makeExtraTag);
    } else {
      var _makeExtraTag = function _makeExtraTag() {
        return makeSpeedyTag(makeStyleTag(target, el));
      };
      return makeSpeedyTag(el, _makeExtraTag);
    }
  }
