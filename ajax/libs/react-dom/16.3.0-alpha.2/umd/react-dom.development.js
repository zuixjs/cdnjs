...
var ReactFiberUnwindWork = function (hostContext, scheduleWork, isAlreadyFailedLegacyErrorBoundary) {
      ...
      if (typeof ref === 'function') {
      ...
      } else {
        {
          if (!ref.hasOwnProperty('current')) {
            warning_1(false, 'Unexpected ref object provided for %s. ' + 'Use either a ref-setter function or Reacte.createRef().%s', getComponentName(finishedWork), getStackAddendumByWorkInProgressFiber(finishedWork));
          }
        }
