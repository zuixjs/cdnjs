...
'use strict';var p=require("object-assign"),q=require("react"),t=require("fbjs/lib/emptyFunction"),w=require("fbjs/lib/emptyObject"),x=require("fbjs/lib/hyphenateStyleName"),y=require("fbjs/lib/memoizeStringOnly");
...
!1)).read(Infinity)},renderToStaticMarkup:function(a){return(new W(a,!0)).read(Infinity)},renderToNodeStream:function(){z("207")},renderToStaticNodeStream:function(){z("208")},version:"16.3.0-alpha.2"},Y=Object.freeze({default:X}),Z=Y&&X||Y;module.exports=Z["default"]?Z["default"]:Z;
