...
var ReactFiberClassComponent = function (scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState, recalculateCurrentTime) {
...
var ReactFiberBeginWork = function (config, hostContext, hydrationContext, scheduleWork, computeExpirationForFiber, recalculateCurrentTime) {
  ...
  var _ReactFiberClassCompo = ReactFiberClassComponent(scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState, recalculateCurrentTime),
              ...
              case SuspendException:
                {
                  ...
                  if (shouldCapture) {
                    ...
                    _workInProgress.memoizedState = true;
...
var ReactFiberScheduler = function (config) {
  ...
  var _ReactFiberBeginWork = ReactFiberBeginWork(config, hostContext, hydrationContext, scheduleWork, computeExpirationForFiber, recalculateCurrentTime),
