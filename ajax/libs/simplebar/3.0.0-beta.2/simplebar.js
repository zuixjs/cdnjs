    ...
    _createClass(SimpleBar, [{
      ...
      value: function initDOM() {
        ...
        if (Array.from(this.el.children).filter(function (child) {
          ...
          this.containerEl.classList.add(this.classNames.container);
          ...
          this.containerEl.appendChild(this.scrollContentEl);
      ...
      value: function hideNativeScrollbar() {
        ...
        this.scrollContentEl.style.marginBottom = "-".concat(this.scrollbarWidth || this.offsetSize, "px");
