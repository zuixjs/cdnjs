(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('glam'), require('react-dom'), require('react-input-autosize'), require('prop-types')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'glam', 'react-dom', 'react-input-autosize', 'prop-types'], factory) :
	(factory((global.Select = {}),global.React,global.glam,global.ReactDOM,global.AutosizeInput,global.PropTypes));
}(this, (function (exports,React,glam,reactDom,AutosizeInput,PropTypes) { 'use strict';
	...
	*/
	...
	function classNames(prefix, name, state) {
	  var arr = Array.isArray(name) ? name.map(function (i) {
	    return applyPrefixToName(prefix, i);
	...
	*/
	...
	var SelectContainer = function SelectContainer(props) {
	  ...
	  return React__default.createElement(
	    ...
	    _extends({
	      ...
	      className: cx('', { isDisabled: isDisabled, isRtl: isRtl })
	    }, innerProps),
	    children
	  );
	};
	    ...
	    value: function render() {
	      ...
	      return React__default.createElement(
	        Div,
	        {
	          ...
	          className: cx('value-container', { isMulti: isMulti, hasValue: hasValue }),
	...
	var Control = function Control(props) {
	  ...
	  return React__default.createElement(
	    Div,
	    _extends({
	      className: cx('control', { isDisabled: isDisabled, isFocused: isFocused }),
	...
	var GroupHeading = function GroupHeading(props) {
	  var cx = props.cx,
	      getStyles = props.getStyles,
	      cleanProps = objectWithoutProperties(props, ['cx', 'getStyles']);
	...
	var Input$1 = function Input$$1(_ref2) {
	  var cx = _ref2.cx,
	      getStyles = _ref2.getStyles,
	      innerRef = _ref2.innerRef,
	      isHidden = _ref2.isHidden,
	      isDisabled = _ref2.isDisabled,
	      props = objectWithoutProperties(_ref2, ['cx', 'getStyles', 'innerRef', 'isHidden', 'isDisabled']);
	  return React__default.createElement(
	    Div,
	...
	var MenuList = function MenuList(props) {
	  ...
	  return React__default.createElement(
	    Div,
	    _extends({
	      className: cx('menu-list', { isMulti: isMulti }),
	...
	var MenuPortal = function (_Component2) {
	  ...
	  function MenuPortal() {
	    ...
	    return _ret2 = (_temp2 = (_this2 = possibleConstructorReturn(this, (_ref6 = MenuPortal.__proto__ || Object.getPrototypeOf(MenuPortal)).call.apply(_ref6, [this].concat(args))), _this2), _this2.state = { placement: null }, _this2.getPortalPlacement = function (_ref7) {
	...
	var MultiValue = function MultiValue(props) {
	  ...
	  var cn = {
	    container: cx('multi-value', { isDisabled: isDisabled }),
	...
	var Option = function Option(props) {
	  ...
	  return React__default.createElement(
	    Div,
	    _extends({
	      className: cx('option', { isFocused: isFocused, isSelected: isSelected }),
	...
	var SingleValue = function SingleValue(props) {
	  ...
	  return React__default.createElement(
	    Div,
	    _extends({
	      className: cx('single-value', { isDisabled: isDisabled }),
	...
	var Select = function (_Component) {
	  ...
	  createClass(Select, [{
	    ...
	    value: function getCommonProps() {
	      ...
	      var cx = className ? classNames.bind(null, className) : noop;
	      return {
	        cx: cx,
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.getActiveDescendentId = function () {
	    ...
	    var _state4 = _this7.state,
	        menuOptions = _state4.menuOptions,
	        focusedOption = _state4.focusedOption;
