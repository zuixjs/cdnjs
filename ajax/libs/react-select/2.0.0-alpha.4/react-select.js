...
var Strong = createPrimitive('strong');


var Ul = function Ul(_ref2) {
  var css = _ref2.css,
      innerRef = _ref2.innerRef,
      props = objectWithoutProperties(_ref2, ['css', 'innerRef']);
  return glam('ul', _extends({ ref: innerRef, css: _extends({ margin: 0, padding: 0 }, css) }, props));
};
var Li = function Li(_ref3) {
  var css = _ref3.css,
      innerRef = _ref3.innerRef,
      props = objectWithoutProperties(_ref3, ['css', 'innerRef']);
  return glam('li', _extends({ ref: innerRef, css: _extends({ listStyle: 'none' }, css) }, props));
};

var SROnly = function SROnly(props) {
...
DropdownIndicator.defaultProps = {
  children: glam(DownChevron, null)
};
...
var LoadingContainer = function LoadingContainer(_ref3) {
  var size = _ref3.size;
  return glam(Div, {
    css: {
      alignSelf: 'center',
...
var LoadingDot = function LoadingDot(_ref4) {
...
var LoadingIcon = function LoadingIcon(_ref5) {
  var isFocused = _ref5.isFocused,
      _ref5$size = _ref5.size,
      size = _ref5$size === undefined ? 4 : _ref5$size;
...
var LoadingIndicator = function LoadingIndicator(props) {
  ...
  return glam(
    ...
    glam(LoadingIcon, { isFocused: props.isFocused })
  );
};
...
var menuListCSS = function menuListCSS(_ref) {
...
var MultiValue = function MultiValue(props) {
  ...
  return React__default.createElement(
    Container,
    _extends({ className: cn.container, css: css$$1.container }, innerProps),
    React__default.createElement(
      Label,
    ...
    React__default.createElement(
      Remove,
      _extends({ className: cn.remove, css: css$$1.remove }, removeProps),
...
var Select$1 = function (_Component) {
  ...
  createClass(Select, [{
    ...
    value: function buildMenuOptions(options, selectValue) {
      ...
      var toOption = function toOption(option) {
    ...
    value: function formatOptionLabel(data, context) {
      if (typeof this.props.formatOptionLabel === 'function') {
        var _state = this.state,
            _inputValue = _state.inputValue,
            _selectValue2 = _state.selectValue;
    ...
    value: function focusOption() {
      ...
      var blockOptionHover = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    value: function renderInput(id) {
      ...
      var _state4 = this.state,
          inputIsHidden = _state4.inputIsHidden,
      ...
      if (isDisabled) return React__default.createElement('div', { style: { height: this.inputHeight } });
    ...
    value: function renderMenu() {
      ...
      var _props7 = this.props,
          ...
          maxMenuHeight = _props7.maxMenuHeight,
          loadingMessage = _props7.loadingMessage,
          noOptionsMessage = _props7.noOptionsMessage;
    ...
    value: function render() {
      ...
      var _props9 = this.props,
          ...
          maxValueHeight = _props9.maxValueHeight;
      var isFocused = this.state.isFocused;
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setValue = function (newValue) {
    ...
    var _props10 = _this7.props,
        closeMenuOnSelect = _props10.closeMenuOnSelect,
        isMulti = _props10.isMulti,
    ...
    var newState = _this7.buildStateForInputValue();
    if (closeMenuOnSelect) {
      newState.menuIsOpen = false;
      newState.inputIsHidden = isMulti ? false : true;
    }
    _this7.setState(newState, onChange ? function () {
      return onChange(newValue, { action: action });
    } : undefined);
  };
  ...
  this.removeValue = function (removedValue) {
    ...
    if (onChange) {
      var _selectValue4 = _this7.state.selectValue;

      onChange(_selectValue4.filter(function (i) {
  ...
  this.popValue = function () {
    ...
    if (onChange) {
      var _selectValue5 = _this7.state.selectValue;

      onChange(_selectValue5.slice(0, _selectValue5.length - 1), {
        action: 'pop-value'
      });
    }
  };
  ...
  this.onKeyDown = function (event) {
    var _props12 = _this7.props,
        backspaceRemovesValue = _props12.backspaceRemovesValue,
        isClearable = _props12.isClearable,
        escapeClearsValue = _props12.escapeClearsValue,
        isDisabled = _props12.isDisabled,
        onKeyDown = _props12.onKeyDown,
        tabSelectsValue = _props12.tabSelectsValue;
    ...
    switch (event.keyCode) {
      ...
      case 27:
        ...
        if (menuIsOpen) {
          _this7.setState(_extends({
            menuIsOpen: false
          }, _this7.buildStateForInputValue()));
      ...
      case 33:
        ...
        _this7.focusOption('pageup', true);
        break;
      case 34:
        // page down
        if (!menuIsOpen) return;
        _this7.focusOption('pagedown', true);
        break;
      case 36:
        // home key
        if (!menuIsOpen) return;
        _this7.focusOption('first', true);
        break;
      case 35:
        // end key
        if (!menuIsOpen) return;
        _this7.focusOption('last', true);
        break;
      default:
        return;
    }
  ...
  this.onInputChange = function (event) {
    ...
    _this7.setState(_extends({
      inputIsHidden: false,
      menuIsOpen: true
    }, _this7.buildStateForInputValue(inputValue)));
  };
  ...
  this.onDropdownIndicatorMouseDown = function (event) {
    ...
    var isMulti = _this7.props.isMulti;
    var menuIsOpen = _this7.state.menuIsOpen;
  ...
  this.getOptionId = function (option) {
    return _this7.getElementId('option') + '-' + _this7.getOptionValue(option);
  };

  this.getActiveDescendentId = function () {
    var _state8 = _this7.state,
        focusedOption = _state8.focusedOption,
        menuIsOpen = _state8.menuIsOpen;

    return focusedOption && menuIsOpen ? _this7.getOptionId(focusedOption) : undefined;
  };
};
