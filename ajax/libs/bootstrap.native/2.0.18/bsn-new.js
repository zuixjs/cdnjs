  ...
  var Modal = function(element, options) { // element can be the modal/triggering button
    ...
    var self = this, relatedTarget = null,
      ...
      isModalOpen = function() {
        return (window.getComputedStyle(modal, null).getPropertyValue('display') == 'block' ? true : false);
      },
      // triggers
      ...
      clickHandler = function(e) {
        ...
        if ( clickTarget === element && !isModalOpen()) {
      ...
      keyHandler = function(e) {
        ...
        if (self[keyboard] && key == 27 && isModalOpen()) {
          self.hide();
        }
      },
      dismissHandler = function(e) {
        var clickTarget = e[target];
        if ( isModalOpen() && (clickTarget[parentNode][getAttribute](dataDismiss) === component
    ...
    // public methods
    this.toggle = function() {
      if ( isModalOpen() ) {this.hide();} else {this.show();}
    };
    this.show = function() {
