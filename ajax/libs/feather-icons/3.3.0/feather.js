...
function toSvg(key) {
  ...
  var attributes = optionsToAttributes(combinedOptions);
...
var _toSvg = __webpack_require__(48);

var _toSvg2 = _interopRequireDefault(_toSvg);

var _replace = __webpack_require__(86);
...
function replaceElement(element, options) {
  ...
  var elementIdAttr = element.getAttribute('id');
  var classNames = options.class ? options.class + ' ' + elementClassAttr : elementClassAttr;

  var svgOptions = Object.assign({}, options, { class: classNames, id: elementIdAttr });
  var svgString = (0, _toSvg2.default)(key, svgOptions);
