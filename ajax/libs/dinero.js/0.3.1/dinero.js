  ...
  var Dinero = function Dinero(options) {
    ...
    return {
      ...
      multiply: function multiply(multiplier) {
        return create.call(this, {
          amount: calculator$1.multiply(this.getAmount(), multiplier)
        });
      },
      ...
      divide: function divide(divisor) {
        return create.call(this, {
          amount: calculator$1.divide(this.getAmount(), divisor)
        });
      },
      ...
      toRoundedUnit: function toRoundedUnit(precision) {
        ...
        return calculator$1.divide(Math.round(calculator$1.multiply(this.toUnit(), factor)), factor);
      },
