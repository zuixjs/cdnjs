	...
	var Dinero = function Dinero(options) {
	  ...
	  return {
	    ...
	    toRoundedUnit: function toRoundedUnit(digits) {
	      ...
	      return calculator$1.divide(calculator$1.round(calculator$1.multiply(calculator$1.divide(this.getAmount(), Math.pow(10, precision)), factor), roundingMode), factor);
	    },
