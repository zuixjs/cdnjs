(function (global, factory) {
  ...
  var Dinero = function Dinero(options) {
    ...
    var create = function create(options) {
      var obj = _extends({}, _extends({}, { amount: amount, currency: currency }, options), _extends({}, { locale: this.locale }, options));
      return _extends(Dinero({ amount: obj.amount, currency: obj.currency }), {
        locale: obj.locale
      });
    };
  ...
  var dinero = _extends(Dinero, Defaults, Globals);
