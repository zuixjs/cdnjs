    ...
    var ClientSvcQueryable = /** @class */ (function (_super) {
        ...
        function ClientSvcQueryable(parent, _objectPaths) {
            ...
            if (typeof parent === "string") {
                ...
                _this._url = common.combinePaths(parent.replace(ProcessQueryPath, ""), ProcessQueryPath);
                ...
                _this._url = common.combinePaths(parent._parentUrl, ProcessQueryPath);
        ...
        ClientSvcQueryable.prototype.inBatch = function (batch) {
            if (this.batch !== null) {
                throw new odata.AlreadyInBatchException();
            }
            this._batch = batch;
            return this;
        };
        ...
        ClientSvcQueryable.prototype.sendGetCollection = function (factory) {
            var _this = this;
            var ops = this._objectPaths.clone().appendActionToLast(opQuery([], this.getSelects()));
            return this.send(ops).then(function (r) { return r.map(function (d) { return common.extend(new factory(_this), d); }); });
        };
        /**
