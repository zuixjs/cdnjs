...
(function (global, factory) {
	...
	(factory((global.Inferno = global.Inferno || {}, global.Inferno.Redux = global.Inferno.Redux || {}),global.Inferno.Component,global.redux,global.hoistStatics,global.Inferno.createElement));
...
var defaultMergeProps = function (parentProps, stateProps, dispatchProps) {
    ...
    if (stateProps) {
        for (key in stateProps) {
            obj[key] = stateProps[key];
        }
    }
    if (dispatchProps) {
        for (key in dispatchProps) {
