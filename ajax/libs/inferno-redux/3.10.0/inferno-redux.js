(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('inferno'), require('hoist-non-inferno-statics'), require('inferno-component'), require('redux')) :
  typeof define === 'function' && define.amd ? define(['exports', 'inferno', 'hoist-non-inferno-statics', 'inferno-component', 'redux'], factory) :
  (factory((global.Inferno = global.Inferno || {}, global.Inferno.Redux = {}),global.Inferno,global.hoistStatics,global.Inferno.Component,global.redux));
}(this, (function (exports,inferno,hoistStatics,Component,redux) { 'use strict';
