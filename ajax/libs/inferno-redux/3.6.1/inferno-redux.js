(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function connectAdvanced(selectorFactory, _a) {
      var getDisplayName = _a.getDisplayName; if ( getDisplayName === void 0 ) getDisplayName = (function (name) { return ("ConnectAdvanced(" + name + ")"); });
  ...
  /**
   * @module Inferno-Shared
   */ /** TypeDoc Comment */ function toArray(children) {
  ...
  /**
   * @module Inferno-Redux
   */ /** TypeDoc Comment */ var warning$1 = function (message) {
  ...
  var createConnect = function (ref) {
      ...
      var connect = function (mapStateToProps, mapDispatchToProps, mergeProps, _a) {
          if ( _a === void 0 ) _a = {};
