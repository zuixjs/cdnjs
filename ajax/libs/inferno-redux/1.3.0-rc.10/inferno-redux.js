...
var defaultMergeProps = function (stateProps, dispatchProps, parentProps) { return assign({}, parentProps, stateProps, dispatchProps); };
    ...
    return function wrapWithConnect(WrappedComponent) {
        ...
        var Connect = (function (Component$$1) {
            ...
            Connect.prototype.render = function render () {
                ...
                if (withRef) {
                    this.renderedElement = createElement(WrappedComponent, assign({}, this.mergedProps, { ref: function (instance) { return this$1.wrappedInstance = instance; } }));
                }
                else {
