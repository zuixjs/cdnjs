 ...
 */
    ...
    if (typeof reactDom.unstable_batchedUpdates === "function")
        mobx.configure({ reactionScheduler: reactDom.unstable_batchedUpdates })
    else if (typeof unstable_batchedUpdates$1 === "function")
        mobx.configure({ reactionScheduler: unstable_batchedUpdates$1 })
    ...
    if (
        ...
        var mobx$1 = { spy: mobx.spy, extras: extras }
        var mobxReact = {
