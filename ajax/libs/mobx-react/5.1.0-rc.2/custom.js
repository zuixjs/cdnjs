;(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ? factory(exports, require("mobx"), require("react"))
        : typeof define === "function" && define.amd
            ? define(["exports", "mobx", "react"], factory)
            : factory((global.mobxReact = {}), global.mobx, global.React)
})(this, function(exports, mobx, react) {
    "use strict"
    ...
    function createChainableTypeChecker(validate) {
        function checkType(isRequired, props, propName, componentName, location, propFullName) {
            for (
                var _len = arguments.length, rest = Array(_len > 6 ? _len - 6 : 0), _key = 6;
                _key < _len;
                _key++
            ) {
            ...
            return mobx.untracked(function() {
                ...
                if (props[propName] == null) {
                    ...
                    return validate.apply(
                        undefined,
                        [props, propName, componentName, location, propFullName].concat(rest)
                    )
                }
            })
        }
    ...
    function createObservableArrayOfTypeChecker(allowNativeType, typeChecker) {
        return createChainableTypeChecker(function(
            ...
            for (
                var _len2 = arguments.length, rest = Array(_len2 > 5 ? _len2 - 5 : 0), _key2 = 5;
                _key2 < _len2;
                _key2++
            ) {
            ...
            return mobx.untracked(function() {
                ...
                var error = createObservableTypeCheckerCreator(allowNativeType, "Array")(
                    props,
                    propName,
                    componentName
                )
            ...
            function Injector() {
                ...
                return (
                    (_ret = ((_temp = ((_this = possibleConstructorReturn(
                        this,
                        (_ref = Injector.__proto__ || Object.getPrototypeOf(Injector)).call.apply(
                            _ref,
                            [this].concat(args)
                        )
                    )),
    ...
    function observer(arg1, arg2) {
        ...
        if (
            ...
            return observer(
                ...
                (_class.displayName = componentClass.displayName || componentClass.name),
    ...
    var ObserverPropsCheck = function ObserverPropsCheck(
        props,
        key,
        componentName,
        location,
    ...
    var Provider = ((_temp = _class = (function(_Component) {
        ...
        function Provider(props, context) {
            ...
            var _this = possibleConstructorReturn(
                this,
                (Provider.__proto__ || Object.getPrototypeOf(Provider)).call(this, props, context)
            )
    ...
    else if (typeof unstable_batchedUpdates === "function")
        mobx.configure({ reactionScheduler: unstable_batchedUpdates })
