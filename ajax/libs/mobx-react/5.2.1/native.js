...
var skipRenderKey = Symbol("mobxReact-skipRender");
var isForcingUpdateKey = Symbol("mobxReact-isForcingUpdate");
...
function makeObservableProp(target, propName) {
    var valueHolderKey = Symbol(propName + " value holder");
    var atomHolderKey = Symbol(propName + " atom holder");
    function getAtom() {
