(function (global, factory) {
    ...
    (factory((global.Inferno = global.Inferno || {}, global.Inferno.Mobx = {}),global.mobx,global.Inferno,global.Inferno.createClass,global.Inferno.createElement,global.hoistStatics));
}(this, (function (exports,mobx,inferno,createClass,infernoCreateElement,hoistStatics) { 'use strict';

    createClass = createClass && createClass.hasOwnProperty('default') ? createClass['default'] : createClass;
    infernoCreateElement = infernoCreateElement && infernoCreateElement.hasOwnProperty('default') ? infernoCreateElement['default'] : infernoCreateElement;
    ...
    */
    ...
    function cloneVNode(vNodeToClone, props) {
        ...
        if (isArray$1(vNodeToClone)) {
            ...
            if (flags & 28 /* Component */) {
                newVNode = inferno.createVNode(flags, vNodeToClone.type, null, null, !vNodeToClone.props && !props
                    ? inferno.EMPTY_OBJ
                ...
                newVNode = inferno.createVNode(flags, vNodeToClone.type, className, children, !vNodeToClone.props && !props
                    ? inferno.EMPTY_OBJ
                    : combineFrom(vNodeToClone.props, props), key, ref, false);
            }
            else if (flags & 1 /* Text */) {
                newVNode = inferno.createVNode(1 /* Text */, null, null, vNodeToClone.children, null, key, null, true);
            }
        }
        return newVNode;
    }
    ...
    var createElement = injectStringRefs(infernoCreateElement);
