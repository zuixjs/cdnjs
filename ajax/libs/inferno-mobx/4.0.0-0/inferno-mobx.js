(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('inferno'), require('hoist-non-inferno-statics')) :
    typeof define === 'function' && define.amd ? define(['exports', 'inferno', 'hoist-non-inferno-statics'], factory) :
    (factory((global.Inferno = global.Inferno || {}, global.Inferno.Mobx = {}),global.Inferno,global.hoistStatics));
}(this, (function (exports,inferno,hoistStatics) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ObservableArray = (function (_super) {
        ...
        ObservableArray.prototype.get = function (index) {
            ...
            if (impl) {
                ...
                console.error("[mobx.array] Attempt to read an array index (" + index + ") that is out of bounds (" + impl
                    .values
        ...
        if (!global_1.__mobxInstanceCount) {
            ...
            setTimeout((function () {
                if (!shareGlobalStateCalled && !runInIsolationCalled && !warnedAboutMultipleInstances) {
                    ...
                    console.error("[mobx] Warning: there are multiple mobx instances active. This might lead to unexpected results. See https://github.com/mobxjs/mobx/issues/1082 for details.");
                }
            }));
        }
    }
        ...
        Object.defineProperty(everything, p, {
            get: function () {
                if (!warnedAboutDefaultExport) {
                    ...
                    console.error("Using default export (`import mobx from 'mobx'`) is deprecated " +
    ...
    function findNode(component) {
        if (inferno.options.findDOMNodeEnabled) {
            return inferno.findDOMNode(component);
        }
        return null;
    }
    ...
    var reactiveMixin = {
        componentWillMount: function componentWillMount() {
            ...
            var initialRender = function () {
                ...
                reaction$$1.reactComponent = this$1;
    ...
    function observer(arg1, arg2) {
        ...
        if (typeof component === "function" &&
            ...
            return observer((_a = (function (Component$$1) {
                ...
                _a.prototype.render = function render (props, state, context) {
    ...
    function createStoreInjector(grabStoresFn, component, injectNames) {
        ...
        var Injector = (function (Component$$1) {
            ...
            Injector.prototype.render = function render (props, state, context) {
                ...
                return inferno.createVNode(16 /* ComponentUnknown */, component, null, null, newProps, null, isStateless(component) ? null : this.storeRef);
            };
