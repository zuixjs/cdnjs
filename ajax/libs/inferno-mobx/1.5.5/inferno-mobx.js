...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('inferno-component'), require('mobx'), require('inferno-create-class'), require('hoist-non-inferno-statics'), require('inferno-create-element')) :
	typeof define === 'function' && define.amd ? define(['exports', 'inferno-component', 'mobx', 'inferno-create-class', 'hoist-non-inferno-statics', 'inferno-create-element'], factory) :
	(factory((global.Inferno = global.Inferno || {}, global.Inferno.Mobx = global.Inferno.Mobx || {}),global.Inferno.Component,global.mobx,global.Inferno.createClass,global.hoistStatics,global.Inferno.createElement));
}(this, (function (exports,Component,mobx,createClass,hoistStatics,createElement) { 'use strict';
