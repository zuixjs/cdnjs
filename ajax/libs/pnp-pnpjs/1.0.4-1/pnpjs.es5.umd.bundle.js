/**
@license
 * @pnp/pnpjs v1.0.4-1 - pnp - rollup library of core functionality (mimics sp-pnp-js)
...
/**
@license
 * @pnp/logging v1.0.4-1 - pnp - light-weight, subscribable logging framework
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return readBlobAsText; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return readBlobAsArrayBuffer; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return mergeHeaders; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return getCtxCallback; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return getRandomString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return getGUID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return isFunc; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return objectDefinedNotNull; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return isArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return extend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return isUrlAbsolute; });
...
/**
@license
 * @pnp/common v1.0.4-1 - pnp - provides shared functionality across all pnp libraries
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var PnPClientStorageWrapper = /** @class */ (function () {
    ...
    function PnPClientStorageWrapper(store, defaultTimeoutMinutes) {
        ...
        if (RuntimeConfig.enableCacheExpiration) {
            __WEBPACK_IMPORTED_MODULE_2__pnp_logging__["c" /* Logger */].write("Enabling cache expiration.", 1 /* Info */);
    ...
    PnPClientStorageWrapper.prototype.get = function (key) {
        ...
        if (new Date(persistable.expiration) <= new Date()) {
            __WEBPACK_IMPORTED_MODULE_2__pnp_logging__["c" /* Logger */].write("Removing item with key '" + key + "' from cache due to expiration.", 1 /* Info */);
            this.delete(key);
            return null;
        }
        else {
    ...
    PnPClientStorageWrapper.prototype.cacheExpirationHandler = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_2__pnp_logging__["c" /* Logger */].write("Called cache expiration handler.", 0 /* Verbose */);
...
/**
@license
 * @pnp/odata v1.0.4-1 - pnp - provides shared odata functionality and base classes
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var CachingOptions = /** @class */ (function () {
    function CachingOptions(key) {
        this.key = key;
        this.expiration = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].dateAdd(new Date(), "second", __WEBPACK_IMPORTED_MODULE_0__pnp_common__["g" /* RuntimeConfig */].defaultCachingTimeoutSeconds);
...
var BufferParser = /** @class */ (function () {
    ...
    BufferParser.prototype.parse = function (r) {
        if (__WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].isFunc(r.arrayBuffer)) {
        ...
        return new Promise(function (resolve) {
            ...
            if (context.verb === "GET" && context.isCached) {
                ...
                if (typeof context.cachingOptions !== "undefined") {
                    cacheOptions = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].extend(cacheOptions, context.cachingOptions);
                }
    ...
    PipelineMethods.send = function (context) {
        return new Promise(function (resolve, reject) {
            ...
            if (context.isBatched) {
                ...
                var opts = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].extend(context.options || {}, { method: context.verb });
...
var ODataQueryable = /** @class */ (function () {
    ...
    */
    ...
    Object.defineProperty(ODataQueryable.prototype, "hasBatch", {
         ...
         */
        get: function () {
            return __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].objectDefinedNotNull(this._batch);
        },
        enumerable: true,
        configurable: true
    });
    ...
    ODataQueryable.prototype.append = function (pathPart) {
        this._url = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].combinePaths(this._url, pathPart);
    };
...
var ODataBatch = /** @class */ (function () {
    function ODataBatch(_batchId) {
        if (_batchId === void 0) { _batchId = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].getGUID(); }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_110", function() { return util; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_104", function() { return sp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_90", function() { return graph; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_108", function() { return storage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_81", function() { return config; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_94", function() { return log; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_103", function() { return setup; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "v", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["m"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "w", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["n"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "x", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["o"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "B", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["q"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "C", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["r"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "D", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["s"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "X", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["B"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["C"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["D"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["G"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["H"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_19", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["N"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_20", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["O"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_22", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["P"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_27", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["Q"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_28", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["R"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_29", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["S"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_32", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["V"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_43", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_3"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_44", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_4"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_55", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_12"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_56", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_13"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_57", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_14"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_58", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_15"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_59", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_16"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_60", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_17"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_61", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_18"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_62", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_19"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_63", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_20"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_71", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_24"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_73", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_25"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_74", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_26"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_75", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_27"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_76", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_28"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_77", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_29"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_78", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_30"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_105", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_31"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_106", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_32"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_107", function() { return __WEBPACK_IMPORTED_MODULE_6__pnp_sp__["_33"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "N", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "O", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "P", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["d"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "R", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["e"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "S", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["f"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "T", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["g"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "U", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["h"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "V", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["i"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "W", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["j"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_12", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["k"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_13", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["l"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_18", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["m"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_21", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["n"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_45", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["o"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_46", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["p"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_64", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["q"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_65", function() { return __WEBPACK_IMPORTED_MODULE_3__pnp_graph__["r"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "z", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "A", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_24", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_25", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_33", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["g"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_34", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["h"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_70", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["i"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_72", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_79", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["k"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_80", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["l"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_82", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["m"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_84", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["n"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_85", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["o"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_86", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["p"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_88", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["q"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_89", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["r"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_91", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["s"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_92", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["t"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_93", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["u"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_95", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["v"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_96", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["w"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_97", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["x"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_99", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["y"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_100", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["z"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_109", function() { return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["A"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "u", function() { return __WEBPACK_IMPORTED_MODULE_0__pnp_logging__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "M", function() { return __WEBPACK_IMPORTED_MODULE_0__pnp_logging__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return __WEBPACK_IMPORTED_MODULE_0__pnp_logging__["c"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return __WEBPACK_IMPORTED_MODULE_2__pnp_config_store__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_36", function() { return __WEBPACK_IMPORTED_MODULE_2__pnp_config_store__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_47", function() { return __WEBPACK_IMPORTED_MODULE_2__pnp_config_store__["d"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["f"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_14", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["g"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_15", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["h"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_16", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["i"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_17", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["j"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_23", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["k"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_26", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["l"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_67", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["m"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_87", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["n"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_98", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["o"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_101", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["p"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_102", function() { return __WEBPACK_IMPORTED_MODULE_7__pnp_odata__["q"]; });
 ...
 */
/* harmony default export */ __webpack_exports__["_83"] = (Def);
...
/**
@license
 * @pnp/config-store v1.0.4-1 - pnp - provides a way to manage configuration within your application
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
/**
@license
 * @pnp/graph v1.0.4-1 - pnp - provides functionality to query the Microsoft Graph
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var GraphHttpClient = /** @class */ (function () {
    ...
    GraphHttpClient.prototype.fetch = function (url, options) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["v" /* mergeHeaders */])(headers, GraphRuntimeConfig.headers);
        // second we add the local options so we can overwrite the globals
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["v" /* mergeHeaders */])(headers, options.headers);
        if (!headers.has("Content-Type")) {
            headers.append("Content-Type", "application/json");
        }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { headers: headers });
    ...
    GraphHttpClient.prototype.fetchRaw = function (url, options) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["v" /* mergeHeaders */])(rawHeaders, options.headers);
        options = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { headers: rawHeaders });
        var retry = function (ctx) {
            _this._impl.fetch(url, options).then(function (response) { return ctx.resolve(response); }).catch(function (response) {
                ...
                setTimeout(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].getCtxCallback(_this, retry, ctx), delay);
            });
        };
        return new Promise(function (resolve, reject) {
            var retryContext = {
    ...
    GraphHttpClient.prototype.get = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { method: "GET" });
        return this.fetch(url, opts);
    };
    GraphHttpClient.prototype.post = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { method: "POST" });
        return this.fetch(url, opts);
    };
    GraphHttpClient.prototype.patch = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { method: "PATCH" });
        return this.fetch(url, opts);
    };
    GraphHttpClient.prototype.delete = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { method: "DELETE" });
        return this.fetch(url, opts);
    };
...
var GraphQueryable = /** @class */ (function (_super) {
    ...
    function GraphQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            _this._url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(urlStr, path);
        }
        else {
            var q = baseUrl;
            _this._parentUrl = q._url;
            _this._options = q._options;
            _this._url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(_this._parentUrl, path);
        }
        return _this;
    }
    /**
    ...
    GraphQueryable.prototype.as = function (factory) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(o, this, true);
    };
    /**
    ...
    GraphQueryable.prototype.toUrlAndQuery = function () {
        var _this = this;
        var url = this.toUrl();
        if (!__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].isUrlAbsolute(url)) {
            url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths("https://graph.microsoft.com", url);
        }
    ...
    GraphQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        return Promise.resolve({
            ...
            requestId: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].getGUID(),
            verb: verb,
        });
    };
...
var Groups = /** @class */ (function (_super) {
    ...
    Groups.prototype.add = function (name, mailNickname, groupType, additionalProperties) {
        ...
        var postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
            displayName: name,
        ...
        if (groupType !== GroupType.Security) {
            postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(postBody, {
    ...
    GraphBatch.prototype.executeImpl = function () {
        ...
        return client.fetch(this.batchUrl, batchOptions)
            ...
            return parsedResponse.responses.reduce(function (chain, response, index) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].objectDefinedNotNull(request)) {
    ...
    GraphBatch.prototype.formatRequests = function () {
        return this.requests.map(function (reqInfo, index) {
            ...
            if (typeof GraphRuntimeConfig.headers !== "undefined" && GraphRuntimeConfig.headers !== null) {
                headers = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(headers, GraphRuntimeConfig.headers);
            }
            if (typeof reqInfo.options !== "undefined") {
                // merge per request headers
                if (typeof reqInfo.options.headers !== "undefined" && reqInfo.options.headers !== null) {
                    headers = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(headers, reqInfo.options.headers);
                }
                // add a request body
                if (typeof reqInfo.options.body !== "undefined" && reqInfo.options.body !== null) {
                    requestFragment = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(requestFragment, {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_31", function() { return spExtractODataId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_32", function() { return spODataEntity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_33", function() { return spODataEntityArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return SharePointQueryable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return SharePointQueryableInstance; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return SharePointQueryableCollection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return SharePointQueryableSecurable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return FileFolderShared; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_9", function() { return SharePointQueryableShareable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_10", function() { return SharePointQueryableShareableFile; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return SharePointQueryableShareableFolder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_12", function() { return SharePointQueryableShareableItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_13", function() { return SharePointQueryableShareableWeb; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return ContentType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return ContentTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return FieldLink; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return FieldLinks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return Field; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return Fields; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return CheckinType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_30", function() { return WebPartsPersonalizationScope; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return MoveOperations; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_21", function() { return TemplateFileType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return File; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return Files; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return Folder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return Folders; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "W", function() { return SPHttpClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return Item; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return Items; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return ItemVersion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return ItemVersions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return PagedItemCollection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "L", function() { return NavigationNodes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "K", function() { return NavigationNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return NavigationService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return List; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return Lists; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return RegionalSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return InstalledLanguages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_22", function() { return TimeZone; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_23", function() { return TimeZones; });
/* unused harmony export sp */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X", function() { return SPRest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "U", function() { return RoleDefinitionBindings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return Search; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return SearchQueryBuilder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return SearchResults; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_20", function() { return SortDirection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return ReorderingRuleMatchType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return QueryPropertyValueType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return SearchBuiltInSourceId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return SearchSuggest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return SearchSuggestResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_18", function() { return Site; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_25", function() { return UtilityMethod; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_29", function() { return WebPartDefinitions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_28", function() { return WebPartDefinition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_27", function() { return WebPart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_26", function() { return Web; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_19", function() { return SocialQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return MySocialQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return ControlMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return FieldTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return DateTimeFieldFormatType; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_24", function() { return UrlFieldFormatType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return PermissionKind; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "V", function() { return RoleType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return PageType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_15", function() { return SharingLinkKind; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_17", function() { return SharingRole; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_16", function() { return SharingOperationStatusCode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return SPSharedObjectType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_14", function() { return SharingDomainRestrictionMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return RenderListDataOptions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return FieldUserSelectionMode; });
...
/**
@license
 * @pnp/sp v1.0.4-1 - pnp - provides a fluent api for working with SharePoint REST
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var SPODataEntityParserImpl = /** @class */ (function (_super) {
    ...
    function SPODataEntityParserImpl(factory) {
        ...
        _this.hydrate = function (d) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(o, d);
        };
        return _this;
    }
    ...
    function SPODataEntityArrayParserImpl(factory) {
        ...
        _this.hydrate = function (d) {
            return d.map(function (v) {
                ...
                return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(o, v);
            });
        };
        return _this;
    }
...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(extractWebUrl(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
    }
...
var DigestCache = /** @class */ (function () {
    ...
    DigestCache.prototype.getDigest = function (webUrl) {
        ...
        var url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(webUrl, "/_api/contextinfo");
        var headers = {
        ...
        return this._httpClient.fetchRaw(url, {
            ...
            headers: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(headers, SPRuntimeConfig.headers, true),
            method: "POST",
...
var SPHttpClient = /** @class */ (function () {
    ...
    SPHttpClient.prototype.fetch = function (url, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, { cache: "no-cache", credentials: "same-origin" }, true);
        var headers = new Headers();
        // first we add the global headers so they can be overwritten by any passed in locally to this call
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["v" /* mergeHeaders */])(headers, SPRuntimeConfig.headers);
        // second we add the local options so we can overwrite the globals
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["v" /* mergeHeaders */])(headers, options.headers);
        ...
        opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(opts, { headers: headers });
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        if (__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].isUrlAbsolute(candidateUrl)) {
            // if we are already absolute, then just return the url
            return resolve(candidateUrl);
        }
        if (SPRuntimeConfig.baseUrl !== null) {
            // base url specified either with baseUrl of spfxContext config property
            return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(SPRuntimeConfig.baseUrl, candidateUrl));
        }
        if (typeof global._spPageContextInfo !== "undefined") {
            // operating in classic pages
            if (global._spPageContextInfo.hasOwnProperty("webAbsoluteUrl")) {
                return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(global._spPageContextInfo.webAbsoluteUrl, candidateUrl));
            }
            else if (global._spPageContextInfo.hasOwnProperty("webServerRelativeUrl")) {
                return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(global._spPageContextInfo.webServerRelativeUrl, candidateUrl));
            }
        }
        ...
        if (typeof global.location !== "undefined") {
            ...
            ["/_layouts/", "/siteassets/"].forEach(function (s) {
                ...
                if (index > 0) {
                    return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(baseUrl_1.substr(0, index), candidateUrl));
                }
            });
        }
        return resolve(candidateUrl);
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].isUrlAbsolute(urlStr) || urlStr.lastIndexOf("/") < 0) {
                _this._parentUrl = urlStr;
                _this._url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(urlStr, path);
            }
                ...
                path = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(urlStr.slice(index), path);
                _this._url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(_this._parentUrl, path);
            }
            else {
                // .../items(19)
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        return toAbsoluteUrl(this.toUrlAndQuery()).then(function (url) {
            Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["w" /* mergeOptions */])(options, _this._options);
...
var SiteUser = /** @class */ (function (_super) {
    ...
    */
    SiteUser.prototype.update = function (properties) {
        var _this = this;
        var postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.User" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
var SiteGroups = /** @class */ (function (_super) {
    ...
    SiteGroups.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.Group" } }, properties));
...
var SiteGroup = /** @class */ (function (_super) {
    ...
    */
    ...
    SiteGroup.prototype.update = function (properties) {
        var _this = this;
        var postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.Group" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
var RoleDefinitions = /** @class */ (function (_super) {
    ...
    RoleDefinitions.prototype.add = function (name, description, order, basePermissions) {
        ...
        var postBody = JSON.stringify({
            BasePermissions: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ __metadata: { type: "SP.BasePermissions" } }, basePermissions),
...
var RoleDefinition = /** @class */ (function (_super) {
    ...
    RoleDefinition.prototype.update = function (properties) {
        ...
        if (typeof properties.hasOwnProperty("BasePermissions") !== "undefined") {
            properties["BasePermissions"] = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ __metadata: { type: "SP.BasePermissions" } }, properties["BasePermissions"]);
        }
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
            "__metadata": { "type": "SP.RoleDefinition" },
        }, properties));
        return this.postCore({
            body: postBody,
...
var SharePointQueryableShareable = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareable.prototype.shareObject = function (options, bypass) {
        ...
        options = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(options, {
            group: null,
...
var SharePointQueryableShareableWeb = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareableWeb.prototype.shareWith = function (loginNames, role, emailData) {
        ...
        return web.get().then(function (url) {
            dependency();
            return _this.shareObject(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(url, "/_layouts/15/aclinv.aspx?forSharing=1&mbypass=1"), loginNames, role, emailData);
        });
    };
    /**
    ...
    */
    ...
    Folder.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(new Item(spGetEntityUrl(d)), d);
        });
    };
    return Folder;
...
var Fields = /** @class */ (function (_super) {
    ...
    Fields.prototype.createFieldAsXml = function (xml) {
        ...
        var postBody = JSON.stringify({
            "parameters": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
                "__metadata": {
    ...
    Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (typeof minValue !== "undefined") {
            props = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ MinimumValue: minValue }, props);
        }
        if (typeof maxValue !== "undefined") {
            props = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    ...
    */
    Fields.prototype.addUser = function (title, selectionMode, properties) {
        ...
        return this.add(title, "SP.FieldUser", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addChoice = function (title, choices, format, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldChoice", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultiChoice = function (title, choices, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldMultiChoice", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addBoolean = function (title, properties) {
        ...
        return this.add(title, "SP.Field", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(props, properties));
    };
    return Fields;
}(SharePointQueryableCollection));
/**
...
var UserCustomActions = /** @class */ (function (_super) {
    ...
    UserCustomActions.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ __metadata: { "type": "SP.UserCustomAction" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
...
var Lists = /** @class */ (function (_super) {
    ...
    Lists.prototype.add = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        if (additionalSettings === void 0) { additionalSettings = {}; }
        var addSettings = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
    ...
    Lists.prototype.ensure = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        return new Promise(function (resolve, reject) {
            var addOrUpdateSettings = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(additionalSettings, { Title: title, Description: description, ContentTypesEnabled: enableContentTypes }, true);
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.getChanges = function (query) {
        return this.clone(List, "getchanges").postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getItemsByCAMLQuery = function (query) {
        ...
        return q.expand.apply(q, expands).postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.CamlQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getListItemChangesSinceToken = function (query) {
        return this.clone(List, "getlistitemchangessincetoken").postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.ChangeLogItemQuery" } }, query) }),
    ...
    List.prototype.renderListDataAsStream = function (parameters, overrideParameters) {
        ...
        var postBody = {
            overrideParameters: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
...
var File = /** @class */ (function (_super) {
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].getGUID();
    ...
    ClientSidePage.create = function (library, pageName, title, pageLayoutType) {
        ...
        return library.rootFolder.files.select("Name").filter("Name eq '" + pageName + "'").get().then(function (fs) {
            ...
            return library.rootFolder.select("ServerRelativePath").get().then(function (path) {
                var pageServerRelPath = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths("/", path.ServerRelativePath.DecodedUrl, pageName);
...
var CanvasControl = /** @class */ (function () {
    function CanvasControl(controlType, dataVersion, column, order, id, controlData) {
        ...
        if (id === void 0) { id = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].getGUID(); }
...
var TimeZone = /** @class */ (function (_super) {
    ...
    TimeZone.prototype.localTimeToUTC = function (localTime) {
        ...
        if (typeof localTime === "string") {
            ...
            dateIsoString = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].dateAdd(localTime, "minute", localTime.getTimezoneOffset() * -1).toISOString();
        }
...
var SearchQueryBuilder = /** @class */ (function () {
    ...
    SearchQueryBuilder.prototype.extendQuery = function (part) {
        this._query = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(this._query, part);
        return this;
    };
...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.execute = function (query) {
        ...
        var postBody = JSON.stringify({
            request: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
...
var SearchResults = /** @class */ (function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var query = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(this._query, {
            RowLimit: rows,
...
var SPBatch = /** @class */ (function (_super) {
    ...
    SPBatch.prototype.executeImpl = function () {
        ...
        return toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                if (reqInfo.method === "GET") {
                    ...
                    if (currentChangeSetId.length < 1) {
                        ...
                        currentChangeSetId = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].getGUID();
                        batchBody.push("--batch_" + _this.batchId + "\n");
                ...
                var url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].isUrlAbsolute(reqInfo.url) ? reqInfo.url : __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(absoluteRequestUrl, reqInfo.url);
                ...
                // merge per-request headers
                if (reqInfo.options) {
                    Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["v" /* mergeHeaders */])(headers, reqInfo.options.headers);
                }
                // lastly we apply any default headers we need that may not exist
                if (!headers.has("Accept")) {
                    headers.append("Accept", "application/json");
            ...
            return client.fetch(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].combinePaths(absoluteRequestUrl, "/_api/$batch"), batchOptions)
...
var Web = /** @class */ (function (_super) {
    ...
    */
    ...
    Web.prototype.getChanges = function (query) {
        var postBody = JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) });
...
var UserProfileQuery = /** @class */ (function (_super) {
    ...
    UserProfileQuery.prototype.setMyProfilePic = function (profilePicSource) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["y" /* readBlobAsArrayBuffer */])(profilePicSource).then(function (buffer) {
...
var ClientPeoplePickerQuery = /** @class */ (function (_super) {
    ...
    ClientPeoplePickerQuery.prototype.createClientPeoplePickerQueryParametersRequestBody = function (queryParams) {
        return JSON.stringify({
            "queryParams": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
...
var SocialQuery = /** @class */ (function (_super) {
    ...
    SocialQuery.prototype.createSocialActorInfoRequestBody = function (actorInfo) {
        return JSON.stringify({
            "actor": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend({
                Id: null,
...
var UtilityMethod = /** @class */ (function (_super) {
    ...
    UtilityMethod.prototype.sendEmail = function (props) {
        ...
        if (props.To && props.To.length > 0) {
            params.properties = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["j" /* Util */].extend(params.properties, {
                To: { results: props.To },
            });
        }
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "util", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_110"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "sp", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_104"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "graph", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_90"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "storage", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_108"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "config", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_81"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "log", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_94"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "setup", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_103"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "spExtractODataId", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_105"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "spODataEntity", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_106"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "spODataEntityArray", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_107"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_48"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableInstance", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_50"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_49"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableSecurable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_51"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FileFolderShared", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["I"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_52"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableFile", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_53"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableFolder", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_54"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableItem", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_55"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableWeb", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_56"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ContentType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["v"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ContentTypes", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["w"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FieldLink", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["C"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FieldLinks", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["D"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Field", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["B"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Fields", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["G"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPartsPersonalizationScope", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_78"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "MoveOperations", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_6"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "TemplateFileType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_66"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "File", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["H"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Files", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["J"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Folder", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["K"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Folders", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["L"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SPHttpClient", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_35"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Item", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["Y"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Items", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_1"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ItemVersion", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["Z"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ItemVersions", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_0"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PagedItemCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_20"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NavigationNodes", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_9"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NavigationNode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_8"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NavigationService", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_10"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "List", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_3"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Lists", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_4"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RegionalSettings", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_28"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "InstalledLanguages", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["X"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "TimeZone", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_68"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "TimeZones", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_69"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SPRest", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_37"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RoleDefinitionBindings", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_31"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Search", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_39"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchQueryBuilder", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_41"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchResults", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_42"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SortDirection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_63"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ReorderingRuleMatchType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_30"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "QueryPropertyValueType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_27"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchBuiltInSourceId", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_40"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchSuggest", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_43"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchSuggestResult", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_44"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Site", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_61"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "UtilityMethod", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_73"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPartDefinitions", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_77"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPartDefinition", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_76"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPart", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_75"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Web", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_74"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SocialQuery", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_62"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "MySocialQuery", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_7"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ControlMode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["x"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FieldTypes", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["E"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "DateTimeFieldFormatType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["y"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "UrlFieldFormatType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_71"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PermissionKind", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_22"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RoleType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_32"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PageType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_19"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingLinkKind", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_58"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingRole", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_60"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingOperationStatusCode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_59"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SPSharedObjectType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_38"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingDomainRestrictionMode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_57"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RenderListDataOptions", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_29"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FieldUserSelectionMode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["F"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphRest", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["T"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GroupType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["V"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Group", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["U"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Groups", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["W"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphBatch", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["N"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphQueryable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["P"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphQueryableCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["Q"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphQueryableInstance", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["R"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphQueryableSearchableCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["S"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Teams", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_65"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Team", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_64"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "GraphEndpoints", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["O"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "OneNote", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_18"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Notebooks", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_13"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Notebook", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_12"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Sections", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_46"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Section", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_45"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Pages", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_21"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "readBlobAsText", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_100"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "readBlobAsArrayBuffer", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_99"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Dictionary", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["z"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "deprecated", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_84"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "beta", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_79"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "UrlException", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_70"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RuntimeConfigImpl", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_34"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RuntimeConfig", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_33"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "mergeHeaders", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_95"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "mergeOptions", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_96"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FetchClient", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["A"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PnPClientStorageWrapper", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_25"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PnPClientStorage", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_24"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "getCtxCallback", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_86"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "dateAdd", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_82"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "combinePaths", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_80"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "getRandomString", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_89"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "getGUID", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_88"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "isFunc", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_92"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "objectDefinedNotNull", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_97"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "isArray", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_91"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "extend", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_85"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "isUrlAbsolute", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_93"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "stringIsNullOrEmpty", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_109"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Util", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_72"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Logger", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_5"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ConsoleListener", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["u"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FunctionListener", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["M"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Settings", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_47"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SPListConfigurationProvider", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_36"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NoCacheAvailableException", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_11"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ProcessHttpClientResponseException", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_26"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ODataParserBase", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_16"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ODataDefaultParser", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_15"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "TextParser", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_67"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "JSONParser", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_2"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "setResult", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_102"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "pipe", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_98"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "requestPipelineMethod", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_101"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PipelineMethods", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_23"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "getDefaultPipeline", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_87"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ODataQueryable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_17"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ODataBatch", function() { return __WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_14"]; });


/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__src_pnpjs__["_83" /* default */]);
...
/**
@license
 * @pnp/sp-addinhelpers v1.0.4-1 - pnp - provides functionality for working within SharePoint add-ins
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var SPRequestExecutorClient = /** @class */ (function () {
    ...
    SPRequestExecutorClient.prototype.fetch = function (url, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (options.body) {
                requestOptions = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].extend(requestOptions, { body: options.body });
            }
            else {
                requestOptions = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].extend(requestOptions, { binaryStringRequestBody: true });
            }
...
var SPRestAddIn = /** @class */ (function (_super) {
    ...
    SPRestAddIn.prototype.crossDomainSite = function (addInWebUrl, hostWebUrl) {
        return this._cdImpl(__WEBPACK_IMPORTED_MODULE_3__pnp_sp__["_18" /* Site */], addInWebUrl, hostWebUrl, "site");
    };
    /**
    ...
    SPRestAddIn.prototype.crossDomainWeb = function (addInWebUrl, hostWebUrl) {
        return this._cdImpl(__WEBPACK_IMPORTED_MODULE_3__pnp_sp__["_26" /* Web */], addInWebUrl, hostWebUrl, "web");
    };
    /**
    ...
    SPRestAddIn.prototype._cdImpl = function (factory, addInWebUrl, hostWebUrl, urlPart) {
        if (!__WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].isUrlAbsolute(addInWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_0__pnp_common__["i" /* UrlException */]("The addInWebUrl parameter must be an absolute url.");
        }
        if (!__WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].isUrlAbsolute(hostWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_0__pnp_common__["i" /* UrlException */]("The hostWebUrl parameter must be an absolute url.");
        }
        var url = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["j" /* Util */].combinePaths(addInWebUrl, "_api/SP.AppContextSite(@target)");
        var instance = new factory(url, urlPart);
        instance.query.add("@target", "'" + encodeURIComponent(hostWebUrl) + "'");
        return instance.configure(this._options);
    };
    return SPRestAddIn;
}(__WEBPACK_IMPORTED_MODULE_3__pnp_sp__["X" /* SPRest */]));
