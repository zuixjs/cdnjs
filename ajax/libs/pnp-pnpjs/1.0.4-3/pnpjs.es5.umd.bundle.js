/**
@license
 * @pnp/pnpjs v1.0.4-3 - pnp - rollup library of core functionality (mimics sp-pnp-js)
...
/**
@license
 * @pnp/sp v1.0.4-3 - pnp - provides a fluent api for working with SharePoint REST
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var SPODataEntityParserImpl = /** @class */ (function (_super) {
    ...
    function SPODataEntityParserImpl(factory) {
        ...
        _this.hydrate = function (d) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(o, d);
        };
        return _this;
    }
    ...
    function SPODataEntityArrayParserImpl(factory) {
        ...
        _this.hydrate = function (d) {
            return d.map(function (v) {
                ...
                return Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(o, v);
            });
        };
        return _this;
    }
...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["l" /* combinePaths */])(extractWebUrl(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
    }
...
var DigestCache = /** @class */ (function () {
    ...
    DigestCache.prototype.getDigest = function (webUrl) {
        ...
        return this._httpClient.fetchRaw(url, {
            ...
            headers: Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(headers, SPRuntimeConfig.headers, true),
            method: "POST",
...
var SPHttpClient = /** @class */ (function () {
    ...
    SPHttpClient.prototype.fetch = function (url, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var opts = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(options, { cache: "no-cache", credentials: "same-origin" }, true);
        var headers = new Headers();
        // first we add the global headers so they can be overwritten by any passed in locally to this call
        ...
        opts = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(opts, { headers: headers });
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        if (Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["u" /* isUrlAbsolute */])(candidateUrl)) {
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["u" /* isUrlAbsolute */])(urlStr) || urlStr.lastIndexOf("/") < 0) {
                _this._parentUrl = urlStr;
                _this._url = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["l" /* combinePaths */])(urlStr, path);
            }
                ...
                path = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["l" /* combinePaths */])(urlStr.slice(index), path);
...
var SiteUser = /** @class */ (function (_super) {
    ...
    */
    SiteUser.prototype.update = function (properties) {
        var _this = this;
        var postBody = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.User" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
var SiteGroups = /** @class */ (function (_super) {
    ...
    SiteGroups.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.Group" } }, properties));
...
var SiteGroup = /** @class */ (function (_super) {
    ...
    */
    ...
    SiteGroup.prototype.update = function (properties) {
        var _this = this;
        var postBody = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.Group" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
var RoleDefinitions = /** @class */ (function (_super) {
    ...
    RoleDefinitions.prototype.add = function (name, description, order, basePermissions) {
        ...
        var postBody = JSON.stringify({
            BasePermissions: Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ __metadata: { type: "SP.BasePermissions" } }, basePermissions),
...
var RoleDefinition = /** @class */ (function (_super) {
    ...
    RoleDefinition.prototype.update = function (properties) {
        ...
        if (typeof properties.hasOwnProperty("BasePermissions") !== "undefined") {
            properties["BasePermissions"] = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ __metadata: { type: "SP.BasePermissions" } }, properties["BasePermissions"]);
        }
        var postBody = JSON.stringify(Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
            "__metadata": { "type": "SP.RoleDefinition" },
        }, properties));
        return this.postCore({
            body: postBody,
...
var SharePointQueryableShareable = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareable.prototype.shareObject = function (options, bypass) {
        ...
        options = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(options, {
            group: null,
    ...
    */
    ...
    Folder.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(new Item(spGetEntityUrl(d)), d);
        });
    };
    return Folder;
...
var Fields = /** @class */ (function (_super) {
    ...
    Fields.prototype.createFieldAsXml = function (xml) {
        ...
        var postBody = JSON.stringify({
            "parameters": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
                "__metadata": {
    ...
    Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (typeof minValue !== "undefined") {
            props = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ MinimumValue: minValue }, props);
        }
        if (typeof maxValue !== "undefined") {
            props = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    ...
    */
    Fields.prototype.addUser = function (title, selectionMode, properties) {
        ...
        return this.add(title, "SP.FieldUser", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addChoice = function (title, choices, format, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldChoice", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultiChoice = function (title, choices, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldMultiChoice", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    /**
    ...
    Fields.prototype.addBoolean = function (title, properties) {
        ...
        return this.add(title, "SP.Field", Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(props, properties));
    };
    return Fields;
}(SharePointQueryableCollection));
/**
...
var UserCustomActions = /** @class */ (function (_super) {
    ...
    UserCustomActions.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ __metadata: { "type": "SP.UserCustomAction" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
...
var Lists = /** @class */ (function (_super) {
    ...
    Lists.prototype.add = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        if (additionalSettings === void 0) { additionalSettings = {}; }
        var addSettings = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
    ...
    Lists.prototype.ensure = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        return new Promise(function (resolve, reject) {
            var addOrUpdateSettings = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(additionalSettings, { Title: title, Description: description, ContentTypesEnabled: enableContentTypes }, true);
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.getChanges = function (query) {
        return this.clone(List, "getchanges").postCore({
            body: JSON.stringify({ "query": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.ChangeQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getItemsByCAMLQuery = function (query) {
        ...
        return q.expand.apply(q, expands).postCore({
            body: JSON.stringify({ "query": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.CamlQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getListItemChangesSinceToken = function (query) {
        return this.clone(List, "getlistitemchangessincetoken").postCore({
            body: JSON.stringify({ "query": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.ChangeLogItemQuery" } }, query) }),
    ...
    List.prototype.renderListDataAsStream = function (parameters, overrideParameters) {
        ...
        var postBody = {
            overrideParameters: Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
...
var File = /** @class */ (function (_super) {
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["q" /* getGUID */])();
...
var CanvasSection = /** @class */ (function () {
    function CanvasSection(page, order, columns) {
        ...
        this._memId = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["q" /* getGUID */])();
    }
...
var CanvasControl = /** @class */ (function () {
    function CanvasControl(controlType, dataVersion, column, order, id, controlData) {
        ...
        if (id === void 0) { id = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["q" /* getGUID */])(); }
...
var ClientSideWebpart = /** @class */ (function (_super) {
    ...
    ClientSideWebpart.prototype.setProperties = function (properties) {
        this.propertieJson = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(this.propertieJson, properties);
        return this;
    };
...
var SearchQueryBuilder = /** @class */ (function () {
    ...
    SearchQueryBuilder.prototype.extendQuery = function (part) {
        this._query = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(this._query, part);
        return this;
    };
...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.execute = function (query) {
        ...
        var postBody = JSON.stringify({
            request: Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
...
var SearchResults = /** @class */ (function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var query = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(this._query, {
            RowLimit: rows,
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                if (reqInfo.method === "GET") {
                    ...
                    if (currentChangeSetId.length < 1) {
                        ...
                        currentChangeSetId = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["q" /* getGUID */])();
                        batchBody.push("--batch_" + _this.batchId + "\n");
                ...
                var url = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["u" /* isUrlAbsolute */])(reqInfo.url) ? reqInfo.url : Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["l" /* combinePaths */])(absoluteRequestUrl, reqInfo.url);
...
var Web = /** @class */ (function (_super) {
    ...
    */
    ...
    Web.prototype.getChanges = function (query) {
        var postBody = JSON.stringify({ "query": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({ "__metadata": { "type": "SP.ChangeQuery" } }, query) });
...
var ClientPeoplePickerQuery = /** @class */ (function (_super) {
    ...
    ClientPeoplePickerQuery.prototype.createClientPeoplePickerQueryParametersRequestBody = function (queryParams) {
        return JSON.stringify({
            "queryParams": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
...
var SocialQuery = /** @class */ (function (_super) {
    ...
    SocialQuery.prototype.createSocialActorInfoRequestBody = function (actorInfo) {
        return JSON.stringify({
            "actor": Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])({
                Id: null,
...
var UtilityMethod = /** @class */ (function (_super) {
    ...
    UtilityMethod.prototype.sendEmail = function (props) {
        ...
        if (props.To && props.To.length > 0) {
            params.properties = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["o" /* extend */])(params.properties, {
                To: { results: props.To },
            });
        }
...
/**
@license
 * @pnp/sp-addinhelpers v1.0.4-3 - pnp - provides functionality for working within SharePoint add-ins
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: https://pnp.github.io/pnp/
 * source: https://github.com/pnp/pnp
...
var SPRequestExecutorClient = /** @class */ (function () {
    ...
    SPRequestExecutorClient.prototype.fetch = function (url, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (options.body) {
                requestOptions = Object(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["o" /* extend */])(requestOptions, { body: options.body });
            }
            else {
                requestOptions = Object(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["o" /* extend */])(requestOptions, { binaryStringRequestBody: true });
            }
...
var SPRestAddIn = /** @class */ (function (_super) {
    ...
    SPRestAddIn.prototype._cdImpl = function (factory, addInWebUrl, hostWebUrl, urlPart) {
        if (!Object(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["u" /* isUrlAbsolute */])(addInWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_0__pnp_common__["i" /* UrlException */]("The addInWebUrl parameter must be an absolute url.");
        }
        if (!Object(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["u" /* isUrlAbsolute */])(hostWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_0__pnp_common__["i" /* UrlException */]("The hostWebUrl parameter must be an absolute url.");
        }
        var url = Object(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["l" /* combinePaths */])(addInWebUrl, "_api/SP.AppContextSite(@target)");
