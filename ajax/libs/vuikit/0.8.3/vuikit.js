...
function ready (fn) {
  ...
  var unbind1 = on(global.document, 'DOMContentLoaded', handle);
  var unbind2 = on(global.window, 'load', handle);
}
...
var isRtl = global.document && attr(document.documentElement, 'dir') === 'rtl';
var hasTouchEvents = global.window && 'ontouchstart' in window;
var hasPointerEvents = global.window && window.PointerEvent;
var hasTouch = hasTouchEvents ||
  global.window && global.document && window.DocumentTouch && document instanceof DocumentTouch ||
  global.navigator && navigator.maxTouchPoints;
...
var Promise = global.window && 'Promise' in global.window ? global.window.Promise : PromiseFn;
var RESOLVED = 0;
var REJECTED = 1;
var PENDING = 2;
var async = global.window && 'setImmediate' in window ? global.setImmediate : global.setTimeout;
...
ready(function () {
  on(global.document, 'click', function () { return clicked = true; }, true);
  on(global.document, pointerDown, function (e) {
    var target = e.target;
    var ref = getPos$1(e);
    var x = ref.x;
    var y = ref.y;
  ...
  on(global.document, pointerMove, function (e) {
  ...
  on(global.document, pointerUp, function (ref) {
    var type = ref.type;
    var target = ref.target;
...
var touching = false;
on(global.document, 'touchstart', function () { return touching = true; }, true);
on(global.document, 'click', function () { touching = false; });
on(global.document, 'touchcancel', function () { return touching = false; }, true);
function isTouch (e) {
...
var VkMargin = {
  ...
  inserted: function inserted (el, binding, vnode) {
    ...
    el[NAMESPACE].unbind = on(global.window, 'resize', function () { return update(el, { binding: binding, vnode: vnode }); }
    );
  },
  componentUpdated: function componentUpdated (el, binding, vnode) {
    vnode.context.$nextTick(function () { return update(el, { binding: binding, vnode: vnode }); }
...
var doc = global.document && document.documentElement;
var active$1;
var activeModals;
var Transition$2 = {
  functional: true,
...
var doc$1 = global.document && document.documentElement;
var core$1 = {
  mixins: [EventsMixin],
  props: {
    show: {
...
var VkModalOverflowAuto = {
  bind: function bind (el, binding) {
    el.vkModalOverflowAutoOff = on(global.window, 'resize', function () { return update$1(el, binding); });
...
var VkHeightViewport = {
  ...
  inserted: function inserted (el, binding, vnode) {
    ...
    el[NAMESPACE$1].unbind = on(global.window, 'resize', function () { return update$2(el, { binding: binding, vnode: vnode }); }
    );
  },
  componentUpdated: function componentUpdated (el, binding, vnode) {
    vnode.context.$nextTick(function () { return update$2(el, { binding: binding, vnode: vnode }); }
...
var active$2;
var scrollbarWidth;
var win = global.window && window;
var body = global.document && document.body;
var doc$2 = global.document && document.documentElement;
var scroll;
...
var scroll$1 = 0;
var instances = [];
on(global.window, 'load resize', function () { return instances.forEach(function (i) { return i.fastdomUpdate(); }); }
);
on(global.window, 'scroll', function (e) {
...
var index$3 = {
  ...
  inserted: function inserted (el, binding, vnode) {
    ...
    el[NAMESPACE$5].unbind = on(global.window, 'resize', function () { return update$3(el, { binding: binding, vnode: vnode }); }
    );
  },
  componentUpdated: function componentUpdated (el, binding, vnode) {
    vnode.context.$nextTick(function () { return update$3(el, { binding: binding, vnode: vnode }); }
