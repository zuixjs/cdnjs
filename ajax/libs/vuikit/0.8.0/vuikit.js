...
var breadcrumb = {
  name: 'VkBreadcrumb',
  functional: true,
  props: Element$1.props,
  render: Element$1.render
}
...
var breadcrumbItem = {
  ...
  functional: true,
  props: Element$2.props,
  render: Element$2.render
}
...
var button = {
  name: 'VkButton',
  functional: true,
  props: Element$3.props,
  render: Element$3.render
}
...
var buttonLink = {
  name: 'VkButtonLink',
  functional: true,
  props: Element$4.props,
  render: Element$4.render
}
...
var buttonGroup = {
  name: 'VkButtonGroup',
  functional: true,
  props: Element$5.props,
  render: Element$5.render
}
...
var card = {
  name: 'VkCard',
  functional: true,
  props: Element$6.props,
  render: Element$6.render
}
...
var cardTitle = {
  name: 'VkCardTitle',
  functional: true,
  props: Element$7.props,
  render: Element$7.render
}
...
var toggle = {
  ...
  mounted: function mounted () {
    ...
    this.$nextTick(function () {
      if (/click/.test(mode)) {
        on$$1(this$1.$refs.target, pointerDown, toggle);
      }
      if (/hover/.test(mode)) {
        on$$1(this$1.$refs.target, pointerEnter, show);
        on$$1(this$1.$refs.target, pointerLeave, hide);
...
var iconImage = {
  name: 'VkIconImage',
  functional: true,
  props: Element$9.props,
  render: Element$9.render
}
...
var iconnavItem = {
  ...
  render: function render (h, ref) {
    var data = ref.data;
    var props = ref.props;
    return h(Element$12, mergeData(data, { props: props }), [
...
var label = {
  name: 'VkLabel',
  functional: true,
  props: Element$14.props,
  render: Element$14.render
}
...
var core$1 = {
  ...
  mounted: function mounted () {
    var this$1 = this;
    this.$nextTick(function () { return this$1.$root.$el.appendChild(this$1.$el); });
  },
  beforeDestroy: function beforeDestroy () {
    if (this.$el.parentNode) {
      this.$el.parentNode.removeChild(this.$el);
...
var modalClose = {
  name: 'VkModalClose',
  functional: true,
  props: Element$15.props,
  render: Element$15.render
}
...
var modalFullClose = {
  ...
  functional: true,
  props: Element$16.props,
  render: Element$16.render
}
...
var modalTitle = {
  name: 'VkModalTitle',
  functional: true,
  props: Element$17.props,
  render: Element$17.render
}
...
var nav = {
  name: 'VkNav',
  functional: true,
  props: Element$18.props,
  render: Element$18.render
}
...
var navItem = {
  ...
  render: function render (h, ref) {
    ...
    return h(Element$20, mergeData(data, { props: props }))
  }
}
...
var navItemHeader = {
  ...
  functional: true,
  props: Element$21.props,
  render: Element$21.render
}
...
var navItemParent = {
  ...
  functional: true,
  props: Element$22.props,
  render: Element$22.render
}
...
var Element$24 = {
  ...
  render: function render (h, ref) {
    ...
    var tag = props.tag;
    var slots = resolveSlots(children);
    return h(tag, mergeData(data, {
      class: ['uk-navbar', {
...
var navbar = {
  name: 'VkNavbar',
  functional: true,
  props: Element$24.props,
  render: Element$24.render
}
...
var navbarFull = {
  name: 'VkNavbarFull',
  functional: true,
  props: Element$25.props,
  render: Element$25.render
}
...
var navbarToggle = {
  name: 'VkNavbarToggle',
  functional: true,
  props: Element$28.props,
  render: Element$28.render
}
...
var navbarNavItem = {
  ...
  render: function render (h, ref) {
    ...
    var props = ref.props;
    props.icon = props.icon && h(("vk-icons-" + (props.icon)));
    return h(Element$30, mergeData(data, { props: props }))
  }
}
...
var navbarNavDropdown = {
  ...
  render: function render (h) {
    ...
    var childrenNodes = this.$slots.default.filter(function (n) { return n.tag; });
    var colCount = childrenNodes.length;
    var Subtitle = subtitle && h('div', [ title, h('div', {
      class: 'uk-navbar-subtitle'
    }, subtitle) ]);
    var grid = function () { return h(Grid, {
      class: [
...
var navbarNavDropdownNav = {
  name: 'VkNavbarNavDropdownNav',
  functional: true,
  render: Element$31.render
}
...
var navbarDropbar = {
  ...
  methods: {
    getActiveDrop: function getActiveDrop () {
      var active = window.vuikitDropActive;
  ...
  mounted: function mounted () {
    var this$1 = this;
    var dropdowns = this.$children
      .filter(function (child) { return /NavbarNavDropdown/.test(child.$options.name); });
    dropdowns.forEach(function (dropdown) {
      dropdown.$refs.drop.$on('show', function () {
        this$1.$nextTick(function () {
          this$1.transitionDropbar(dropdown.$refs.drop.$el);
        });
      });
      dropdown.$refs.drop.$on('hide', function () {
        this$1.$nextTick(function () {
          var active = this$1.getActiveDrop();
          if (!active) {
            this$1.transitionDropbar(dropdown.$refs.drop.$el);
          }
        });
...
var offcanvas = {
  ...
  render: function render (h) {
    var customBar = findBar(this.$slots.default || []);
    var bar = customBar || h(Element$32, this.$slots.default);
...
var offcanvasClose = {
  ...
  functional: true,
  props: Element$33.props,
  render: Element$33.render
}
...
var pagination = {
  ...
  render: function render (h) {
    ...
    return h(Element$35, {
      props: this.$props
    }, this.$slots.default.filter(function (node) { return node.tag; }).map(function (node) {
      if ("development" !== 'production' && !node.fnOptions) {
        warn('vk-pagination -> pagination components must be functional', this$1);
      }
...
var paginationPageFirst = {
  functional: true,
  props: Element$36.props,
  render: function render (h, ref) {
    var data = ref.data;
    var props = ref.props;
    var parent = ref.parent;
...
var paginationPageNext = {
  functional: true,
  props: Element$37.props,
  render: function render (h, ref) {
    var data = ref.data;
    var props = ref.props;
    var parent = ref.parent;
...
var skeletonText = {
  name: 'VkSkeletonText',
  functional: true,
  props: Element$38.props,
  render: Element$38.render
}
...
var skeletonTitle = {
  ...
  functional: true,
  props: Element$39.props,
  render: Element$39.render
}
...
var skeletonImage = {
  ...
  functional: true,
  props: Element$40.props,
  render: Element$40.render
}
...
var spinner = {
  name: 'VkSpinner',
  functional: true,
  props: Element$41.props,
  render: Element$41.render
}
...
var subnavItem = {
  ...
  render: function render (h, ref) {
    ...
    return h(Element$43, mergeData(data, { props: props }, {
      rerender: true,
      on: {
        click: function (e) {
          e.preventDefault();
...
var subnavItemDropdown = {
  name: 'VkSubnavItemDropdown',
  functional: true,
  props: mergeData({}, Element$44.props, VkDropdown.props, {
    mode: {
      type: String,
      default: 'click'
    }
  ...
  render: function render (h, ref) {
    ...
    var children = ref.children;
    var title = props.title;
    return h(Element$44, { props: props }, [
      h('a', {
        class: ['uk-icon']
      }, [
        title + ' ',
...
function Render (h, ref) {
  ...
  return h(ElementTable, { props: props }, [
    isHeadless || h('thead', [
      h(ElementTr, columns.map(function (node) {
...
var tabsItem = {
  ...
  tabRender: function tabRender (h, ref) {
    ...
    var parent = ref.parent;
    props.icon = props.icon && h(("vk-icons-" + (props.icon)));
    return h(Element$45, mergeData(data, {
      props: props,
      on: {
        click: function (e) {
          e.preventDefault();
...
ElementBreadcrumb: Element$1,
ElementBreadcrumbItem: Element$2,
Button: button,
ButtonLink: buttonLink,
ButtonGroup: buttonGroup,
ElementButton: Element$3,
ElementButtonLink: Element$4,
ElementButtonGroup: Element$5,
Card: card,
CardTitle: cardTitle,
ElementsCard: Element$6,
ElementsCardTitle: Element$7,
Drop: Drop,
ElementDrop: elDrop,
Dropdown: VkDropdown,
Grid: Grid,
ElementGrid: Element$8,
Icon: icon,
IconLink: iconLink,
IconImage: iconImage,
IconButton: iconButton,
ElementIcon: ElementIcon,
ElementIconLink: ElementIconLink,
ElementIconButton: Element$10,
ElementIconImage: Element$9,
Iconnav: iconnav,
IconnavItem: iconnavItem,
IconnavVertical: iconnavVertical,
ElementsIconnav: Element$11,
ElementsIconnavItem: Element$12,
ElementsIconnavVertical: Element$13,
Label: label,
ElementsLabel: Element$14,
Modal: modal,
ModalFull: modalFull,
ModalClose: modalClose,
ModalFullClose: modalFullClose,
ModalTitle: modalTitle,
ElementModal: Modal,
ElementModalFull: ModalFull,
ElementModalClose: Element$15,
ElementModalFullClose: Element$16,
ElementModalTitle: Element$17,
ElementModalBody: ModalBody,
ElementModalDialog: ModalDialog,
ElementModalFooter: ModalFooter,
ElementModalHeader: ModalHeader,
Nav: nav,
...
ElementNav: Element$18,
ElementNavDropdown: Element$19,
ElementNavItem: Element$20,
ElementNavItemDivider: Element$23,
ElementNavItemHeader: Element$21,
ElementNavItemParent: Element$22,
Navbar: navbar,
...
NavbarNavDropdownNav: navbarNavDropdownNav,
NavbarDropbar: navbarDropbar,
ElementNavbar: Element$24,
ElementNavbarFull: Element$25,
ElementNavbarItem: Element$26,
ElementNavbarLogo: Element$27,
ElementNavbarToggle: Element$28,
ElementNavbarNav: Element$29,
ElementNavbarNavItem: Element$30,
ElementNavbarNavDropdownNav: Element$31,
ElementNavbarDropbar: ElementNavbarDropbar,
Notification: notification,
ElementNotification: ElementNotification,
ElementNotificationClose: ElementNotificationClose,
ElementNotificationMessage: ElementNotificationMessage,
Offcanvas: offcanvas,
OffcanvasBar: offcanvasBar,
OffcanvasClose: offcanvasClose,
OffcanvasContent: offcanvasContent,
ElementOffcanvas: ElementOffcanvas,
ElementOffcanvasBar: Element$32,
ElementOffcanvasClose: Element$33,
ElementOffcanvasContent: Element$34,
Pagination: pagination,
PaginationPages: paginationPages,
PaginationPageFirst: paginationPageFirst,
PaginationPagePrev: paginationPagePrev,
PaginationPageNext: paginationPageNext,
PaginationPageLast: paginationPageLast,
EleemntPagination: Element$35,
EleemntPaginationPage: ElementPage,
EleemntPaginationPageNext: Element$37,
EleemntPaginationPagePrev: Element$36,
Scrollspy: scrollspy,
...
ElementSkeletonImage: Element$40,
ElementSkeletonText: Element$38,
ElementSkeletonTitle: Element$39,
Spinner: spinner,
Sticky: sticky,
Subnav: subnav,
SubnavItem: subnavItem,
SubnavItemDropdown: subnavItemDropdown,
ElementSubnav: Element$42,
ElementSubnavItem: Element$43,
ElementSubnavItemDropdown: Element$44,
Table: Table,
TableTree: tableTree,
TableColumn: Column,
TableColumnSort: tableColumnSort,
TableColumnSelect: tableColumnSelect,
TableColumnTree: tableColumnTree,
ElementTable: ElementTable,
ElementTableTd: ElementTd,
ElementTableTr: ElementTr,
ElementTableTh: ElementTh,
ElementTableThSort: ElementThSort,
Tabs: tabs,
TabsVertical: tabsVertical,
TabsItem: tabsItem,
ElementTabs: ElementTabs,
ElementTabsVertical: ElementTabsVertical,
ElementTabsItem: Element$45,
ElementTabsItemDropdown: tabsItemDropdown
});
