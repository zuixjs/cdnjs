                ...
                if (isVoidElement) {
                    ...
                    if (!isInvalid(children)) {
                        if (isArray(children)) {
                            ...
                            this.addToQueue((firstChild ? "" : "<!---->") + escapeText(children) + "</" + type + ">", position);
                            return;
                        }
                        else if (isNumber(children)) {
    ...
    var RenderStream = (function (Readable$$1) {
        ...
        RenderStream.prototype.renderNode = function renderNode (vNode, context, isRoot) {
            if (isInvalid(vNode)) {
                ...
                var flags = vNode.flags;
                if ((flags & 14 /* Component */) > 0) {
                    return this.renderComponent(vNode, isRoot, context, flags & 2 /* ComponentClass */);
                }
                if ((flags & 1985 /* Element */) > 0) {
            ...
            return children.reduce((function (p, child) {
                return p.then((function (insertComment) {
                    ...
                    if (isTextOrNumber) {
                        ...
                        return Promise.resolve(this$1.renderNode(child, context, false)).then((function () { return false; }));
                    }
                }));
