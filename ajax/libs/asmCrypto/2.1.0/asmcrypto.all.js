...
var HmacSha512 = /** @class */ (function (_super) {
    ...
    HmacSha512.prototype.reset = function () {
        var key = this.key;
        this.hash
            .reset()
    ...
    HmacSha512.prototype.finish = function () {
        if (this.key === null)
            throw new IllegalStateError('no key is associated with the instance');
        if (this.result !== null)
            throw new IllegalStateError('state must be reset before processing new data');
...
var RSA_OAEP = /** @class */ (function () {
    ...
    RSA_OAEP.prototype.encrypt = function (data) {
...
var RSA_PSS = /** @class */ (function () {
    ...
    RSA_PSS.prototype.sign = function (data) {
