...
var gitGraphAst = __webpack_require__(20);
var d3 = __webpack_require__(1);
...
exports.draw = function (txt, id, ver) {
  try {
    ...
    config = _lodash2.default.extend(config, apiConfig, db.getOptions());
