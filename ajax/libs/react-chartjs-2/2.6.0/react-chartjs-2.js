...
var ChartComponent = function (_React$Component) {
  ...
  ChartComponent.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    ...
    if (!index$1(legend, nextProps.legend)) {
      return true;
    }

    if (!index$1(options, nextProps.options)) {
      return true;
    }

    var nextData = this.transformDataProp(nextProps);

    if (!index$1(this.shadowDataProp, nextData)) {
      return true;
    }

    return !index$1(plugins, nextProps.plugins);
  };
  ...
  ChartComponent.prototype.updateChart = function updateChart() {
    ...
    var _loop = function _loop(idx) {
      ...
      if (nextDatasetKeys.indexOf(currentDatasetKey) === -1) {
        ...
        var retainedDataset = index$2(nextDatasets, function (d) {
        ...
        if (retainedDataset) {
          ...
          var _data = retainedDataset.data,
              otherProps = objectWithoutProperties(retainedDataset, ['data']);
  ...
  ChartComponent.prototype.renderChart = function renderChart() {
    ...
    if (typeof legend !== 'undefined' && !index$1(ChartComponent.defaultProps.legend, legend)) {
