...
var SVG = (function () {
	...
	***/
	...
	function (_Container) {
	  ...
	  _createClass(G, [{
	    key: "x",
	    value: function x(_x2) {
	      var box = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.bbox();
	      if (_x2 == null) return box.x;
	      this.children().dx(_x2 - box.x);
	      return this;
	    }
	  }, {
	    key: "y",
	    value: function y(_y2) {
	      var box = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.bbox();
	      if (_y2 == null) return box.y;
	      this.children().dy(_y2 - box.y);
	      return this;
	    }
	  }, {
	    key: "move",
	    ...
	    key: "dx",
	    value: function dx(_dx) {
	      return this.children().dx(_dx);
	    }
	  }, {
	    key: "dy",
	    value: function dy(_dy) {
	      return this.children().dy(_dy);
	    }
	  }, {
	    key: "width",
	    value: function width(_width2) {
	      var box = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.bbox();
	      if (_width2 == null) return box.width;
	      var scale = _width2 / box.width;
	      this.each(function () {
	    ...
	    value: function height(_height2) {
	      var box = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.bbox();
	      if (_height2 == null) return box.height;
	      var scale = _height2 / box.height;
	      this.each(function () {
	...
	extend([Svg$1, _Symbol, Image, Pattern, Marker], getMethodsFor('viewbox'));
