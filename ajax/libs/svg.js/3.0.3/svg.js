...
* @license MIT
*
* BUILT: Wed Dec 05 2018 19:36:52 GMT+0100 (GMT+01:00)
*/;
var SVG = (function () {
	'use strict';
	  ...
	  _createClass(Timeline, [{
	    ...
	    value: function schedule(runner, delay, when) {
	      ...
	      if (runner == null) {
	        return this._order.map(function (id) {
	          return makeSchedule(_this2._runners[id]);
	        });
	      ...
	      var persist = runner.persist(); // Save runnerInfo
	    ...
	    value: function _step() {
	      ...
	      for (var i = 0, len = this._order.length; i < len; i++) {
	        ...
	        if (dtToStart <= 0) {
	          runnersLeft = true; // This is for the case that the timeline was seeked so that the time
	  ...
	  _createClass(RunnerArray, [{
	    ...
	    value: function merge() {
	      ...
	      this.runners.forEach(function (runner, i) {
	        ...
	        && (!runner._timeline || !runner._timeline._order.includes(runner.id)) && (!lastRunner._timeline || !lastRunner._timeline._order.includes(lastRunner.id));
	...
	registerMethods({
	  Element: {
	    ...
	    _addRunner: function _addRunner(runner) {
	      ...
	      setTimeout(function () {
	        Animator.cancelFrame(_this3._frameId);
	        _this3._frameId = Animator.frame(mergeTransforms.bind(_this3));
	      }, 0);
	    },
