      ...
      if (this.isAutocomplete) {
        ...
        if (this.combobox) {
          ...
          data.on.blur = function () {
            _this2.inputValue = _this2.lazySearch;
          };
        }
