...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    render: function render(h) {
        ...
        var dialog = h('div', data, [this.$createElement(_util_SlotProvider__WEBPACK_IMPORTED_MODULE_9__["default"], {
            props: {
                provide: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util_SlotProvider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../util/SlotProvider */ "./src/util/SlotProvider.ts");
var __assign = undefined && undefined.__assign || function () {
    __assign = Object.assign || function (t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
/* harmony default export */ __webpack_exports__["default"] = ({
    methods: {
        ...
        genContent: function genContent() {
            ...
            return this.$createElement('div', options, [this.$createElement(_util_SlotProvider__WEBPACK_IMPORTED_MODULE_0__["default"], {
                props: {
                    provide: {
                        theme: { isDark: this.$vuetify.dark || this.dark }
                    }
