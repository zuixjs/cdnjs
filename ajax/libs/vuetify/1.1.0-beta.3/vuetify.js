...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    render: function render() {
        return this.$createElement('div', {
            ...
            class: __assign({}, this.themeClasses)
    ...
    methods: {
        ...
        genIcon: function genIcon(type, cb, shouldDeprecate) {
            ...
            if (shouldDeprecate && type && cb) {
                Object(_util_console__WEBPACK_IMPORTED_MODULE_8__["deprecate"])(":" + type + "-icon-cb", "@click:" + type, this);
            }
            var data = {
                props: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setSelectedItems: function setSelectedItems() {
            var _this = this;
            var selectedItems = [];
            var values = !this.isMulti || !Array.isArray(this.internalValue) ? [this.internalValue] : this.internalValue;
...
/* harmony import */ var _VAutocomplete__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../VAutocomplete */ "./src/components/VAutocomplete/index.js");
/* harmony import */ var _util_rebuildFunctionalSlots__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../util/rebuildFunctionalSlots */ "./src/util/rebuildFunctionalSlots.js");
/* harmony import */ var _util_console__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../util/console */ "./src/util/console.ts");
...
var wrapper = {
    ...
    render: function render(h, _a) {
        ...
        if (props.autocomplete) {
            Object(_util_console__WEBPACK_IMPORTED_MODULE_4__["deprecate"])('<v-select autocomplete>', '<v-autocomplete>', wrapper, parent);
        }
        if (props.combobox) {
            Object(_util_console__WEBPACK_IMPORTED_MODULE_4__["deprecate"])('<v-select combobox>', '<v-autocomplete combobox>', wrapper, parent);
        }
        if (props.tags) {
            Object(_util_console__WEBPACK_IMPORTED_MODULE_4__["deprecate"])('<v-select tags>', '<v-autocomplete tags>', wrapper, parent);
        }
        if (props.overflow) {
            Object(_util_console__WEBPACK_IMPORTED_MODULE_4__["deprecate"])('<v-select overflow>', '<v-overflow-btn>', wrapper, parent);
        }
        if (props.segmented) {
            Object(_util_console__WEBPACK_IMPORTED_MODULE_4__["deprecate"])('<v-select segmented>', '<v-overflow-btn segmented>', wrapper, parent);
        }
        if (props.editable) {
            Object(_util_console__WEBPACK_IMPORTED_MODULE_4__["deprecate"])('<v-select editable>', '<v-overflow-btn editable>', wrapper, parent);
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        labelPosition: function labelPosition() {
            ...
            var right = 'auto';
            // Create spacing
            if ((this.prefix || this.reverse) && (this.isSingle || !this.isFocused) && !this.isDirty) value = 16;
            // Check if RTL
        ...
        genLabel: function genLabel() {
            ...
            var data = {
                props: {
                    ...
                    value: Boolean(!isSingleLine && (this.isFocused || this.isLabelActive || this.placeholder))
                }
            };
...
function checkVueVersion(Vue) {
    ...
    var actual = Vue.version.split('.').map(Number);
...
/*!*****************************!*\
  !*** ./src/util/console.ts ***!
  \*****************************/
/*! exports provided: consoleWarn, consoleError, deprecate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
