...
/* harmony import */ var _mixins_loadable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../mixins/loadable */ "./src/mixins/loadable.ts");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        genListWithSlot: function genListWithSlot() {
            return this.$createElement(_VSelectList__WEBPACK_IMPORTED_MODULE_4__["default"], this.listData, [this.$createElement('template', {
                slot: 'no-data'
            }, this.$slots['no-data'])]);
        },
...
function inserted(el, _a, _b) {
    ...
    try {
        for (var _e = __values(Object.keys(handlers)), _f = _e.next(); !_f.done; _f = _e.next()) {
