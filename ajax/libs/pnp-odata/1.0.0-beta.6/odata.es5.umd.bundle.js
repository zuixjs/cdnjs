...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return defaultPipeline; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(1);
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "defaultPipeline", function() { return __WEBPACK_IMPORTED_MODULE_0__src_odata__["n"]; });
...
var ODataQueryable = /** @class */ (function () {
    ...
    ODataQueryable.prototype.get = function (parser, options) {
        ...
        if (options === void 0) { options = {}; }
        return this.toRequestContext("GET", options, parser, __WEBPACK_IMPORTED_MODULE_4__pipeline__["b" /* defaultPipeline */]).then(function (context) { return Object(__WEBPACK_IMPORTED_MODULE_4__pipeline__["c" /* pipe */])(context); });
    };
    ODataQueryable.prototype.postCore = function (options, parser) {
        if (options === void 0) { options = {}; }
        if (parser === void 0) { parser = new __WEBPACK_IMPORTED_MODULE_3__parsers__["d" /* ODataDefaultParser */](); }
        return this.toRequestContext("POST", options, parser, __WEBPACK_IMPORTED_MODULE_4__pipeline__["b" /* defaultPipeline */]).then(function (context) { return Object(__WEBPACK_IMPORTED_MODULE_4__pipeline__["c" /* pipe */])(context); });
    };
    ODataQueryable.prototype.patchCore = function (options, parser) {
        if (options === void 0) { options = {}; }
        if (parser === void 0) { parser = new __WEBPACK_IMPORTED_MODULE_3__parsers__["d" /* ODataDefaultParser */](); }
        return this.toRequestContext("PATCH", options, parser, __WEBPACK_IMPORTED_MODULE_4__pipeline__["b" /* defaultPipeline */]).then(function (context) { return Object(__WEBPACK_IMPORTED_MODULE_4__pipeline__["c" /* pipe */])(context); });
    };
    ODataQueryable.prototype.deleteCore = function (options, parser) {
        if (options === void 0) { options = {}; }
        if (parser === void 0) { parser = new __WEBPACK_IMPORTED_MODULE_3__parsers__["d" /* ODataDefaultParser */](); }
        return this.toRequestContext("DELETE", options, parser, __WEBPACK_IMPORTED_MODULE_4__pipeline__["b" /* defaultPipeline */]).then(function (context) { return Object(__WEBPACK_IMPORTED_MODULE_4__pipeline__["c" /* pipe */])(context); });
    };
    /**
