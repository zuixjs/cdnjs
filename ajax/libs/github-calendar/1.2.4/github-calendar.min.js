  ...
  return function () {
    function e(t, r, n) {
      function a(u, s) {
        if (!r[u]) {
          if (!t[u]) {
            var i = "function" == typeof require && require;if (!s && i) return i(u, !0);if (o) return o(u, !0);var c = new Error("Cannot find module '" + u + "'");throw c.code = "MODULE_NOT_FOUND", c;
          }var l = r[u] = { exports: {} };t[u][0].call(l.exports, function (e) {
            var r = t[u][1][e];return a(r || e);
          }, l, l.exports, e, t, r, n);
        }return r[u].exports;
      ...
      var r = e("github-calendar-parser"),
          ...
          o = e("formatoid"),
          u = "MMM D, YYYY",
          s = "MMMM D";t.exports = function (e, t, i) {
        e = n(e), i = i || {}, i.summary_text = i.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + t + '" target="blank">@' + t + "</a>", i.global_stats === !1 && (e.style.minHeight = "175px"), i.proxy = i.proxy || function (e) {
          ...
          return fetch(i.proxy("https://github.com/" + t)).then(function (e) {
            ...
            var c = document.createElement("div");c.innerHTML = t;var d = c.querySelector(".js-yearly-contributions");if (d.querySelector(".float-left.text-gray").innerHTML = i.summary_text, d.querySelector("include-fragment")) setTimeout(l, 500);else {
              if (i.responsive === !0) {
                ...
                var m = r(n("svg", d).outerHTML),
                    g = m.current_streak ? o(m.current_streak_range[0], s) + " &ndash; " + o(m.current_streak_range[1], s) : m.last_contributed ? "Last contributed in " + o(m.last_contributed, s) + "." : "Rock - Hard Place",
                    h = m.longest_streak ? o(m.longest_streak_range[0], s) + " &ndash; " + o(m.longest_streak_range[1], s) : m.last_contributed ? "Last contributed in " + o(m.last_contributed, s) + "." : "Rock - Hard Place",
                    y = n("<div>", { "class": "contrib-column contrib-column-first table-column", html: '<span class="text-muted">Contributions in the last year</span>\n                               <span class="contrib-number">' + m.last_year + ' total</span>\n                               <span class="text-muted">' + o(a.subtract(new Date(), 1, "year"), u) + " &ndash; " + o(new Date(), u) + "</span>" }),
                    M = n("<div>", { "class": "contrib-column table-column", html: '<span class="text-muted">Longest streak</span>\n                               <span class="contrib-number">' + m.longest_streak + ' days</span>\n                               <span class="text-muted">' + h + "</span>" }),
                    x = n("<div>", { "class": "contrib-column table-column", html: '<span class="text-muted">Current streak</span>\n                               <span class="contrib-number">' + m.current_streak + ' days</span>\n                               <span class="text-muted">' + g + "</span>" });d.appendChild(y), d.appendChild(M), d.appendChild(x);
      ...
      var r = e("months"),
          ...
          s = new o(u);t.exports = function (e, t) {
      ...
      var r = e("github-calendar-legend");t.exports = function (e) {
        var t = { last_year: 0, longest_streak: -1, longest_streak_range: [], current_streak: 0, current_streak_range: [], weeks: [], days: [], last_contributed: null },
          ...
          if (e.startsWith("<g transform")) return n.length && t.weeks.push(n) && (n = []);var o = e.match(/fill="(#[a-z0-9]+)"/),
              ...
              s = e.match(/data-count="([0-9]+)"/);if (o = o && o[1], u = u && u[1], s = s && +s[1], o) {
            var i = { fill: o, date: new Date(u), count: s, level: r.indexOf(o) };0 === t.current_streak && (t.current_streak_range[0] = i.date), i.count ? (++t.current_streak, t.last_year += i.count, t.last_contributed = i.date, t.current_streak_range[1] = i.date) : (a(), t.current_streak = 0), n.push(i), t.days.push(i);
          }
        }), a(), t;
      };
          ...
          r(this, e), this.obj = t || {}, this.re = new RegExp("^(" + Object.keys(t).map(o).join("|") + ")");
            ...
            var r = "";t = t || [];do {
              var n = e.match(this.re),
                  a = n && n[1],
                  o = a || e.charAt(0);if (a) {
                var u = this.obj[a];"function" == typeof u && (u = u.apply(this, t)), r += u;
