/*!
 * Quasar Framework v0.17.0-beta.13
...
(function (global, factory) {
  ...
  var QDatetimePicker = {
    ...
    computed: {
      ...
      daysInterval: function daysInterval () {
        ...
        if (this.beforeMinDays > 0 || after) {
          ...
          return { min: min, max: this.daysInMonth - after + 1 }
        }
    ...
    methods: {
            ...
            h('div', { staticClass: 'q-datetime-datestring row flex-center' }, [
              h('span', {
                ...
                h('span', {
                  attrs: { tabindex: -1 },
                  on: this.disable ? {} : {
                    click: function () { this$1.view = 'month'; }
                  }
                }, [ this.monthString ])
              ]),
              ...
              h('span', {
                ...
                on: {
                  keydown: function (e) {
                    ...
                    if (key === 37 || key === 38) { // left, up
                      stopAndPrevent(e);
                      this$1.setDay(this$1.day - (key === 37 ? 1 : 7), true);
                    }
                ...
                h('span', {
                  attrs: { tabindex: -1 },
                  on: this.disable ? {} : {
                    click: function () { this$1.view = 'day'; }
                  }
                }, [ this.day ])
              ]),
              ...
              h('span', {
                ...
                h('span', {
                  attrs: { tabindex: -1 },
                  on: this.disable ? {} : {
                    click: function () { this$1.view = 'year'; }
                  }
                }, [ this.year ])
              ])
            ])
      ...
      __getYearView: function __getYearView (h) {
        ...
        for (var i = this.yearMin; i <= max; i++) loop( i );
      ...
      __getMonthView: function __getMonthView (h) {
        ...
        for (var i = this.monthMin; i <= this.monthInterval; i++) loop( i );
      ...
      __getDayView: function __getDayView (h) {
        ...
        for (var i$2 = min; i$2 <= max; i$2++) loop( i$2 );
  ...
  ['meta', 'link', 'htmlAttr', 'bodyAttr'].forEach(function (type) {
  ...
  function apply (ref) {
    ...
    if (Object.keys(remove).length > 0) {
      remove.meta.forEach(function (name) {
        document.head.querySelector(("meta[data-qmeta=\"" + name + "\"]")).remove();
      });
      remove.link.forEach(function (name) {
  ...
  ['meta', 'link'].forEach(function (type) {
  ...
  ['meta', 'link'].forEach(function (type) {
      ...
      for (var att in metaType) {
        var attrs = Object.keys(metaType[att]).map(getAttr(metaType[att]));
