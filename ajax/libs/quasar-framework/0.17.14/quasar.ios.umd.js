  ...
  var QPopover = {
    ...
    methods: {
      __show: function __show (evt) {
        ...
        this.timer = setTimeout(function () {
          document.body.addEventListener(this$1.closeEvents[0], this$1.__bodyHideStart, true);
          document.body.addEventListener(this$1.closeEvents[1], this$1.__bodyHide, true);
          this$1.showPromise && this$1.showPromiseResolve();
        }, 0);
      },
      ...
      __shouldAbortDismiss: function __shouldAbortDismiss (evt) {
        return this.persistent || (
          evt && evt.target &&
          (this.$el.contains(evt.target) || this.anchorEl.contains(evt.target))
        )
      },
      __bodyHideStart: function __bodyHideStart (evt) {
