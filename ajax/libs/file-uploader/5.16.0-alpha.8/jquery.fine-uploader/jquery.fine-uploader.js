// Fine Uploader 5.16.0-alpha.8 - (c) 2013-present Widen Enterprises, Inc. MIT licensed. http://fineuploader.com
(function(global) {
    (function($) {
        "use strict";
        ...
        var controller = this, chunkingPossible = false, concurrentChunkingPossible = false, chunking, preventRetryResponse, log, handler, options = {
            ...
            finalize: function(id) {
                ...
                handler.finalizeChunks(id).then(function(response, xhr) {
                    ...
                    if (normalizedResponse.reset || options.chunking.success.resetOnStatus.indexOf(xhr.status) >= 0) {
                        chunked.reset(id);
                    }
    ...
    qq.XhrUploadHandler = function(spec) {
        ...
        qq.extend(this, {
            ...
            isResumable: function(id) {
                return !!chunking && handler.isValid(id) && !handler._getFileState(id).notResumable && handler._getFileState(id).loaded > 0;
            },
            ...
            _getLocalStorageId: function(id) {
                var formatVersion = "5.0", name = getName(id), size = getSize(id), chunkSize = chunking.partSize, endpoint = getEndpoint(id), customKeys = resume.customKeys(id), localStorageId = qq.format("qq{}resume{}-{}-{}-{}-{}", namespace, formatVersion, name, size, chunkSize, endpoint);
    ...
    qq.traditional.XhrUploadHandler = function(spec, proxy) {
        ...
        qq.extend(this, {
            uploadChunk: function(uploadChunkParams) {
                ...
                var chunkData = handler._getChunkData(id, chunkIdx), xhr = handler._createXhr(id, chunkIdx), promise, toSend, params;
