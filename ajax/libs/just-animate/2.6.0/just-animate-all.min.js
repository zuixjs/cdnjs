...
var r=n.exec(t)
return r&&(e.unit=r[2]||_,e.value=r[1]?parseFloat(r[1]):_),e}var I={name:"web",animate:function(t){var r=t.keyframes,a=t.prop,e=t.from,n=t.to,i=t.target,o=n-e,u=B(function(){var t=r.map(function(t){var e,r=t.offset,n=t.value,i=t.easing
...
a<1?n.currentTime=1:a<o-1||(n.currentTime=o-1),n.playbackRate=e}r&&!(n.playState===y||"finish"===n.playState)&&!(e<0&&i<C)&&!(0<=e&&o-C<i)&&n.play(),!r&&(n.playState===y||"pending"===n.playState)&&n.pause()}}},getValue:function(t,e){return getComputedStyle(t)[e]},onWillAnimate:function(t,e,r){c(t.target)&&(function(t){for(var e in t)if(j(O,e)){var r=t[e]
...
var r,e,v,p,d,g,m,h,y}),(t=n).duration=h.apply(_,t.players.filter(function(t){return isFinite(t.to)}).map(function(t){return t.to})),t.time=isFinite(t.time)?t.time:t.rate<0?t.duration:0}var Ft=function(o,t,e){o.players===_&&Et(o)
var u=o.state===l,f=o.time
u||ht(o.id),Z(o.players,function(t){var e,r=t.from,n=t.to,i=u&&m(d(f),r,n),a=(e=1,g(h((f-r)/(n-r),0),e))
t.update(a,o.rate,i)}),e.trigger(ot)},Ot=function(t,e,r){t.round=0,t.state=f,t.yoyo||(t.time=t.rate<0?0:t.duration),ht(t.id),Ft(t,0,r),r.trigger(Q),t.destroy&&bt(t,0,r)},Bt=function(t,e,r){t.state=f,ht(t.id),Ft(t,0,r),r.trigger(et)},Ct=function(t,e,r){e&&(t.repeat=e.repeat,t.yoyo=!!e.alternate,t.destroy=!!e.destroy),t.repeat=t.repeat||1,t.yoyo=t.yoyo||!1,t.state=l
var n,i=0<=t.rate
i&&t.time===t.duration?t.time=0:i||0!==t.time||(t.time=t.duration),n=t.id,j(vt,n)||N(vt,n),pt||(pt=st(mt)),Ft(t,0,r),r.trigger(rt)},jt=function(t){for(var e=0,r=0,n=t.configs,i=0,a=n.length;i<a;i++){var o=n[i],u=o.keyframes.map(function(t){return t.time}),f=h.apply(_,u),s=g.apply(_,u)
...
Pt(t,n,r)},Ht[J]=yt,Ht[K]=bt,Ht[Q]=Ot,Ht[tt]=Pt,Ht[et]=Bt,Ht[rt]=Ct,Ht[nt]=function(t,e,r){t.rate*=-1,Ft(t,0,r),r.trigger(nt)},Ht[it]=function(f,t,e){var s=Object.keys(b),r=H(t).map(function(t){var e=t.at||f.cursor,r={}
...
m(o+=e*a,0,n)||(t.round=++u,o=f?0:n,s=!0,t.yoyo&&(t.rate=-1*(t.rate||0)),o=t.rate<0?n:0),t.time=o,t.round=u,s&&i===u?Ot(t,0,r):Ft(t,0,r)},Ht[ot]=Ft,Ht[ut]=function(t,e,r){t.rate=e||1,Ft(t,0,r)},Ht[ft]=function(t,e,r){var n=+e
t.time=isFinite(n)?n:t.rate<0?t.duration:0,Ft(t,0,r)},Ht)
...
switch(Z(t.players,function(t){return t.cancel()}),t.players=_,r){case f:Bt(t,_,e)
break
...
var ue=B(function(t){var e,r,n,i,o,u,f,s,a=ae(t),c=a[0]
...
a<t?e=i:r=i}while(--n)
return t}
throw new Error("css parse error")}),fe=B(function(t){return B(t)})
function se(t,e,r){return t+(e-t)*r}function ce(t,e,r){return r<.5?t:e}var le=0,ve=1,pe=2,de=3,ge=/^\-\-[a-z0-9\-]+$/i,me="viewBox",he=[me],ye=[me]
function be(t,e){return c(t)?ge.test(e)?de:"undefined"==typeof t[e]||j(he,e)?j(ye,e)?ve:pe:le:le}function we(t,e){var r,n,i,a,o,u,f,s,c=be(t,e)
...
return o.simpleFn?o.interpolate(o.value,c[r].value,f):o.interpolate(o.value,c[r].value)(f)}),y=(n=be(e=g,r=m))===de?(p=e,d=r,function(t){return p.style.setProperty(d,t?t+"":"")}):n===ve?(f=e,v=r,function(t){return f.setAttribute(v,t)}):n===pe?(o=e,u=S(r),function(t){return o.setAttribute(u,t)}):(i=e,a=r,function(t){return i[a]=t}),b=we(g,m),w=_
return{cancel:function(){w!==_&&y(w),w=_},update:function(t,e,r){w===_&&(w=b()),y(h(t))}}},getValue:function(t,e){return we(t,e)()}})
var ke=Math.random,xe=Math.floor
function Te(t){var e=document.createElement("div")
return e.setAttribute("style","display:inline-block;position:relative;text-align:start"),e.innerHTML=t||"",e}return e(I),t.animate=function(t){return _t().add(t)},t.sequence=function(t){return _t().sequence(t)},t.timeline=_t,t.addPlugin=e,t.removePlugin=function(t){delete b[t.name]},t.interpolate=se,t.random=function(t,e,r,n){var i=t+ke()*(e-t)
return!0===n&&(i=xe(i)),r?i+r:i},t.shuffle=function(t){return t[Math.floor(Math.random()*t.length)]},t.splitText=function(t){for(var e=[],r=[],n="string"==typeof t?document.querySelectorAll(t):t instanceof Element?[t]:"number"==typeof t.length?t:[],i=0,a=n.length;i<a;i++){var o=n[i]
if(o){var u=o.textContent.replace(/[\r\n\s\t]+/gi," ").trim()
o.innerHTML=""
for(var f=u.split(/[\s]+/gi),s=0,c=f.length;s<c;s++){var l=f[s]
if(l){if(0<s){var v=Te("&nbsp;")
o.appendChild(v)}var p=Te()
r.push(p),o.appendChild(p)
for(var d=0,g=l.length;d<g;d++){var m=Te(l[d])
