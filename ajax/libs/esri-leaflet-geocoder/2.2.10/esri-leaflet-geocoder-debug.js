/* esri-leaflet-geocoder - v2.2.10 - Wed Jun 13 2018 17:32:47 GMT-0700 (PDT)
...
var Geocode$$1 = esriLeaflet.Task.extend({
...
function geocode$$1 (options) {
  return new Geocode$$1(options);
}

var ReverseGeocode$$1 = esriLeaflet.Task.extend({
  path: 'reverseGeocode',
...
function reverseGeocode$$1 (options) {
  return new ReverseGeocode$$1(options);
}

var Suggest$$1 = esriLeaflet.Task.extend({
  path: 'suggest',
...
function suggest$$1 (options) {
  return new Suggest$$1(options);
}

var GeocodeService$$1 = esriLeaflet.Service.extend({
  initialize: function (options) {
    options = options || {};
    if (options.url) {
  ...
  geocode: function () {
    return geocode$$1(this);
  },

  reverse: function () {
    return reverseGeocode$$1(this);
  },

  suggest: function () {
    // requires either the Esri World Geocoding Service or a <10.3 ArcGIS Server Geocoding Service that supports suggest.
    return suggest$$1(this);
  },
...
function geocodeService$$1 (options) {
  return new GeocodeService$$1(options);
}
...
var ArcgisOnlineProvider = GeocodeService$$1.extend({
  options: {
...
var Geosearch = leaflet.Control.extend({
  ...
  onAdd: function (map) {
    ...
    this._suggestions.addEventListener('touchend', leaflet.Util.bind(this.geocodeSuggestion, this));
...
var GeocodeServiceProvider = GeocodeService$$1.extend({
  options: {
...
exports.Geocode = Geocode$$1;
exports.geocode = geocode$$1;
exports.ReverseGeocode = ReverseGeocode$$1;
exports.reverseGeocode = reverseGeocode$$1;
exports.Suggest = Suggest$$1;
exports.suggest = suggest$$1;
exports.GeocodeService = GeocodeService$$1;
exports.geocodeService = geocodeService$$1;
