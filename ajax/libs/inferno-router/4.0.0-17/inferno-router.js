(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function Link(props, context) {
        ...
        return inferno.normalizeChildren(inferno.createVNode(1 /* HtmlElement */, 'a', className, null, 1 /* HasInvalidChildren */, Object.assign({}, rest, { href: href, onClick: inferno.linkEvent({
                context: context,
                props: props
            }, handleClick) }), null, innerRef ? function (x) { return innerRef(x); } : null), children);
    }
