(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('path-to-regexp-es6'), require('history'), require('inferno'), require('hoist-non-inferno-statics')) :
    typeof define === 'function' && define.amd ? define(['exports', 'path-to-regexp-es6', 'history', 'inferno', 'hoist-non-inferno-statics'], factory) :
    (factory((global.Inferno = global.Inferno || {}, global.Inferno.Router = global.Inferno.Router || {}),global.pathToRegexp,global.history,global.Inferno,global.hoistNonReactStatics));
}(this, (function (exports,pathToRegexp,history,inferno,hoistNonReactStatics) { 'use strict';
    ...
    }(inferno.Component));
    {
        Route.prototype.componentWillMount = function () {
            ...
            warning$1(!(this.props.component && this.props.children), 'You should not use <Route component> and <Route children> in the same route; <Route children> will be ignored');
            warning$1(!(this.props.render && this.props.children), 'You should not use <Route render> and <Route children> in the same route; <Route children> will be ignored');
        };
    }
