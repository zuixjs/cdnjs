  ...
  ***************************************************************************** */
  ...
  var StaticRouter = (function (Component$$1) {
      ...
      StaticRouter.prototype.render = function render () {
          ...
          return inferno.createComponentVNode(4 /* ComponentClass */, Router, Object.assign({}, props, { history: history$$1 }));
      };
  ...
  };
  {
      StaticRouter.prototype.componentWillMount = function () {
          warning$1(!this.props.history, '<StaticRouter> ignores the history prop. To use a custom history, ' +
  ...
  }(inferno.Component));
  {
      BrowserRouter.prototype.componentWillMount = function () {
          warning$1(!this.props.history, '<BrowserRouter> ignores the history prop. To use a custom history, ' +
  ...
  }(inferno.Component));
  {
      HashRouter.prototype.componentWillMount = function () {
          warning$1(!this.props.history, '<HashRouter> ignores the history prop. To use a custom history, ' +
  ...
  var Route = (function (Component$$1) {
      ...
      Route.prototype.render = function render () {
          ...
          if (component) {
              return match
                  ? inferno.createComponentVNode(2 /* ComponentUnknown */, component, props)
                  : null;
          }
          if (render) {
  ...
  }(inferno.Component));
  {
      Route.prototype.componentWillMount = function () {
          ...
          warning$1(!(this.props.component &&
              this.props.children &&
  ...
  var Link = (function (Component$$1) {
      ...
      Link.prototype.render = function render (_a) {
          ...
          var rest = __rest(_a, ["replace", "children", "className", "to", "innerRef"]);
          invariant(this.context.router, 'You should not use <Link> outside a <Router>');
          var href = this.context.router.history.createHref(typeof to === 'string' ? { pathname: to } : to);
          return inferno.normalizeChildren(inferno.createVNode(1 /* HtmlElement */, 'a', className, null, 1 /* HasInvalidChildren */, Object.assign({}, rest, { href: href, onClick: this.handleClick }), null, innerRef ? function (x) { return innerRef(x); } : null), children);
      };
  ...
  function NavLink(_a) {
      ...
      function linkComponent(ref) {
          ...
          return inferno.createComponentVNode(4 /* ComponentClass */, Link, Object.assign({ 'aria-current': isActive && ariaCurrent, className: isActive
  ...
  function IndexLink(props) {
      ...
      return inferno.createComponentVNode(8 /* ComponentFunction */, NavLink, props);
  }
  ...
  function IndexRoute(props) {
      ...
      return inferno.createComponentVNode(4 /* ComponentClass */, Route, props);
  }
  ...
  }(inferno.Component));
  {
      MemoryRouter.prototype.componentWillMount = function () {
          warning$1(!this.props.history, '<MemoryRouter> ignores the history prop. To use a custom history, ' +
  ...
  var Switch = (function (Component$$1) {
      ...
      Switch.prototype.render = function render () {
          ...
          return match
              ? inferno.createComponentVNode(child.flags, child.type, combineFrom(child.props, { location: location, computedMatch: match }), null, child.ref)
              : null;
      };
