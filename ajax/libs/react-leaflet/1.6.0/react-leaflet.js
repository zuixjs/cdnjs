(function (global, factory) {
	...
	(factory((global.ReactLeaflet = {}),global.L,global.React,global.ReactDOM));
}(this, (function (exports,leaflet,React,reactDom) { 'use strict';
...
var latlng = index$1.oneOfType([index$1.arrayOf(index$1.number), // [number, number]
index$1.shape({ lat: index$1.number, lng: index$1.number }), index$1.shape({ lat: index$1.number, lon: index$1.number })]);

var latlngList = index$1.arrayOf(latlng);

var bounds = index$1.oneOfType([index$1.instanceOf(leaflet.LatLngBounds), latlngList]);

var children = index$1.oneOfType([index$1.arrayOf(index$1.node), index$1.node]);

var controlPositionType = index$1.oneOf(['topleft', 'topright', 'bottomleft', 'bottomright']);

var layer = index$1.object;

var layerContainer = index$1.shape({
  addLayer: index$1.func.isRequired,
  removeLayer: index$1.func.isRequired
});

var map = index$1.instanceOf(leaflet.Map);

var viewport = index$1.shape({
  center: latlng,
  zoom: index$1.number
});
...
var index = Object.freeze({
	bounds: bounds,
	children: children,
	controlPosition: controlPositionType,
	latlng: latlng,
...
var MapControl = function (_Component) {
  ...
  MapControl.prototype.render = function render$$1() {
    return null;
  };
...
var MapComponent = function (_Component) {
  ...
  MapComponent.prototype.extractLeafletEvents = function extractLeafletEvents(props) {
    return reduce(keys(props), function (res, prop) {
...
var MapLayer = function (_MapComponent) {
  ...
  function MapLayer() {
    ...
    return possibleConstructorReturn(this, _MapComponent.apply(this, arguments));
  }
  ...
  MapLayer.prototype.render = function render$$1() {
    var children$$1 = this.props.children;

    if (React.Children.count(children$$1) > 1) {
    ...
    return children$$1 == null ? null : children$$1;
  };
...
var Circle$1 = function (_Path) {
  inherits(Circle$$1, _Path);
  ...
  Circle$$1.prototype.createLeafletElement = function createLeafletElement(props) {
  ...
  Circle$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
...
Circle$1.propTypes = {
  ...
  children: children,
  radius: index$1.number.isRequired
};

var CircleMarker$1 = function (_Path) {
  inherits(CircleMarker$$1, _Path);

  function CircleMarker$$1() {
    classCallCheck(this, CircleMarker$$1);
    return possibleConstructorReturn(this, _Path.apply(this, arguments));
  }

  CircleMarker$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.CircleMarker(props.center, this.getOptions(props));
  };

  CircleMarker$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    if (toProps.center !== fromProps.center) {
      this.leafletElement.setLatLng(toProps.center);
    }
    if (toProps.radius !== fromProps.radius) {
  ...
  return CircleMarker$$1;
}(Path);

CircleMarker$1.propTypes = {
  center: latlng.isRequired,
  children: children,
  radius: index$1.number
};

var FeatureGroup$1 = function (_Path) {
  inherits(FeatureGroup$$1, _Path);

  function FeatureGroup$$1() {
    classCallCheck(this, FeatureGroup$$1);
    return possibleConstructorReturn(this, _Path.apply(this, arguments));
  }

  FeatureGroup$$1.prototype.getChildContext = function getChildContext() {
    return {
  ...
  FeatureGroup$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.FeatureGroup(this.getOptions(props));
  };

  FeatureGroup$$1.prototype.componentDidMount = function componentDidMount() {
...
FeatureGroup$1.childContextTypes = {
  children: children,
  layerContainer: layerContainer,
  popupContainer: layer
};

var GeoJSON$1 = function (_Path) {
  inherits(GeoJSON$$1, _Path);

  function GeoJSON$$1() {
    classCallCheck(this, GeoJSON$$1);
    return possibleConstructorReturn(this, _Path.apply(this, arguments));
  }

  GeoJSON$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.GeoJSON(props.data, this.getOptions(props));
  };

  GeoJSON$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
...
GeoJSON$1.propTypes = {
  children: children,
  data: index$1.oneOfType([index$1.array, index$1.object]).isRequired
};

var GridLayer$1 = function (_MapLayer) {
  inherits(GridLayer$$1, _MapLayer);

  function GridLayer$$1() {
    classCallCheck(this, GridLayer$$1);
    return possibleConstructorReturn(this, _MapLayer.apply(this, arguments));
  }

  GridLayer$$1.prototype.getOptions = function getOptions(props) {
  ...
  GridLayer$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.GridLayer(this.getOptions(props));
  };

  GridLayer$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
  ...
  GridLayer$$1.prototype.render = function render$$1() {
    return null;
  };
...
GridLayer$1.propTypes = {
  children: children,
  opacity: index$1.number,
  zIndex: index$1.number
};

var ImageOverlay$1 = function (_MapLayer) {
  inherits(ImageOverlay$$1, _MapLayer);

  function ImageOverlay$$1() {
    classCallCheck(this, ImageOverlay$$1);
    return possibleConstructorReturn(this, _MapLayer.apply(this, arguments));
  }

  ImageOverlay$$1.prototype.getChildContext = function getChildContext() {
    return {
      popupContainer: this.leafletElement
    };
  };

  ImageOverlay$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.ImageOverlay(props.url, props.bounds, this.getOptions(props));
  };

  ImageOverlay$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
  ...
  return ImageOverlay$$1;
}(MapLayer);

ImageOverlay$1.propTypes = {
  attribution: index$1.string,
  bounds: bounds.isRequired,
  children: children,
  opacity: index$1.number,
  url: index$1.string.isRequired,
  zIndex: index$1.number
};
ImageOverlay$1.childContextTypes = {
  popupContainer: layer
};

var LayerGroup$1 = function (_MapLayer) {
  inherits(LayerGroup$$1, _MapLayer);

  function LayerGroup$$1() {
    classCallCheck(this, LayerGroup$$1);
    return possibleConstructorReturn(this, _MapLayer.apply(this, arguments));
  }

  LayerGroup$$1.prototype.getChildContext = function getChildContext() {
    return {
      layerContainer: this.leafletElement
    };
  };

  LayerGroup$$1.prototype.createLeafletElement = function createLeafletElement() {
    return new leaflet.LayerGroup(this.getOptions(this.props));
  };

  return LayerGroup$$1;
}(MapLayer);

LayerGroup$1.childContextTypes = {
  layerContainer: layerContainer
};

var baseControlledLayerPropTypes = {
  checked: index$1.bool,
  children: index$1.node.isRequired,
  removeLayer: index$1.func,
  removeLayerControl: index$1.func
};

var controlledLayerPropTypes = _extends({}, baseControlledLayerPropTypes, {
  addBaseLayer: index$1.func,
  addOverlay: index$1.func,
  name: index$1.string.isRequired
});
...
var ControlledLayer = function (_Component) {
  ...
  ControlledLayer.prototype.render = function render$$1() {
...
var BaseLayer = function (_ControlledLayer) {
  ...
  function BaseLayer() {
    ...
    return possibleConstructorReturn(this, _ControlledLayer.apply(this, arguments));
  }
...
var Overlay = function (_ControlledLayer2) {
  ...
  function Overlay() {
    ...
    return possibleConstructorReturn(this, _ControlledLayer2.apply(this, arguments));
  }
...
var LayersControl = function (_MapControl) {
  ...
  LayersControl.prototype.render = function render$$1() {
    var _this6 = this;

    var children$$1 = React.Children.map(this.props.children, function (child) {
...
LayersControl.propTypes = {
  baseLayers: index$1.object,
  children: children,
  overlays: index$1.object,
  position: controlPositionType
};
...
var Map$3 = function (_MapComponent) {
  inherits(Map$$1, _MapComponent);

  function Map$$1(props, context) {
    classCallCheck(this, Map$$1);

    var _this = possibleConstructorReturn(this, _MapComponent.call(this, props, context));
  ...
  Map$$1.prototype.getChildContext = function getChildContext() {
    return {
      layerContainer: this.leafletElement,
  ...
  Map$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    var viewport$$1 = props.viewport,
        options = objectWithoutProperties(props, ['viewport']);

    if (viewport$$1) {
      if (viewport$$1.center) {
        options.center = viewport$$1.center;
      }
      if (typeof viewport$$1.zoom === 'number') {
        options.zoom = viewport$$1.zoom;
      }
    }
    return new leaflet.Map(this.container, options);
  };

  Map$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    this._updating = true;
    ...
    if (viewport$$1 && viewport$$1 !== fromProps.viewport) {
      var c = viewport$$1.center ? viewport$$1.center : center;
      var z = viewport$$1.zoom == null ? zoom : viewport$$1.zoom;
      if (useFlyTo === true) {
    ...
    if (bounds$$1 && (this.shouldUpdateBounds(bounds$$1, fromProps.bounds) || boundsOptions !== fromProps.boundsOptions)) {
      if (useFlyTo === true) {
  ...
  Map$$1.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    this.updateLeafletElement(prevProps, this.props);
  };

  Map$$1.prototype.componentWillUnmount = function componentWillUnmount() {
    _MapComponent.prototype.componentWillUnmount.call(this);
  ...
  Map$$1.prototype.shouldUpdateCenter = function shouldUpdateCenter(next, prev) {
    if (!prev) return true;
  ...
  Map$$1.prototype.shouldUpdateBounds = function shouldUpdateBounds(next, prev) {
...
Map$3.propTypes = {
  animate: index$1.bool,
  bounds: bounds,
  boundsOptions: index$1.object,
  center: latlng,
  children: children,
  className: index$1.string,
  id: index$1.string,
  maxBounds: bounds,
  maxZoom: index$1.number,
  minZoom: index$1.number,
  style: index$1.object,
  useFlyTo: index$1.bool,
  viewport: viewport,
  whenReady: index$1.func,
  zoom: index$1.number
};
Map$3.childContextTypes = {
  layerContainer: layerContainer,
  map: map
};

var Marker$1 = function (_MapLayer) {
  inherits(Marker$$1, _MapLayer);
  ...
  Marker$$1.prototype.getChildContext = function getChildContext() {
    return {
      popupContainer: this.leafletElement
    };
  };

  Marker$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.Marker(props.position, this.getOptions(props));
  };
...
Marker$1.propTypes = {
  children: children,
  draggable: index$1.bool,
  icon: index$1.instanceOf(leaflet.Icon),
  opacity: index$1.number,
  position: latlng.isRequired,
  zIndexOffset: index$1.number
};
Marker$1.childContextTypes = {
  popupContainer: layer
};
...
var Pane = function (_Component) {
  ...
  Pane.prototype.removePane = function removePane() {
    ...
    if (name) {
      ...
      if (_map && _map._panes) {
        _map._panes = omit(_map._panes, name);
        _map._paneRenderers = omit(_map._paneRenderers, name);
      }
  ...
  Pane.prototype.render = function render$$1() {
    return this.state.name ? React__default.createElement(
      'div',
      { style: paneStyles },
      this.props.children
    ) : null;
...
var multiLatLngList = index$1.arrayOf(latlngList);

var Polygon$1 = function (_Path) {
  inherits(Polygon$$1, _Path);
  ...
  Polygon$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.Polygon(props.positions, this.getOptions(props));
  };

  Polygon$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
...
Polygon$1.propTypes = {
  children: children,
  positions: index$1.oneOfType([latlngList, multiLatLngList, index$1.arrayOf(multiLatLngList)]).isRequired
};

var Polyline$1 = function (_Path) {
  inherits(Polyline$$1, _Path);
  ...
  Polyline$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.Polyline(props.positions, this.getOptions(props));
  };

  Polyline$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    if (toProps.positions !== fromProps.positions) {
      this.leafletElement.setLatLngs(toProps.positions);
    }
    this.setStyleIfChanged(fromProps, toProps);
...
Polyline$1.propTypes = {
  children: children,
  positions: index$1.oneOfType([latlng, index$1.arrayOf(latlng)]).isRequired
};

var Popup$1 = function (_MapComponent) {
  inherits(Popup$$1, _MapComponent);
  ...
  function Popup$$1() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _MapComponent.call.apply(_MapComponent, [this].concat(args))), _this), _this.onPopupOpen = function (_ref) {
      ...
      if (_this.props.children == null) {
        ...
        reactDom.render(React.Children.only(_this.props.children), _this.leafletElement._contentNode);
      ...
      if (_this.leafletElement._contentNode) {
        reactDom.unmountComponentAtNode(_this.leafletElement._contentNode);
      }
    }, _temp), possibleConstructorReturn(_this, _ret);
  }

  Popup$$1.prototype.getOptions = function getOptions(props) {
    return _extends({}, _MapComponent.prototype.getOptions.call(this, props), {
      autoPan: false
    });
  };

  Popup$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.Popup(this.getOptions(props), this.context.popupContainer);
  };
  ...
  Popup$$1.prototype.componentWillMount = function componentWillMount() {
    _MapComponent.prototype.componentWillMount.call(this);
    this.leafletElement = this.createLeafletElement(this.props);
  ...
  Popup$$1.prototype.componentDidMount = function componentDidMount() {
  ...
  Popup$$1.prototype.componentWillUnmount = function componentWillUnmount() {
  ...
  Popup$$1.prototype.render = function render$$1() {
    return null;
  };
...
Popup$1.contextTypes = {
  map: map,
  popupContainer: layer,
  pane: index$1.string
};

var Rectangle$1 = function (_Path) {
  inherits(Rectangle$$1, _Path);
  ...
  Rectangle$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.Rectangle(props.bounds, this.getOptions(props));
  };

  Rectangle$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    if (toProps.bounds !== fromProps.bounds) {
...
var ScaleControl = function (_MapControl) {
  ...
  ScaleControl.prototype.createLeafletElement = function createLeafletElement(props) {
    return leaflet.Control.Scale(props);
  };
...
ScaleControl.propTypes = {
  imperial: index$1.bool,
  maxWidth: index$1.number,
  metric: index$1.bool,
  position: controlPositionType,
  updateWhenIdle: index$1.bool
};

var TileLayer$1 = function (_GridLayer) {
  inherits(TileLayer$$1, _GridLayer);

  function TileLayer$$1() {
    classCallCheck(this, TileLayer$$1);
    return possibleConstructorReturn(this, _GridLayer.apply(this, arguments));
  }

  TileLayer$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.TileLayer(props.url, this.getOptions(props));
  };

  TileLayer$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
...
var Tooltip$1 = function (_MapComponent) {
  inherits(Tooltip$$1, _MapComponent);

  function Tooltip$$1() {
    var _temp, _this, _ret;

    classCallCheck(this, Tooltip$$1);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn(this, _MapComponent.call.apply(_MapComponent, [this].concat(args))), _this), _this.onTooltipOpen = function (_ref) {
  ...
  Tooltip$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.Tooltip(this.getOptions(props), this.context.popupContainer);
  };

  Tooltip$$1.prototype.componentWillMount = function componentWillMount() {
    _MapComponent.prototype.componentWillMount.call(this);
    this.leafletElement = this.createLeafletElement(this.props);
  ...
  Tooltip$$1.prototype.componentDidMount = function componentDidMount() {
    this.context.popupContainer.bindTooltip(this.leafletElement);
  };

  Tooltip$$1.prototype.componentDidUpdate = function componentDidUpdate() {
    if (this.leafletElement.isOpen()) {
      this.renderTooltipContent();
    }
  };

  Tooltip$$1.prototype.componentWillUnmount = function componentWillUnmount() {
  ...
  Tooltip$$1.prototype.render = function render$$1() {
    return null;
  };
...
Tooltip$1.contextTypes = {
  map: map,
  popupContainer: layer,
  pane: index$1.string
};

var VideoOverlay$1 = function (_MapLayer) {
  inherits(VideoOverlay$$1, _MapLayer);

  function VideoOverlay$$1() {
    classCallCheck(this, VideoOverlay$$1);
    return possibleConstructorReturn(this, _MapLayer.apply(this, arguments));
  }

  VideoOverlay$$1.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.VideoOverlay(props.url, props.bounds, this.getOptions(props));
  };

  VideoOverlay$$1.prototype.componentDidMount = function componentDidMount() {
  ...
  VideoOverlay$$1.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    if (toProps.url !== fromProps.url) {
      this.leafletElement.setUrl(toProps.url);
    }
    if (toProps.bounds !== fromProps.bounds) {
  ...
  return VideoOverlay$$1;
}(MapLayer);

VideoOverlay$1.propTypes = {
  attribution: index$1.string,
  bounds: bounds.isRequired,
  opacity: index$1.number,
  play: index$1.bool,
  url: index$1.oneOfType([index$1.string, index$1.arrayOf(index$1.string), index$1.instanceOf(HTMLVideoElement)]).isRequired,
  zIndex: index$1.number
};
...
var WMSTileLayer = function (_GridLayer) {
  ...
  WMSTileLayer.prototype.createLeafletElement = function createLeafletElement(props) {
    return new leaflet.TileLayer.WMS(props.url, this.getOptions(props));
  };
...
ZoomControl.propTypes = {
  position: controlPositionType,
  zoomInText: index$1.string,
  zoomInTitle: index$1.string,
  zoomOutText: index$1.string,
  zoomOutTitle: index$1.string
};
