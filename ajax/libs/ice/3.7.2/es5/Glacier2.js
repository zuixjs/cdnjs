  ...
  (function () {
    ...
    function (_IceMX$Metrics) {
      ...
      function _class2(id, total, current, totalLifetime, failures) {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(_class2).call(this, id, total, current, totalLifetime, failures));
  ...
  (function () {
    ...
    function (_Ice$UserException2) {
      ...
      function _class16() {
        ...
        _this3 = _possibleConstructorReturn(this, _getPrototypeOf(_class16).call(this, _cause));
  ...
  (function () {
    ...
    function (_Ice$UserException3) {
      ...
      function _class21() {
        ...
        return _possibleConstructorReturn(this, _getPrototypeOf(_class21).call(this, _cause));
      }
