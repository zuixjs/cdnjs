...
(function (global, factory) {
    ...
    (factory((global.pnp = global.pnp || {}, global.pnp.graph = {}),global.pnp.common,global.pnp.odata,global.pnp.logging));
    ...
    ***************************************************************************** */
    ...
    var Photo = /** @class */ (function (_super) {
        ...
        Photo.prototype.getBlob = function () {
            return this.clone(Photo_1, "$value", false).get(new odata.BlobParser());
        };
        /**
         * Gets the image file byets as a Buffer (node.js)
         */
        Photo.prototype.getBuffer = function () {
            return this.clone(Photo_1, "$value", false).get(new odata.BufferParser());
        };
        /**
         * Sets the file bytes
         *
    ...
    var DriveItem = /** @class */ (function (_super) {
        ...
        DriveItem.prototype.move = function (parentReference, properties) {
            var patchBody = common.extend({}, parentReference);
            if (properties) {
                patchBody = common.extend({}, properties);
            }
            return this.patchCore({
                body: common.jsS(patchBody),
            });
        };
        return DriveItem;
    }(GraphQueryableInstance));
    ...
    })(exports.DirectoryObjectType || (exports.DirectoryObjectType = {}));
    /**
    ...
    var DirectoryObjects = /** @class */ (function (_super) {
        ...
        */
        DirectoryObjects.prototype.getByIds = function (ids, type) {
            if (type === void 0) { type = exports.DirectoryObjectType.directoryObject; }
    ...
    var GraphBatch = /** @class */ (function (_super) {
        ...
        GraphBatch.prototype.executeImpl = function () {
            ...
            var _loop_1 = function () {
                ...
                logging.Logger.write("[" + this_1.batchId + "] (" + (new Date()).getTime() + ") Sending batch request.", 1 /* Info */);
    ...
    */
    ...
    exports.ContactFolders = ContactFolders;
    exports.ContactFolder = ContactFolder;
    exports.Drives = Drives;
    exports.Drive = Drive;
    exports.Root = Root;
    exports.DriveItems = DriveItems;
    ...
    exports.DirectoryObjects = DirectoryObjects;
    exports.DirectoryObject = DirectoryObject;
    exports.Invitations = Invitations;
    exports.Subscriptions = Subscriptions;
    exports.Subscription = Subscription;
    exports.Sites = Sites;
    exports.GraphSite = GraphSite;
    exports.GraphContentTypes = GraphContentTypes;
    exports.GraphContentType = GraphContentType;
    exports.GraphColumns = GraphColumns;
    exports.GraphColumn = GraphColumn;
    exports.GraphColumnLinks = GraphColumnLinks;
    exports.GraphColumnLink = GraphColumnLink;
    exports.GraphLists = GraphLists;
    exports.GraphList = GraphList;
    exports.GraphItems = GraphItems;
    exports.GraphItem = GraphItem;
    exports.GraphFields = GraphFields;
