...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__net_graphclient__ = __webpack_require__(6);
...
var GraphQueryable = /** @class */ (function (_super) {
    ...
    GraphQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        if (pipeline === void 0) { pipeline = __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["e" /* PipelineMethods */].default; }
        // TODO:: add batch support
        return Promise.resolve({
            batch: this.batch,
            batchDependency: function () { return void (0); },
            cachingOptions: this._cachingOptions,
            clientFactory: function () { return new __WEBPACK_IMPORTED_MODULE_3__net_graphclient__["a" /* GraphHttpClient */](); },
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return PipelineMethods; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__exceptions__ = __webpack_require__(7);
...
var GraphRuntimeConfigImpl = /** @class */ (function () {
    ...
    Object.defineProperty(GraphRuntimeConfigImpl.prototype, "fetchClientFactory", {
        get: function () {
            ...
            if (typeof __WEBPACK_IMPORTED_MODULE_0__pnp_common__["c" /* RuntimeConfig */].spfxContext !== "undefined") {
                return function () { return __WEBPACK_IMPORTED_MODULE_0__pnp_common__["c" /* RuntimeConfig */].spfxContext.graphHttpClient; };
            }
            throw new __WEBPACK_IMPORTED_MODULE_1__exceptions__["b" /* NoGraphClientAvailableException */]();
        },
        enumerable: true,
        configurable: true
    });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return NoGraphClientAvailableException; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraphBatchParseException; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(0);
...
var NoGraphClientAvailableException = /** @class */ (function (_super) {
    ...
    function NoGraphClientAvailableException(msg) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__pnp_logging__["b" /* Logger */].log({ data: null, level: __WEBPACK_IMPORTED_MODULE_1__pnp_logging__["a" /* LogLevel */].Error, message: _this.message });
        return _this;
    }
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "graph", function() { return __WEBPACK_IMPORTED_MODULE_0__src_graph__["g"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_0__rest__["b"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__groups__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__graphqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__members__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__calendars__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__conversations__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__plans__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__photos__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__graphqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__attachments__ = __webpack_require__(16);
...
var Photo = /** @class */ (function (_super) {
    ...
    Photo.prototype.getBlob = function () {
        return this.clone(Photo, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["a" /* BlobFileParser */]());
    };
    /**
     * Gets the image file byets as a Buffer (node.js)
     */
    Photo.prototype.getBuffer = function () {
        return this.clone(Photo, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["b" /* BufferFileParser */]());
    };
    /**
     * Sets the file bytes
     *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__net_graphclient__ = __webpack_require__(6);
...
var GraphBatch = /** @class */ (function (_super) {
    ...
    GraphBatch.prototype.executeImpl = function () {
        ...
        var client = new __WEBPACK_IMPORTED_MODULE_5__net_graphclient__["a" /* GraphHttpClient */]();
        var batchRequest = {
        ...
        __WEBPACK_IMPORTED_MODULE_2__pnp_logging__["b" /* Logger */].write("[" + this.batchId + "] (" + (new Date()).getTime() + ") Sending batch request.", __WEBPACK_IMPORTED_MODULE_2__pnp_logging__["a" /* LogLevel */].Info);
        var nextLinkFlag = false;
        return client.fetch(this.batchUrl, batchOptions)
            ...
            return parsedResponse.responses.reduce(function (chain, response, index) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].objectDefinedNotNull(request)) {
                    ...
                    if (!__WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].stringIsNullOrEmpty(parsedResponse.nextLink)) {
                        throw new __WEBPACK_IMPORTED_MODULE_6__exceptions__["a" /* GraphBatchParseException */]("Could not properly parse responses to match requests in batch.");
                    }
                    nextLinkFlag = true;
