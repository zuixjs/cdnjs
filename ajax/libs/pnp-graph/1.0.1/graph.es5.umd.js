/**
@license
 * @pnp/graph v1.0.1 - pnp - provides functionality to query the Microsoft Graph
...
(function (global, factory) {
	...
	(factory((global.pnp = global.pnp || {}, global.pnp.graph = {}),global.tslib_1,global.pnp.common,global.pnp.odata,global.pnp.logging));
    ...
    Object.defineProperty(GraphRuntimeConfigImpl.prototype, "fetchClientFactory", {
        get: function () {
            ...
            if (typeof common.RuntimeConfig.spfxContext !== "undefined") {
                return function () { return new SPfxClient(common.RuntimeConfig.spfxContext.graphHttpClient); };
            }
