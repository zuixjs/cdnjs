...
var proto$2 = Object.create( Item.prototype );
...
var Partial = (function (MustacheContainer) {
	...
	Partial__proto__.bind = function bind () {
		...
		var template = this.refName ? getPartialTemplate( this.ractive, this.refName, this.containerFragment || this.parentFragment ) || null : null;
		var templateObj;
