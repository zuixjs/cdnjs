/*
	Ractive.js v0.9.6-edge
	Build: 58bdee15cbd8a4937e0134490e0532ed37e7371f
	Date: Wed Oct 11 2017 21:12:45 GMT+0000 (UTC)
...
if ( hasConsole ) {
	var welcomeIntro = [
		"%cRactive.js %c0.9.6-edge %cin debug mode, %cmore...",
		'color: rgb(114, 157, 52); font-weight: normal;',
		'color: rgb(85, 85, 85); font-weight: normal;',
		'color: rgb(85, 85, 85); font-weight: normal;',
		'color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;'
	];
	var welcomeMessage = "You're running Ractive 0.9.6-edge in debug mode - messages will be printed to the console to help you fix problems and optimise your application.\n\nTo disable debug mode, add this line at the start of your app:\n  Ractive.DEBUG = false;\n\nTo disable debug mode when your app is minified, add this snippet:\n  Ractive.DEBUG = /unminified/.test(function(){/*unminified*/});\n\nGet help and support:\n  http://docs.ractivejs.org\n  http://stackoverflow.com/questions/tagged/ractivejs\n  http://groups.google.com/forum/#!forum/ractive-js\n  http://twitter.com/ractivejs\n\nFound a bug? Raise an issue:\n  https://github.com/ractivejs/ractive/issues\n\n";
...
var proto$4 = MustacheContainer.prototype;
var mustache = Mustache.prototype;
proto$4.bind = mustache.bind;
proto$4.handleChange = mustache.handleChange;
proto$4.rebind = mustache.rebind;
proto$4.unbind = mustache.unbind;
...
var Partial = (function (MustacheContainer) {
	...
	Partial__proto__.bind = function bind () {
		...
		var template = this.refName ? getPartialTemplate( this.ractive, this.refName, this.containerFragment || this.up ) || null : null;
		var templateObj;
...
function createItem ( options ) {
	...
	if ( options.template.t === ELEMENT ) {
		...
		var ComponentConstructor = getComponentConstructor( options.up.ractive, options.template.e );
