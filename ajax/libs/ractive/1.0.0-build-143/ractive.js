/*
	...
	Build: eb7c7a972b02fb43103bf3d6141f6a1b3e60eb05
	Date: Sun Mar 11 2018 08:41:21 GMT+0000 (UTC)
...
function swizzleFragment(section, fragment, key, idx) {
  var model = section.context ? section.context.joinKey(key) : undefined;
...
function addStyle(id, css) {
  if (this.extraStyles.find(function (s) { return s.id === id; }))
    { throw new Error(("Extra styles with the id '" + id + "' have already been added.")); }
  this.extraStyles.push({ id: id, css: css });
