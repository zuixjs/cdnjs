/*
	...
	Build: 32f7525d5a7d5ce9aff5a45e604ce0db1eed3ecd
	Date: Tue Aug 29 2017 19:58:53 GMT+0000 (UTC)
...
ArrayObserver.prototype.handleChange = function handleChange ( path ) {
	if ( this.pending ) {
		// post-shuffle
		runloop.addObserver( this, this.options.defer );
	} else if ( !path ) {
...
var ExpressionProxy = (function (Model) {
	...
	ExpressionProxy.prototype.notifyUpstream = function notifyUpstream () {};
...
var ReferenceExpressionChild = (function (Model) {
	...
	ReferenceExpressionChild.prototype.mark = function mark () {
		this.dirty = true;
...
var ConditionalAttribute = (function (Item) {
	...
	ConditionalAttribute.prototype.destroyed = function destroyed () {
		this.unrender();
	};
...
var Attribute = (function (Item) {
	...
	Attribute.prototype.firstNode = function firstNode () {};
