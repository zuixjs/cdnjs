(function(u){"object"===typeof exports&&"undefined"!==typeof module?module.exports=u():"function"===typeof define&&define.amd?define([],u):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).xstream=u()})(function(){return function e(k,h,d){function q(l,m){if(!h[l]){if(!k[l]){var n="function"==typeof require&&require;if(!m&&n)return n(l,!0);if(t)return t(l,!0);m=Error("Cannot find module '"+l+"'");throw m.code="MODULE_NOT_FOUND",m;}m=h[l]={exports:{}};
k[l][0].call(m.exports,function(c){var d=k[l][1][c];return q(d?d:c)},m,m.exports,e,k,h,d)}return h[l].exports}for(var t="function"==typeof require&&require,n=0;n<d.length;n++)q(d[n]);return q}({1:[function(e,k,h){function d(){}function q(a){for(var b=a.length,f=Array(b),c=0;c<b;++c)f[c]=a[c];return f}function t(a,b){return function(f){return a(f)&&b(f)}}function n(a,b,f){try{return a.f(b)}catch(g){return f._e(g),c}}function l(a){a._start=function(b){b.next=b._n;b.error=b._e;b.complete=b._c;this.start(b)};
a._stop=a.stop}var m=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(b,f){b.__proto__=f}||function(b,f){for(var a in f)f.hasOwnProperty(a)&&(b[a]=f[a])};return function(b,f){function c(){this.constructor=b}a(b,f);b.prototype=null===f?Object.create(f):(c.prototype=f.prototype,new c)}}();Object.defineProperty(h,"__esModule",{value:!0});var w=e("symbol-observable"),c={};h.NO=c;var r={_n:d,_e:d,_c:d};h.NO_IL=r;var x=function(){function a(b,f){this._stream=
...
b;this.out._n(this.val);this.ins._add(b)};a.prototype._stop=function(){this.ins._remove(this.out);this.out=c};return a}(),T=function(){function a(b,a){this.type="take";this.ins=a;this.out=c;this.max=b;this.taken=0}a.prototype._start=function(b){this.out=b;this.taken=0;0>=this.max?b._c():this.ins._add(this)};a.prototype._stop=function(){this.ins._remove(this);this.out=c};a.prototype._n=function(b){var a=this.out;if(a!==c){var g=++this.taken;g<this.max?a._n(b):g===this.max&&(a._n(b),a._c())}};a.prototype._e=
function(b){var a=this.out;a!==c&&a._e(b)};a.prototype._c=function(){var b=this.out;b!==c&&b._c()};return a}();e=function(){function a(b){this._prod=b||c;this._ils=[];this._dl=this._stopID=c;this._d=!1;this._err=this._target=c}a.prototype._n=function(b){var a=this._ils,c=a.length;this._d&&this._dl._n(b);if(1==c)a[0]._n(b);else if(0!=c)for(var a=q(a),d=0;d<c;d++)a[d]._n(b)};a.prototype._e=function(b){if(this._err===c){this._err=b;var a=this._ils,g=a.length;this._x();this._d&&this._dl._e(b);if(1==g)a[0]._e(b);
else{if(0==g)return;for(var a=q(a),d=0;d<g;d++)a[d]._e(b)}if(!this._d&&0==g)throw this._err;}};a.prototype._c=function(){var b=this._ils,a=b.length;this._x();this._d&&this._dl._c();if(1==a)b[0]._c();else if(0!=a)for(var b=q(b),c=0;c<a;c++)b[c]._c()};a.prototype._x=function(){0!==this._ils.length&&(this._prod!==c&&this._prod._stop(),this._err=c,this._ils=[])};a.prototype._stopNow=function(){this._prod._stop();this._stopID=this._err=c};a.prototype._add=function(b){var a=this._target;if(a!==c)return a._add(b);
a=this._ils;a.push(b);1<a.length||(this._stopID!==c?(clearTimeout(this._stopID),this._stopID=c):(b=this._prod,b!==c&&b._start(this)))};a.prototype._remove=function(b){var a=this,d=this._target;if(d!==c)return d._remove(b);d=this._ils;b=d.indexOf(b);-1<b&&(d.splice(b,1),this._prod!==c&&0>=d.length?(this._err=c,this._stopID=setTimeout(function(){return a._stopNow()})):1===d.length&&this._pruneCycles())};a.prototype._pruneCycles=function(){this._hasNoSinks(this,[])&&this._remove(this._ils[0])};a.prototype._hasNoSinks=
...
return new x(this,b)};a.prototype[w.default]=function(){return this};a.create=function(b){if(b){if("function"!==typeof b.start||"function"!==typeof b.stop)throw Error("producer requires both start and stop functions");l(b)}return new a(b)};a.createWithMemory=function(b){b&&l(b);return new p(b)};a.never=function(){return new a({_start:d,_stop:d})};a.empty=function(){return new a({_start:function(b){b._c()},_stop:d})};a.throw=function(b){return new a({_start:function(a){a._e(b)},_stop:d})};a.from=function(b){if("function"===
typeof b[w.default])return a.fromObservable(b);if("function"===typeof b.then)return a.fromPromise(b);if(Array.isArray(b))return a.fromArray(b);throw new TypeError("Type of input to from() must be an Array, Promise, or Observable");};a.of=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return a.fromArray(b)};a.fromArray=function(b){return new a(new E(b))};a.fromPromise=function(b){return new a(new F(b))};a.fromObservable=function(b){return b.endWhen?b:new a(new z(b))};a.periodic=
function(b){return new a(new G(b))};a.prototype._map=function(b){return new (this.ctor())(new P(b,this))};a.prototype.map=function(b){return this._map(b)};a.prototype.mapTo=function(b){var a=this.map(function(){return b});a._prod.type="mapTo";return a};a.prototype.filter=function(b){var c=this._prod;return c instanceof v?new a(new v(t(c.f,b),c.ins)):new a(new v(b,this))};a.prototype.take=function(a){return new (this.ctor())(new T(a,this))};a.prototype.drop=function(b){return new a(new I(b,this))};
a.prototype.last=function(){return new a(new O(this))};a.prototype.startWith=function(a){return new p(new S(this,a))};a.prototype.endWhen=function(a){return new (this.ctor())(new K(a,this))};a.prototype.fold=function(a,c){return new p(new N(a,c,this))};a.prototype.replaceError=function(a){return new (this.ctor())(new R(a,this))};a.prototype.flatten=function(){return new a(new M(this))};a.prototype.compose=function(a){return a(this)};a.prototype.remember=function(){return new p(new Q(this))};a.prototype.debug=
function(a){return new (this.ctor())(new H(this,a))};a.prototype.imitate=function(a){if(a instanceof p)throw Error("A MemoryStream was given to imitate(), but it only supports a Stream. Read more about this restriction here: https://github.com/staltz/xstream#faq");this._target=a;for(var b=this._ils,c=b.length,d=0;d<c;d++)a._add(b[d]);this._ils=[]};a.prototype.shamefullySendNext=function(a){this._n(a)};a.prototype.shamefullySendError=function(a){this._e(a)};a.prototype.shamefullySendComplete=function(){this._c()};
a.prototype.setDebugListener=function(a){a?(this._d=!0,a._n=a.next||d,a._e=a.error||d,a._c=a.complete||d,this._dl=a):(this._d=!1,this._dl=c)};a.merge=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new A(b))};a.combine=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];return new a(new D(b))};return a}();h.Stream=e;var p=function(a){function b(b){b=a.call(this,b)||this;b._has=!1;return b}m(b,a);b.prototype._n=function(b){this._v=b;this._has=!0;a.prototype._n.call(this,
b)};b.prototype._add=function(a){var b=this._target;if(b!==c)return b._add(a);b=this._ils;b.push(a);1<b.length?this._has&&a._n(this._v):this._stopID!==c?(this._has&&a._n(this._v),clearTimeout(this._stopID),this._stopID=c):this._has?a._n(this._v):(a=this._prod,a!==c&&a._start(this))};b.prototype._stopNow=function(){this._has=!1;a.prototype._stopNow.call(this)};b.prototype._x=function(){this._has=!1;a.prototype._x.call(this)};b.prototype.map=function(a){return this._map(a)};b.prototype.mapTo=function(b){return a.prototype.mapTo.call(this,
b)};b.prototype.take=function(b){return a.prototype.take.call(this,b)};b.prototype.endWhen=function(b){return a.prototype.endWhen.call(this,b)};b.prototype.replaceError=function(b){return a.prototype.replaceError.call(this,b)};b.prototype.remember=function(){return this};b.prototype.debug=function(b){return a.prototype.debug.call(this,b)};return b}(e);h.MemoryStream=p;h.default=e},{"symbol-observable":2}],2:[function(e,k,h){k.exports=e("./lib/index")},{"./lib/index":3}],3:[function(e,k,h){var d="undefined"!==
typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{};Object.defineProperty(h,"__esModule",{value:!0});e=(e=e("./ponyfill"))&&e.__esModule?e:{"default":e};k="undefined"!==typeof self?self:"undefined"!==typeof window?window:"undefined"!==typeof d?d:"undefined"!==typeof k?k:Function("return this")();k=(0,e["default"])(k);h["default"]=k},{"./ponyfill":4}],4:[function(e,k,h){Object.defineProperty(h,"__esModule",{value:!0});h["default"]=function(d){var e=d.Symbol;"function"===
typeof e?e.observable?d=e.observable:(d=e("observable"),e.observable=d):d="@@observable";return d}},{}]},{},[1])(1)});