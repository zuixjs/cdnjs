(function (global, factory) {
	...
	*/
...

	{
	  ...
	  Router.prototype.componentDidUpdate = function (prevProps) {
	    warning_1$1(prevProps.history === this.props.history, "You cannot change <Router history>");
	  };
	}
	/**
	...
	function Prompt(props) {
	  return React.createElement(context.Consumer, null, function (context$$1) {
	    !context$$1 ? invariant_1(false, "You should not use <Prompt> outside a <Router>") : void 0;
	...
	function Redirect(props) {
	  return React.createElement(context.Consumer, null, function (context$$1) {
	    !context$$1 ? invariant_1(false, "You should not use <Redirect> outside a <Router>") : void 0;
	...
	function (_React$Component) {
	  ...
	  _proto.render = function render() {
	    ...
	    return React.createElement(context.Consumer, null, function (context$$1) {
	      !context$$1 ? invariant_1(false, "You should not use <Route> outside a <Router>") : void 0;
	        ...
	        if (children === undefined) {
	          {
	            ...
	            warning_1$1(false, "You returned `undefined` from the `children` function of " + ("<Route" + (path ? " path=\"" + path + "\"" : "") + ">, but you ") + "should have returned a React element or `null`");
	          }
	...
	if (!React.createContext) {
	  ...
	  Route.prototype.getChildContext = function () {
	    !this.context.router ? invariant_1(false, "You should not use <Route> outside a <Router>") : void 0;
...

	{
	  ...
	  Route.prototype.componentDidMount = function () {
	    warning_1$1(!(this.props.children && !isEmptyChildren(this.props.children) && this.props.component), "You should not use <Route component> and <Route children> in the same route; <Route component> will be ignored");
	    warning_1$1(!(this.props.children && !isEmptyChildren(this.props.children) && this.props.render), "You should not use <Route render> and <Route children> in the same route; <Route render> will be ignored");
	  ...
	  Route.prototype.componentDidUpdate = function (prevProps) {
	    warning_1$1(!(this.props.location && !prevProps.location), '<Route> elements should not change from uncontrolled to controlled (or vice versa). You initially used no "location" prop and then provided one on a subsequent render.');
	    warning_1$1(!(!this.props.location && prevProps.location), '<Route> elements should not change from controlled to uncontrolled (or vice versa). You provided a "location" prop initially but omitted it on a subsequent render.');
	  };
	}
	...
	function (_React$Component) {
	  ...
	  _proto.render = function render() {
	    ...
	    return React.createElement(context.Consumer, null, function (context$$1) {
	      !context$$1 ? invariant_1(false, "You should not use <Switch> outside a <Router>") : void 0;
...

	{
	  ...
	  Switch.prototype.componentDidUpdate = function (prevProps) {
	    warning_1$1(!(this.props.location && !prevProps.location), '<Switch> elements should not change from uncontrolled to controlled (or vice versa). You initially used no "location" prop and then provided one on a subsequent render.');
	    warning_1$1(!(!this.props.location && prevProps.location), '<Switch> elements should not change from controlled to uncontrolled (or vice versa). You provided a "location" prop initially but omitted it on a subsequent render.');
	  };
	}
	/**
	...
	function createTransitionManager$1() {
	  ...
	  function setPrompt(nextPrompt) {
	    warning$3(prompt == null, "A history supports only one prompt at a time");
	    prompt = nextPrompt;
	    return function () {
	      if (prompt === nextPrompt) prompt = null;
	    };
	    ...
	    if (prompt != null) {
	      ...
	      if (typeof result === "string") {
	        if (typeof getUserConfirmation === "function") {
	          ...
	          warning$3(false, "A history needs a getUserConfirmation function in order to use a prompt message");
	          callback(true);
	        }
	      } else {
	        // Return false from a transition hook to cancel the transition.
	...
	function createBrowserHistory$1(props) {
	  ...
	  !canUseDOM$1 ? invariant$2(false, "Browser history needs a DOM") : void 0;
	  ...
	  function getDOMLocation(historyState) {
	    ...
	    warning$3(!basename || hasBasename$1(path, basename), "You are attempting to use a basename on a page whose URL path does not begin " + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".');
	  ...
	  function push(path, state) {
	    warning$3(!(typeof path === "object" && path.state !== undefined && state !== undefined), "You should avoid providing a 2nd state argument to push when the 1st " + "argument is a location-like object that already has state; it is ignored");
	    var action = "PUSH";
	    ...
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      ...
	      if (canUseHistory) {
	        ...
	        warning$3(state === undefined, "Browser history cannot push state in browsers that do not support HTML5 history");
	        window.location.href = href;
	      }
	    });
	  }
	  ...
	  function replace(path, state) {
	    warning$3(!(typeof path === "object" && path.state !== undefined && state !== undefined), "You should avoid providing a 2nd state argument to replace when the 1st " + "argument is a location-like object that already has state; it is ignored");
	    var action = "REPLACE";
	    var location = createLocation$1(path, state, createKey(), history.location);
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      if (!ok) return;
	      ...
	      if (canUseHistory) {
	        ...
	        warning$3(state === undefined, "Browser history cannot replace state in browsers that do not support HTML5 history");
	        window.location.replace(href);
	      }
	    });
	  }
	...
	function createHashHistory$1(props) {
	  ...
	  !canUseDOM$1 ? invariant$2(false, "Hash history needs a DOM") : void 0;
	  var globalHistory = window.history;
	  ...
	  function push(path, state) {
	    warning$3(state === undefined, "Hash history cannot push state; it is ignored");
	    var action = "PUSH";
	    ...
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      ...
	      if (hashChanged) {
	        ...
	        warning$3(false, "Hash history cannot PUSH the same path; a new entry will not be added to the history stack");
	        setState();
	      }
	    });
	  }
	  ...
	  function replace(path, state) {
	    warning$3(state === undefined, "Hash history cannot replace state; it is ignored");
	    var action = "REPLACE";
	    var location = createLocation$1(path, undefined, undefined, history.location);
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      if (!ok) return;
	  ...
	  function go(n) {
	    warning$3(canGoWithoutReload, "Hash history go(n) causes a full page reload in this browser");
	    globalHistory.go(n);
	  }
	...
	*/
	...
	var factoryWithTypeCheckers$1 = function(isValidElement, throwOnDirectAccess) {
	  ...
	  function createEnumTypeChecker(expectedValues) {
	    if (!Array.isArray(expectedValues)) {
	      printWarning$5('Invalid argument supplied to oneOf, expected an instance of array.');
	  ...
	  function createUnionTypeChecker(arrayOfTypeCheckers) {
	    if (!Array.isArray(arrayOfTypeCheckers)) {
	      printWarning$5('Invalid argument supplied to oneOfType, expected an instance of array.');
	      return emptyFunctionThatReturnsNull$1;
	    }
	...
	function (_React$Component) {
	  ...
	  _proto.render = function render() {
	    ...
	    return React.createElement(context.Consumer, null, function (context$$1) {
	      !context$$1 ? invariant_1$1(false, "You should not use <Link> outside a <Router>") : void 0;
