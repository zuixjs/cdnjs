(function (global, factory) {
	...
	*/
	...
	var Link = function (_React$Component) {
	  ...
	  Link.prototype.handleClick = function handleClick(event, context$$1) {
	  ...
	  Link.prototype.render = function render() {
	    ...
	    return React.createElement(
	      ...
	      null,
	      function (context$$1) {
	        !context$$1 ? invariant_1(false, "You should not use <Link> outside a <Router>") : void 0;
	        ...
	        return React.createElement("a", _extends$4({}, props, {
	          onClick: function onClick(event) {
	            return _this2.handleClick(event, context$$1);
	          },
	          href: href,
	          ref: innerRef
	        }));
	...
	var Route = function (_React$Component) {
	  ...
	  Route.prototype.render = function render() {
	    ...
	    return React.createElement(context.Consumer, null, function (context$$1) {
	      ...
	      return React.createElement(context.Provider, { value: props }, children && !isEmptyChildren(children) ? children : props.match ? component ? React.createElement(component, props) : render ? render(props) : null : null);
	    });
	  };
	...
	var Block = function (_React$Component) {
	  _inherits$3(Block, _React$Component);

	  function Block(props) {
	    _classCallCheck$3(this, Block);
	...
	function Prompt(props) {
	  return React.createElement(context.Consumer, null, function (context$$1) {
	    ...
	    return props.when ? React.createElement(Block, { method: context$$1.history.block, message: props.message }) : null;
	  });
	}
	...
	function generatePath() {
	  ...
	  return path === "/" ? path : compilePath$1(path)(params, { pretty: true });
	}
	...
	var Navigate = function (_React$Component) {
	  _inherits$4(Navigate, _React$Component);

	  function Navigate(props) {
	    _classCallCheck$4(this, Navigate);
	...
	var StaticRouter = function (_React$Component) {
	  ...
	  StaticRouter.prototype.render = function render() {
	    ...
	    return React.createElement(Router, _extends$5({}, props, {
	      history: history,
	  ...
	  var C = function C(props) {
	    ...
	    return React.createElement(Route, {
	      children: function children(routeComponentProps) {
	        return React.createElement(Component, _extends$6({}, remainingProps, routeComponentProps, {
