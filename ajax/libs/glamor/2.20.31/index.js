...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inline_style_prefixer_static__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inline_style_prefixer_static___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_inline_style_prefixer_static__);
...
function plugins_prefixes(node) {
  return plugins___WEBPACK_IMPORTED_MODULE_0_object_assign___default()({}, node, { style: __WEBPACK_IMPORTED_MODULE_2_inline_style_prefixer_static___default()(node.style) });
}
...
var plugins = styleSheet.plugins = new PluginSet([plugins_prefixes, fallbacks]);
plugins.media = new PluginSet(); // neat! media, font-face, keyframes
plugins.fontFace = new PluginSet();
plugins.keyframes = new PluginSet([plugins_prefixes, fallbacks]);
    ...
    Object.keys(_src || {}).forEach(function (key) {
      if (isSelector(key)) {
        ...
        if (key === 'label') {
          ...
          if (_src[key].indexOf('url(') === -1 && !(_src[key].charAt(0) === _src[key].charAt(key.length - 1) && (_src[key].charAt(0) === '"' || _src[key].charAt(0) === "'"))) {
            _dest[key] = '"' + _src[key] + '"';
          } else {
            _dest[key] = _src[key];
          }
...
var _createPrefixer = __webpack_require__(12);

var _createPrefixer2 = _interopRequireDefault(_createPrefixer);

var _staticData = __webpack_require__(17);
...
var _crossFade = __webpack_require__(19);
...
var _gradient = __webpack_require__(23);

var _gradient2 = _interopRequireDefault(_gradient);

var _imageSet = __webpack_require__(24);
...
var _sizing = __webpack_require__(26);
...
var _prefixProperty = __webpack_require__(13);

var _prefixProperty2 = _interopRequireDefault(_prefixProperty);

var _prefixValue = __webpack_require__(14);

var _prefixValue2 = _interopRequireDefault(_prefixValue);

var _addNewValuesOnly = __webpack_require__(15);
...
var _hyphenateProperty = __webpack_require__(28);
