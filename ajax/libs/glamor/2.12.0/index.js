...
exports.merge = merge;
exports.insertMediaRule = insertMediaRule;
exports.media = media;
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // we include these by default 
...
var styleSheet = exports.styleSheet = new _sheet.StyleSheet({ name: '_css_' }); // stores all the registered styles. most important, for such a small name.  
  ...
  rules.forEach(function (rule, i) {
    ...
    if (isRule(rule)) {
      ...
      if (styleSheet.cache[_id].expr) {
        var _ret2 = function () {
          ...
          if (rule) {
            ...
            if (styleSheet.cache[iid].bag) {
              ...
              var _style = _styleSheet$cache$iid.style;
        ...
        var _style2 = _styleSheet$cache$_id3.style;

        styleBag[type] = _extends({}, styleBag[type] || {}, _style2);
        hasLabels && labels.push(_style2.label || '*'); // todo - match 'add()'s original label
        return;
        // not too bad 
      }
    } else {
...
function media(expr) {
  ...
  if (isRule(rule)) {
    ...
    if (!styleSheet.cache[_newId2]) {
      var _css = [cssrule(_newId2, '_', _style3)];
...
function fontFace(font) {
  ...
  if (!styleSheet.cache[id]) {
    ...
    // todo - crossbrowser 
    styleSheet.insert('@font-face { ' + (0, _CSSPropertyOperations.createMarkupForStyles)(font) + '}');
  }
