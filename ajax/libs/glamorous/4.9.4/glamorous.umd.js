...
var glamorous$3 = createGlamorous$1(splitProps);
 ...
 */
Object.assign(glamorous$3, domElements.reduce(function (getters, tag) {
  // TODO: next breaking change, let's make
  // the `displayName` be: `glamorous.${tag}`
  getters[tag] = glamorous$3(tag);
  return getters;
}, {}));
 ...
 * </glamorous.Div>
 */
Object.assign(glamorous$3, domElements.reduce(function (comps, tag) {
  var capitalTag = capitalize(tag);
  comps[capitalTag] = glamorous$3[tag]();
 ...
 */
glamorous$3.default = glamorous$3;
