...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_adal_angular__ = __webpack_require__(9);
...
var SPHttpClient = /** @class */ (function () {
    ...
    SPHttpClient.prototype.fetch = function (url, options) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["m" /* mergeHeaders */])(headers, SPRuntimeConfig.headers);
        // second we add the local options so we can overwrite the globals
        Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["m" /* mergeHeaders */])(headers, options.headers);
    ...
    SPHttpClient.prototype.fetchRaw = function (url, options) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["m" /* mergeHeaders */])(rawHeaders, options.headers);
        ...
        var retry = function (ctx) {
            _this._impl.fetch(url, options).then(function (response) { return ctx.resolve(response); }).catch(function (response) {
                ...
                setTimeout(Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["i" /* getCtxCallback */])(_this, retry, ctx), delay);
            });
        };
        return new Promise(function (resolve, reject) {
            var retryContext = {
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        if (Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["l" /* isUrlAbsolute */])(candidateUrl)) {
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["l" /* isUrlAbsolute */])(urlStr) || urlStr.lastIndexOf("/") < 0) {
                _this._parentUrl = urlStr;
                _this._url = Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* combinePaths */])(urlStr, path);
            }
            else if (urlStr.lastIndexOf("/") > urlStr.lastIndexOf("(")) {
                // .../items(19)/fields
                var index = urlStr.lastIndexOf("/");
                _this._parentUrl = urlStr.slice(0, index);
                path = Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* combinePaths */])(urlStr.slice(index), path);
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        return toAbsoluteUrl(this.toUrlAndQuery()).then(function (url) {
            Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["n" /* mergeOptions */])(options, _this._options);
            ...
            var context = {
                ...
                requestId: Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["j" /* getGUID */])(),
                verb: verb,
            };
            return context;
        });
...
var File = /** @class */ (function (_super) {
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["j" /* getGUID */])();
...
var CanvasSection = /** @class */ (function () {
    function CanvasSection(page, order, columns) {
        ...
        this._memId = Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["j" /* getGUID */])();
    }
...
var CanvasControl = /** @class */ (function () {
    function CanvasControl(controlType, dataVersion, column, order, id, controlData) {
        ...
        if (id === void 0) { id = Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["j" /* getGUID */])(); }
    ...
    SPBatch.prototype.executeImpl = function () {
        ...
        return toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                var url = Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["l" /* isUrlAbsolute */])(reqInfo.url) ? reqInfo.url : Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* combinePaths */])(absoluteRequestUrl, reqInfo.url);
            ...
            return client.fetch(Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* combinePaths */])(absoluteRequestUrl, "/_api/$batch"), batchOptions)
                ...
                return responses.reduce(function (chain, response, index) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__pnp_logging__["a" /* Logger */].write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Resolving batched request " + request.method + " " + request.url + ".", 0 /* Verbose */);
...
var SPRestAddIn = /** @class */ (function (_super) {
    ...
    SPRestAddIn.prototype._cdImpl = function (factory, addInWebUrl, hostWebUrl, urlPart) {
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["l" /* isUrlAbsolute */])(addInWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_2__pnp_common__["e" /* UrlException */]("The addInWebUrl parameter must be an absolute url.");
        }
        if (!Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["l" /* isUrlAbsolute */])(hostWebUrl)) {
