...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return readBlobAsArrayBuffer; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return Util; });
...
var SPRequestExecutorClient = /** @class */ (function () {
    ...
    SPRequestExecutorClient.prototype.fetch = function (url, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (options.body) {
                requestOptions = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].extend(requestOptions, { body: options.body });
            }
            else {
                requestOptions = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].extend(requestOptions, { binaryStringRequestBody: true });
            }
...
var SPRestAddIn = /** @class */ (function (_super) {
    ...
    SPRestAddIn.prototype._cdImpl = function (factory, addInWebUrl, hostWebUrl, urlPart) {
        if (!__WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* Util */].isUrlAbsolute(addInWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_2__pnp_common__["e" /* UrlException */]("The addInWebUrl parameter must be an absolute url.");
        }
        if (!__WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* Util */].isUrlAbsolute(hostWebUrl)) {
            throw new __WEBPACK_IMPORTED_MODULE_2__pnp_common__["e" /* UrlException */]("The hostWebUrl parameter must be an absolute url.");
        }
        var url = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["f" /* Util */].combinePaths(addInWebUrl, "_api/SP.AppContextSite(@target)");
...
var SPODataEntityParserImpl = /** @class */ (function (_super) {
    ...
    function SPODataEntityParserImpl(factory) {
        ...
        _this.hydrate = function (d) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(o, d);
        };
        return _this;
    }
    ...
    function SPODataEntityArrayParserImpl(factory) {
        ...
        _this.hydrate = function (d) {
            return d.map(function (v) {
                ...
                return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(o, v);
            });
        };
        return _this;
    }
...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(extractWebUrl(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
    }
...
var DigestCache = /** @class */ (function () {
    ...
    DigestCache.prototype.getDigest = function (webUrl) {
        ...
        var url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(webUrl, "/_api/contextinfo");
        var headers = {
        ...
        return this._httpClient.fetchRaw(url, {
            ...
            headers: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(headers, SPRuntimeConfig.headers, true),
            method: "POST",
...
var SPHttpClient = /** @class */ (function () {
    ...
    SPHttpClient.prototype.fetch = function (url, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, { cache: "no-cache", credentials: "same-origin" }, true);
        var headers = new Headers();
        // first we add the global headers so they can be overwritten by any passed in locally to this call
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["g" /* mergeHeaders */])(headers, SPRuntimeConfig.headers);
        // second we add the local options so we can overwrite the globals
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["g" /* mergeHeaders */])(headers, options.headers);
        ...
        opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(opts, { headers: headers });
    ...
    SPHttpClient.prototype.fetchRaw = function (url, options) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["g" /* mergeHeaders */])(rawHeaders, options.headers);
        options = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, { headers: rawHeaders });
        var retry = function (ctx) {
            _this._impl.fetch(url, options).then(function (response) { return ctx.resolve(response); }).catch(function (response) {
                ...
                setTimeout(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].getCtxCallback(_this, retry, ctx), delay);
            });
        };
        return new Promise(function (resolve, reject) {
            var retryContext = {
    ...
    SPHttpClient.prototype.get = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, { method: "GET" });
        return this.fetch(url, opts);
    };
    SPHttpClient.prototype.post = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, { method: "POST" });
        return this.fetch(url, opts);
    };
    SPHttpClient.prototype.patch = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, { method: "PATCH" });
        return this.fetch(url, opts);
    };
    SPHttpClient.prototype.delete = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, { method: "DELETE" });
        return this.fetch(url, opts);
    };
    return SPHttpClient;
}());
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        if (__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].isUrlAbsolute(candidateUrl)) {
            // if we are already absolute, then just return the url
            return resolve(candidateUrl);
        }
        if (SPRuntimeConfig.baseUrl !== null) {
            // base url specified either with baseUrl of spfxContext config property
            return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(SPRuntimeConfig.baseUrl, candidateUrl));
        }
        if (typeof global._spPageContextInfo !== "undefined") {
            // operating in classic pages
            if (global._spPageContextInfo.hasOwnProperty("webAbsoluteUrl")) {
                return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(global._spPageContextInfo.webAbsoluteUrl, candidateUrl));
            }
            else if (global._spPageContextInfo.hasOwnProperty("webServerRelativeUrl")) {
                return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(global._spPageContextInfo.webServerRelativeUrl, candidateUrl));
            }
        }
        ...
        if (typeof global.location !== "undefined") {
            ...
            ["/_layouts/", "/siteassets/"].forEach(function (s) {
                ...
                if (index > 0) {
                    return resolve(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(baseUrl_1.substr(0, index), candidateUrl));
                }
            });
        }
        return resolve(candidateUrl);
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].isUrlAbsolute(urlStr) || urlStr.lastIndexOf("/") < 0) {
                _this._parentUrl = urlStr;
                _this._url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(urlStr, path);
            }
            else if (urlStr.lastIndexOf("/") > urlStr.lastIndexOf("(")) {
                // .../items(19)/fields
                var index = urlStr.lastIndexOf("/");
                _this._parentUrl = urlStr.slice(0, index);
                path = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(urlStr.slice(index), path);
                _this._url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(_this._parentUrl, path);
            }
            else {
                // .../items(19)
                var index = urlStr.lastIndexOf("(");
    ...
    SharePointQueryable.prototype.as = function (factory) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(o, this, true);
    };
    /**
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        return toAbsoluteUrl(this.toUrlAndQuery()).then(function (url) {
            Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["h" /* mergeOptions */])(options, _this._options);
            ...
            var context = {
                ...
                requestId: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].getGUID(),
                verb: verb,
            };
            return context;
        });
...
var SiteUser = /** @class */ (function (_super) {
    ...
    */
    SiteUser.prototype.update = function (properties) {
        var _this = this;
        var postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.User" } }, properties);
...
var SiteGroups = /** @class */ (function (_super) {
    ...
    SiteGroups.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.Group" } }, properties));
...
var SiteGroup = /** @class */ (function (_super) {
    ...
    */
    ...
    SiteGroup.prototype.update = function (properties) {
        var _this = this;
        var postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.Group" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
var RoleDefinitions = /** @class */ (function (_super) {
    ...
    RoleDefinitions.prototype.add = function (name, description, order, basePermissions) {
        ...
        var postBody = JSON.stringify({
            BasePermissions: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ __metadata: { type: "SP.BasePermissions" } }, basePermissions),
...
var RoleDefinition = /** @class */ (function (_super) {
    ...
    RoleDefinition.prototype.update = function (properties) {
        ...
        if (typeof properties.hasOwnProperty("BasePermissions") !== "undefined") {
            properties["BasePermissions"] = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ __metadata: { type: "SP.BasePermissions" } }, properties["BasePermissions"]);
        }
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
            "__metadata": { "type": "SP.RoleDefinition" },
        }, properties));
        return this.postCore({
            body: postBody,
...
var SharePointQueryableShareable = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareable.prototype.shareWith = function (loginNames, role, requireSignin, propagateAcl, emailData) {
        ...
        return w.select("Id").filter("RoleTypeKind eq " + roleFilter).get().then(function (def) {
            ...
            if (typeof emailData !== "undefined") {
                postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(postBody, {
    ...
    SharePointQueryableShareable.prototype.shareObject = function (options, bypass) {
        ...
        options = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(options, {
            group: null,
...
var SharePointQueryableShareableWeb = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareableWeb.prototype.shareWith = function (loginNames, role, emailData) {
        ...
        return web.get().then(function (url) {
            dependency();
            return _this.shareObject(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(url, "/_layouts/15/aclinv.aspx?forSharing=1&mbypass=1"), loginNames, role, emailData);
        });
    };
    /**
    ...
    */
    ...
    Folder.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(new Item(spGetEntityUrl(d)), d);
        });
    };
    return Folder;
...
var Fields = /** @class */ (function (_super) {
    ...
    Fields.prototype.createFieldAsXml = function (xml) {
        ...
        var postBody = JSON.stringify({
            "parameters": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
                "__metadata": {
    ...
    Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (typeof minValue !== "undefined") {
            props = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ MinimumValue: minValue }, props);
        }
        if (typeof maxValue !== "undefined") {
            props = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    ...
    */
    Fields.prototype.addUser = function (title, selectionMode, properties) {
        ...
        return this.add(title, "SP.FieldUser", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addChoice = function (title, choices, format, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldChoice", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultiChoice = function (title, choices, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldMultiChoice", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addBoolean = function (title, properties) {
        ...
        return this.add(title, "SP.Field", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(props, properties));
    };
    return Fields;
}(SharePointQueryableCollection));
/**
...
var UserCustomActions = /** @class */ (function (_super) {
    ...
    UserCustomActions.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ __metadata: { "type": "SP.UserCustomAction" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
...
var Lists = /** @class */ (function (_super) {
    ...
    Lists.prototype.add = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        if (additionalSettings === void 0) { additionalSettings = {}; }
        var addSettings = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
    ...
    Lists.prototype.ensure = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        return new Promise(function (resolve, reject) {
            var addOrUpdateSettings = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(additionalSettings, { Title: title, Description: description, ContentTypesEnabled: enableContentTypes }, true);
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.getChanges = function (query) {
        return this.clone(List, "getchanges").postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getItemsByCAMLQuery = function (query) {
        ...
        return q.expand.apply(q, expands).postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.CamlQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getListItemChangesSinceToken = function (query) {
        return this.clone(List, "getlistitemchangessincetoken").postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.ChangeLogItemQuery" } }, query) }),
    ...
    List.prototype.renderListDataAsStream = function (parameters, overrideParameters) {
        ...
        var postBody = {
            overrideParameters: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
...
var File = /** @class */ (function (_super) {
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].getGUID();
    ...
    ClientSidePage.create = function (library, pageName, title, pageLayoutType) {
        ...
        return library.rootFolder.files.select("Name").filter("Name eq '" + pageName + "'").get().then(function (fs) {
            ...
            return library.rootFolder.select("ServerRelativePath").get().then(function (path) {
                var pageServerRelPath = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths("/", path.ServerRelativePath.DecodedUrl, pageName);
...
var CanvasControl = /** @class */ (function () {
    function CanvasControl(controlType, dataVersion, column, order, id, controlData) {
        ...
        if (id === void 0) { id = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].getGUID(); }
...
var TimeZone = /** @class */ (function (_super) {
    ...
    TimeZone.prototype.localTimeToUTC = function (localTime) {
        ...
        if (typeof localTime === "string") {
            ...
            dateIsoString = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].dateAdd(localTime, "minute", localTime.getTimezoneOffset() * -1).toISOString();
        }
...
var SearchQueryBuilder = /** @class */ (function () {
    ...
    SearchQueryBuilder.prototype.extendQuery = function (part) {
        this._query = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(this._query, part);
        return this;
    };
...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.execute = function (query) {
        ...
        var postBody = JSON.stringify({
            request: __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
...
var SearchResults = /** @class */ (function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var query = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(this._query, {
            RowLimit: rows,
...
var SPBatch = /** @class */ (function (_super) {
    ...
    SPBatch.prototype.executeImpl = function () {
        ...
        return toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                if (reqInfo.method === "GET") {
                    ...
                    if (currentChangeSetId.length < 1) {
                        ...
                        currentChangeSetId = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].getGUID();
                        batchBody.push("--batch_" + _this.batchId + "\n");
                ...
                var url = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].isUrlAbsolute(reqInfo.url) ? reqInfo.url : __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(absoluteRequestUrl, reqInfo.url);
                ...
                if (reqInfo.options) {
                    Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["g" /* mergeHeaders */])(headers, reqInfo.options.headers);
                }
                // lastly we apply any default headers we need that may not exist
                if (!headers.has("Accept")) {
                    headers.append("Accept", "application/json");
            ...
            return client.fetch(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].combinePaths(absoluteRequestUrl, "/_api/$batch"), batchOptions)
...
var Web = /** @class */ (function (_super) {
    ...
    */
    ...
    Web.prototype.getChanges = function (query) {
        var postBody = JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) });
...
var UserProfileQuery = /** @class */ (function (_super) {
    ...
    UserProfileQuery.prototype.setMyProfilePic = function (profilePicSource) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["i" /* readBlobAsArrayBuffer */])(profilePicSource).then(function (buffer) {
...
var ClientPeoplePickerQuery = /** @class */ (function (_super) {
    ...
    ClientPeoplePickerQuery.prototype.createClientPeoplePickerQueryParametersRequestBody = function (queryParams) {
        return JSON.stringify({
            "queryParams": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
...
var SocialQuery = /** @class */ (function (_super) {
    ...
    SocialQuery.prototype.createSocialActorInfoRequestBody = function (actorInfo) {
        return JSON.stringify({
            "actor": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend({
                Id: null,
...
var UtilityMethod = /** @class */ (function (_super) {
    ...
    UtilityMethod.prototype.sendEmail = function (props) {
        ...
        if (props.To && props.To.length > 0) {
            params.properties = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* Util */].extend(params.properties, {
                To: { results: props.To },
            });
        }
...
var CachingOptions = /** @class */ (function () {
    function CachingOptions(key) {
        this.key = key;
        this.expiration = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].dateAdd(new Date(), "second", __WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* RuntimeConfig */].defaultCachingTimeoutSeconds);
...
var BufferParser = /** @class */ (function () {
    ...
    BufferParser.prototype.parse = function (r) {
        if (__WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].isFunc(r.arrayBuffer)) {
        ...
        return new Promise(function (resolve) {
            ...
            if (context.verb === "GET" && context.isCached) {
                ...
                if (typeof context.cachingOptions !== "undefined") {
                    cacheOptions = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].extend(cacheOptions, context.cachingOptions);
                }
    ...
    PipelineMethods.send = function (context) {
        return new Promise(function (resolve, reject) {
            ...
            if (context.isBatched) {
                ...
                var opts = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].extend(context.options || {}, { method: context.verb });
...
var ODataQueryable = /** @class */ (function () {
    ...
    */
    ...
    Object.defineProperty(ODataQueryable.prototype, "hasBatch", {
         ...
         */
        get: function () {
            return __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].objectDefinedNotNull(this._batch);
        },
        enumerable: true,
        configurable: true
    });
    ...
    ODataQueryable.prototype.append = function (pathPart) {
        this._url = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].combinePaths(this._url, pathPart);
    };
...
var ODataBatch = /** @class */ (function () {
    function ODataBatch(_batchId) {
        if (_batchId === void 0) { _batchId = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* Util */].getGUID(); }
