...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return Util; });
...
var SPODataIdException = /** @class */ (function (_super) {
    ...
    function SPODataIdException(data, msg) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__pnp_logging__["a" /* Logger */].log({ data: data, level: 3 /* Error */, message: "[" + _this.name + "]::" + _this.message });
        return _this;
    }
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        var _this = this;
        if (options === void 0) { options = {}; }
        if (pipeline === void 0) { pipeline = __WEBPACK_IMPORTED_MODULE_3__pnp_odata__["i" /* defaultPipeline */]; }
