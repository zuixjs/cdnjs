...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* combinePaths */])(extractWebUrl(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
    }
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["l" /* isUrlAbsolute */])(urlStr) || urlStr.lastIndexOf("/") < 0) {
                ...
                path = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* combinePaths */])(urlStr.slice(index), path);
    ...
    */
    ...
    Folder.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["h" /* extend */])(new Item(spGetEntityUrl(d)), d);
        });
    };
    return Folder;
    ...
    SPBatch.prototype.executeImpl = function () {
        ...
        return toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                var url = Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["l" /* isUrlAbsolute */])(reqInfo.url) ? reqInfo.url : Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* combinePaths */])(absoluteRequestUrl, reqInfo.url);
