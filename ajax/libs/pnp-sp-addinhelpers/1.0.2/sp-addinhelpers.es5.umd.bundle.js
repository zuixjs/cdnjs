/**
@license
 * @pnp/sp-addinhelpers v1.0.2 - pnp - provides functionality for working within SharePoint add-ins
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sprestaddin__ = __webpack_require__(8);
...
/**
@license
 * @pnp/sp v1.0.2 - pnp - provides a fluent api for working with SharePoint REST
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: http://officedev.github.io/PnP-JS-Core
 * source: https://github.com/pnp/pnp
...
var ClientSidePage = /** @class */ (function (_super) {
     ...
     */
    function ClientSidePage(file, sections) {
                ...
                return library.rootFolder.files.addTemplateFile(pageServerRelPath, TemplateFileType.ClientSidePage).then(function (far) {
                    ...
                    return far.file.getItem().then(function (i) {
                        ...
                        return i.update({
                            ...
                            Title: title,
                        }).then(function (iar) { return new ClientSidePage(iar.item.file); });
                    });
                });
            });
        });
    ...
    ClientSidePage.prototype.load = function () {
        var _this = this;
        return this.getItem("CanvasContent1").then(function (item) {
...
/**
@license
 * @pnp/odata v1.0.2 - pnp - provides shared odata functionality and base classes
 * MIT (https://github.com/pnp/pnp/blob/master/LICENSE)
 * Copyright (c) 2018 Microsoft
 * docs: http://officedev.github.io/PnP-JS-Core
 * source: https://github.com/pnp/pnp
