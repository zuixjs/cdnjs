...
var Html5DashJS = function () {
  function Html5DashJS(source, tech, options) {
    ...
    this.mediaPlayer_.on(_dashjs2['default'].MediaPlayer.events.MANIFEST_LOADED, this.getDuration_);
  ...
  Html5DashJS.prototype.dispose = function dispose() {
    if (this.mediaPlayer_) {
      ...
      this.mediaPlayer_.off(_dashjs2['default'].MediaPlayer.events.MANIFEST_LOADED, this.getDuration_);
