        ...
        function(module, exports, __webpack_require__) {
		   ...
		   */
                function SearchUtility() {
                    ...
                    }, this.terminate = function() {}, this._indexMode = indexMode, this._tokenizePattern = tokenizePattern, 
                    this._caseSensitive = caseSensitive, this._searchIndex = new _SearchIndex2.default(), 
                    this._uids = {};
                }
                /**
                ...
                return _createClass(SearchIndex, [ {
                    ...
                    value: function(tokens) {
                        ...
                        tokens.forEach(function(token) {
                            ...
                            if (initialized) for (var _uid2 in uidMap) currentUidMap[_uid2] || delete uidMap[_uid2]; else {
                                initialized = !0;
                                for (var _uid in currentUidMap) uidMap[_uid] = currentUidMap[_uid];
                            }
                        });
                        var uids = [];
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _regenerator = __webpack_require__(88), _regenerator2 = _interopRequireDefault(_regenerator), _asyncToGenerator2 = __webpack_require__(91), _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2), _classCallCheck2 = __webpack_require__(108), _classCallCheck3 = _interopRequireDefault(_classCallCheck2), _createClass2 = __webpack_require__(109), _createClass3 = _interopRequireDefault(_createClass2), _jsWorkerSearch = __webpack_require__(1), _jsWorkerSearch2 = _interopRequireDefault(_jsWorkerSearch), SubscribableSearchApi = function() {
            function SubscribableSearchApi() {
                var _ref = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, indexMode = _ref.indexMode, tokenizePattern = _ref.tokenizePattern, caseSensitive = _ref.caseSensitive;
                (0, _classCallCheck3.default)(this, SubscribableSearchApi), this._indexMode = indexMode, 
                this._tokenizePattern = tokenizePattern, this._caseSensitive = caseSensitive, this._resourceToSearchMap = {}, 
