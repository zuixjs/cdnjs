!function(root, factory) {
    ...
    function(module, exports) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            Object.defineProperty(exports, "__esModule", {
                value: !0
            }), exports.INDEX_MODES = exports["default"] = void 0;
            ...
            var _SearchApi = __webpack_require__(6), _SearchApi2 = _interopRequireDefault(_SearchApi);
        ...
        function(module, exports, __webpack_require__) {
            ...
            var _SearchUtility = __webpack_require__(4), _SearchUtility2 = _interopRequireDefault(_SearchUtility);
        ...
        function(module, exports, __webpack_require__) {
            ...
            function _inspect(input) {
                ...
                if (void 0 === input) return "void";
                if ("string" == typeof input || "number" == typeof input || "boolean" == typeof input) return "undefined" == typeof input ? "undefined" : _typeof(input);
                if (Array.isArray(input)) {
                    if (input.length > 0) {
                        var first = _inspect(input[0]);
                        return input.every(function(item) {
                            return _inspect(item) === first;
                        }) ? first.trim() + "[]" : "[" + input.map(_inspect).join(", ") + "]";
                    }
                    return "Array";
                }
                var keys = Object.keys(input);
                if (!keys.length) return input.constructor && input.constructor.name && "Object" !== input.constructor.name ? input.constructor.name : "Object";
                var entries = keys.map(function(key) {
                    return (/^([A-Z_$][A-Z0-9_$]*)$/i.test(key) ? key : JSON.stringify(key)) + ": " + _inspect(input[key]) + ";";
                }).join("\n  ");
                return input.constructor && input.constructor.name && "Object" !== input.constructor.name ? input.constructor.name + " {\n  " + entries + "\n}" : "{ " + entries + "\n}";
            }
            ...
            var _constants = __webpack_require__(3), _SearchIndex = __webpack_require__(5), _SearchIndex2 = _interopRequireDefault(_SearchIndex), SearchUtility = function() {
                /**
		   * Constructor.
		   *
		   ...
		   */
                function SearchUtility() {
                    var _ref10 = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], _ref10$indexMode = _ref10.indexMode, indexMode = void 0 === _ref10$indexMode ? _constants.INDEX_MODES.ALL_SUBSTRINGS : _ref10$indexMode;
                    _classCallCheck(this, SearchUtility), this._indexMode = indexMode, this.searchIndex = new _SearchIndex2["default"](), 
                    this.uids = {};
                }
                /**
		   ...
		   */
                return _createClass(SearchUtility, [ {
                    ...
                    value: function() {
                        function _ref(_id) {
                            if ("string" != typeof _id) throw new TypeError("Function return value violates contract.\n\nExpected:\nstring\n\nGot:\n" + _inspect(_id));
                            return _id;
                        }
                    ...
                    key: "indexDocument",
                    value: function(uid, text) {
                        function _ref2(_id2) {
                            if (!(_id2 instanceof SearchUtility)) throw new TypeError("Function return value violates contract.\n\nExpected:\nSearchUtility\n\nGot:\n" + _inspect(_id2));
                            return _id2;
                        }
                        if ("string" != typeof text) throw new TypeError('Value of argument "text" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(text));
                        this.uids[uid] = !0;
                        ...
                        if (!fieldTokens || "function" != typeof fieldTokens[Symbol.iterator] && !Array.isArray(fieldTokens)) throw new TypeError("Expected fieldTokens to be iterable, got " + _inspect(fieldTokens));
                        var _iteratorNormalCompletion = !0, _didIteratorError = !1, _iteratorError = void 0;
                        try {
                            for (var _step, _iterator = fieldTokens[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
                                var fieldToken = _step.value, expandedTokens = this._expandToken(fieldToken);
                                ...
                                if (!expandedTokens || "function" != typeof expandedTokens[Symbol.iterator] && !Array.isArray(expandedTokens)) throw new TypeError("Expected expandedTokens to be iterable, got " + _inspect(expandedTokens));
                                var _iteratorNormalCompletion2 = !0, _didIteratorError2 = !1, _iteratorError2 = void 0;
                                try {
                                    for (var _step2, _iterator2 = expandedTokens[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = !0) {
                    ...
                    value: function(query) {
                        function _ref3(_id3) {
                            if (!Array.isArray(_id3)) throw new TypeError("Function return value violates contract.\n\nExpected:\nArray<any>\n\nGot:\n" + _inspect(_id3));
                            return _id3;
                        }
                        if ("string" != typeof query) throw new TypeError('Value of argument "query" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(query));
                        if (query) {
                    ...
                    value: function(indexMode) {
                        if ("string" != typeof indexMode) throw new TypeError('Value of argument "indexMode" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(indexMode));
                        if (Object.keys(this.uids).length > 0) throw Error("indexMode cannot be changed once documents have been indexed");
                    ...
                    value: function(token) {
                        ...
                        if ("string" != typeof token) throw new TypeError('Value of argument "token" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(token));
                    ...
                    value: function(token) {
                        ...
                        try {
                            for (var i = 0, length = token.length; i < length; ++i) for (var substring = "", j = i; j < length; ++j) {
                                if (substring += token.charAt(j), "string" != typeof substring) throw new TypeError('Value of variable "substring" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(substring));
                    ...
                    value: function(string) {
                        function _ref8(_id8) {
                            if ("string" != typeof _id8) throw new TypeError("Function return value violates contract.\n\nExpected:\nstring\n\nGot:\n" + _inspect(_id8));
                            return _id8;
                        }
                        if ("string" != typeof string) throw new TypeError('Value of argument "string" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(string));
		   ...
		   */
                return _createClass(SearchIndex, [ {
                    ...
                    value: function(tokens) {
                        function _ref2(_id2) {
                            if (!Array.isArray(_id2)) throw new TypeError("Function return value violates contract.\n\nExpected:\nArray<any>\n\nGot:\n" + _inspect(_id2));
                            return _id2;
                        }
                        if (!Array.isArray(tokens) || !tokens.every(function(item) {
                            return "string" == typeof item;
                        ...
                        var uidMap = {};
                        if (null == uidMap || "object" !== ("undefined" == typeof uidMap ? "undefined" : _typeof(uidMap))) throw new TypeError('Value of variable "uidMap" violates contract.\n\nExpected:\n{ [uid: any]: any\n}\n\nGot:\n' + _inspect(uidMap));
                        var initialized = !1;
                        if (!tokens || "function" != typeof tokens[Symbol.iterator] && !Array.isArray(tokens)) throw new TypeError("Expected tokens to be iterable, got " + _inspect(tokens));
                        var _iteratorNormalCompletion = !0, _didIteratorError = !1, _iteratorError = void 0;
                        try {
                            for (var _step, _iterator = tokens[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
                                var _token = _step.value, currentUidMap = this.tokenToUidMap[_token] || {};
                                if (null == currentUidMap || "object" !== ("undefined" == typeof currentUidMap ? "undefined" : _typeof(currentUidMap))) throw new TypeError('Value of variable "currentUidMap" violates contract.\n\nExpected:\n{ [uid: any]: any\n}\n\nGot:\n' + _inspect(currentUidMap));
                                if (initialized) for (var _uid3 in uidMap) currentUidMap[_uid3] || delete uidMap[_uid3]; else {
                                    initialized = !0;
                                    for (var _uid2 in currentUidMap) uidMap[_uid2] = currentUidMap[_uid2];
                                }
                            }
                        } catch (err) {
                            _didIteratorError = !0, _iteratorError = err;
                        ...
                        var uids = [];
                        if (!Array.isArray(uids)) throw new TypeError('Value of variable "uids" violates contract.\n\nExpected:\nArray<any>\n\nGot:\n' + _inspect(uids));
                        for (var _uid in uidMap) uids.push(uidMap[_uid]);
                        return _ref2(uids);
                    }
                } ]), SearchIndex;
            }();
        ...
        function(module, exports, __webpack_require__) {
            ...
            var _util = __webpack_require__(2), _util2 = _interopRequireDefault(_util), _worker = __webpack_require__(7), _worker2 = _interopRequireDefault(_worker), SearchApi = function() {
                function SearchApi() {
                    var _ref3 = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], indexMode = _ref3.indexMode;
                    if (_classCallCheck(this, SearchApi), // Based on https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers
                    ...
                    this.indexDocument = this.indexDocument.bind(this), "function" != typeof this.indexDocument) throw new TypeError('Value of "this.indexDocument" violates contract.\n\nExpected:\n(any, string) => SearchApi\n\nGot:\n' + _inspect(this.indexDocument));
                    if (this.search = this.search.bind(this), "function" != typeof this.search) throw new TypeError('Value of "this.search" violates contract.\n\nExpected:\n(string) => Promise\n\nGot:\n' + _inspect(this.search));
                }
                /**
		   ...
		   */
                return _createClass(SearchApi, [ {
                    ...
                    value: function(uid, text) {
                        function _ref(_id) {
                            if (!(_id instanceof SearchApi)) throw new TypeError("Function return value violates contract.\n\nExpected:\nSearchApi\n\nGot:\n" + _inspect(_id));
                            return _id;
                        }
                        if ("string" != typeof text) throw new TypeError('Value of argument "text" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(text));
                        return this._search.indexDocument(uid, text), _ref(this);
                    }
                }, {
                    key: "search",
                    value: function(query) {
                        function _ref2(_id2) {
                            if (!(_id2 instanceof Promise)) throw new TypeError("Function return value violates contract.\n\nExpected:\nPromise\n\nGot:\n" + _inspect(_id2));
                            return _id2;
                        }
                        if ("string" != typeof query) throw new TypeError('Value of argument "query" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(query));
        ...
        function(module, exports, __webpack_require__) {
            ...
            var _uuid = __webpack_require__(9), _uuid2 = _interopRequireDefault(_uuid), SearchWorkerLoader = function() {
                /**
		   * Constructor.
		   */
                function SearchWorkerLoader() {
                    var _this = this, _ref3 = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], indexMode = _ref3.indexMode, WorkerClass = _ref3.WorkerClass;
                    if (_classCallCheck(this, SearchWorkerLoader), // Defer worker import until construction to avoid testing error:
                    // Error: Cannot find module 'worker!./[workername]'
                    WorkerClass || (WorkerClass = __webpack_require__(11)), // Maintain context if references are passed around
                    this.indexDocument = this.indexDocument.bind(this), "function" != typeof this.indexDocument) throw new TypeError('Value of "this.indexDocument" violates contract.\n\nExpected:\n(any, string) => SearchWorkerLoader\n\nGot:\n' + _inspect(this.indexDocument));
                    if (this.search = this.search.bind(this), "function" != typeof this.search) throw new TypeError('Value of "this.search" violates contract.\n\nExpected:\n(string) => Promise\n\nGot:\n' + _inspect(this.search));
                    this.callbackQueue = [], this.callbackIdMap = {}, this.worker = new WorkerClass(), 
                    this.worker.onerror = function(event) {
                        var _event$data = event.data, callbackId = _event$data.callbackId, error = _event$data.error;
                        _this._updateQueue({
                    ...
                    indexMode && this.worker.postMessage({
                        method: "setIndexMode",
                        indexMode: indexMode
                    });
                }
		   ...
		   */
                return _createClass(SearchWorkerLoader, [ {
                    ...
                    value: function(uid, text) {
                        function _ref(_id) {
                            if (!(_id instanceof SearchWorkerLoader)) throw new TypeError("Function return value violates contract.\n\nExpected:\nSearchWorkerLoader\n\nGot:\n" + _inspect(_id));
                            return _id;
                        }
                        if ("string" != typeof text) throw new TypeError('Value of argument "text" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(text));
                    ...
                    value: function(query) {
                        ...
                        return new Promise(function(resolve, reject) {
                            ...
                            _this2.worker.postMessage({
                                ...
                                query: query,
                                callbackId: callbackId
                            }), _this2.callbackQueue.push(data), _this2.callbackIdMap[callbackId] = data;
                        });
                    }
                }, {
                    key: "_updateQueue",
                    value: function(_ref4) {
                        var callbackId = _ref4.callbackId, error = _ref4.error, results = _ref4.results, target = this.callbackIdMap[callbackId];
                        for (target.complete = !0, target.error = error, target.results = results; this.callbackQueue.length; ) {
                            var data = this.callbackQueue[0];
                            if (!data.complete) break;
                            this.callbackQueue.shift(), delete this.callbackIdMap[data.callbackId], data.error ? data.reject(data.error) : data.resolve(data.results);
                        }
                    }
                } ]), SearchWorkerLoader;
            }();
    ...
    function(module, exports, __webpack_require__) {
        ...
        function reduxSearch() {
            ...
            return function(createStore) {
                return function(reducer, initialState) {
                    ...
                    return store.dispatch(actions.initializeResources(resourceNames)), searchApi.subscribe(function(_ref2) {
                        var result = _ref2.result, resourceName = _ref2.resourceName;
                        _ref2.text;
                        store.dispatch(actions.receiveResult(resourceName)(result));
                    }, function(error) {
                        throw error;
                    }), resourceSelector && !function() {
        ...
        var _redux = __webpack_require__(41), _selectors = __webpack_require__(2), _actions = __webpack_require__(3), actions = _interopRequireWildcard(_actions), _constants = __webpack_require__(4), _searchMiddleware = __webpack_require__(57), _searchMiddleware2 = _interopRequireDefault(_searchMiddleware), _SearchApi = __webpack_require__(81), _SearchApi2 = _interopRequireDefault(_SearchApi);
    }, /* 6 */
    /***/
    function(module, exports, __webpack_require__) {
        module.exports = {
	...
	*/
            ...
            var _createStore = __webpack_require__(43), _createStore2 = _interopRequireDefault(_createStore), _combineReducers = __webpack_require__(52), _combineReducers2 = _interopRequireDefault(_combineReducers), _bindActionCreators = __webpack_require__(54), _bindActionCreators2 = _interopRequireDefault(_bindActionCreators), _applyMiddleware = __webpack_require__(55), _applyMiddleware2 = _interopRequireDefault(_applyMiddleware), _compose = __webpack_require__(56), _compose2 = _interopRequireDefault(_compose), _warning = __webpack_require__(53), _warning2 = _interopRequireDefault(_warning);
	 ...
	 */
	   ...
	   */
        ...
        var _isPlainObject = __webpack_require__(44), _isPlainObject2 = _interopRequireDefault(_isPlainObject), _symbolObservable = __webpack_require__(48), _symbolObservable2 = _interopRequireDefault(_symbolObservable), ActionTypes = exports.ActionTypes = {
            INIT: "@@redux/INIT"
        };
    }, /* 44 */
    /***/
	 ...
	 */
        ...
        var getPrototype = __webpack_require__(45), isObjectLike = __webpack_require__(47), objectTag = "[object Object]", funcProto = Function.prototype, objectProto = Object.prototype, funcToString = funcProto.toString, hasOwnProperty = objectProto.hasOwnProperty, objectCtorString = funcToString.call(Object), objectToString = objectProto.toString;
        module.exports = isPlainObject;
    }, /* 45 */
    /***/
    function(module, exports, __webpack_require__) {
        var overArg = __webpack_require__(46), getPrototype = overArg(Object.getPrototypeOf, Object);
    ...
    function(module, exports, __webpack_require__) {
        ...
        (function(global, module) {
            ...
            var root, _ponyfill = __webpack_require__(51), _ponyfill2 = _interopRequireDefault(_ponyfill);
            /* global window */
	 ...
	 */
            ...
            var _createStore = __webpack_require__(43), _isPlainObject = __webpack_require__(44), _isPlainObject2 = _interopRequireDefault(_isPlainObject), _warning = __webpack_require__(53), _warning2 = _interopRequireDefault(_warning);
        }).call(exports, __webpack_require__(42));
    }, /* 53 */
    /***/
    function(module, exports) {
	 ...
	 */
        ...
        var _compose = __webpack_require__(56), _compose2 = _interopRequireDefault(_compose);
    }, /* 56 */
    /***/
    function(module, exports) {
        "use strict";
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _toConsumableArray2 = __webpack_require__(58), _toConsumableArray3 = _interopRequireDefault(_toConsumableArray2);
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var _from = __webpack_require__(59), _from2 = _interopRequireDefault(_from);
    ...
    /***/
    function(module, exports, __webpack_require__) {
        __webpack_require__(61), __webpack_require__(74), module.exports = __webpack_require__(28).Array.from;
    }, /* 61 */
    /***/
    function(module, exports, __webpack_require__) {
        "use strict";
    ...
    function(module, exports, __webpack_require__) {
        "use strict";
        var LIBRARY = __webpack_require__(64), $export = __webpack_require__(27), redefine = __webpack_require__(65), hide = __webpack_require__(31), has = __webpack_require__(13), Iterators = __webpack_require__(66), $iterCreate = __webpack_require__(67), setToStringTag = __webpack_require__(71), getPrototypeOf = __webpack_require__(73), ITERATOR = __webpack_require__(72)("iterator"), BUGGY = !([].keys && "next" in [].keys()), FF_ITERATOR = "@@iterator", KEYS = "keys", VALUES = "values", returnThis = function() {
            return this;
        };
    ...
    function(module, exports, __webpack_require__) {
        "use strict";
        var create = __webpack_require__(68), descriptor = __webpack_require__(40), setToStringTag = __webpack_require__(71), IteratorPrototype = {};
        // 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
        __webpack_require__(31)(IteratorPrototype, __webpack_require__(72)("iterator"), function() {
            return this;
    ...
    function(module, exports, __webpack_require__) {
        ...
        var anObject = __webpack_require__(33), dPs = __webpack_require__(69), enumBugKeys = __webpack_require__(25), IE_PROTO = __webpack_require__(21)("IE_PROTO"), Empty = function() {}, PROTOTYPE = "prototype", createDict = function() {
            // Thrash, waste and sodomy: IE GC bug
            var iframeDocument, iframe = __webpack_require__(38)("iframe"), i = enumBugKeys.length, lt = "<", gt = ">";
            for (iframe.style.display = "none", __webpack_require__(70).appendChild(iframe), 
    ...
    /***/
    function(module, exports, __webpack_require__) {
        var def = __webpack_require__(32).f, has = __webpack_require__(13), TAG = __webpack_require__(72)("toStringTag");
    ...
    function(module, exports, __webpack_require__) {
        "use strict";
        var ctx = __webpack_require__(29), $export = __webpack_require__(27), toObject = __webpack_require__(9), call = __webpack_require__(75), isArrayIter = __webpack_require__(76), toLength = __webpack_require__(18), createProperty = __webpack_require__(77), getIterFn = __webpack_require__(78);
    ...
    function(module, exports, __webpack_require__) {
        ...
        var Iterators = __webpack_require__(66), ITERATOR = __webpack_require__(72)("iterator"), ArrayProto = Array.prototype;
        module.exports = function(it) {
    ...
    /***/
    function(module, exports, __webpack_require__) {
        var classof = __webpack_require__(79), ITERATOR = __webpack_require__(72)("iterator"), Iterators = __webpack_require__(66);
    ...
    function(module, exports, __webpack_require__) {
        ...
        var cof = __webpack_require__(16), TAG = __webpack_require__(72)("toStringTag"), ARG = "Arguments" == cof(function() {
            return arguments;
    ...
    /***/
    function(module, exports, __webpack_require__) {
        var ITERATOR = __webpack_require__(72)("iterator"), SAFE_CLOSING = !1;
        try {
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _regenerator = __webpack_require__(82), _regenerator2 = _interopRequireDefault(_regenerator), _asyncToGenerator2 = __webpack_require__(85), _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2), _classCallCheck2 = __webpack_require__(102), _classCallCheck3 = _interopRequireDefault(_classCallCheck2), _createClass2 = __webpack_require__(103), _createClass3 = _interopRequireDefault(_createClass2), _jsWorkerSearch = __webpack_require__(1), _jsWorkerSearch2 = _interopRequireDefault(_jsWorkerSearch), SubscribableSearchApi = function() {
            function SubscribableSearchApi() {
                var _ref = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, indexMode = _ref.indexMode;
                (0, _classCallCheck3["default"])(this, SubscribableSearchApi), this._indexMode = indexMode, 
            ...
            return (0, _createClass3["default"])(SubscribableSearchApi, [ {
                ...
                value: function(_ref2) {
                    var fieldNamesOrIndexFunction = _ref2.fieldNamesOrIndexFunction, resourceName = _ref2.resourceName, resources = _ref2.resources, state = _ref2.state, search = new _jsWorkerSearch2["default"]({
    ...
    function(module, exports, __webpack_require__) {
        ...
        (function(global) {
            ...
            g.regeneratorRuntime = void 0, module.exports = __webpack_require__(84), hadRuntime) // Restore the original runtime.
	 ...
	 */
            !function(global) {
                ...
                var undefined, hasOwn = Object.prototype.hasOwnProperty, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag", inModule = "object" == typeof module, runtime = global.regeneratorRuntime;
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var _promise = __webpack_require__(86), _promise2 = _interopRequireDefault(_promise);
    ...
    /***/
    function(module, exports, __webpack_require__) {
        __webpack_require__(88), __webpack_require__(61), __webpack_require__(89), __webpack_require__(93), 
        module.exports = __webpack_require__(28).Promise;
    }, /* 88 */
    /***/
    function(module, exports) {}, /* 89 */
    /***/
    function(module, exports, __webpack_require__) {
        __webpack_require__(90);
        for (var global = __webpack_require__(23), hide = __webpack_require__(31), Iterators = __webpack_require__(66), TO_STRING_TAG = __webpack_require__(72)("toStringTag"), collections = [ "NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList" ], i = 0; i < 5; i++) {
    ...
    function(module, exports, __webpack_require__) {
        "use strict";
        var addToUnscopables = __webpack_require__(91), step = __webpack_require__(92), Iterators = __webpack_require__(66), toIObject = __webpack_require__(14);
    ...
    function(module, exports, __webpack_require__) {
        "use strict";
        var Internal, GenericPromiseCapability, Wrapper, LIBRARY = __webpack_require__(64), global = __webpack_require__(23), ctx = __webpack_require__(29), classof = __webpack_require__(79), $export = __webpack_require__(27), isObject = __webpack_require__(34), aFunction = __webpack_require__(30), anInstance = __webpack_require__(94), forOf = __webpack_require__(95), speciesConstructor = __webpack_require__(96), task = __webpack_require__(97).set, microtask = __webpack_require__(99)(), PROMISE = "Promise", TypeError = global.TypeError, process = global.process, $Promise = global[PROMISE], process = global.process, isNode = "process" == classof(process), empty = function() {}, USE_NATIVE = !!function() {
            try {
                // correct subclassing with @@species support
                var promise = $Promise.resolve(1), FakePromise = (promise.constructor = {})[__webpack_require__(72)("species")] = function(exec) {
                    exec(empty, empty);
                };
        ...
        $Promise = function(executor) {
            ...
            Promise: $Promise
        }), __webpack_require__(71)($Promise, PROMISE), __webpack_require__(101)(PROMISE), 
    ...
    /***/
    function(module, exports, __webpack_require__) {
        var ctx = __webpack_require__(29), call = __webpack_require__(75), isArrayIter = __webpack_require__(76), anObject = __webpack_require__(33), toLength = __webpack_require__(18), getIterFn = __webpack_require__(78), BREAK = {}, RETURN = {}, exports = module.exports = function(iterable, entries, fn, that, ITERATOR) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        var anObject = __webpack_require__(33), aFunction = __webpack_require__(30), SPECIES = __webpack_require__(72)("species");
    ...
    /***/
    function(module, exports, __webpack_require__) {
        var defer, channel, port, ctx = __webpack_require__(29), invoke = __webpack_require__(98), html = __webpack_require__(70), cel = __webpack_require__(38), global = __webpack_require__(23), process = global.process, setTask = global.setImmediate, clearTask = global.clearImmediate, MessageChannel = global.MessageChannel, counter = 0, queue = {}, ONREADYSTATECHANGE = "onreadystatechange", run = function() {
            var id = +this;
    ...
    /***/
    function(module, exports, __webpack_require__) {
        var global = __webpack_require__(23), macrotask = __webpack_require__(97).set, Observer = global.MutationObserver || global.WebKitMutationObserver, process = global.process, Promise = global.Promise, isNode = "process" == __webpack_require__(16)(process);
        module.exports = function() {
    ...
    function(module, exports, __webpack_require__) {
        "use strict";
        var global = __webpack_require__(23), core = __webpack_require__(28), dP = __webpack_require__(32), DESCRIPTORS = __webpack_require__(36), SPECIES = __webpack_require__(72)("species");
        module.exports = function(KEY) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var _defineProperty = __webpack_require__(104), _defineProperty2 = _interopRequireDefault(_defineProperty);
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _handlers, _defineProperty2 = __webpack_require__(108), _defineProperty3 = _interopRequireDefault(_defineProperty2), _extends4 = __webpack_require__(109), _extends5 = _interopRequireDefault(_extends4);
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var _assign = __webpack_require__(110), _assign2 = _interopRequireDefault(_assign);
    ...
    /***/
    function(module, exports, __webpack_require__) {
        __webpack_require__(112), module.exports = __webpack_require__(28).Object.assign;
    }, /* 112 */
    /***/
    function(module, exports, __webpack_require__) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        var getKeys = __webpack_require__(11), gOPS = __webpack_require__(114), pIE = __webpack_require__(115), toObject = __webpack_require__(9), IObject = __webpack_require__(15), $assign = Object.assign;
