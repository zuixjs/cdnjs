(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var css$2 = ".vega-embed .vega-actions > a {\n  transition: opacity 200ms ease-in;\n  opacity: 0.3;\n  margin-right: 0.6em;\n  color: #444;\n  text-decoration: none;\n  font-size: 0.9em;\n}\n\n.vega-embed .vega-actions > a:hover {\n  color: #000;\n  text-decoration: underline;\n}\n\n.vega-embed:hover .vega-actions > a {\n  opacity: 1;\n  transition: opacity 50ms ease-out;\n}\n";
  ...
  function embed(el, spec, opt) {
      ...
      return __awaiter(this, void 0, void 0, function () {
          var actions, loader, renderer, logLevel, data, config, data, ID, style, mode, vgSpec, parsed, div, runtime, view, handler, wrapper, ctrl, ext_1, editorUrl_1;
                  ...
                  case 4:
                      if (opt.defaultStyle) {
                          ...
                          if (!document.getElementById(ID)) {
                              ...
                              style.id = ID;
                              style.innerText = opt.defaultStyle === true ? css$2 : opt.defaultStyle;
                      ...
                      if (actions !== false) {
                          ...
                          if (actions === true || actions.export !== false) {
                              ...
                              ctrl
                                  ...
                                  var _this = this;
                                  view
                                      .toImageURL(ext_1, opt.scaleFactor)
                                      .then(function (url) {
                                      _this.href = url;
                                  })
  ...
  function container(spec, opt) {
      ...
      return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
              ...
              return [2 /*return*/, embed(div, spec, __assign({ _actionsWrapperContent: SVG_CIRCLES, actions: actions, defaultStyle: css, runAsync: true }, (opt || {}))).then(function (result) {
