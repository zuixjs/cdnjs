(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function createDefaultStyle(id) {
      ...
      return css.toString().replace(EL_ID, id);
  }
                  ...
                  case 4:
                      if (opt.defaultStyle) {
                          ...
                          if (!document.getElementById(ID)) {
                              ...
                              style.id = ID;
                              style.innerText = opt.defaultStyle === true ? (css$1 || '').toString() : opt.defaultStyle;
