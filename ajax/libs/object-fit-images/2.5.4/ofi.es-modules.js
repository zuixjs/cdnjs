...
function hijackAttributes() {
	...
	if (!supportsObjectPosition) {
		HTMLImageElement.prototype.getAttribute = function (name) {
			if (this$1[ಠ] && (name === 'src' || name === 'srcset')) {
				return this$1[ಠ][name + 'Attr'];
			}
			return nativeGetAttribute.call(this$1, name);
		};

		HTMLImageElement.prototype.setAttribute = function (name, value) {
			if (this$1[ಠ] && (name === 'src' || name === 'srcset')) {
				this$1[name === 'src' ? 'src' : name + 'Attr'] = String(value);
			} else {
				nativeSetAttribute.call(this$1, name, value);
			}
		};
	}
}
