...
var IteratorObservable = /** @class */ (function (_super) {
    ...
    IteratorObservable.prototype._subscribe = function (subscriber) {
        var index = 0;
        var scheduler = this.scheduler;
        var iterator$$1 = getIterator(this.iteratorObject);
        if (scheduler) {
...
function combineLatest$1() {
    ...
    return this.lift.call(new ArrayObservable([this].concat(observables)), new CombineLatestOperator(project));
}
...
function onErrorResumeNext$2() {
    ...
    return function (source) { return source.lift(new OnErrorResumeNextOperator$1(nextSources)); };
}
/* tslint:enable:max-line-length */

var OnErrorResumeNextOperator$1 = /** @class */ (function () {
    function OnErrorResumeNextOperator(nextSources) {
        this.nextSources = nextSources;
    }
    OnErrorResumeNextOperator.prototype.call = function (subscriber, source) {
        return source.subscribe(new OnErrorResumeNextSubscriber$1(subscriber, this.nextSources));
    };
    return OnErrorResumeNextOperator;
}());
var OnErrorResumeNextSubscriber$1 = /** @class */ (function (_super) {
    __extends(OnErrorResumeNextSubscriber, _super);
    function OnErrorResumeNextSubscriber(destination, nextSources) {
        var _this = _super.call(this, destination) || this;
        _this.destination = destination;
