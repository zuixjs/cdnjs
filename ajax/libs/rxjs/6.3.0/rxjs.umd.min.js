...
a,g){var f=c.call(this)||this;f.syncErrorValue=null;f.syncErrorThrown=!1;f.syncErrorThrowable=!1;f.isStopped=!1;f._parentSubscription=null;switch(arguments.length){case 0:f.destination=pa;break;case 1:if(!b){f.destination=pa;break}if("object"===typeof b){if(b instanceof q||"syncErrorThrowable"in b&&b[ea]){var d=b[ea]();f.syncErrorThrowable=d.syncErrorThrowable;f.destination=d;d._addParentTeardownLogic(f)}else f.syncErrorThrowable=!0,f.destination=new vb(f,b);break}default:f.syncErrorThrowable=!0,
f.destination=new vb(f,b,a,g)}return f}d(a,c);a.prototype[ea]=function(){return this};a.create=function(b,c,g){b=new a(b,c,g);b.syncErrorThrowable=!1;return b};a.prototype.next=function(b){this.isStopped||this._next(b)};a.prototype.error=function(b){this.isStopped||(this.isStopped=!0,this._error(b),this._unsubscribeParentSubscription())};a.prototype.complete=function(){this.isStopped||(this.isStopped=!0,this._complete(),this._unsubscribeParentSubscription())};a.prototype.unsubscribe=function(){this.closed||
(this.isStopped=!0,c.prototype.unsubscribe.call(this))};a.prototype._next=function(b){this.destination.next(b)};a.prototype._error=function(b){this.destination.error(b);this.unsubscribe()};a.prototype._complete=function(){this.destination.complete();this.unsubscribe()};a.prototype._addParentTeardownLogic=function(b){this._parentSubscription=this.add(b)};a.prototype._unsubscribeParentSubscription=function(){null!==this._parentSubscription&&this._parentSubscription.unsubscribe()};a.prototype._unsubscribeAndRecycle=
...
b,a,g);b.actions.push(this);return b.scheduled||(b.scheduled=Cb.setImmediate(b.flush.bind(b,null)))};a.prototype.recycleAsyncId=function(b,a,g){void 0===g&&(g=0);if(null!==g&&0<g||null===g&&0<this.delay)return c.prototype.recycleAsyncId.call(this,b,a,g);0===b.actions.length&&(Cb.clearImmediate(a),b.scheduled=void 0)};return a}(ka),qa=new (function(c){function a(){return null!==c&&c.apply(this,arguments)||this}d(a,c);a.prototype.flush=function(b){this.active=!0;this.scheduled=void 0;var a=this.actions,
c,k=-1,d=a.length;b=b||a.shift();do if(c=b.execute(b.state,b.delay))break;while(++k<d&&(b=a.shift()));this.active=!1;if(c){for(;++k<d&&(b=a.shift());)b.unsubscribe();throw c;}};return a}(Z))(ad),C=new Z(ka),bd=function(c){function a(b,a){var f=c.call(this,b,a)||this;f.scheduler=b;f.work=a;return f}d(a,c);a.prototype.requestAsyncId=function(b,a,g){void 0===g&&(g=0);if(null!==g&&0<g)return c.prototype.requestAsyncId.call(this,b,a,g);b.actions.push(this);return b.scheduled||(b.scheduled=requestAnimationFrame(function(){return b.flush(null)}))};
a.prototype.recycleAsyncId=function(b,a,g){void 0===g&&(g=0);if(null!==g&&0<g||null===g&&0<this.delay)return c.prototype.recycleAsyncId.call(this,b,a,g);0===b.actions.length&&(cancelAnimationFrame(a),b.scheduled=void 0)};return a}(ka),cd=new (function(c){function a(){return null!==c&&c.apply(this,arguments)||this}d(a,c);a.prototype.flush=function(b){this.active=!0;this.scheduled=void 0;var a=this.actions,c,k=-1,d=a.length;b=b||a.shift();do if(c=b.execute(b.state,b.delay))break;while(++k<d&&(b=a.shift()));
this.active=!1;if(c){for(;++k<d&&(b=a.shift());)b.unsubscribe();throw c;}};return a}(Z))(bd),Db=function(c){function a(b,a){void 0===b&&(b=Ka);void 0===a&&(a=Number.POSITIVE_INFINITY);var f=c.call(this,b,function(){return f.frame})||this;f.maxFrames=a;f.frame=0;f.index=-1;return f}d(a,c);a.prototype.flush=function(){for(var b=this.actions,a=this.maxFrames,c,k;(k=b.shift())&&(this.frame=k.delay)<=a&&!(c=k.execute(k.state,k.delay)););if(c){for(;k=b.shift();)k.unsubscribe();throw c;}};a.frameTimeFactor=
10;return a}(Z),Ka=function(c){function a(b,a,g){void 0===g&&(g=b.index+=1);var f=c.call(this,b,a)||this;f.scheduler=b;f.work=a;f.index=g;f.active=!0;f.index=b.index=g;return f}d(a,c);a.prototype.schedule=function(b,f){void 0===f&&(f=0);if(!this.id)return c.prototype.schedule.call(this,b,f);this.active=!1;var g=new a(this.scheduler,this.work);this.add(g);return g.schedule(b,f)};a.prototype.requestAsyncId=function(b,c,g){void 0===g&&(g=0);this.delay=b.frame+g;b=b.actions;b.push(this);b.sort(a.sortActions);
...
this.unsubscribe()};return a}(q),Wa=function(c){return function(a){c.then(function(b){a.closed||(a.next(b),a.complete())},function(b){return a.error(b)}).then(null,h);return a}},L;L="function"===typeof Symbol&&Symbol.iterator?Symbol.iterator:"@@iterator";var Xa=function(c){return function(a){var b=c[L]();do{var f=b.next();if(f.done){a.complete();break}a.next(f.value);if(a.closed)break}while(1);"function"===typeof b.return&&a.add(function(){b.return&&b.return()});return a}},Ya=function(c){return function(a){var b=
...
a.prototype._complete=function(){var b=this.observables,a=b.length;if(0===a)this.destination.complete();else{this.toRespond=this.active=a;for(var c=0;c<a;c++){var k=b[c];this.add(u(this,k,k,c))}}};a.prototype.notifyComplete=function(b){0===--this.active&&this.destination.complete()};a.prototype.notifyNext=function(b,a,c,k,d){b=this.values;k=b[c];k=this.toRespond?k===Eb?--this.toRespond:this.toRespond:0;b[c]=a;0===k&&(this.resultSelector?this._tryResultSelector(b):this.destination.next(b.slice()))};
a.prototype._tryResultSelector=function(b){var a;try{a=this.resultSelector.apply(this,b)}catch(g){this.destination.error(g);return}this.destination.next(a)};return a}(v),ac=function(){function c(a,b){void 0===b&&(b=Number.POSITIVE_INFINITY);this.project=a;this.concurrent=b}c.prototype.call=function(a,b){return b.subscribe(new fd(a,this.project,this.concurrent))};return c}(),fd=function(c){function a(b,a,g){void 0===g&&(g=Number.POSITIVE_INFINITY);b=c.call(this,b)||this;b.project=a;b.concurrent=g;
b.hasCompleted=!1;b.buffer=[];b.active=0;b.index=0;return b}d(a,c);a.prototype._next=function(b){this.active<this.concurrent?this._tryNext(b):this.buffer.push(b)};a.prototype._tryNext=function(b){var a,c=this.index++;try{a=this.project(b,c)}catch(k){this.destination.error(k);return}this.active++;this._innerSub(a,b,c)};a.prototype._innerSub=function(b,a,c){var f=new O(this,void 0,void 0);this.add(f);u(this,b,a,c,f)};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&0===this.buffer.length&&
this.destination.complete()};a.prototype.notifyNext=function(b,a,c,k,d){this.destination.next(a)};a.prototype.notifyComplete=function(b){var a=this.buffer;this.remove(b);this.active--;0<a.length?this._next(a.shift()):0===this.active&&this.hasCompleted&&this.destination.complete()};return a}(v),bc=function(c){function a(b,a){b=c.call(this,b)||this;b.sources=a;b.completed=0;b.haveValues=0;var f=a.length;b.values=Array(f);for(var k=0;k<f;k++){var d=u(b,a[k],null,k);d&&b.add(d)}return b}d(a,c);a.prototype.notifyNext=
function(b,a,c,k,d){this.values[c]=a;d._hasValue||(d._hasValue=!0,this.haveValues++)};a.prototype.notifyComplete=function(b){var a=this.destination,c=this.haveValues,d=this.values,e=d.length;b._hasValue?(this.completed++,this.completed===e&&(c===e&&a.next(d),a.complete())):a.complete()};return a}(v),Fb=new r(z),fc=function(){function c(){}c.prototype.call=function(a,b){return b.subscribe(new gd(a))};return c}(),gd=function(c){function a(b){b=c.call(this,b)||this;b.hasFirst=!1;b.observables=[];b.subscriptions=
...
this.subscriptions=null}this.destination.next(a)};return a}(v),ib=function(){function c(a){this.resultSelector=a}c.prototype.call=function(a,b){return b.subscribe(new hd(a,this.resultSelector))};return c}(),hd=function(c){function a(b,a,g){void 0===g&&(g=Object.create(null));b=c.call(this,b)||this;b.iterators=[];b.active=0;b.resultSelector="function"===typeof a?a:null;b.values=g;return b}d(a,c);a.prototype._next=function(b){var a=this.iterators;D(b)?a.push(new id(b)):"function"===typeof b[L]?a.push(new jd(b[L]())):
a.push(new kd(this.destination,this,b))};a.prototype._complete=function(){var b=this.iterators,a=b.length;if(0===a)this.destination.complete();else{this.active=a;for(var c=0;c<a;c++){var d=b[c];d.stillUnsubscribed?this.add(d.subscribe(d,c)):this.active--}}};a.prototype.notifyInactive=function(){this.active--;0===this.active&&this.destination.complete()};a.prototype.checkIterators=function(){for(var b=this.iterators,a=b.length,c=this.destination,d=0;d<a;d++){var e=b[d];if("function"===typeof e.hasValue&&
!e.hasValue())return}for(var h=!1,l=[],d=0;d<a;d++){var e=b[d],m=e.next();e.hasCompleted()&&(h=!0);if(m.done){c.complete();return}l.push(m.value)}this.resultSelector?this._tryresultSelector(l):c.next(l);h&&c.complete()};a.prototype._tryresultSelector=function(b){var a;try{a=this.resultSelector.apply(this,b)}catch(g){this.destination.error(g);return}this.destination.next(a)};return a}(q),jd=function(){function c(a){this.iterator=a;this.nextResult=a.next()}c.prototype.hasValue=function(){return!0};
c.prototype.next=function(){var a=this.nextResult;this.nextResult=this.iterator.next();return a};c.prototype.hasCompleted=function(){var a=this.nextResult;return a&&a.done};return c}(),id=function(){function c(a){this.array=a;this.length=this.index=0;this.length=a.length}c.prototype[L]=function(){return this};c.prototype.next=function(a){a=this.index++;var b=this.array;return a<this.length?{value:b[a],done:!1}:{value:null,done:!0}};c.prototype.hasValue=function(){return this.array.length>this.index};
...
this.errored){var a=this.scheduler;b=new Jd(a.now()+this.delay,b);this.queue.push(b);!1===this.active&&this._schedule(a)}};a.prototype._next=function(b){this.scheduleNotification(A.createNext(b))};a.prototype._error=function(b){this.errored=!0;this.queue=[];this.destination.error(b)};a.prototype._complete=function(){this.scheduleNotification(A.createComplete())};return a}(q),Jd=function(){return function(c,a){this.time=c;this.notification=a}}(),Gb=function(){function c(a){this.delayDurationSelector=
...
if(this.active<this.concurrent){c.next(b);var d=m(this.project)(b,g);d===p?c.error(p.e):this.scheduler?this.add(this.scheduler.schedule(a.dispatch,0,{subscriber:this,result:d,value:b,index:g})):this.subscribeToProjection(d,b,g)}else this.buffer.push(b)}};a.prototype.subscribeToProjection=function(b,a,c){this.active++;this.add(u(this,b,a,c))};a.prototype._complete=function(){(this.hasCompleted=!0,0===this.active)&&this.destination.complete()};a.prototype.notifyNext=function(b,a,c,d,e){this._next(a)};
a.prototype.notifyComplete=function(b){var a=this.buffer;this.remove(b);this.active--;a&&0<a.length&&this._next(a.shift());this.hasCompleted&&0===this.active&&this.destination.complete()};return a}(v),ce=function(){function c(a){this.callback=a}c.prototype.call=function(a,b){return b.subscribe(new be(a,this.callback))};return c}(),be=function(c){function a(b,a){b=c.call(this,b)||this;b.add(new w(a));return b}d(a,c);return a}(q),Hb=function(){function c(a,b,c,g){this.predicate=a;this.source=b;this.yieldIndex=
c;this.thisArg=g}c.prototype.call=function(a,b){return b.subscribe(new de(a,this.predicate,this.source,this.yieldIndex,this.thisArg))};return c}(),de=function(c){function a(b,a,g,d,e){b=c.call(this,b)||this;b.predicate=a;b.source=g;b.yieldIndex=d;b.thisArg=e;b.index=0;return b}d(a,c);a.prototype.notifyComplete=function(b){var a=this.destination;a.next(b);a.complete();this.unsubscribe()};a.prototype._next=function(b){var a=this.predicate,c=this.thisArg,d=this.index++;try{a.call(c||this,b,d,this.source)&&
this.notifyComplete(this.yieldIndex?d:b)}catch(E){this.destination.error(E)}};a.prototype._complete=function(){this.notifyComplete(this.yieldIndex?-1:void 0)};return a}(q),fe=function(){function c(){}c.prototype.call=function(a,b){return b.subscribe(new ee(a))};return c}(),ee=function(c){function a(){return null!==c&&c.apply(this,arguments)||this}d(a,c);a.prototype._next=function(b){};return a}(q),he=function(){function c(){}c.prototype.call=function(a,b){return b.subscribe(new ge(a))};return c}(),
ge=function(c){function a(b){return c.call(this,b)||this}d(a,c);a.prototype.notifyComplete=function(b){var a=this.destination;a.next(b);a.complete()};a.prototype._next=function(b){this.notifyComplete(!1)};a.prototype._complete=function(){this.notifyComplete(!0)};return a}(q),sc=function(){function c(a){this.total=a;if(0>this.total)throw new T;}c.prototype.call=function(a,b){return b.subscribe(new ie(a,this.total))};return c}(),ie=function(c){function a(b,a){b=c.call(this,b)||this;b.total=a;b.ring=
[];b.count=0;return b}d(a,c);a.prototype._next=function(b){var a=this.ring,c=this.total,d=this.count++;a.length<c?a.push(b):a[d%c]=b};a.prototype._complete=function(){var b=this.destination,a=this.count;if(0<a)for(var c=this.count>=this.total?this.total:this.count,d=this.ring,e=0;e<c;e++){var h=a++%c;b.next(d[h])}b.complete()};return a}(q),ke=function(){function c(a){this.value=a}c.prototype.call=function(a,b){return b.subscribe(new je(a,this.value))};return c}(),je=function(c){function a(b,a){b=
c.call(this,b)||this;b.value=a;return b}d(a,c);a.prototype._next=function(b){this.destination.next(this.value)};return a}(q),me=function(){function c(){}c.prototype.call=function(a,b){return b.subscribe(new le(a))};return c}(),le=function(c){function a(b){return c.call(this,b)||this}d(a,c);a.prototype._next=function(b){this.destination.next(A.createNext(b))};a.prototype._error=function(b){var a=this.destination;a.next(A.createError(b));a.complete()};a.prototype._complete=function(){var b=this.destination;
b.next(A.createComplete());b.complete()};return a}(q),tc=function(){function c(a,b,c){void 0===c&&(c=!1);this.accumulator=a;this.seed=b;this.hasSeed=c}c.prototype.call=function(a,b){return b.subscribe(new ne(a,this.accumulator,this.seed,this.hasSeed))};return c}(),ne=function(c){function a(b,a,g,d){b=c.call(this,b)||this;b.accumulator=a;b._seed=g;b.hasSeed=d;b.index=0;return b}d(a,c);Object.defineProperty(a.prototype,"seed",{get:function(){return this._seed},set:function(b){this.hasSeed=!0;this._seed=
b},enumerable:!0,configurable:!0});a.prototype._next=function(b){if(this.hasSeed)return this._tryNext(b);this.seed=b;this.destination.next(b)};a.prototype._tryNext=function(b){var a=this.index++,c;try{c=this.accumulator(this.seed,b,a)}catch(k){this.destination.error(k)}this.seed=c;this.destination.next(c)};return a}(q),pe=function(){function c(a,b,c){this.accumulator=a;this.seed=b;this.concurrent=c}c.prototype.call=function(a,b){return b.subscribe(new oe(a,this.accumulator,this.seed,this.concurrent))};
return c}(),oe=function(c){function a(b,a,g,d){b=c.call(this,b)||this;b.accumulator=a;b.acc=g;b.concurrent=d;b.hasValue=!1;b.hasCompleted=!1;b.buffer=[];b.active=0;b.index=0;return b}d(a,c);a.prototype._next=function(b){if(this.active<this.concurrent){var a=this.index++,c=m(this.accumulator)(this.acc,b),d=this.destination;c===p?d.error(p.e):(this.active++,this._innerSub(c,b,a))}else this.buffer.push(b)};a.prototype._innerSub=function(b,a,c){var f=new O(this,void 0,void 0);this.add(f);u(this,b,a,c,
f)};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&0===this.buffer.length&&(!1===this.hasValue&&this.destination.next(this.acc),this.destination.complete())};a.prototype.notifyNext=function(b,a,c,d,e){b=this.destination;this.acc=a;this.hasValue=!0;b.next(a)};a.prototype.notifyComplete=function(b){var a=this.buffer;this.remove(b);this.active--;0<a.length?this._next(a.shift()):0===this.active&&this.hasCompleted&&(!1===this.hasValue&&this.destination.next(this.acc),this.destination.complete())};
return a}(v),uc=function(){function c(a,b){this.subjectFactory=a;this.selector=b}c.prototype.call=function(a,b){var c=this.selector,g=this.subjectFactory();a=c(g).subscribe(a);a.add(b.subscribe(g));return a};return c}(),re=function(){function c(a){this.nextSources=a}c.prototype.call=function(a,b){return b.subscribe(new qe(a,this.nextSources))};return c}(),qe=function(c){function a(b,a){var f=c.call(this,b)||this;f.destination=b;f.nextSources=a;return f}d(a,c);a.prototype.notifyError=function(b,a){this.subscribeToNextSource()};
a.prototype.notifyComplete=function(b){this.subscribeToNextSource()};a.prototype._error=function(b){this.subscribeToNextSource()};a.prototype._complete=function(){this.subscribeToNextSource()};a.prototype.subscribeToNextSource=function(){var b=this.nextSources.shift();if(b){var a=new O(this,void 0,void 0);this.add(a);u(this,b,void 0,void 0,a)}else this.destination.complete()};return a}(v),te=function(){function c(){}c.prototype.call=function(a,b){return b.subscribe(new se(a))};return c}(),se=function(c){function a(b){b=
c.call(this,b)||this;b.hasPrev=!1;return b}d(a,c);a.prototype._next=function(b){this.hasPrev?this.destination.next([this.prev,b]):this.hasPrev=!0;this.prev=b};return a}(q),Ib=function(){function c(a,b){this.count=a;this.source=b}c.prototype.call=function(a,b){return b.subscribe(new ue(a,this.count,this.source))};return c}(),ue=function(c){function a(b,a,g){b=c.call(this,b)||this;b.count=a;b.source=g;return b}d(a,c);a.prototype.complete=function(){if(!this.isStopped){var b=this.source,a=this.count;
if(0===a)return c.prototype.complete.call(this);-1<a&&(this.count=a-1);b.subscribe(this._unsubscribeAndRecycle())}};return a}(q),we=function(){function c(a){this.notifier=a}c.prototype.call=function(a,b){return b.subscribe(new ve(a,this.notifier,b))};return c}(),ve=function(c){function a(b,a,g){b=c.call(this,b)||this;b.notifier=a;b.source=g;b.sourceIsBeingSubscribedTo=!0;return b}d(a,c);a.prototype.notifyNext=function(b,a,c,d,e){this.sourceIsBeingSubscribedTo=!0;this.source.subscribe(this)};a.prototype.notifyComplete=
function(b){if(!1===this.sourceIsBeingSubscribedTo)return c.prototype.complete.call(this)};a.prototype.complete=function(){this.sourceIsBeingSubscribedTo=!1;if(!this.isStopped){this.retries||this.subscribeToRetries();if(!this.retriesSubscription||this.retriesSubscription.closed)return c.prototype.complete.call(this);this._unsubscribeAndRecycle();this.notifications.next()}};a.prototype._unsubscribe=function(){var b=this.notifications,a=this.retriesSubscription;b&&(b.unsubscribe(),this.notifications=
null);a&&(a.unsubscribe(),this.retriesSubscription=null);this.retries=null};a.prototype._unsubscribeAndRecycle=function(){var b=this._unsubscribe;this._unsubscribe=null;c.prototype._unsubscribeAndRecycle.call(this);this._unsubscribe=b;return this};a.prototype.subscribeToRetries=function(){this.notifications=new y;var b=m(this.notifier)(this.notifications);if(b===p)return c.prototype.complete.call(this);this.retries=b;this.retriesSubscription=u(this,b)};return a}(v),ye=function(){function c(a,b){this.count=
a;this.source=b}c.prototype.call=function(a,b){return b.subscribe(new xe(a,this.count,this.source))};return c}(),xe=function(c){function a(b,a,g){b=c.call(this,b)||this;b.count=a;b.source=g;return b}d(a,c);a.prototype.error=function(b){if(!this.isStopped){var a=this.source,g=this.count;if(0===g)return c.prototype.error.call(this,b);-1<g&&(this.count=g-1);a.subscribe(this._unsubscribeAndRecycle())}};return a}(q),Ae=function(){function c(a,b){this.notifier=a;this.source=b}c.prototype.call=function(a,
b){return b.subscribe(new ze(a,this.notifier,this.source))};return c}(),ze=function(c){function a(b,a,g){b=c.call(this,b)||this;b.notifier=a;b.source=g;return b}d(a,c);a.prototype.error=function(b){if(!this.isStopped){var a=this.errors,g=this.retries,d=this.retriesSubscription;if(g)this.retriesSubscription=this.errors=null;else{a=new y;g=m(this.notifier)(a);if(g===p)return c.prototype.error.call(this,p.e);d=u(this,g)}this._unsubscribeAndRecycle();this.errors=a;this.retries=g;this.retriesSubscription=
d;a.next(b)}};a.prototype._unsubscribe=function(){var b=this.errors,a=this.retriesSubscription;b&&(b.unsubscribe(),this.errors=null);a&&(a.unsubscribe(),this.retriesSubscription=null);this.retries=null};a.prototype.notifyNext=function(b,a,c,d,e){b=this._unsubscribe;this._unsubscribe=null;this._unsubscribeAndRecycle();this._unsubscribe=b;this.source.subscribe(this)};return a}(v),Ce=function(){function c(a){this.notifier=a}c.prototype.call=function(a,b){a=new Be(a);b=b.subscribe(a);b.add(u(a,this.notifier));
return b};return c}(),Be=function(c){function a(){var b=null!==c&&c.apply(this,arguments)||this;b.hasValue=!1;return b}d(a,c);a.prototype._next=function(b){this.value=b;this.hasValue=!0};a.prototype.notifyNext=function(b,a,c,d,e){this.emitValue()};a.prototype.notifyComplete=function(){this.emitValue()};a.prototype.emitValue=function(){this.hasValue&&(this.hasValue=!1,this.destination.next(this.value))};return a}(v),Ee=function(){function c(a,b){this.period=a;this.scheduler=b}c.prototype.call=function(a,
b){return b.subscribe(new De(a,this.period,this.scheduler))};return c}(),De=function(c){function a(b,a,g){b=c.call(this,b)||this;b.period=a;b.scheduler=g;b.hasValue=!1;b.add(g.schedule(yc,a,{subscriber:b,period:a}));return b}d(a,c);a.prototype._next=function(b){this.lastValue=b;this.hasValue=!0};a.prototype.notifyNext=function(){this.hasValue&&(this.hasValue=!1,this.destination.next(this.lastValue))};return a}(q),Ge=function(){function c(a,b){this.compareTo=a;this.comparor=b}c.prototype.call=function(a,
b){return b.subscribe(new Fe(a,this.compareTo,this.comparor))};return c}(),Fe=function(c){function a(b,a,g){var f=c.call(this,b)||this;f.compareTo=a;f.comparor=g;f._a=[];f._b=[];f._oneComplete=!1;f.add(a.subscribe(new He(b,f)));return f}d(a,c);a.prototype._next=function(b){this._oneComplete&&0===this._b.length?this.emit(!1):(this._a.push(b),this.checkValues())};a.prototype._complete=function(){this._oneComplete?this.emit(0===this._a.length&&0===this._b.length):this._oneComplete=!0};a.prototype.checkValues=
function(){for(var b=this._a,a=this._b,c=this.comparor;0<b.length&&0<a.length;){var d=b.shift(),e=a.shift();c?(d=m(c)(d,e),d===p&&this.destination.error(p.e)):d=d===e;d||this.emit(!1)}};a.prototype.emit=function(b){var a=this.destination;a.next(b);a.complete()};a.prototype.nextB=function(b){this._oneComplete&&0===this._a.length?this.emit(!1):(this._b.push(b),this.checkValues())};return a}(q),He=function(c){function a(b,a){b=c.call(this,b)||this;b.parent=a;return b}d(a,c);a.prototype._next=function(b){this.parent.nextB(b)};
a.prototype._error=function(b){this.parent.error(b)};a.prototype._complete=function(){this.parent._complete()};return a}(q),Je=function(){function c(a,b){this.predicate=a;this.source=b}c.prototype.call=function(a,b){return b.subscribe(new Ie(a,this.predicate,this.source))};return c}(),Ie=function(c){function a(b,a,g){b=c.call(this,b)||this;b.predicate=a;b.source=g;b.seenValue=!1;b.index=0;return b}d(a,c);a.prototype.applySingleValue=function(b){this.seenValue?this.destination.error("Sequence contains more than one element"):
(this.seenValue=!0,this.singleValue=b)};a.prototype._next=function(b){var a=this.index++;this.predicate?this.tryNext(b,a):this.applySingleValue(b)};a.prototype.tryNext=function(b,a){try{this.predicate(b,a,this.source)&&this.applySingleValue(b)}catch(g){this.destination.error(g)}};a.prototype._complete=function(){var b=this.destination;0<this.index?(b.next(this.seenValue?this.singleValue:void 0),b.complete()):b.error(new ha)};return a}(q),Le=function(){function c(a){this.total=a}c.prototype.call=function(a,
b){return b.subscribe(new Ke(a,this.total))};return c}(),Ke=function(c){function a(b,a){b=c.call(this,b)||this;b.total=a;b.count=0;return b}d(a,c);a.prototype._next=function(b){++this.count>this.total&&this.destination.next(b)};return a}(q),Ne=function(){function c(a){this._skipCount=a;if(0>this._skipCount)throw new T;}c.prototype.call=function(a,b){return 0===this._skipCount?b.subscribe(new q(a)):b.subscribe(new Me(a,this._skipCount))};return c}(),Me=function(c){function a(b,a){b=c.call(this,b)||
this;b._skipCount=a;b._count=0;b._ring=Array(a);return b}d(a,c);a.prototype._next=function(b){var a=this._skipCount,c=this._count++;if(c<a)this._ring[c]=b;else{var a=c%a,c=this._ring,d=c[a];c[a]=b;this.destination.next(d)}};return a}(q),Pe=function(){function c(a){this.notifier=a}c.prototype.call=function(a,b){return b.subscribe(new Oe(a,this.notifier))};return c}(),Oe=function(c){function a(b,a){b=c.call(this,b)||this;b.hasValue=!1;var f=new O(b,void 0,void 0);b.add(f);b.innerSubscription=f;u(b,
a,void 0,void 0,f);return b}d(a,c);a.prototype._next=function(a){this.hasValue&&c.prototype._next.call(this,a)};a.prototype.notifyNext=function(a,c,g,d,e){this.hasValue=!0;this.innerSubscription&&this.innerSubscription.unsubscribe()};a.prototype.notifyComplete=function(){};return a}(v),Re=function(){function c(a){this.predicate=a}c.prototype.call=function(a,b){return b.subscribe(new Qe(a,this.predicate))};return c}(),Qe=function(c){function a(a,f){a=c.call(this,a)||this;a.predicate=f;a.skipping=!0;
a.index=0;return a}d(a,c);a.prototype._next=function(a){var b=this.destination;this.skipping&&this.tryCallPredicate(a);this.skipping||b.next(a)};a.prototype.tryCallPredicate=function(a){try{this.skipping=!!this.predicate(a,this.index++)}catch(f){this.destination.error(f)}};return a}(q),Se=function(c){function a(a,f,d){void 0===f&&(f=0);void 0===d&&(d=qa);var b=c.call(this)||this;b.source=a;b.delayTime=f;b.scheduler=d;if(!ca(f)||0>f)b.delayTime=0;d&&"function"===typeof d.schedule||(b.scheduler=qa);
return b}d(a,c);a.create=function(b,c,d){void 0===c&&(c=0);void 0===d&&(d=qa);return new a(b,c,d)};a.dispatch=function(a){return this.add(a.source.subscribe(a.subscriber))};a.prototype._subscribe=function(b){return this.scheduler.schedule(a.dispatch,this.delayTime,{source:this.source,subscriber:b})};return a}(r),Te=function(){function c(a,b){this.scheduler=a;this.delay=b}c.prototype.call=function(a,b){return(new Se(b,this.delay,this.scheduler)).subscribe(a)};return c}(),Bc=function(){function c(a){this.project=
...
function(){var a=this.innerSubscription;a&&!a.closed||c.prototype._complete.call(this)};a.prototype._unsubscribe=function(){this.innerSubscription=null};a.prototype.notifyComplete=function(a){this.remove(a);this.innerSubscription=null;this.isStopped&&c.prototype._complete.call(this)};a.prototype.notifyNext=function(a,c,d,e,h){this.destination.next(c)};return a}(v),We=function(){function c(a){this.notifier=a}c.prototype.call=function(a,b){a=new Ve(a);var c=u(a,this.notifier);return c&&!a.seenValue?
(a.add(c),b.subscribe(a)):a};return c}(),Ve=function(c){function a(a){a=c.call(this,a)||this;a.seenValue=!1;return a}d(a,c);a.prototype.notifyNext=function(a,c,d,e,h){this.seenValue=!0;this.complete()};a.prototype.notifyComplete=function(){};return a}(v),Ye=function(){function c(a){this.predicate=a}c.prototype.call=function(a,b){return b.subscribe(new Xe(a,this.predicate))};return c}(),Xe=function(c){function a(a,f){a=c.call(this,a)||this;a.predicate=f;a.index=0;return a}d(a,c);a.prototype._next=
function(a){var b=this.destination,c;try{c=this.predicate(a,this.index++)}catch(k){b.error(k);return}this.nextOrComplete(a,c)};a.prototype.nextOrComplete=function(a,c){var b=this.destination;c?b.next(a):b.complete()};return a}(q),Jb={leading:!0,trailing:!1},$e=function(){function c(a,b,c){this.durationSelector=a;this.leading=b;this.trailing=c}c.prototype.call=function(a,b){return b.subscribe(new Ze(a,this.durationSelector,this.leading,this.trailing))};return c}(),Ze=function(c){function a(a,f,d,e){var b=
c.call(this,a)||this;b.destination=a;b.durationSelector=f;b._leading=d;b._trailing=e;b._hasValue=!1;return b}d(a,c);a.prototype._next=function(a){this._hasValue=!0;this._sendValue=a;this._throttled||(this._leading?this.send():this.throttle(a))};a.prototype.send=function(){var a=this._sendValue;this._hasValue&&(this.destination.next(a),this.throttle(a));this._hasValue=!1;this._sendValue=null};a.prototype.throttle=function(a){(a=this.tryDurationSelector(a))&&this.add(this._throttled=u(this,a))};a.prototype.tryDurationSelector=
function(a){try{return this.durationSelector(a)}catch(f){return this.destination.error(f),null}};a.prototype.throttlingDone=function(){var a=this._throttled,c=this._trailing;a&&a.unsubscribe();this._throttled=null;c&&this.send()};a.prototype.notifyNext=function(a,c,d,e,h){this.throttlingDone()};a.prototype.notifyComplete=function(){this.throttlingDone()};return a}(v),bf=function(){function c(a,b,c,d){this.duration=a;this.scheduler=b;this.leading=c;this.trailing=d}c.prototype.call=function(a,b){return b.subscribe(new af(a,
this.duration,this.scheduler,this.leading,this.trailing))};return c}(),af=function(c){function a(a,f,d,e,h){a=c.call(this,a)||this;a.duration=f;a.scheduler=d;a.leading=e;a.trailing=h;a._hasTrailingValue=!1;a._trailingValue=null;return a}d(a,c);a.prototype._next=function(a){this.throttled?this.trailing&&(this._trailingValue=a,this._hasTrailingValue=!0):(this.add(this.throttled=this.scheduler.schedule(Cc,this.duration,{subscriber:this})),this.leading&&this.destination.next(a))};a.prototype._complete=
function(){this._hasTrailingValue&&this.destination.next(this._trailingValue);this.destination.complete()};a.prototype.clearThrottle=function(){var a=this.throttled;a&&(this.trailing&&this._hasTrailingValue&&(this.destination.next(this._trailingValue),this._trailingValue=null,this._hasTrailingValue=!1),a.unsubscribe(),this.remove(a),this.throttled=null)};return a}(q),cf=function(){return function(c,a){this.value=c;this.interval=a}}(),Dc=function(){function c(a,b,c,d){this.waitFor=a;this.absoluteTimeout=
...
b?this.action=b.schedule(this,this.waitFor):this.add(this.action=this.scheduler.schedule(a.dispatchTimeout,this.waitFor,this))};a.prototype._next=function(a){this.absoluteTimeout||this.scheduleTimeout();c.prototype._next.call(this,a)};a.prototype._unsubscribe=function(){this.withObservable=this.scheduler=this.action=null};return a}(v),ef=function(){return function(c,a){this.value=c;this.timestamp=a}}(),gf=function(){function c(a){this.windowBoundaries=a}c.prototype.call=function(a,b){a=new ff(a);
b=b.subscribe(a);b.closed||a.add(u(a,this.windowBoundaries));return b};return c}(),ff=function(c){function a(a){var b=c.call(this,a)||this;b.window=new y;a.next(b.window);return b}d(a,c);a.prototype.notifyNext=function(a,c,d,e,h){this.openWindow()};a.prototype.notifyError=function(a,c){this._error(a)};a.prototype.notifyComplete=function(a){this._complete()};a.prototype._next=function(a){this.window.next(a)};a.prototype._error=function(a){this.window.error(a);this.destination.error(a)};a.prototype._complete=
function(){this.window.complete();this.destination.complete()};a.prototype._unsubscribe=function(){this.window=null};a.prototype.openWindow=function(){var a=this.window;a&&a.complete();var a=this.destination,c=this.window=new y;a.next(c)};return a}(v),jf=function(){function c(a,b){this.windowSize=a;this.startWindowEvery=b}c.prototype.call=function(a,b){return b.subscribe(new hf(a,this.windowSize,this.startWindowEvery))};return c}(),hf=function(c){function a(a,f,d){var b=c.call(this,a)||this;b.destination=
a;b.windowSize=f;b.startWindowEvery=d;b.windows=[new y];b.count=0;a.next(b.windows[0]);return b}d(a,c);a.prototype._next=function(a){for(var b=0<this.startWindowEvery?this.startWindowEvery:this.windowSize,c=this.destination,d=this.windowSize,e=this.windows,h=e.length,l=0;l<h&&!this.closed;l++)e[l].next(a);a=this.count-d+1;0<=a&&0===a%b&&!this.closed&&e.shift().complete();0!==++this.count%b||this.closed||(b=new y,e.push(b),c.next(b))};a.prototype._error=function(a){var b=this.windows;if(b)for(;0<b.length&&
!this.closed;)b.shift().error(a);this.destination.error(a)};a.prototype._complete=function(){var a=this.windows;if(a)for(;0<a.length&&!this.closed;)a.shift().complete();this.destination.complete()};a.prototype._unsubscribe=function(){this.count=0;this.windows=null};return a}(q),lf=function(){function c(a,b,c,d){this.windowTimeSpan=a;this.windowCreationInterval=b;this.maxWindowSize=c;this.scheduler=d}c.prototype.call=function(a,b){return b.subscribe(new kf(a,this.windowTimeSpan,this.windowCreationInterval,
this.maxWindowSize,this.scheduler))};return c}(),mf=function(c){function a(){var a=null!==c&&c.apply(this,arguments)||this;a._numberOfNextedValues=0;return a}d(a,c);a.prototype.next=function(a){this._numberOfNextedValues++;c.prototype.next.call(this,a)};Object.defineProperty(a.prototype,"numberOfNextedValues",{get:function(){return this._numberOfNextedValues},enumerable:!0,configurable:!0});return a}(y),kf=function(c){function a(a,f,d,e,h){var b=c.call(this,a)||this;b.destination=a;b.windowTimeSpan=
f;b.windowCreationInterval=d;b.maxWindowSize=e;b.scheduler=h;b.windows=[];a=b.openWindow();null!==d&&0<=d?(e={windowTimeSpan:f,windowCreationInterval:d,subscriber:b,scheduler:h},b.add(h.schedule(rb,f,{subscriber:b,window:a,context:null})),b.add(h.schedule(Gc,d,e))):b.add(h.schedule(Fc,f,{subscriber:b,window:a,windowTimeSpan:f}));return b}d(a,c);a.prototype._next=function(a){for(var b=this.windows,c=b.length,d=0;d<c;d++){var e=b[d];e.closed||(e.next(a),e.numberOfNextedValues>=this.maxWindowSize&&this.closeWindow(e))}};
a.prototype._error=function(a){for(var b=this.windows;0<b.length;)b.shift().error(a);this.destination.error(a)};a.prototype._complete=function(){for(var a=this.windows;0<a.length;){var c=a.shift();c.closed||c.complete()}this.destination.complete()};a.prototype.openWindow=function(){var a=new mf;this.windows.push(a);this.destination.next(a);return a};a.prototype.closeWindow=function(a){a.complete();var b=this.windows;b.splice(b.indexOf(a),1)};return a}(q),of=function(){function c(a,b){this.openings=
a;this.closingSelector=b}c.prototype.call=function(a,b){return b.subscribe(new nf(a,this.openings,this.closingSelector))};return c}(),nf=function(c){function a(a,f,d){a=c.call(this,a)||this;a.openings=f;a.closingSelector=d;a.contexts=[];a.add(a.openSubscription=u(a,f,f));return a}d(a,c);a.prototype._next=function(a){var b=this.contexts;if(b)for(var c=b.length,d=0;d<c;d++)b[d].window.next(a)};a.prototype._error=function(a){var b=this.contexts;this.contexts=null;if(b)for(var d=b.length,e=-1;++e<d;){var h=
b[e];h.window.error(a);h.subscription.unsubscribe()}c.prototype._error.call(this,a)};a.prototype._complete=function(){var a=this.contexts;this.contexts=null;if(a)for(var f=a.length,d=-1;++d<f;){var e=a[d];e.window.complete();e.subscription.unsubscribe()}c.prototype._complete.call(this)};a.prototype._unsubscribe=function(){var a=this.contexts;this.contexts=null;if(a)for(var c=a.length,d=-1;++d<c;){var e=a[d];e.window.unsubscribe();e.subscription.unsubscribe()}};a.prototype.notifyNext=function(a,c,
d,e,h){if(a===this.openings){e=m(this.closingSelector)(c);if(e===p)return this.error(p.e);a=new y;c=new w;d={window:a,subscription:c};this.contexts.push(d);e=u(this,e,d);e.closed?this.closeWindow(this.contexts.length-1):(e.context=d,c.add(e));this.destination.next(a)}else this.closeWindow(this.contexts.indexOf(a))};a.prototype.notifyError=function(a){this.error(a)};a.prototype.notifyComplete=function(a){a!==this.openSubscription&&this.closeWindow(this.contexts.indexOf(a.context))};a.prototype.closeWindow=
function(a){if(-1!==a){var b=this.contexts,c=b[a],d=c.window,c=c.subscription;b.splice(a,1);d.complete();c.unsubscribe()}};return a}(v),qf=function(){function c(a){this.closingSelector=a}c.prototype.call=function(a,b){return b.subscribe(new pf(a,this.closingSelector))};return c}(),pf=function(c){function a(a,d){var b=c.call(this,a)||this;b.destination=a;b.closingSelector=d;b.openWindow();return b}d(a,c);a.prototype.notifyNext=function(a,c,d,e,h){this.openWindow(h)};a.prototype.notifyError=function(a,
c){this._error(a)};a.prototype.notifyComplete=function(a){this.openWindow(a)};a.prototype._next=function(a){this.window.next(a)};a.prototype._error=function(a){this.window.error(a);this.destination.error(a);this.unsubscribeClosingNotification()};a.prototype._complete=function(){this.window.complete();this.destination.complete();this.unsubscribeClosingNotification()};a.prototype.unsubscribeClosingNotification=function(){this.closingNotification&&this.closingNotification.unsubscribe()};a.prototype.openWindow=
function(a){void 0===a&&(a=null);a&&(this.remove(a),a.unsubscribe());(a=this.window)&&a.complete();a=this.window=new y;this.destination.next(a);a=m(this.closingSelector)();a===p?(a=p.e,this.destination.error(a),this.window.error(a)):this.add(this.closingNotification=u(this,a))};return a}(v),sf=function(){function c(a,b){this.observables=a;this.project=b}c.prototype.call=function(a,b){return b.subscribe(new rf(a,this.observables,this.project))};return c}(),rf=function(c){function a(a,d,g){a=c.call(this,
a)||this;a.observables=d;a.project=g;a.toRespond=[];g=d.length;a.values=Array(g);for(var b=0;b<g;b++)a.toRespond.push(b);for(b=0;b<g;b++){var f=d[b];a.add(u(a,f,f,b))}return a}d(a,c);a.prototype.notifyNext=function(a,c,d,e,h){this.values[d]=c;a=this.toRespond;0<a.length&&(d=a.indexOf(d),-1!==d&&a.splice(d,1))};a.prototype.notifyComplete=function(){};a.prototype._next=function(a){0===this.toRespond.length&&(a=[a].concat(this.values),this.project?this._tryProject(a):this.destination.next(a))};a.prototype._tryProject=
function(a){var b;try{b=this.project.apply(this,a)}catch(g){this.destination.error(g);return}this.destination.next(b)};return a}(v),tf=Object.freeze({audit:jb,auditTime:function(c,a){void 0===a&&(a=C);return jb(function(){return gb(c,a)})},buffer:function(c){return function(a){return a.lift(new nd(c))}},bufferCount:function(c,a){void 0===a&&(a=null);return function(b){return b.lift(new qd(c,a))}},bufferTime:function(c){var a=arguments.length,b=C;B(arguments[arguments.length-1])&&(b=arguments[arguments.length-
1],a--);var d=null;2<=a&&(d=arguments[1]);var g=Number.POSITIVE_INFINITY;3<=a&&(g=arguments[2]);return function(a){return a.lift(new sd(c,d,g,b))}},bufferToggle:function(c,a){return function(b){return b.lift(new vd(c,a))}},bufferWhen:function(c){return function(a){return a.lift(new xd(c))}},catchError:function(c){return function(a){var b=new zd(c);a=a.lift(b);return b.caught=a}},combineAll:function(c){return function(a){return a.lift(new La(c))}},combineLatest:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=
arguments[a];var b=null;"function"===typeof c[c.length-1]&&(b=c.pop());1===c.length&&D(c[0])&&(c=c[0].slice());return function(a){return a.lift.call(M([a].concat(c)),new La(b))}},concat:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){return a.lift.call(P.apply(void 0,[a].concat(c)))}},concatAll:$a,concatMap:mb,concatMapTo:function(c,a){return mb(function(){return c},a)},count:function(c){return function(a){return a.lift(new Bd(c,a))}},debounce:function(c){return function(a){return a.lift(new Dd(c))}},
debounceTime:function(c,a){void 0===a&&(a=C);return function(b){return b.lift(new Fd(c,a))}},defaultIfEmpty:ga,delay:function(c,a){void 0===a&&(a=C);var b=c instanceof Date&&!isNaN(+c)?+c-a.now():Math.abs(c);return function(c){return c.lift(new Id(b,a))}},delayWhen:function(c,a){return a?function(b){return(new Md(b,a)).lift(new Gb(c))}:function(a){return a.lift(new Gb(c))}},dematerialize:function(){return function(c){return c.lift(new Od)}},distinct:function(c,a){return function(b){return b.lift(new Qd(c,
a))}},distinctUntilChanged:nb,distinctUntilKeyChanged:function(c,a){return nb(function(b,d){return a?a(b[c],d[c]):b[c]===d[c]})},elementAt:function(c,a){if(0>c)throw new T;var b=2<=arguments.length;return function(d){return d.pipe(da(function(a,b){return b===c}),Ea(1),b?ga(a):ra(function(){return new T}))}},endWith:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){var b=c[c.length-1];B(b)?c.pop():b=null;var d=c.length;return 1!==d||b?0<d?P(a,K(c,b)):P(a,I(b)):
P(a,va(c[0]))}},every:function(c,a){return function(b){return b.lift(new Wd(c,a,b))}},exhaust:function(){return function(c){return c.lift(new Yd)}},exhaustMap:pb,expand:function(c,a,b){void 0===a&&(a=Number.POSITIVE_INFINITY);void 0===b&&(b=void 0);a=1>(a||0)?Number.POSITIVE_INFINITY:a;return function(d){return d.lift(new ae(c,a,b))}},filter:da,finalize:function(c){return function(a){return a.lift(new ce(c))}},find:function(c,a){if("function"!==typeof c)throw new TypeError("predicate is not a function");
return function(b){return b.lift(new Hb(c,b,!1,a))}},findIndex:function(c,a){return function(b){return b.lift(new Hb(c,b,!0,a))}},first:function(c,a){var b=2<=arguments.length;return function(d){return d.pipe(c?da(function(a,b){return c(a,b,d)}):S,Ea(1),b?ga(a):ra(function(){return new ha}))}},groupBy:function(c,a,b,d){return function(f){return f.lift(new Tc(c,a,b,d))}},ignoreElements:function(){return function(c){return c.lift(new fe)}},isEmpty:function(){return function(c){return c.lift(new he)}},
last:function(c,a){var b=2<=arguments.length;return function(d){return d.pipe(c?da(function(a,b){return c(a,b,d)}):S,ma(1),b?ga(a):ra(function(){return new ha}))}},map:G,mapTo:function(c){return function(a){return a.lift(new ke(c))}},materialize:function(){return function(c){return c.lift(new me)}},max:function(c){return oa("function"===typeof c?function(a,b){return 0<c(a,b)?a:b}:function(a,b){return a>b?a:b})},merge:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){return a.lift.call(eb.apply(void 0,
[a].concat(c)))}},mergeAll:Ba,mergeMap:V,flatMap:V,mergeMapTo:function(c,a,b){void 0===b&&(b=Number.POSITIVE_INFINITY);if("function"===typeof a)return V(function(){return c},a,b);"number"===typeof a&&(b=a);return V(function(){return c},b)},mergeScan:function(c,a,b){void 0===b&&(b=Number.POSITIVE_INFINITY);return function(d){return d.lift(new pe(c,a,b))}},min:function(c){return oa("function"===typeof c?function(a,b){return 0>c(a,b)?a:b}:function(a,b){return a<b?a:b})},multicast:W,observeOn:function(c,
a){void 0===a&&(a=0);return function(b){return b.lift(new Xc(c,a))}},onErrorResumeNext:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];1===c.length&&D(c[0])&&(c=c[0]);return function(a){return a.lift(new re(c))}},pairwise:function(){return function(c){return c.lift(new te)}},partition:function(c,a){return function(b){return[da(c,a)(b),da(wc(c,a))(b)]}},pluck:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var b=c.length;if(0===b)throw Error("list of properties cannot be empty.");
return function(a){return G(xc(c,b))(a)}},publish:function(c){return c?W(function(){return new y},c):W(new y)},publishBehavior:function(c){return function(a){return W(new zb(c))(a)}},publishLast:function(){return function(c){return W(new aa)(c)}},publishReplay:function(c,a,b,d){b&&"function"!==typeof b&&(d=b);var f="function"===typeof b?b:void 0,e=new X(c,a,d);return function(a){return W(function(){return e},f)(a)}},race:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){1===
c.length&&D(c[0])&&(c=c[0]);return a.lift.call(fb.apply(void 0,[a].concat(c)))}},reduce:oa,repeat:function(c){void 0===c&&(c=-1);return function(a){return 0===c?I():0>c?a.lift(new Ib(-1,a)):a.lift(new Ib(c-1,a))}},repeatWhen:function(c){return function(a){return a.lift(new we(c))}},retry:function(c){void 0===c&&(c=-1);return function(a){return a.lift(new ye(c,a))}},retryWhen:function(c){return function(a){return a.lift(new Ae(c,a))}},refCount:ua,sample:function(c){return function(a){return a.lift(new Ce(c))}},
sampleTime:function(c,a){void 0===a&&(a=C);return function(b){return b.lift(new Ee(c,a))}},scan:na,sequenceEqual:function(c,a){return function(b){return b.lift(new Ge(c,a))}},share:function(){return function(c){return ua()(W(zc)(c))}},shareReplay:function(c,a,b){void 0===c&&(c=Number.POSITIVE_INFINITY);void 0===a&&(a=Number.MAX_VALUE);return function(d){return d.lift(Ac(c,a,b))}},single:function(c){return function(a){return a.lift(new Je(c,a))}},skip:function(c){return function(a){return a.lift(new Le(c))}},
skipLast:function(c){return function(a){return a.lift(new Ne(c))}},skipUntil:function(c){return function(a){return a.lift(new Pe(c))}},skipWhile:function(c){return function(a){return a.lift(new Re(c))}},startWith:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){var b=c[c.length-1];B(b)?c.pop():b=null;var d=c.length;return 1!==d||b?0<d?P(K(c,b),a):P(I(b),a):P(va(c[0]),a)}},subscribeOn:function(c,a){void 0===a&&(a=0);return function(b){return b.lift(new Te(c,a))}},
switchAll:function(){return ia(S)},switchMap:ia,switchMapTo:function(c,a){return a?ia(function(){return c},a):ia(function(){return c})},take:Ea,takeLast:ma,takeUntil:function(c){return function(a){return a.lift(new We(c))}},takeWhile:function(c){return function(a){return a.lift(new Ye(c))}},tap:ob,throttle:function(c,a){void 0===a&&(a=Jb);return function(b){return b.lift(new $e(c,a.leading,a.trailing))}},throttleTime:function(c,a,b){void 0===a&&(a=C);void 0===b&&(b=Jb);return function(d){return d.lift(new bf(c,
a,b.leading,b.trailing))}},throwIfEmpty:ra,timeInterval:function(c){void 0===c&&(c=C);return function(a){return Ca(function(){return a.pipe(na(function(a,d){a=a.current;return{value:d,current:c.now(),last:a}},{current:c.now(),value:void 0,last:void 0}),G(function(a){return new cf(a.value,a.current-a.last)}))})}},timeout:function(c,a){void 0===a&&(a=C);return qb(c,xa(new ya),a)},timeoutWith:qb,timestamp:function(c){void 0===c&&(c=C);return G(function(a){return new ef(a,c.now())})},toArray:function(){return oa(Ec,
[])},window:function(c){return function(a){return a.lift(new gf(c))}},windowCount:function(c,a){void 0===a&&(a=0);return function(b){return b.lift(new jf(c,a))}},windowTime:function(c,a,b,d){var f=C,e=null,h=Number.POSITIVE_INFINITY;B(d)&&(f=d);B(b)?f=b:ca(b)&&(h=b);B(a)?f=a:ca(a)&&(e=a);return function(a){return a.lift(new lf(c,e,h,f))}},windowToggle:function(c,a){return function(b){return b.lift(new of(c,a))}},windowWhen:function(c){return function(a){return a.lift(new qf(c))}},withLatestFrom:function(){for(var c=
[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){var b;"function"===typeof c[c.length-1]&&(b=c.pop());return a.lift(new sf(c,b))}},zip:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){return a.lift.call(hb.apply(void 0,[a].concat(c)))}},zipAll:function(c){return function(a){return a.lift(new ib(c))}}}),la=function(){return function(c,a){void 0===a&&(a=Number.POSITIVE_INFINITY);this.subscribedFrame=c;this.unsubscribedFrame=a}}(),Kb=function(){function c(){this.subscriptions=
[]}c.prototype.logSubscribedFrame=function(){this.subscriptions.push(new la(this.scheduler.now()));return this.subscriptions.length-1};c.prototype.logUnsubscribedFrame=function(a){var b=this.subscriptions;b[a]=new la(b[a].subscribedFrame,this.scheduler.now())};return c}(),Ma=function(c){function a(a,d){var b=c.call(this,function(a){var b=this,c=b.logSubscribedFrame(),d=new w;d.add(new w(function(){b.logUnsubscribedFrame(c)}));b.scheduleMessages(a);return d})||this;b.messages=a;b.subscriptions=[];
b.scheduler=d;return b}d(a,c);a.prototype.scheduleMessages=function(a){for(var b=this.messages.length,c=0;c<b;c++){var d=this.messages[c];a.add(this.scheduler.schedule(function(a){a.message.notification.observe(a.subscriber)},d.frame,{message:d,subscriber:a}))}};return a}(r);sb(Ma,[Kb]);var Lb=function(c){function a(a,d){var b=c.call(this)||this;b.messages=a;b.subscriptions=[];b.scheduler=d;return b}d(a,c);a.prototype._subscribe=function(a){var b=this,d=b.logSubscribedFrame(),e=new w;e.add(new w(function(){b.logUnsubscribedFrame(d)}));
e.add(c.prototype._subscribe.call(this,a));return e};a.prototype.setup=function(){for(var a=this,c=a.messages.length,d=0;d<c;d++)(function(){var b=a.messages[d];a.scheduler.schedule(function(){b.notification.observe(a)},b.frame)})()};return a}(y);sb(Lb,[Kb]);var uf=function(c){function a(a){var b=c.call(this,Ka,750)||this;b.assertDeepEqual=a;b.hotObservables=[];b.coldObservables=[];b.flushTests=[];b.runMode=!1;return b}d(a,c);a.prototype.createTime=function(b){b=b.indexOf("|");if(-1===b)throw Error('marble diagram for time should have a completion marker "|"');
...
c,d,void 0,this.runMode);b=new Lb(b,this);this.hotObservables.push(b);return b};a.prototype.materializeInnerObservable=function(a,c){var b=this,d=[];a.subscribe(function(a){d.push({frame:b.frame-c,notification:A.createNext(a)})},function(a){d.push({frame:b.frame-c,notification:A.createError(a)})},function(){d.push({frame:b.frame-c,notification:A.createComplete()})});return d};a.prototype.expectObservable=function(b,c){var d=this;void 0===c&&(c=null);var f=[],e={actual:f,ready:!1};c=a.parseMarblesAsSubscriptions(c,
this.runMode);var h=c.unsubscribedFrame,l;this.schedule(function(){l=b.subscribe(function(a){var b=a;a instanceof r&&(b=d.materializeInnerObservable(b,d.frame));f.push({frame:d.frame,notification:A.createNext(b)})},function(a){f.push({frame:d.frame,notification:A.createError(a)})},function(){f.push({frame:d.frame,notification:A.createComplete()})})},c.subscribedFrame===Number.POSITIVE_INFINITY?0:c.subscribedFrame);h!==Number.POSITIVE_INFINITY&&this.schedule(function(){return l.unsubscribe()},h);this.flushTests.push(e);
...
(a.assertDeepEqual(b.actual,b.expected),!1):!0})};a.parseMarblesAsSubscriptions=function(a,c){var b=this;void 0===c&&(c=!1);if("string"!==typeof a)return new la(Number.POSITIVE_INFINITY);for(var d=a.length,f=-1,e=Number.POSITIVE_INFINITY,h=Number.POSITIVE_INFINITY,l=0,m=function(d){var g=l,k=function(a){g+=a*b.frameTimeFactor},m=a[d];switch(m){case " ":c||k(1);break;case "-":k(1);break;case "(":f=l;k(1);break;case ")":f=-1;k(1);break;case "^":if(e!==Number.POSITIVE_INFINITY)throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");
e=-1<f?f:l;k(1);break;case "!":if(h!==Number.POSITIVE_INFINITY)throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");h=-1<f?f:l;break;default:if(c&&m.match(/^[0-9]$/)&&(0===d||" "===a[d-1])){var t=a.slice(d).match(/^([0-9]+(?:\.[0-9]+)?)(ms|s|m) /);if(t){d+=t[0].length-1;var m=parseFloat(t[1]),p=void 0;switch(t[2]){case "ms":p=m;break;case "s":p=1E3*m;break;case "m":p=6E4*m}k(p/n.frameTimeFactor);break}}throw Error("there can only be '^' and '!' markers in a subscription marble diagram. Found instead '"+
m+"'.");}l=g;q=d},n=this,q,p=0;p<d;p++)m(p),p=q;return 0>h?new la(e):new la(e,h)};a.parseMarbles=function(a,c,d,e,h){var b=this;void 0===e&&(e=!1);void 0===h&&(h=!1);if(-1!==a.indexOf("!"))throw Error('conventional marble diagrams cannot have the unsubscription marker "!"');for(var f=a.length,g=[],k=h?a.replace(/^[ ]+/,"").indexOf("^"):a.indexOf("^"),l=-1===k?0:k*-this.frameTimeFactor,m="object"!==typeof c?function(a){return a}:function(a){return e&&c[a]instanceof Ma?c[a].messages:c[a]},p=-1,k=function(c){var f=
l,e=function(a){f+=a*b.frameTimeFactor},k=void 0,t=a[c];switch(t){case " ":h||e(1);break;case "-":e(1);break;case "(":p=l;e(1);break;case ")":p=-1;e(1);break;case "|":k=A.createComplete();e(1);break;case "^":e(1);break;case "#":k=A.createError(d||"error");e(1);break;default:if(h&&t.match(/^[0-9]$/)&&(0===c||" "===a[c-1])){var r=a.slice(c).match(/^([0-9]+(?:\.[0-9]+)?)(ms|s|m) /);if(r){c+=r[0].length-1;var t=parseFloat(r[1]),E=void 0;switch(r[2]){case "ms":E=t;break;case "s":E=1E3*t;break;case "m":E=
6E4*t}e(E/n.frameTimeFactor);break}}k=A.createNext(m(t));e(1)}k&&g.push({frame:-1<p?p:l,notification:k});l=f;q=c},n=this,q,r=0;r<f;r++)k(r),r=q;return g};a.prototype.run=function(b){var c=a.frameTimeFactor,d=this.maxFrames;a.frameTimeFactor=1;this.maxFrames=Number.POSITIVE_INFINITY;this.runMode=!0;Z.delegate=this;var e={cold:this.createColdObservable.bind(this),hot:this.createHotObservable.bind(this),flush:this.flush.bind(this),expectObservable:this.expectObservable.bind(this),expectSubscriptions:this.expectSubscriptions.bind(this)};
try{var h=b(e);this.flush();return h}finally{a.frameTimeFactor=c,this.maxFrames=d,this.runMode=!1,Z.delegate=void 0}};return a}(Db),vf=Object.freeze({TestScheduler:uf}),wf="undefined"!==typeof self&&"undefined"!==typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope&&self,xf="undefined"!==typeof global&&global,F="undefined"!==typeof window&&window||xf||wf;if(!F)throw Error("RxJS could not find any global context (window, self, global)");var Nc=G(function(c,a){return c.response}),Y=function(c){function a(a){var b=
...
d.headers=d.headers||{};d.crossDomain||b["X-Requested-With"]||(b["X-Requested-With"]="XMLHttpRequest");"Content-Type"in b||F.FormData&&d.body instanceof F.FormData||"undefined"===typeof d.body||(b["Content-Type"]="application/x-www-form-urlencoded; charset\x3dUTF-8");d.body=a.serializeBody(d.body,d.headers["Content-Type"]);a.send();return a}d(a,c);a.prototype.next=function(a){this.done=!0;var b=this.destination;a=new Mb(a,this.xhr,this.request);a.response===p?b.error(p.e):b.next(a)};a.prototype.send=
function(){var a=this.request,c=this.request,d=c.user,e=c.method,h=c.url,l=c.async,n=c.password,q=c.headers,c=c.body,t=m(a.createXHR).call(a);if(t===p)this.error(p.e);else{this.xhr=t;this.setupEvents(t,a);d=d?m(t.open).call(t,e,h,l,d,n):m(t.open).call(t,e,h,l);if(d===p)return this.error(p.e),null;l&&(t.timeout=a.timeout,t.responseType=a.responseType);"withCredentials"in t&&(t.withCredentials=!!a.withCredentials);this.setHeaders(t,q);d=c?m(t.send).call(t,c):m(t.send).call(t);if(d===p)return this.error(p.e),
...
ub(this.responseType,a)}}();tb.prototype=Object.create(Error.prototype);var sa=tb,Nb=function(c,a){sa.call(this,"ajax timeout",c,a);this.name="AjaxTimeoutError";return this},zf=Object.freeze({ajax:Y.create,AjaxResponse:Mb,AjaxError:sa,AjaxTimeoutError:Nb}),Af={url:"",deserializer:function(c){return JSON.parse(c.data)},serializer:function(c){return JSON.stringify(c)}},Ob=function(c){function a(a,d){var b=c.call(this)||this;if(a instanceof r)b.destination=d,b.source=a;else{d=b._config=Pc({},Af);b._output=
...
T;e.EmptyError=ha;e.ObjectUnsubscribedError=J;e.UnsubscriptionError=fa;e.TimeoutError=ya;e.bindCallback=Ra;e.bindNodeCallback=Sa;e.combineLatest=function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var b=a=null;B(c[c.length-1])&&(b=c.pop());"function"===typeof c[c.length-1]&&(a=c.pop());1===c.length&&D(c[0])&&(c=c[0]);return K(c,b).lift(new La(a))};e.concat=P;e.defer=Ca;e.empty=I;e.forkJoin=ab;e.from=M;e.fromEvent=bb;e.fromEventPattern=db;e.generate=function(c,a,b,d,e){var f,g;1==
arguments.length?(g=c.initialState,a=c.condition,b=c.iterate,f=c.resultSelector||S,e=c.scheduler):void 0===d||B(d)?(g=c,f=S,e=d):(g=c,f=d);return new r(function(c){var d=g;if(e)return e.schedule(cc,0,{subscriber:c,iterate:b,condition:a,resultSelector:f,state:d});do{if(a){var h=void 0;try{h=a(d)}catch(t){c.error(t);break}if(!h){c.complete();break}}h=void 0;try{h=f(d)}catch(t){c.error(t);break}c.next(h);if(c.closed)break;try{d=b(d)}catch(t){c.error(t);break}}while(1)})};e.iif=function(c,a,b){void 0===
a&&(a=R);void 0===b&&(b=R);return Ca(function(){return c()?a:b})};e.interval=function(c,a){void 0===c&&(c=0);void 0===a&&(a=C);if(!ca(c)||0>c)c=0;a&&"function"===typeof a.schedule||(a=C);return new r(function(b){b.add(a.schedule(dc,c,{subscriber:b,counter:0,period:c}));return b})};e.merge=eb;e.never=function(){return Fb};e.of=wa;e.onErrorResumeNext=Da;e.pairs=function(c,a){return a?new r(function(b){var d=Object.keys(c),e=new w;e.add(a.schedule(ec,0,{keys:d,index:0,subscriber:b,subscription:e,obj:c}));
return e}):new r(function(a){for(var b=Object.keys(c),d=0;d<b.length&&!a.closed;d++){var e=b[d];c.hasOwnProperty(e)&&a.next([e,c[e]])}a.complete()})};e.race=fb;e.range=function(c,a,b){void 0===c&&(c=0);void 0===a&&(a=0);return new r(function(d){var e=0,f=c;if(b)return b.schedule(gc,0,{index:e,count:a,start:c,subscriber:d});do{if(e++>=a){d.complete();break}d.next(f++);if(d.closed)break}while(1)})};e.throwError=xa;e.timer=gb;e.using=function(c,a){return new r(function(b){var d;try{d=c()}catch(E){b.error(E);
return}var e;try{e=a(d)}catch(E){b.error(E);return}var h=(e?M(e):R).subscribe(b);return function(){h.unsubscribe();d&&d.unsubscribe()}})};e.zip=hb;e.EMPTY=R;e.NEVER=Fb;e.config=H;Object.defineProperty(e,"__esModule",{value:!0})});