...
function from(input, scheduler) {
    ...
    if (input != null) {
        ...
        else if (typeof input[iterator] === 'function' || typeof input === 'string') {
...
function throwError(error, scheduler) {
    if (!scheduler) {
        ...
        return new Observable(function (subscriber) { return scheduler.schedule(dispatch$4, 0, { error: error, subscriber: subscriber }); });
    }
}
function dispatch$4(_a) {
...
function timer(dueTime, periodOrScheduler, scheduler) {
    ...
    return new Observable(function (subscriber) {
        ...
        return scheduler.schedule(dispatch$5, due, {
...
function onErrorResumeNext$1() {
    ...
    return onErrorResumeNext$2.apply(void 0, nextSources)(this);
}
...
var AnimationFrameAction = /** @class */ (function (_super) {
    ...
    AnimationFrameAction.prototype.requestAsyncId = function (scheduler, id, delay) {
        ...
        return scheduler.scheduled || (scheduler.scheduled = AnimationFrame.requestAnimationFrame(function () { return scheduler.flush(null); }));
    };
