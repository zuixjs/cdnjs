...
function toPromise(PromiseCtor) {
    return function (source) {
        ...
        return new PromiseCtor(function (resolve, reject) {
            var value;
            source.subscribe(function (x) { return value = x; }, function (err) { return reject(err); }, function () { return resolve(value); });
        });
    };
}
...
function onErrorResumeNext$2() {
    ...
    return onErrorResumeNext.apply(void 0, nextSources)(this);
}
 ...
 * @owner Observable
 */
function publishReplay$1(bufferSize, windowTime$$1, scheduler) {
    if (bufferSize === void 0) { bufferSize = Number.POSITIVE_INFINITY; }
    if (windowTime$$1 === void 0) { windowTime$$1 = Number.POSITIVE_INFINITY; }
    return publishReplay(bufferSize, windowTime$$1, scheduler)(this);
}
 ...
 * @owner Observable
 */
function toPromise$1(PromiseCtor) {
    return toPromise(PromiseCtor)(this);
}

Observable.prototype.toPromise = toPromise$1;
...
function zipProto() {
    ...
    return zip.apply(void 0, observables)(this);
}
