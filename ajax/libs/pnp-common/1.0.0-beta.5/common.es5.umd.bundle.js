...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return RuntimeConfigImpl; });
...
function mergeOptions(target, source) {
    if (__WEBPACK_IMPORTED_MODULE_0__util__["a" /* Util */].objectDefinedNotNull(source)) {
        var headers = __WEBPACK_IMPORTED_MODULE_0__util__["a" /* Util */].extend(target.headers || {}, source.headers);
        target = __WEBPACK_IMPORTED_MODULE_0__util__["a" /* Util */].extend(target, source);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = mergeHeaders;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__collections__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__libconfig__ = __webpack_require__(3);
...
var PnPClientStorageWrapper = /** @class */ (function () {
    ...
    PnPClientStorageWrapper.prototype.createPersistable = function (o, expire) {
        if (typeof expire === "undefined") {
            ...
            var defaultTimeout = __WEBPACK_IMPORTED_MODULE_2__libconfig__["b" /* RuntimeConfig */].defaultCachingTimeoutSeconds;
    ...
    PnPClientStorageWrapper.prototype.cacheExpirationHandler = function () {
        ...
        this.deleteExpired().then(function (_) {
            ...
            setTimeout(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* Util */].getCtxCallback(_this, _this.cacheExpirationHandler), __WEBPACK_IMPORTED_MODULE_2__libconfig__["b" /* RuntimeConfig */].cacheExpirationIntervalMilliseconds);
        }).catch(function (e) {
