...
(function (global, factory) {
    ...
    var Component = {
        ...
        props: uikitUtil.assign({toggle: String}, props),

        data: uikitUtil.assign({toggle: 'a'}, Object.keys(props).reduce(function (data, key) {
    ...
    function merge(options, prop) {
        return uikitUtil.assign.apply(
            void 0, [ {} ].concat( (options.mixins ? options.mixins.map(function (mixin) { return merge(mixin, prop); }) : []),
            [uikitUtil.isFunction(options[prop]) ? options[prop]() : options[prop]] ));
    }
