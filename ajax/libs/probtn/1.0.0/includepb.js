...
document.write(
    ...
    + "function ($) {"
        ...
        + "jQuery(document).ready(function() {"
            + "jQuery.getScript('https://cdnjs.cloudflare.com/ajax/libs/probtn/1.0.0/javascripts/jquery.pep.min.js', function() {"
                + "jQuery.getScript('https://cdnjs.cloudflare.com/ajax/libs/probtn/1.0.0/javascripts/jquery.fancybox.js', function () {"
