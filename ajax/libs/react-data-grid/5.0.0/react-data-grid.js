	...
	var EditorContainer = function (_React$Component) {
	  ...
	  _createClass(EditorContainer, [{
	    ...
	    value: function render() {
	      ...
	      var editorTop = top - scrollTop;
	      var zIndex = isFrozen(column) ? _zIndexes2['default'].FROZEN_EDITOR_CONTAINER : _zIndexes2['default'].EDITOR_CONTAINER;
	      var style = { position: 'fixed', height: height, width: width, zIndex: zIndex, transform: 'translate(' + editorLeft + 'px, ' + editorTop + 'px)' };
	      return _react2['default'].createElement(
	        'div',
	        { style: style, className: this.getContainerClass(), onBlur: this.handleBlur, onKeyDown: this.onKeyDown, onContextMenu: this.handleRightClick },
	        this.createEditor(),
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.createEditor = function () {
	    ...
	    if ((0, _utils.isFunction)(CustomEditor)) {
	      return _react2['default'].createElement(CustomEditor, _extends({ ref: _this2.createEditorRef }, editorProps));
	    }

	    return _react2['default'].createElement(_SimpleTextEditor2['default'], { ref: _this2.createEditorRef, column: _this2.props.column, value: _this2.getInitialValue(), onBlur: _this2.commit, rowMetaData: _this2.getRowMetaData(), onKeyDown: function onKeyDown() {}, commit: function commit() {} });
	  };
	  ...
	  this.getInitialValue = function () {
	    var _props2 = _this2.props,
	        key = _props2.firstEditorKeyPress,
	        value = _props2.value;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Grid = function (_React$Component) {
	  ...
	  function Grid() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Grid.__proto__ || Object.getPrototypeOf(Grid)).call.apply(_ref, [this].concat(args))), _this), _this.getStyle = function () {
	      return {
	        overflow: 'hidden',
	        outline: 0,
	        position: 'relative',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HeaderRow = function (_React$Component) {
	  ...
	  function HeaderRow() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HeaderRow.__proto__ || Object.getPrototypeOf(HeaderRow)).call.apply(_ref, [this].concat(args))), _this), _this.getHeaderCellType = function (column) {
