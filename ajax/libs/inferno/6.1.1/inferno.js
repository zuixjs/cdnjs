(function (global, factory) {
    ...
    function mountClassComponent(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
        var instance = createClassComponentInstance(vNode, vNode.type, vNode.props || EMPTY_OBJ, context, lifecycle);
    ...
    function __render(input, parentDOM, callback, context) {
        ...
        if (isNullOrUndef(rootInput)) {
            if (!isNullOrUndef(input)) {
                ...
                mount(input, parentDOM, context || EMPTY_OBJ, false, null, lifecycle);
                parentDOM.$V = input;
                rootInput = input;
            }
        }
            ...
            if (isNullOrUndef(input)) {
                ...
                patch(rootInput, input, parentDOM, context || EMPTY_OBJ, false, null, lifecycle);
    ...
    function applyState(component, force, callback) {
        ...
        if (force || !component.$BR) {
            ...
            component.$UPD = true;
            var lifecycle = [];
            updateClassComponent(component, combineFrom(component.state, pendingState), component.props, findDOMfromVNode(component.$LI).parentNode, component.context, false, force, null, lifecycle);
            component.$UPD = false;
            if (lifecycle.length > 0) {
                callAll(lifecycle);
            }
