(function (global, factory) {
    ...
    function directClone(vNodeToClone) {
        ...
        if (flags & 28 /* Component */) {
            ...
            newVNode = createVNode(flags, vNodeToClone.type, vNodeToClone.className, children, vNodeToClone.props, vNodeToClone.key, vNodeToClone.ref, !children);
        }
    ...
    function normalizeVNodes(nodes) {
        ...
        for (var i = 0, len = nodes.length; i < len; i++) {
            ...
            else if (!isNull(n.dom) || isNull(n.key) && (n.flags & 64 /* HasNonKeyedChildren */) === 0) {
                if (!newNodes) {
                    newNodes = nodes.slice(0, i);
                }
    ...
    function normalizeChildren(children) {
        ...
        else if (isVNode(children) && !isNull(children.dom)) {
