(function (global, factory) {
    ...
    function getVNode(childFlags, children, className, flags, key, props, ref, type) {
        return {
            childFlags: childFlags === void 0 ? 1 /* HasInvalidChildren */ : childFlags,
    ...
    function createVNode(flags, type, className, children, childFlags, props, key, ref) {
        ...
        var vNode = getVNode(childFlags, children, className, flags, key, props, ref, type);
    ...
    function normalizeVNodes(nodes, len, newNodes) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (isInvalid(n) || isArray(n)) {
                ...
                if (!isNullDom ||
                    (isNullKey && (n.childFlags & 4 /* HasNonKeyedChildren */) === 0) ||
                    isPrefixed) {
                    if (!newNodes) {
                        newNodes = nodes.slice(0, i);
                    }
    ...
    function normalizeChildren(vNode, children) {
        ...
        if (isInvalid(children)) {
            ...
            newChildren = normalizeVNodes(children, children.length, null);
            newChildren.$ = true;
        }
        else {
