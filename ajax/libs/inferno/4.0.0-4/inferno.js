(function (global, factory) {
    ...
    function createTextVNode(text, key) {
        return getVNode(1 /* HasInvalidChildren */, text, null, 16 /* Text */, key, null, null, 0);
    }
    function normalizeProps(vNode) {
        var props = vNode.props;
        if (props) {
            if (vNode.flags & 993 /* Element */) {
    ...
    function directClone(vNodeToClone) {
        ...
        else if (flags & 2048 /* Portal */) {
            newVNode = vNodeToClone;
        }
        return newVNode;
    }
    function createVoidVNode() {
        return createVNode(1024 /* Void */, null, null, '', 0, null, null, null);
    }
    function isVNode(o) {
    ...
    function getFlagsForElementVnode(type) {
        ...
        if (type === 'input') {
            return 128 /* InputElement */;
        }
        if (type === 'select') {
            return 512 /* SelectElement */;
        }
        if (type === 'textarea') {
            return 256 /* TextareaElement */;
        }
        if (type === 'media') {
            return 64 /* MediaElement */;
        }
    ...
    function processElement(flags, vNode, dom, nextPropsOrEmpty, mounting, isControlled) {
        if (flags & 128 /* InputElement */) {
            processInput(vNode, dom, nextPropsOrEmpty, mounting, isControlled);
        }
        else if (flags & 512 /* SelectElement */) {
            processSelect(vNode, dom, nextPropsOrEmpty, mounting, isControlled);
        }
        else if (flags & 256 /* TextareaElement */) {
    ...
    function removeProp(prop, lastValue, dom, nextFlags) {
        if (prop === 'value') {
            ...
            dom.value = nextFlags & 512 /* SelectElement */ ? null : '';
        }
        else if (prop === 'style') {
    ...
    function mountProps(vNode, flags, props, dom, isSVG) {
        ...
        var isFormElement = (flags & 896 /* FormElement */) > 0;
        if (isFormElement) {
    ...
    function validateKeys(vNode, forceKeyed) {
        {
            ...
            else if (vNode.children && vNode.flags & 993 /* Element */) {
    ...
    function mount(vNode, parentDom, lifecycle, context, isSVG) {
        ...
        if (flags & 1024 /* Void */ || flags & 16 /* Text */) {
            return mountText(vNode, parentDom);
        }
        if (flags & 2048 /* Portal */) {
    ...
    function patch(lastVNode, nextVNode, parentDom, lifecycle, context, isSVG) {
        if (lastVNode !== nextVNode) {
            ...
            if (lastVNode.flags !== nextFlags || nextFlags & 4096 /* ReCreate */) {
                unmount(lastVNode);
            ...
            else if (nextFlags & 1024 /* Void */) {
                nextVNode.dom = lastVNode.dom;
            }
            else if (nextFlags & 2048 /* Portal */) {
        ...
        if (lastVNode.type !== nextTag) {
            ...
            if (lastProps !== nextProps) {
                ...
                if (nextPropsOrEmpty !== EMPTY_OBJ) {
                    var isFormElement = (nextFlags & 896 /* FormElement */) > 0;
                    if (isFormElement) {
    ...
    function createPortal(children, container) {
        return normalizeChildren(createVNode(2048 /* Portal */, container, null, null, 0, null, isInvalid(children) ? null : children.key, null), children);
    }
    ...
    function applyState(component, force, callback) {
        ...
        if (force || !component.$BR) {
            ...
            if ((component.$LI.flags & 2048 /* Portal */) === 0) {
