(function (global, factory) {
    ...
    function applyState(component, force, callback) {
        ...
        if (force || !component.$BR) {
            ...
            component.$UPD = true;
            var lifecycle = [];
            updateClassComponent(component, combineFrom(component.state, pendingState), component.props, findDOMfromVNode(component.$LI, true).parentNode, component.context, false, force, null, lifecycle);
            component.$UPD = false;
            if (lifecycle.length > 0) {
                callAll(lifecycle);
            }
