...
var MaskedNumber = function (_Masked) {
  ...
  MaskedNumber.prototype.appendWithTail = function appendWithTail(str, tail) {
    ...
    var appendDetails = _Masked.prototype.appendWithTail.call(this, str, tail);
...
var MaskedDynamic = function (_Masked) {
  ...
  MaskedDynamic.prototype.appendWithTail = function appendWithTail(str, tail) {
    ...
    return this._append('').aggregate(_Masked.prototype.appendWithTail.call(this, str, tail));
  };
