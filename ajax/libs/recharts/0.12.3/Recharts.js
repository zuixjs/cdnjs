	    ...
	    value: function getEndPoints(isX, isY) {
	      ...
	      if (isY) {
	        ...
	        if ((0, _DataUtils.validateCoordinateInRange)(coord, scale)) {
	          return xAxis.orientation === 'left' ? [{ x: x, y: coord }, { x: x + width, y: coord }] : [{ x: x + width, y: coord }, { x: x, y: coord }];
	        }
	      } else if (isX) {
	        ...
	        if ((0, _DataUtils.validateCoordinateInRange)(_coord, _scale)) {
	          return yAxis.orientation === 'top' ? [{ x: _coord, y: y }, { x: _coord, y: y + height }] : [{ x: _coord, y: y + height }, { x: _coord, y: y }];
	        }
	      }
	  ...
	  _createClass(ReferenceDot, [{
	    ...
	    value: function renderDot(option, props) {
	      ...
	      if (_react2.default.isValidElement(option)) {
	        ...
	        dot = _react2.default.createElement(_Dot2.default, _extends({}, (0, _ReactUtils.getPresentationAttributes)(props), {
	          cx: props.cx,
	          cy: props.cy,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sumBy2 = __webpack_require__(273);

	var _sumBy3 = _interopRequireDefault(_sumBy2);

	var _min2 = __webpack_require__(275);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(168),
	    baseSum = __webpack_require__(274);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseExtremum = __webpack_require__(229),
	    baseLt = __webpack_require__(276),
	    identity = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AreaChart = __webpack_require__(279);
