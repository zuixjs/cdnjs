	...
	var Pie = (0, _PureRender2.default)(_class = (_temp = _class2 = function (_Component) {
	  ...
	  _createClass(Pie, [{
	    ...
	    value: function renderLabels(sectors) {
	      ...
	      var isLabelLineElement = _react2.default.isValidElement(labelLine);
	      ...
	      var labels = sectors.map(function (entry, i) {
	        ...
	        return _react2.default.createElement(
	          _Layer2.default,
	          { key: 'label-' + i },
	          isLabelLineElement ? _react2.default.cloneElement(labelLine, lineProps) : _react2.default.createElement(_Curve2.default, _extends({}, lineProps, { type: 'linear', className: 'recharts-pie-label-line' })),
	  ...
	  labelLine: _react.PropTypes.oneOfType([_react.PropTypes.object, _react.PropTypes.element, _react.PropTypes.bool]),
	  ...
	  _createClass(BarChart, [{
	    ...
	    value: function getComposedData(item, barPosition, xAxis, yAxis, offset, stackedData) {
	      ...
	      return data.map(function (entry, index) {
	        ...
	        return _extends({}, entry, {
	          x: x, y: y, width: width, height: height, value: value[1]
