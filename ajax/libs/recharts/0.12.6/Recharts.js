...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * @param  {Number}  roughStep        The rough step calculated by deviding the difference by the tickCount
	...
	function getFormatStep(roughStep, correctionFactor) {
	  ...
	  var amendStepRatio = digitCount >= 2 ? _arithmetic2.default.multiply(Math.ceil(stepRatio / 0.05) + correctionFactor, 0.05) : _arithmetic2.default.multiply(Math.ceil(stepRatio / 0.1) + correctionFactor, 0.1);
	...
	function calculateStep(min, max, tickCount) {
	  var correctionFactor = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];

	  // The step which is easy to understand between two ticks
	  var step = getFormatStep((max - min) / (tickCount - 1), correctionFactor);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RadarChart = (0, _AnimationDecorator2.default)(_class = (0, _PureRender2.default)(_class = (_temp2 = _class2 = function (_Component) {
	  ...
	  function RadarChart() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(RadarChart)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      activeTooltipLabel: '',
	      activeTooltipCoord: { x: 0, y: 0 },
	      isTooltipActive: false
	    }, _this.handleMouseEnter = function (itemProps, e) {
	      var _this$props = _this.props;
	      var children = _this$props.children;
	      var onMouseEnter = _this$props.onMouseEnter;
