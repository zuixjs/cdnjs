	...
	var Sankey = (0, _PureRender2.default)(_class = (_temp2 = _class2 = function (_Component) {
	  ...
	  _createClass(Sankey, [{
	    ...
	    value: function renderLinks(links, nodes) {
	      ...
	      return _react2.default.createElement(
	        ...
	        links.map(function (link, i) {
	          ...
	          var sourceX = source.x + source.dx;
	          var targetX = target.x;
	          var interpolationFunc = interpolationGenerator(sourceX, targetX);
	          var sourceControlX = interpolationFunc(linkCurvature);
	          var targetControlX = interpolationFunc(1 - linkCurvature);

	          var sourceY = source.y + sourceRelativeY + linkWidth / 2;
	          var targetY = target.y + targetRelativeY + linkWidth / 2;
	    ...
	    value: function renderNodes(nodes) {
	      var nodeContent = this.props.node;
	    ...
	    value: function render() {
	      ...
	      var _props4 = this.props;
	      var data = _props4.data;
	      var iterations = _props4.iterations;
	      var nodeWidth = _props4.nodeWidth;
	      var nodePadding = _props4.nodePadding;
	      var width = _props4.width;
	      var height = _props4.height;
	      var className = _props4.className;
	      var style = _props4.style;
	      ...
	      var _computeData = computeData({
	        data: data, width: width, height: height, iterations: iterations, nodeWidth: nodeWidth, nodePadding: nodePadding
	      });
