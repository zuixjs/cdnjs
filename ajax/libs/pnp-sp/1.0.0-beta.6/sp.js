...
import { BlobParser, BufferParser, JSONParser, ODataBatch, ODataDefaultParser, ODataParserBase, ODataQueryable, TextParser, defaultPipeline } from '@pnp/odata';
...
class SharePointQueryable extends ODataQueryable {
     ...
     */
    toRequestContext(verb, options = {}, parser, pipeline = defaultPipeline) {
