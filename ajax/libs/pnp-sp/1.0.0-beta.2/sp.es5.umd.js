(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pnp/common'), require('@pnp/odata'), require('@pnp/logging')) :
	typeof define === 'function' && define.amd ? define(['exports', '@pnp/common', '@pnp/odata', '@pnp/logging'], factory) :
	(factory((global.pnp = {}),global.common,global.odata,global.logging));
}(this, (function (exports,common,odata,logging) { 'use strict';
...
var DigestCache = /** @class */ (function () {
    ...
    DigestCache.prototype.getDigest = function (webUrl) {
        ...
        var url = common.Util.combinePaths(webUrl, "/_api/contextinfo");
        var headers = {
        ...
        return this._httpClient.fetchRaw(url, {
            ...
            headers: common.Util.extend(headers, SPRuntimeConfig.headers, true),
            method: "POST",
...
var SPBatchParseException = /** @class */ (function (_super) {
    __extends$2(SPBatchParseException, _super);
...
var SPODataIdException = /** @class */ (function (_super) {
    __extends$2(SPODataIdException, _super);
    function SPODataIdException(data, msg) {
        ...
        logging.Logger.log({ data: data, level: logging.LogLevel.Error, message: "[" + _this.name + "]::" + _this.message });
        return _this;
    }
    return SPODataIdException;
}(Error));
var MaxCommentLengthException = /** @class */ (function (_super) {
    __extends$2(MaxCommentLengthException, _super);
...
var NotSupportedInBatchException = /** @class */ (function (_super) {
    __extends$2(NotSupportedInBatchException, _super);
...
var APIUrlException = /** @class */ (function (_super) {
    __extends$2(APIUrlException, _super);
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.fetch = function (url, options) {
        ...
        var opts = common.Util.extend(options, { cache: "no-cache", credentials: "same-origin" }, true);
        ...
        opts = common.Util.extend(opts, { headers: headers });
    ...
    HttpClient.prototype.fetchRaw = function (url, options) {
        ...
        options = common.Util.extend(options, { headers: rawHeaders });
        var retry = function (ctx) {
            _this._impl.fetch(url, options).then(function (response) { return ctx.resolve(response); }).catch(function (response) {
                ...
                setTimeout(common.Util.getCtxCallback(_this, retry, ctx), delay);
            });
        };
    ...
    HttpClient.prototype.get = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = common.Util.extend(options, { method: "GET" });
        return this.fetch(url, opts);
    };
    HttpClient.prototype.post = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = common.Util.extend(options, { method: "POST" });
        return this.fetch(url, opts);
    };
    HttpClient.prototype.patch = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = common.Util.extend(options, { method: "PATCH" });
        return this.fetch(url, opts);
    };
    HttpClient.prototype.delete = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = common.Util.extend(options, { method: "DELETE" });
        return this.fetch(url, opts);
    };
    return HttpClient;
}());
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        if (common.Util.isUrlAbsolute(candidateUrl)) {
            // if we are already absolute, then just return the url
            return resolve(candidateUrl);
        }
        if (SPRuntimeConfig.baseUrl !== null) {
            // base url specified either with baseUrl of spfxContext config property
            return resolve(common.Util.combinePaths(SPRuntimeConfig.baseUrl, candidateUrl));
        }
        if (typeof global._spPageContextInfo !== "undefined") {
            // operating in classic pages
            if (global._spPageContextInfo.hasOwnProperty("webAbsoluteUrl")) {
                return resolve(common.Util.combinePaths(global._spPageContextInfo.webAbsoluteUrl, candidateUrl));
            }
            else if (global._spPageContextInfo.hasOwnProperty("webServerRelativeUrl")) {
                return resolve(common.Util.combinePaths(global._spPageContextInfo.webServerRelativeUrl, candidateUrl));
            }
        }
        ...
        if (typeof global.location !== "undefined") {
            ...
            ["/_layouts/", "/siteassets/"].forEach(function (s) {
                ...
                if (index > 0) {
                    return resolve(common.Util.combinePaths(baseUrl_1.substr(0, index), candidateUrl));
                }
            });
        }
        return resolve(candidateUrl);
...
var SharePointQueryable = /** @class */ (function (_super) {
    __extends$1(SharePointQueryable, _super);
    /**
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (common.Util.isUrlAbsolute(urlStr) || urlStr.lastIndexOf("/") < 0) {
                _this._parentUrl = urlStr;
                _this._url = common.Util.combinePaths(urlStr, path);
            }
            else if (urlStr.lastIndexOf("/") > urlStr.lastIndexOf("(")) {
                // .../items(19)/fields
                var index = urlStr.lastIndexOf("/");
                _this._parentUrl = urlStr.slice(0, index);
                path = common.Util.combinePaths(urlStr.slice(index), path);
                _this._url = common.Util.combinePaths(_this._parentUrl, path);
            }
            else {
                // .../items(19)
                var index = urlStr.lastIndexOf("(");
    ...
    SharePointQueryable.prototype.as = function (factory) {
        ...
        return common.Util.extend(o, this, true);
    };
    /**
    ...
    SharePointQueryable.prototype.toUrlAndQuery = function () {
        ...
        var url = this.toUrl().replace(/'!(@.*?)::(.*?)'/ig, function (match, labelName, value) {
            logging.Logger.write("Rewriting aliased parameter from match " + match + " to label: " + labelName + " value: " + value, logging.LogLevel.Verbose);
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        var _this = this;
        if (options === void 0) { options = {}; }
        if (pipeline === void 0) { pipeline = odata.PipelineMethods.default; }
...
var SharePointQueryableCollection = /** @class */ (function (_super) {
    __extends$1(SharePointQueryableCollection, _super);
...
var SharePointQueryableInstance = /** @class */ (function (_super) {
    __extends$1(SharePointQueryableInstance, _super);
...
var SearchQueryBuilder = /** @class */ (function () {
    ...
    SearchQueryBuilder.prototype.extendQuery = function (part) {
        this._query = common.Util.extend(this._query, part);
        return this;
    };
...
var SearchResults = /** @class */ (function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var query = common.Util.extend(this._query, {
            RowLimit: rows,
...
var SearchSuggest = /** @class */ (function (_super) {
    __extends$3(SearchSuggest, _super);
...
var SPODataEntityParserImpl = /** @class */ (function (_super) {
    __extends$7(SPODataEntityParserImpl, _super);
    ...
    SPODataEntityParserImpl.prototype.parse = function (r) {
        ...
        return _super.prototype.parse.call(this, r).then(function (d) {
            ...
            return common.Util.extend(o, d);
        });
    };
    return SPODataEntityParserImpl;
}(odata.ODataParserBase));
var SPODataEntityArrayParserImpl = /** @class */ (function (_super) {
    __extends$7(SPODataEntityArrayParserImpl, _super);
...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return common.Util.combinePaths(extractWebUrl(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
    }
        ...
        logging.Logger.write("No uri information found in ODataEntity parsing, chaining will fail for this object.", logging.LogLevel.Warning);
        return "";
    }
}
...
var SiteUser = /** @class */ (function (_super) {
    ...
    */
    SiteUser.prototype.update = function (properties) {
        var _this = this;
        var postBody = common.Util.extend({ "__metadata": { "type": "SP.User" } }, properties);
...
var CurrentUser = /** @class */ (function (_super) {
    __extends$11(CurrentUser, _super);
...
var SiteGroups = /** @class */ (function (_super) {
    __extends$10(SiteGroups, _super);
    /**
    ...
    SiteGroups.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(common.Util.extend({ "__metadata": { "type": "SP.Group" } }, properties));
...
var SiteGroup = /** @class */ (function (_super) {
    ...
    */
    ...
    SiteGroup.prototype.update = function (properties) {
        var _this = this;
        var postBody = common.Util.extend({ "__metadata": { "type": "SP.Group" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
var RoleAssignments = /** @class */ (function (_super) {
    __extends$9(RoleAssignments, _super);
    /**
...
var RoleAssignment = /** @class */ (function (_super) {
    __extends$9(RoleAssignment, _super);
...
var RoleDefinitions = /** @class */ (function (_super) {
    __extends$9(RoleDefinitions, _super);
    /**
    ...
    RoleDefinitions.prototype.add = function (name, description, order, basePermissions) {
        var _this = this;
        var postBody = JSON.stringify({
            BasePermissions: common.Util.extend({ __metadata: { type: "SP.BasePermissions" } }, basePermissions),
...
var RoleDefinition = /** @class */ (function (_super) {
    __extends$9(RoleDefinition, _super);
    ...
    RoleDefinition.prototype.update = function (properties) {
        ...
        if (typeof properties.hasOwnProperty("BasePermissions") !== "undefined") {
            properties["BasePermissions"] = common.Util.extend({ __metadata: { type: "SP.BasePermissions" } }, properties["BasePermissions"]);
        }
        var postBody = JSON.stringify(common.Util.extend({
            "__metadata": { "type": "SP.RoleDefinition" },
        }, properties));
        return this.postCore({
            body: postBody,
...
var RoleDefinitionBindings = /** @class */ (function (_super) {
    __extends$9(RoleDefinitionBindings, _super);
    /**
...
var SharePointQueryableSecurable = /** @class */ (function (_super) {
    __extends$8(SharePointQueryableSecurable, _super);
...
var SharePointQueryableShareable = /** @class */ (function (_super) {
    __extends$6(SharePointQueryableShareable, _super);
    ...
    SharePointQueryableShareable.prototype.shareWith = function (loginNames, role, requireSignin, propagateAcl, emailData) {
        ...
        return Web.fromUrl(this.toUrl()).roleDefinitions.select("Id").filter("RoleTypeKind eq " + roleFilter).get().then(function (def) {
            ...
            if (typeof emailData !== "undefined") {
                postBody = common.Util.extend(postBody, {
    ...
    SharePointQueryableShareable.prototype.shareObject = function (options, bypass) {
        ...
        options = common.Util.extend(options, {
            group: null,
        ...
        if (typeof group !== "undefined" && group !== null) {
            switch (group) {
                case exports.RoleType.Contributor:
                    return Web.fromUrl(this.toUrl()).associatedMemberGroup.select("Id").getAs().then(function (g) { return "group: " + g.Id; });
                case exports.RoleType.Reader:
                case exports.RoleType.Guest:
                    return Web.fromUrl(this.toUrl()).associatedVisitorGroup.select("Id").getAs().then(function (g) { return "group: " + g.Id; });
                default:
            ...
            var roleFilter = role === exports.SharingRole.Edit ? exports.RoleType.Contributor : exports.RoleType.Reader;
            return Web.fromUrl(this.toUrl()).roleDefinitions.select("Id").top(1).filter("RoleTypeKind eq " + roleFilter).getAs().then(function (def) {
                if (def.length < 1) {
...
var SharePointQueryableShareableWeb = /** @class */ (function (_super) {
    __extends$6(SharePointQueryableShareableWeb, _super);
    ...
    SharePointQueryableShareableWeb.prototype.shareWith = function (loginNames, role, emailData) {
        ...
        return Web.fromUrl(this.toUrl(), "/_api/web/url").get().then(function (url) {
            dependency();
            return _this.shareObject(common.Util.combinePaths(url, "/_layouts/15/aclinv.aspx?forSharing=1&mbypass=1"), loginNames, role, emailData);
        });
    };
    /**
...
var SharePointQueryableShareableItem = /** @class */ (function (_super) {
    __extends$6(SharePointQueryableShareableItem, _super);
...
var FileFolderShared = /** @class */ (function (_super) {
    __extends$6(FileFolderShared, _super);
...
var SharePointQueryableShareableFile = /** @class */ (function (_super) {
    __extends$6(SharePointQueryableShareableFile, _super);
...
var SharePointQueryableShareableFolder = /** @class */ (function (_super) {
    __extends$6(SharePointQueryableShareableFolder, _super);
...
var LimitedWebPartManager = /** @class */ (function (_super) {
    __extends$14(LimitedWebPartManager, _super);
...
var WebPartDefinitions = /** @class */ (function (_super) {
    __extends$14(WebPartDefinitions, _super);
...
var WebPartDefinition = /** @class */ (function (_super) {
    __extends$14(WebPartDefinition, _super);
...
var ContentTypes = /** @class */ (function (_super) {
    __extends$16(ContentTypes, _super);
    /**
...
var ContentType = /** @class */ (function (_super) {
    __extends$16(ContentType, _super);
...
var FieldLinks = /** @class */ (function (_super) {
    __extends$16(FieldLinks, _super);
    /**
...
var AttachmentFiles = /** @class */ (function (_super) {
    __extends$17(AttachmentFiles, _super);
    /**
...
var AttachmentFile = /** @class */ (function (_super) {
    __extends$17(AttachmentFile, _super);
    ...
    AttachmentFile.prototype.getText = function () {
        return this.clone(AttachmentFile, "$value", false).get(new odata.TextFileParser());
    };
    /**
    ...
    AttachmentFile.prototype.getBlob = function () {
        return this.clone(AttachmentFile, "$value", false).get(new odata.BlobFileParser());
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js
     */
    AttachmentFile.prototype.getBuffer = function () {
        return this.clone(AttachmentFile, "$value", false).get(new odata.BufferFileParser());
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js
     */
    AttachmentFile.prototype.getJSON = function () {
        return this.clone(AttachmentFile, "$value", false).get(new odata.JSONFileParser());
    };
    /**
...
var ViewFields = /** @class */ (function (_super) {
    __extends$19(ViewFields, _super);
...
var Fields = /** @class */ (function (_super) {
    ...
    Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", common.Util.extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", common.Util.extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", common.Util.extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (typeof minValue !== "undefined") {
            props = common.Util.extend({ MinimumValue: minValue }, props);
        }
        if (typeof maxValue !== "undefined") {
            props = common.Util.extend({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", common.Util.extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", common.Util.extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", common.Util.extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", common.Util.extend(props, properties));
    };
    return Fields;
}(SharePointQueryableCollection));
/**
...
var Subscriptions = /** @class */ (function (_super) {
    __extends$22(Subscriptions, _super);
    /**
...
var Subscription = /** @class */ (function (_super) {
    __extends$22(Subscription, _super);
...
var UserCustomActions = /** @class */ (function (_super) {
    __extends$23(UserCustomActions, _super);
    /**
    ...
    UserCustomActions.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(common.Util.extend({ __metadata: { "type": "SP.UserCustomAction" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
...
var UserCustomAction = /** @class */ (function (_super) {
    __extends$23(UserCustomAction, _super);
...
var Lists = /** @class */ (function (_super) {
    ...
    Lists.prototype.add = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        if (additionalSettings === void 0) { additionalSettings = {}; }
        var addSettings = common.Util.extend({
    ...
    Lists.prototype.ensure = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        return new Promise(function (resolve, reject) {
            var addOrUpdateSettings = common.Util.extend(additionalSettings, { Title: title, Description: description, ContentTypesEnabled: enableContentTypes }, true);
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.getChanges = function (query) {
        return this.clone(List, "getchanges").postCore({
            body: JSON.stringify({ "query": common.Util.extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getItemsByCAMLQuery = function (query) {
        ...
        return q.expand.apply(q, expands).postCore({
            body: JSON.stringify({ "query": common.Util.extend({ "__metadata": { "type": "SP.CamlQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getListItemChangesSinceToken = function (query) {
        return this.clone(List, "getlistitemchangessincetoken").postCore({
            body: JSON.stringify({ "query": common.Util.extend({ "__metadata": { "type": "SP.ChangeLogItemQuery" } }, query) }),
    ...
    List.prototype.renderListDataAsStream = function (parameters, overrideParameters) {
        ...
        var postBody = {
            overrideParameters: common.Util.extend({
...
var PagedItemCollectionParser = /** @class */ (function (_super) {
    __extends$15(PagedItemCollectionParser, _super);
...
var ItemUpdatedParser = /** @class */ (function (_super) {
    __extends$15(ItemUpdatedParser, _super);
...
var File = /** @class */ (function (_super) {
    ...
    File.prototype.getText = function () {
        return this.clone(File, "$value", false).get(new odata.TextFileParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
    ...
    File.prototype.getBlob = function () {
        return this.clone(File, "$value", false).get(new odata.BlobFileParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js. Not supported in batching.
     */
    File.prototype.getBuffer = function () {
        return this.clone(File, "$value", false).get(new odata.BufferFileParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js. Not supported in batching.
     */
    File.prototype.getJSON = function () {
        return this.clone(File, "$value", false).get(new odata.JSONFileParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
    ...
    File.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return common.Util.extend(new Item(spGetEntityUrl(d)), d);
        });
    };
    /**
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = common.Util.getGUID();
...
var NavigationNodes = /** @class */ (function (_super) {
    __extends$24(NavigationNodes, _super);
...
var NavigationNode = /** @class */ (function (_super) {
    __extends$24(NavigationNode, _super);
...
var Navigation = /** @class */ (function (_super) {
    __extends$24(Navigation, _super);
    /**
...
var SPBatch = /** @class */ (function (_super) {
    ...
    SPBatch.prototype.executeImpl = function () {
        var _this = this;
        logging.Logger.write("[" + this.batchId + "] (" + (new Date()).getTime() + ") Executing batch with " + this.requests.length + " requests.", logging.LogLevel.Info);
        // if we don't have any requests, don't bother sending anything
        // this could be due to caching further upstream, or just an empty batch
        if (this.requests.length < 1) {
            logging.Logger.write("Resolving empty batch.", logging.LogLevel.Info);
        ...
        return toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                if (reqInfo.method === "GET") {
                    ...
                    if (currentChangeSetId.length < 1) {
                        ...
                        currentChangeSetId = common.Util.getGUID();
                        batchBody.push("--batch_" + _this.batchId + "\n");
                ...
                var url = common.Util.isUrlAbsolute(reqInfo.url) ? reqInfo.url : common.Util.combinePaths(absoluteRequestUrl, reqInfo.url);
                logging.Logger.write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Adding request " + reqInfo.method + " " + url + " to batch.", logging.LogLevel.Verbose);
                if (reqInfo.method !== "GET") {
            ...
            logging.Logger.write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Sending batch request.", logging.LogLevel.Info);
            return client.fetch(common.Util.combinePaths(absoluteRequestUrl, "/_api/$batch"), batchOptions)
                ...
                logging.Logger.write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Resolving batched requests.", logging.LogLevel.Info);
                return responses.reduce(function (chain, response, index) {
                    var request = _this.requests[index];
                    logging.Logger.write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Resolving batched request " + request.method + " " + request.url + ".", logging.LogLevel.Verbose);
...
var RelatedItemManagerImpl = /** @class */ (function (_super) {
    __extends$27(RelatedItemManagerImpl, _super);
...
var Web = /** @class */ (function (_super) {
    ...
    Web.prototype.getChanges = function (query) {
        var postBody = JSON.stringify({ "query": common.Util.extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) });
...
var UserProfileQuery = /** @class */ (function (_super) {
    __extends$28(UserProfileQuery, _super);
    /**
    ...
    Object.defineProperty(UserProfileQuery.prototype, "editProfileLink", {
         ...
         */
        get: function () {
            return this.clone(UserProfileQuery, "EditProfileLink").getAs(odata.ODataValue());
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserProfileQuery.prototype, "isMyPeopleListPublic", {
         ...
         */
        get: function () {
            return this.clone(UserProfileQuery, "IsMyPeopleListPublic").getAs(odata.ODataValue());
        },
        enumerable: true,
        configurable: true
    });
...
var ProfileLoader = /** @class */ (function (_super) {
    __extends$28(ProfileLoader, _super);
    /**
...
var UtilityMethod = /** @class */ (function (_super) {
    __extends$29(UtilityMethod, _super);
    /**
    ...
    UtilityMethod.prototype.sendEmail = function (props) {
        ...
        if (props.To && props.To.length > 0) {
            params.properties = common.Util.extend(params.properties, {
                To: { results: props.To },
            });
        }
