 ...
 */
import { stringIsNullOrEmpty, extend, combine, hOP, RuntimeConfig, FetchClient, mergeHeaders, getCtxCallback, isUrlAbsolute, mergeOptions, getGUID, jsS, dateAdd, getHashCode, objectDefinedNotNull, isArray } from '@pnp/common';
...
class SharePointQueryableSecurable extends SharePointQueryableInstance {
    ...
    getCurrentUserEffectivePermissions() {
        ...
        return w.configureFrom(this).select("LoginName").get().then(user => {
    ...
    */
    ...
    add(properties = {}, listItemEntityTypeFullName = null) {
        ...
        return this.ensureListItemEntityTypeName(listItemEntityTypeFullName).then(listItemEntityType => {
            ...
            const clonedReq = this.clone(Items_1, "");
            ...
            const promise = clonedReq.postCore({ body: postBody }).then((data) => {
                return {
                    data: data,
...
class ClientSidePage extends SharePointQueryable {
     ...
     * @param sections
     */
    constructor(baseUrl, json, noInit = false, sections = [], commentsDisabled = false) {
        super(baseUrl);
        this.json = json;
     ...
     */
    static create(_library = null, pageName, title, pageLayoutType = "Article") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pageInitData = yield ClientSidePage.getPoster("_api/sitepages/pages").postCore({
            ...
            for (let i = 0; i < canvasControls.length; i++) {
                ...
                switch (controlType) {
                    case 0:
                        ...
                        break;
                    case 3:
                        const part = new ClientSideWebpart(canvasControls[i]);
                        this.mergePartToTree(part, part.data.position);
                        break;
                    case 4:
                        const textData = canvasControls[i];
    ...
    load() {
        ...
        return this.getItem("Id", "CommentsDisabled").then(item => {
            return (new SharePointQueryable(`_api/sitepages/pages(${item.Id})`)).get().then(pageData => {
    ...
    save(publish = true) {
        ...
        if (!this.json.IsPageCheckedOutToCurrentUser) {
            promise = promise.then(_ => (ClientSidePage.getPoster(`_api/sitepages/pages(${this.json.Id})/checkoutpage`)).postCore());
        }
        promise = promise.then(_ => (ClientSidePage.getPoster(`_api/sitepages/pages(${this.json.Id})/savepage`)).postCore({
            body: jsS(Object.assign(metadata("SP.Publishing.SitePage"), {
        ...
        if (publish) {
            promise = promise.then(_ => (ClientSidePage.getPoster(`_api/sitepages/pages(${this.json.Id})/publish`)).postCore());
        }
        return promise;
    }
    discardPageCheckout() {
...
class CanvasColumn {
    constructor(json = CanvasColumn.Default, controls = []) {
        this.json = json;
...
class ColumnControl extends CanvasControl {
    get column() {
        return this._column;
    }
    set column(value) {
...
class ClientSideText extends ColumnControl {
    constructor(text, json = ClientSideText.Default) {
        super(json);
        this.text = text;
    }
    get text() {
...
class ClientSideWebpart extends ColumnControl {
    constructor(json = ClientSideWebpart.Default) {
        super(json);
    }
...
let Site = Site_1 = class Site extends SharePointQueryableInstance {
     ...
     */
    createCommunicationSite(title, lcid = 1033, shareByEmailEnabled = false, url, description = "", classification = "", siteDesignId = "00000000-0000-0000-0000-000000000000") {
        const props = {
     ...
     */
    createModernTeamSite(displayName, alias, isPublic = true, lcid = 1033, description = "", classification = "", owners) {
        const postBody = jsS({
            alias: alias,
 ...
 *
 */
class SiteScripts extends SharePointQueryable {
    /**
    ...
    createSiteScript(title, description, content) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.clone(SiteScripts, `CreateSiteScript(Title=@title,Description=@desc)?@title='${encodeURIComponent(title)}'&@desc='${encodeURIComponent(description)}'`)
                .execute(content);
        });
    }
    /**
    ...
    getSiteScriptMetadata(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.clone(SiteScripts, "GetSiteScriptMetadata").execute({ id: id });
        });
    }
    /**
    ...
    deleteSiteScript(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.clone(SiteScripts, "DeleteSiteScript").execute({ id: id });
        });
    }
    /**
    ...
    updateSiteScript(siteScriptUpdateInfo, content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.clone(SiteScripts, "UpdateSiteScript").execute({ updateInfo: siteScriptUpdateInfo });
        });
    }
}
...
export { odataUrlFrom, spODataEntity, spODataEntityArray, SharePointQueryable, SharePointQueryableInstance, SharePointQueryableCollection, SharePointQueryableSecurable, FileFolderShared, SharePointQueryableShareable, SharePointQueryableShareableFile, SharePointQueryableShareableFolder, SharePointQueryableShareableItem, SharePointQueryableShareableWeb, AppCatalog, App, SPBatch, ContentType, ContentTypes, FieldLink, FieldLinks, Field, Fields, CheckinType, WebPartsPersonalizationScope, MoveOperations, TemplateFileType, File, Files, Folder, Folders, SPHttpClient, Item, Items, ItemVersion, ItemVersions, PagedItemCollection, NavigationNodes, NavigationNode, NavigationService, List, Lists, RegionalSettings, InstalledLanguages, TimeZone, TimeZones, sp, SPRest, RoleDefinitionBindings, Search, SearchQueryBuilder, SearchResults, SortDirection, ReorderingRuleMatchType, QueryPropertyValueType, SearchBuiltInSourceId, SearchSuggest, Site, UserProfileQuery, toAbsoluteUrl, extractWebUrl, UtilityMethod, View, Views, ViewFields, WebPartDefinitions, WebPartDefinition, WebPart, Web, SiteScripts, SiteDesigns, HubSite, HubSites, PromotedState, ClientSidePage, CanvasControl, CanvasSection, CanvasColumn, ColumnControl, ClientSideText, ClientSideWebpart, Comments, Comment, Replies, SocialQuery, MySocialQuery, SocialActorType, SocialActorTypes, SocialFollowResult, SocialStatusCode, ControlMode, FieldTypes, DateTimeFieldFormatType, DateTimeFieldFriendlyFormatType, AddFieldOptions, CalendarType, UrlFieldFormatType, PermissionKind, PrincipalType$1 as PrincipalType, PrincipalSource, RoleType, PageType, SharingLinkKind, SharingRole, SharingOperationStatusCode, SPSharedObjectType, SharingDomainRestrictionMode, RenderListDataOptions, FieldUserSelectionMode, ChoiceFieldFormatType, UrlZone };
