import { Dictionary, RuntimeConfig, UrlException, Util, mergeHeaders, mergeOptions, readBlobAsArrayBuffer } from '@pnp/common';
...
var Item = /** @class */ (function (_super) {
    ...
    Item.prototype.update = function (properties, eTag) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var parentList = _this.getParent(SharePointQueryableInstance, _this.parentUrl.substr(0, _this.parentUrl.lastIndexOf("/")));
...
export { sp, CheckinType, WebPartsPersonalizationScope, MoveOperations, TemplateFileType, File, Files, Folder, Folders, HttpClient, Item, Items, PagedItemCollection, NavigationNodes, NavigationNode, List, Lists, spExtractODataId, spODataEntity, spODataEntityArray, SharePointQueryable, SharePointQueryableInstance, SharePointQueryableCollection, SharePointQueryableSecurable, RoleDefinitionBindings, Search, SearchQueryBuilder, SearchResults, SortDirection, ReorderingRuleMatchType, QueryPropertyValueType, SearchBuiltInSourceId, SearchSuggest, SearchSuggestResult, Site, UtilityMethod, WebPartDefinitions, WebPartDefinition, WebPart, Web, ControlMode, FieldTypes, DateTimeFieldFormatType, AddFieldOptions, CalendarType, UrlFieldFormatType, PermissionKind, PrincipalType$1 as PrincipalType, PrincipalSource, RoleType, PageType, SharingLinkKind, SharingRole, SharingOperationStatusCode, SPSharedObjectType, SharingDomainRestrictionMode };
