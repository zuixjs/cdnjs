...
class ClientSidePage extends SharePointQueryable {
    ...
    static create(web, pageName, title, pageLayoutType = "Article") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pageInitData = yield ClientSidePage.getPoster(web, "_api/sitepages/pages").postCore({
    ...
    save(publish = true) {
        ...
        if (!this.json.IsPageCheckedOutToCurrentUser) {
            promise = promise.then(_ => (ClientSidePage.getPoster(this, `_api/sitepages/pages(${this.json.Id})/checkoutpage`)).postCore());
        }
        promise = promise.then(_ => (ClientSidePage.getPoster(this, `_api/sitepages/pages(${this.json.Id})/savepage`)).postCore({
            body: jsS(Object.assign(metadata("SP.Publishing.SitePage"), {
        ...
        if (publish) {
            promise = promise.then(_ => (ClientSidePage.getPoster(this, `_api/sitepages/pages(${this.json.Id})/publish`)).postCore()).then(r => {
                if (r) {
     ...
     */
    copyPage(web, pageName, title, publish = true) {
        return __awaiter(this, void 0, void 0, function* () {
            const page = yield ClientSidePage.create(web, pageName, title, this.pageLayout);
