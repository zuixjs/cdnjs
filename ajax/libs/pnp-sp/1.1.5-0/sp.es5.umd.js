    ...
    function toAbsoluteUrl(candidateUrl) {
        return new Promise(function (resolve) {
            ...
            if (global._spPageContextInfo !== undefined) {
                ...
                if (common.hOP(global._spPageContextInfo, "webAbsoluteUrl")) {
                    return resolve(common.combine(global._spPageContextInfo.webAbsoluteUrl, candidateUrl));
                }
                else if (common.hOP(global._spPageContextInfo, "webServerRelativeUrl")) {
                    return resolve(common.combine(global._spPageContextInfo.webServerRelativeUrl, candidateUrl));
                }
            }
