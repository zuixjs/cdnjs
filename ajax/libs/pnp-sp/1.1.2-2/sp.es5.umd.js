...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@pnp/logging'), require('@pnp/common'), require('@pnp/odata'), require('..')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@pnp/logging', '@pnp/common', '@pnp/odata', '..'], factory) :
    (factory((global.pnp = global.pnp || {}, global.pnp.sp = {}),null,global.pnp.logging,global.pnp.common,global.pnp.odata,null));
}(this, (function (exports,tslib_1,logging,common,odata,__) { 'use strict';
        ...
        function SharePointQueryable(baseUrl, path) {
            ...
            if (typeof baseUrl === "string") {
                ...
                if (common.isUrlAbsolute(baseUrl) || baseUrl.lastIndexOf("/") < 0) {
                    ...
                    _this._url = common.combinePaths(baseUrl, path);
                }
                else if (baseUrl.lastIndexOf("/") > baseUrl.lastIndexOf("(")) {
                    // .../items(19)/fields
                    var index = baseUrl.lastIndexOf("/");
                    _this._parentUrl = baseUrl.slice(0, index);
                    path = common.combinePaths(baseUrl.slice(index), path);
    ...
    var Replies = /** @class */ (function (_super) {
        ...
        Replies.prototype.add = function (info) {
            ...
            return this.clone(Replies, null).postCore({ body: postBody }).then(function (d) {
                return common.extend(new Comment(__.spExtractODataId(d)), d);
            });
        };
        return Replies;
    }(SharePointQueryableCollection));
