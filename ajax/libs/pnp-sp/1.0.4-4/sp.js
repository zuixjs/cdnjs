 ...
 */
import { Dictionary, FetchClient, RuntimeConfig, combinePaths, dateAdd, extend, getCtxCallback, getGUID, isUrlAbsolute, mergeHeaders, mergeOptions, readBlobAsArrayBuffer } from '@pnp/common';
...
class SPHttpClient {
    ...
    fetch(url, options = {}) {
        ...
        if (!headers.has("X-ClientService-ClientTag")) {
            headers.append("X-ClientService-ClientTag", "PnPCoreJS:@pnp-1.0.4-4");
        }
        if (!headers.has("User-Agent")) {
            // this marks the requests for understanding by the service
            headers.append("User-Agent", "NONISV|SharePointPnP|PnPCoreJS/1.0.4-4");
        }
...
class ClientSideWebpart extends ClientSidePart {
    constructor(title, description = "", propertieJson = {}, webPartId = "", htmlProperties = "", serverProcessedContent = null) {
        super(3, "1.0");
        this.title = title;
