...
class CanvasControl {
    constructor(controlType, dataVersion, column = null, order = 1, id = Util.getGUID(), controlData = null) {
...
class ClientSideText extends CanvasControl {
    constructor(text = "") {
        super(4, "1.0");
        this.text = text;
    }
...
class ClientSideWebpart extends CanvasControl {
