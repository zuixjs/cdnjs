        ...
        ClientSidePage.prototype.fromJSON = function (pageData) {
            ...
            if (canvasControls && canvasControls.length) {
                for (var i = 0; i < canvasControls.length; i++) {
                    ...
                    var controlType = common.hOP(canvasControls[i], "controlType") ? canvasControls[i].controlType : 0;
                    switch (controlType) {
                        case 0:
                            // empty canvas column or page settings
                            if (common.hOP(canvasControls[i], "pageSettingsSlice")) {
