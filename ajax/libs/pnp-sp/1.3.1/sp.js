...
let Site = Site_1 = class Site extends SharePointQueryableInstance {
     ...
     */
    createCommunicationSite(title, lcid = 1033, shareByEmailEnabled = false, url, description = "", classification = "", siteDesignId = "00000000-0000-0000-0000-000000000000", hubSiteId = "00000000-0000-0000-0000-000000000000") {
        const props = {
     ...
     */
    createModernTeamSite(displayName, alias, isPublic = true, lcid = 1033, description = "", classification = "", owners, hubSiteId = "00000000-0000-0000-0000-000000000000") {
        const postBody = jsS({
            alias: alias,
