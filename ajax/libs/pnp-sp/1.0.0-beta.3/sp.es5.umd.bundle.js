...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__net_httpclient__ = __webpack_require__(14);
...
var SharePointQueryable = /** @class */ (function (_super) {
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if (__WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].isUrlAbsolute(urlStr) || urlStr.lastIndexOf("/") < 0) {
                ...
                path = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].combinePaths(urlStr.slice(index), path);
    ...
    SharePointQueryable.prototype.toUrlAndQuery = function () {
        ...
        var url = this.toUrl().replace(/'!(@.*?)::(.*?)'/ig, function (match, labelName, value) {
            __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("Rewriting aliased parameter from match " + match + " to label: " + labelName + " value: " + value, __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Verbose);
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        if (pipeline === void 0) { pipeline = __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["i" /* PipelineMethods */].default; }
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_5__utils_toabsoluteurl__["a" /* toAbsoluteUrl */])(this.toUrlAndQuery()).then(function (url) {
            Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["f" /* mergeOptions */])(options, _this._options);
            // build our request context
            var context = {
                batch: _this.batch,
                batchDependency: dependencyDispose,
                cachingOptions: _this._cachingOptions,
                clientFactory: function () { return new __WEBPACK_IMPORTED_MODULE_4__net_httpclient__["a" /* HttpClient */](); },
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return readBlobAsArrayBuffer; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_extractweburl__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pnp_logging__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__exceptions__ = __webpack_require__(6);
...
var SPODataEntityParserImpl = /** @class */ (function (_super) {
    ...
    SPODataEntityParserImpl.prototype.parse = function (r) {
        ...
        return _super.prototype.parse.call(this, r).then(function (d) {
            ...
            return __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(o, d);
        });
    };
    ...
    SPODataEntityArrayParserImpl.prototype.parse = function (r) {
        ...
        return _super.prototype.parse.call(this, r).then(function (d) {
            return d.map(function (v) {
                ...
                return __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(o, v);
            });
        });
    };
...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].combinePaths(Object(__WEBPACK_IMPORTED_MODULE_1__utils_extractweburl__["a" /* extractWebUrl */])(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
    }
        ...
        __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("No uri information found in ODataEntity parsing, chaining will fail for this object.", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Warning);
        return "";
    }
}
...
var BufferFileParser = /** @class */ (function () {
    ...
    BufferFileParser.prototype.parse = function (r) {
        if (__WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].isFunction(r.arrayBuffer)) {
...
var ODataQueryable = /** @class */ (function () {
    ...
    ODataQueryable.prototype.configure = function (options) {
        Object(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["f" /* mergeOptions */])(this._options, options);
        return this;
    };
    /**
...
var SPODataIdException = /** @class */ (function (_super) {
    ...
    function SPODataIdException(data, msg) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__pnp_logging__["b" /* Logger */].log({ data: data, level: __WEBPACK_IMPORTED_MODULE_1__pnp_logging__["a" /* LogLevel */].Error, message: "[" + _this.name + "]::" + _this.message });
        return _this;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__net_fetchclient__ = __webpack_require__(37);
...
var SPRuntimeConfigImpl = /** @class */ (function () {
    ...
    Object.defineProperty(SPRuntimeConfigImpl.prototype, "baseUrl", {
        get: function () {
            ...
            if (__WEBPACK_IMPORTED_MODULE_0__pnp_common__["c" /* RuntimeConfig */].spfxContext !== null) {
    ...
    Object.defineProperty(SPRuntimeConfigImpl.prototype, "fetchClientFactory", {
        get: function () {
            ...
            if (spPart !== null && typeof spPart.fetchClientFactory !== "undefined") {
                ...
                return function () { return new __WEBPACK_IMPORTED_MODULE_1__net_fetchclient__["a" /* FetchClient */](); };
            }
        },
        enumerable: true,
        configurable: true
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__types__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_extractweburl__ = __webpack_require__(13);
...
var SharePointQueryableShareable = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareable.prototype.shareWith = function (loginNames, role, requireSignin, propagateAcl, emailData) {
        ...
        return w.select("Id").filter("RoleTypeKind eq " + roleFilter).get().then(function (def) {
            ...
            if (typeof emailData !== "undefined") {
                postBody = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(postBody, {
    ...
    SharePointQueryableShareable.prototype.shareObject = function (options, bypass) {
        ...
        options = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, {
            group: null,
...
var SharePointQueryableShareableWeb = /** @class */ (function (_super) {
    ...
    SharePointQueryableShareableWeb.prototype.shareWith = function (loginNames, role, emailData) {
        ...
        return web.get().then(function (url) {
            dependency();
            return _this.shareObject(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].combinePaths(url, "/_layouts/15/aclinv.aspx?forSharing=1&mbypass=1"), loginNames, role, emailData);
        });
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__exceptions__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__webparts__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__items__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sharepointqueryableshareable__ = __webpack_require__(8);
...
var File = /** @class */ (function (_super) {
    ...
    File.prototype.getText = function () {
        return this.clone(File, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["j" /* TextFileParser */](), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
    ...
    File.prototype.getBlob = function () {
        return this.clone(File, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["a" /* BlobFileParser */](), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js. Not supported in batching.
     */
    File.prototype.getBuffer = function () {
        return this.clone(File, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["b" /* BufferFileParser */](), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js. Not supported in batching.
     */
    File.prototype.getJSON = function () {
        return this.clone(File, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["c" /* JSONFileParser */](), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
    ...
    File.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return __WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend(new __WEBPACK_IMPORTED_MODULE_6__items__["a" /* Item */](Object(__WEBPACK_IMPORTED_MODULE_8__odata__["b" /* spGetEntityUrl */])(d)), d);
        });
    };
    /**
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = __WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].getGUID();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return PagedItemCollection; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sharepointqueryableshareable__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__folders__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__files__ = __webpack_require__(9);
...
var Items = /** @class */ (function (_super) {
    ...
    Items.prototype.add = function (properties, listItemEntityTypeFullName) {
        ...
        return this.ensureListItemEntityTypeName(listItemEntityTypeFullName).then(function (listItemEntityType) {
            var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_6__pnp_common__["d" /* Util */].extend({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__files__ = __webpack_require__(9);
...
var Folder = /** @class */ (function (_super) {
    ...
    Folder.prototype.update = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend({
    ...
    */
    ...
    Folder.prototype.getItem = function () {
        ...
        var q = this.listItemAllFields;
        return q.select.apply(q, selects).get().then(function (d) {
            return __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(new __WEBPACK_IMPORTED_MODULE_6__items__["a" /* Item */](Object(__WEBPACK_IMPORTED_MODULE_5__odata__["b" /* spGetEntityUrl */])(d)), d);
        });
    };
    return Folder;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__digestcache__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_splibconfig__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__exceptions__ = __webpack_require__(6);
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.fetch = function (url, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, { cache: "no-cache", credentials: "same-origin" }, true);
        var headers = new Headers();
        // first we add the global headers so they can be overwritten by any passed in locally to this call
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* mergeHeaders */])(headers, __WEBPACK_IMPORTED_MODULE_2__config_splibconfig__["a" /* SPRuntimeConfig */].headers);
        // second we add the local options so we can overwrite the globals
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* mergeHeaders */])(headers, options.headers);
        ...
        opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(opts, { headers: headers });
    ...
    HttpClient.prototype.fetchRaw = function (url, options) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* mergeHeaders */])(rawHeaders, options.headers);
        options = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, { headers: rawHeaders });
        var retry = function (ctx) {
            _this._impl.fetch(url, options).then(function (response) { return ctx.resolve(response); }).catch(function (response) {
                ...
                setTimeout(__WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].getCtxCallback(_this, retry, ctx), delay);
            });
        };
        return new Promise(function (resolve, reject) {
            var retryContext = {
    ...
    HttpClient.prototype.get = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, { method: "GET" });
        return this.fetch(url, opts);
    };
    HttpClient.prototype.post = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, { method: "POST" });
        return this.fetch(url, opts);
    };
    HttpClient.prototype.patch = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, { method: "PATCH" });
        return this.fetch(url, opts);
    };
    HttpClient.prototype.delete = function (url, options) {
        if (options === void 0) { options = {}; }
        var opts = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend(options, { method: "DELETE" });
        return this.fetch(url, opts);
    };
    return HttpClient;
}());
...
var RoleDefinitions = /** @class */ (function (_super) {
    ...
    RoleDefinitions.prototype.add = function (name, description, order, basePermissions) {
        ...
        var postBody = JSON.stringify({
            BasePermissions: __WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend({ __metadata: { type: "SP.BasePermissions" } }, basePermissions),
...
var RoleDefinition = /** @class */ (function (_super) {
    ...
    RoleDefinition.prototype.update = function (properties) {
        ...
        if (typeof properties.hasOwnProperty("BasePermissions") !== "undefined") {
            properties["BasePermissions"] = __WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend({ __metadata: { type: "SP.BasePermissions" } }, properties["BasePermissions"]);
        }
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend({
            "__metadata": { "type": "SP.RoleDefinition" },
        }, properties));
        return this.postCore({
            body: postBody,
...
var SiteGroups = /** @class */ (function (_super) {
    ...
    SiteGroups.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.Group" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
                data: data,
...
var SiteGroup = /** @class */ (function (_super) {
    ...
    */
    ...
    SiteGroup.prototype.update = function (properties) {
        var _this = this;
        var postBody = __WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.Group" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fields__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__exceptions__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__folders__ = __webpack_require__(12);
...
var Lists = /** @class */ (function (_super) {
    ...
    Lists.prototype.add = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        if (additionalSettings === void 0) { additionalSettings = {}; }
        var addSettings = __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({
    ...
    Lists.prototype.ensure = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        return new Promise(function (resolve, reject) {
            var addOrUpdateSettings = __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend(additionalSettings, { Title: title, Description: description, ContentTypesEnabled: enableContentTypes }, true);
...
var List = /** @class */ (function (_super) {
    ...
    Object.defineProperty(List.prototype, "items", {
         ...
         */
        get: function () {
            return new __WEBPACK_IMPORTED_MODULE_1__items__["b" /* Items */](this);
        },
        enumerable: true,
        configurable: true
    });
    ...
    List.prototype.update = function (properties, eTag) {
        var _this = this;
        if (eTag === void 0) { eTag = "*"; }
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({
            "__metadata": { "type": "SP.List" },
        }, properties));
        return this.postCore({
            body: postBody,
    ...
    List.prototype.getChanges = function (query) {
        return this.clone(List, "getchanges").postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getItemsByCAMLQuery = function (query) {
        ...
        return q.expand.apply(q, expands).postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.CamlQuery" } }, query) }),
        });
    };
    /**
    ...
    List.prototype.getListItemChangesSinceToken = function (query) {
        return this.clone(List, "getlistitemchangessincetoken").postCore({
            body: JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.ChangeLogItemQuery" } }, query) }),
    ...
    List.prototype.renderListDataAsStream = function (parameters, overrideParameters) {
        ...
        var postBody = {
            overrideParameters: __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({
                "__metadata": { "type": "SP.RenderListDataOverrideParameters" },
            }, overrideParameters),
            parameters: __WEBPACK_IMPORTED_MODULE_9__pnp_common__["d" /* Util */].extend({
...
var UserCustomActions = /** @class */ (function (_super) {
    ...
    UserCustomActions.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend({ __metadata: { "type": "SP.UserCustomAction" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
...
var UserCustomAction = /** @class */ (function (_super) {
    ...
    */
    UserCustomAction.prototype.update = function (properties) {
        var _this = this;
        var postBody = JSON.stringify(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sharepointqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__folders__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lists__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__fields__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__navigation__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__files__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils_extractweburl__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__batch__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__features__ = __webpack_require__(32);
...
var Webs = /** @class */ (function (_super) {
    ...
    Webs.prototype.add = function (title, url, description, template, language, inheritPermissions) {
        ...
        var postBody = JSON.stringify({
            "parameters": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend({
...
var Web = /** @class */ (function (_super) {
    ...
    */
    ...
    Web.prototype.getChanges = function (query) {
        var postBody = JSON.stringify({ "query": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.ChangeQuery" } }, query) });
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        if (__WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].isUrlAbsolute(candidateUrl)) {
            // if we are already absolute, then just return the url
            return resolve(candidateUrl);
        }
        if (__WEBPACK_IMPORTED_MODULE_1__config_splibconfig__["a" /* SPRuntimeConfig */].baseUrl !== null) {
            // base url specified either with baseUrl of spfxContext config property
            return resolve(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].combinePaths(__WEBPACK_IMPORTED_MODULE_1__config_splibconfig__["a" /* SPRuntimeConfig */].baseUrl, candidateUrl));
        }
        if (typeof global._spPageContextInfo !== "undefined") {
            // operating in classic pages
            if (global._spPageContextInfo.hasOwnProperty("webAbsoluteUrl")) {
                return resolve(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].combinePaths(global._spPageContextInfo.webAbsoluteUrl, candidateUrl));
            }
            else if (global._spPageContextInfo.hasOwnProperty("webServerRelativeUrl")) {
                return resolve(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].combinePaths(global._spPageContextInfo.webServerRelativeUrl, candidateUrl));
            }
        }
        ...
        if (typeof global.location !== "undefined") {
            ...
            ["/_layouts/", "/siteassets/"].forEach(function (s) {
                ...
                if (index > 0) {
                    return resolve(__WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].combinePaths(baseUrl_1.substr(0, index), candidateUrl));
                }
            });
        }
        return resolve(candidateUrl);
...
var SiteUser = /** @class */ (function (_super) {
    ...
    */
    SiteUser.prototype.update = function (properties) {
        var _this = this;
        var postBody = __WEBPACK_IMPORTED_MODULE_3__pnp_common__["d" /* Util */].extend({ "__metadata": { "type": "SP.User" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__types__ = __webpack_require__(10);
...
var Fields = /** @class */ (function (_super) {
    ...
    Fields.prototype.createFieldAsXml = function (xml) {
        ...
        var postBody = JSON.stringify({
            "parameters": __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend({
                "__metadata": {
    ...
    Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (typeof minValue !== "undefined") {
            props = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend({ MinimumValue: minValue }, props);
        }
        if (typeof maxValue !== "undefined") {
            props = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(props, properties));
    };
    return Fields;
}(__WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__["b" /* SharePointQueryableCollection */]));
...
var SearchQueryBuilder = /** @class */ (function () {
    ...
    SearchQueryBuilder.prototype.extendQuery = function (part) {
        this._query = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(this._query, part);
        return this;
    };
...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.execute = function (query) {
        ...
        var postBody = JSON.stringify({
            request: __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend({
...
var SearchResults = /** @class */ (function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var query = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(this._query, {
            RowLimit: rows,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__batch__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__features__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__exceptions__ = __webpack_require__(6);
...
var SPBatch = /** @class */ (function (_super) {
    ...
    SPBatch.prototype.executeImpl = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("[" + this.batchId + "] (" + (new Date()).getTime() + ") Executing batch with " + this.requests.length + " requests.", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Info);
        // if we don't have any requests, don't bother sending anything
        // this could be due to caching further upstream, or just an empty batch
        if (this.requests.length < 1) {
            __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("Resolving empty batch.", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Info);
            return Promise.resolve();
        }
        // creating the client here allows the url to be populated for nodejs client as well as potentially
        // any other hacks needed for other types of clients. Essentially allows the absoluteRequestUrl
        // below to be correct
        var client = new __WEBPACK_IMPORTED_MODULE_4__net_httpclient__["a" /* HttpClient */]();
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_7__utils_toabsoluteurl__["a" /* toAbsoluteUrl */])(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                if (reqInfo.method === "GET") {
                    ...
                    if (currentChangeSetId.length < 1) {
                        ...
                        currentChangeSetId = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].getGUID();
                        batchBody.push("--batch_" + _this.batchId + "\n");
                ...
                var url = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].isUrlAbsolute(reqInfo.url) ? reqInfo.url : __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].combinePaths(absoluteRequestUrl, reqInfo.url);
                __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Adding request " + reqInfo.method + " " + url + " to batch.", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Verbose);
                if (reqInfo.method !== "GET") {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["e" /* mergeHeaders */])(headers, __WEBPACK_IMPORTED_MODULE_5__config_splibconfig__["a" /* SPRuntimeConfig */].headers);
                // merge per-request headers
                if (reqInfo.options) {
                    Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["e" /* mergeHeaders */])(headers, reqInfo.options.headers);
                }
                // lastly we apply any default headers we need that may not exist
                if (!headers.has("Accept")) {
                    headers.append("Accept", "application/json");
            ...
            __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Sending batch request.", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Info);
            return client.fetch(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].combinePaths(absoluteRequestUrl, "/_api/$batch"), batchOptions)
                ...
                __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Resolving batched requests.", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Info);
                return responses.reduce(function (chain, response, index) {
                    var request = _this.requests[index];
                    __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["b" /* Logger */].write("[" + _this.batchId + "] (" + (new Date()).getTime() + ") Resolving batched request " + request.method + " " + request.url + ".", __WEBPACK_IMPORTED_MODULE_3__pnp_logging__["a" /* LogLevel */].Verbose);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__files__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__odata__ = __webpack_require__(3);
...
var UtilityMethod = /** @class */ (function (_super) {
    ...
    UtilityMethod.prototype.sendEmail = function (props) {
        ...
        if (props.To && props.To.length > 0) {
            params.properties = __WEBPACK_IMPORTED_MODULE_2__pnp_common__["d" /* Util */].extend(params.properties, {
                To: { results: props.To },
            });
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_sp__ = __webpack_require__(35);
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "spExtractODataId", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_9"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "spODataEntity", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_10"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "spODataEntityArray", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_11"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["L"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableInstance", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["N"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["M"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableSecurable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["O"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FileFolderShared", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["h"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareable", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["P"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableFile", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["Q"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableFolder", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["R"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableItem", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["S"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharePointQueryableShareableWeb", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["T"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "CheckinType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["c"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPartsPersonalizationScope", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_7"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "MoveOperations", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["q"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "TemplateFileType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_0"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "File", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["g"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Files", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["i"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Folder", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["j"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Folders", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["k"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "HttpClient", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["l"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Item", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["m"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Items", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["n"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PagedItemCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["u"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NavigationNodes", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["s"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NavigationNode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["r"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "List", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["o"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Lists", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["p"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "sp", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_8"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SPRest", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["D"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RoleDefinitionBindings", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["B"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Search", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["F"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchQueryBuilder", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["H"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchResults", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["I"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SortDirection", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["Z"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ReorderingRuleMatchType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["A"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "QueryPropertyValueType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["y"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchBuiltInSourceId", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["G"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchSuggest", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["J"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SearchSuggestResult", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["K"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Site", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["Y"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "UtilityMethod", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_2"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPartDefinitions", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_6"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPartDefinition", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_5"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "WebPart", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_4"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "Web", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_3"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "ControlMode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["d"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "FieldTypes", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["f"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "DateTimeFieldFormatType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["e"]; });
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "CalendarType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["b"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "UrlFieldFormatType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["_1"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PermissionKind", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["v"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PrincipalType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["x"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PrincipalSource", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["w"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RoleType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["C"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "PageType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["t"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingLinkKind", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["V"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingRole", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["X"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingOperationStatusCode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["W"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SPSharedObjectType", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["E"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "SharingDomainRestrictionMode", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["U"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "RenderListDataOptions", function() { return __WEBPACK_IMPORTED_MODULE_0__src_sp__["z"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_9", function() { return __WEBPACK_IMPORTED_MODULE_0__odata__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_10", function() { return __WEBPACK_IMPORTED_MODULE_0__odata__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return __WEBPACK_IMPORTED_MODULE_0__odata__["d"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__ = __webpack_require__(1);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "L", function() { return __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sharepointqueryablesecurable__ = __webpack_require__(15);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return __WEBPACK_IMPORTED_MODULE_2__sharepointqueryablesecurable__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__ = __webpack_require__(8);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return __WEBPACK_IMPORTED_MODULE_3__sharepointqueryableshareable__["f"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__files__ = __webpack_require__(9);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_4__files__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return __WEBPACK_IMPORTED_MODULE_4__files__["f"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return __WEBPACK_IMPORTED_MODULE_4__files__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return __WEBPACK_IMPORTED_MODULE_4__files__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_4__files__["b"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__folders__ = __webpack_require__(12);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_5__folders__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return __WEBPACK_IMPORTED_MODULE_5__folders__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__net_httpclient__ = __webpack_require__(14);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return __WEBPACK_IMPORTED_MODULE_6__net_httpclient__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__items__ = __webpack_require__(11);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return __WEBPACK_IMPORTED_MODULE_7__items__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return __WEBPACK_IMPORTED_MODULE_7__items__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return __WEBPACK_IMPORTED_MODULE_7__items__["c"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__navigation__ = __webpack_require__(27);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return __WEBPACK_IMPORTED_MODULE_8__navigation__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return __WEBPACK_IMPORTED_MODULE_8__navigation__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__lists__ = __webpack_require__(19);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return __WEBPACK_IMPORTED_MODULE_9__lists__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return __WEBPACK_IMPORTED_MODULE_9__lists__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__rest__ = __webpack_require__(42);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return __WEBPACK_IMPORTED_MODULE_10__rest__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return __WEBPACK_IMPORTED_MODULE_10__rest__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__roles__ = __webpack_require__(16);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return __WEBPACK_IMPORTED_MODULE_11__roles__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__search__ = __webpack_require__(28);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["e"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["f"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["g"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return __WEBPACK_IMPORTED_MODULE_12__search__["d"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__searchsuggest__ = __webpack_require__(29);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return __WEBPACK_IMPORTED_MODULE_13__searchsuggest__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "K", function() { return __WEBPACK_IMPORTED_MODULE_13__searchsuggest__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__site__ = __webpack_require__(30);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return __WEBPACK_IMPORTED_MODULE_14__site__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__types__ = __webpack_require__(10);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["d"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["e"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "t", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["f"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "v", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["g"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "w", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["h"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "x", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["i"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "z", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["j"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "C", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["k"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "E", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["l"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "U", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["m"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "V", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["n"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "W", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["o"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "X", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["p"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return __WEBPACK_IMPORTED_MODULE_15__types__["q"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__utilities__ = __webpack_require__(33);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return __WEBPACK_IMPORTED_MODULE_16__utilities__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__webparts__ = __webpack_require__(25);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return __WEBPACK_IMPORTED_MODULE_17__webparts__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return __WEBPACK_IMPORTED_MODULE_17__webparts__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return __WEBPACK_IMPORTED_MODULE_17__webparts__["b"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__webs__ = __webpack_require__(21);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return __WEBPACK_IMPORTED_MODULE_18__webs__["a"]; });
...
var DigestCache = /** @class */ (function () {
    ...
    DigestCache.prototype.getDigest = function (webUrl) {
        ...
        var url = __WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].combinePaths(webUrl, "/_api/contextinfo");
        var headers = {
        ...
        return this._httpClient.fetchRaw(url, {
            ...
            headers: __WEBPACK_IMPORTED_MODULE_0__pnp_common__["d" /* Util */].extend(headers, __WEBPACK_IMPORTED_MODULE_2__config_splibconfig__["a" /* SPRuntimeConfig */].headers, true),
            method: "POST",
        }).then(function (response) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FetchClient; });
/**
...
var AttachmentFile = /** @class */ (function (_super) {
    ...
    AttachmentFile.prototype.getText = function () {
        return this.clone(AttachmentFile, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["j" /* TextFileParser */]());
    };
    /**
    ...
    AttachmentFile.prototype.getBlob = function () {
        return this.clone(AttachmentFile, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["a" /* BlobFileParser */]());
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js
     */
    AttachmentFile.prototype.getBuffer = function () {
        return this.clone(AttachmentFile, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["b" /* BufferFileParser */]());
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js
     */
    AttachmentFile.prototype.getJSON = function () {
        return this.clone(AttachmentFile, "$value", false).get(new __WEBPACK_IMPORTED_MODULE_2__pnp_odata__["c" /* JSONFileParser */]());
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__search__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__searchsuggest__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__site__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utilities__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__config_splibconfig__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sharepointqueryable__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pnp_common__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pnp_odata__ = __webpack_require__(4);
...
var UserProfileQuery = /** @class */ (function (_super) {
    ...
    UserProfileQuery.prototype.setMyProfilePic = function (profilePicSource) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            Object(__WEBPACK_IMPORTED_MODULE_2__pnp_common__["g" /* readBlobAsArrayBuffer */])(profilePicSource).then(function (buffer) {
