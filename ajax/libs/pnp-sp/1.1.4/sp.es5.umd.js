...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pnp/common'), require('tslib'), require('@pnp/logging'), require('@pnp/odata'), require('..')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pnp/common', 'tslib', '@pnp/logging', '@pnp/odata', '..'], factory) :
    (factory((global.pnp = global.pnp || {}, global.pnp.sp = {}),global.pnp.common,global.tslib_1,global.pnp.logging,global.pnp.odata,global.__));
}(this, (function (exports,common,tslib_1,logging,odata,__) { 'use strict';
    ...
    function spExtractODataId(candidate) {
        if (candidate.hasOwnProperty("odata.metadata") && candidate.hasOwnProperty("odata.editLink")) {
            ...
            return common.combinePaths(extractWebUrl(candidate["odata.metadata"]), "_api", candidate["odata.editLink"]);
        }
        else if (candidate.hasOwnProperty("odata.editLink")) {
            return common.combinePaths("_api", candidate["odata.editLink"]);
        }
    ...
    var FileFolderShared = /** @class */ (function (_super) {
        ...
        FileFolderShared.prototype.getShareable = function () {
            ...
            return this.clone(SharePointQueryableShareableFile, "listItemAllFields", false).select("odata.id").get().then(function (d) {
                var shareable = new SharePointQueryableShareable(spExtractODataId(d));
        ...
        */
        ...
        Folder.prototype.getItem = function () {
            ...
            return q.select.apply(q, selects).get().then(function (d) {
                return common.extend(new Item(spExtractODataId(d)), d);
            });
        };
        /**
