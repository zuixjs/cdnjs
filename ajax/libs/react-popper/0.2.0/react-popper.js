	...
	var PopperManager = function (_Component) {
	  ...
	  _createClass(PopperManager, [{
	    ...
	    value: function render() {
	      ...
	      var restProps = _objectWithoutProperties(_props, ['component']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Target = function Target(_ref, context) {
	  ...
	  var restProps = _objectWithoutProperties(_ref, ['component']);
	...
	var Popper = function (_Component) {
	  ...
	  function Popper() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Popper.__proto__ || Object.getPrototypeOf(Popper)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this._setArrowNode = function (node) {
	      ...
	      var top = _this$state$data$offs.top;
	      var left = _this$state$data$offs.left;
	      var position = _this$state$data$offs.position;
	      ...
	      if (!_this.state.data || !_this.state.data.offsets.arrow) {
	        ...
	        var top = _this$state$data$offs2.top;
	        var left = _this$state$data$offs2.left;
	  ...
	  _createClass(Popper, [{
	    ...
	    value: function _createPopper() {
	      ...
	      var eventsEnabled = _props2.eventsEnabled;
	    ...
	    value: function render() {
	      ...
	      var eventsEnabled = _props3.eventsEnabled;
	      var modifiers = _props3.modifiers;
	      var style = _props3.style;

	      var restProps = _objectWithoutProperties(_props3, ['component', 'placement', 'eventsEnabled', 'modifiers', 'style']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Arrow = function Arrow(_ref, context) {
	  ...
	  var restProps = _objectWithoutProperties(_ref, ['component', 'style']);
