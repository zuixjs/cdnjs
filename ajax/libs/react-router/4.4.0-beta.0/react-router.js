(function (global, factory) {
	...
	*/
	...
	var Navigate = function (_React$Component) {
	  inherits(Navigate, _React$Component);

	  function Navigate(props) {
	    classCallCheck(this, Navigate);
	...
	function matchPath(pathname) {
	  ...
	  var _compilePath = compilePath$1(path, { end: exact, strict: strict, sensitive: sensitive }),
	...
	var StaticRouter = function (_React$Component) {
	  ...
	  StaticRouter.prototype.render = function render() {
	    ...
	    return React.createElement(Router, _extends$4({}, props, {
	      history: history,
