...
var Canvas = (function () {
    function Canvas(config) {
        ...
        this.isCache = false;
        var conf = config || {};
        var pixelRatio = conf.pixelRatio || Global_1._getGlobalKonva().pixelRatio || getDevicePixelRatio();
...
var Context = (function () {
    function Context(canvas) {
        ...
        if (Global_1._getGlobalKonva().enableTrace) {
            this.traceArr = [];
            this._enableTrace();
        }
    }
...
var SceneContext = (function (_super) {
    ...
    SceneContext.prototype._fillPattern = function (shape) {
        var fillPatternX = shape.getFillPatternX(), fillPatternY = shape.getFillPatternY(), fillPatternScaleX = shape.getFillPatternScaleX(), fillPatternScaleY = shape.getFillPatternScaleY(), fillPatternRotation = Global_1.getAngle(shape.getFillPatternRotation()), fillPatternOffsetX = shape.getFillPatternOffsetX(), fillPatternOffsetY = shape.getFillPatternOffsetY();
...
exports.DD = {
    ...
    _endDragBefore: function (evt) {
        var node = exports.DD.node, layer;
        if (node) {
            layer = node.getLayer();
            ...
            if (exports.DD.isDragging) {
                ...
                Global_1._getGlobalKonva().listenClickTap = false;
                if (evt) {
                    evt.dragEndNode = node;
                }
            }
            exports.DD.node = null;
            if (layer || node instanceof Global_1._getGlobalKonva().Stage) {
                (layer || node).draw();
            }
        }
    },
...
exports.isUnminified = /comment/.test(function () {
}.toString());
exports.dblClickWindow = 400;
exports.getAngle = function (angle) {
    return exports._getGlobalKonva().angleDeg ? angle * PI_OVER_180 : angle;
};
...
exports.glob = typeof global !== 'undefined'
    ...
    : typeof window !== 'undefined'
        ...
        : typeof WorkerGlobalScope !== 'undefined'
            ? self
            : {};
exports.UA = exports._parseUA((exports.glob.navigator && exports.glob.navigator.userAgent) || '');
exports.document = exports.glob.document;
exports._getGlobalKonva = function () {
    return exports.glob.Konva;
};
exports._NODES_REGISTRY = {};
var globalKonva = {};
exports._injectGlobal = function (Konva) {
    globalKonva = Konva;
    exports.glob.Konva = Konva;
    Object.assign(Konva, exports._NODES_REGISTRY);
};
...
var Node = (function () {
    ...
    Node.prototype._getTransform = function () {
        var m = new Util_1.Transform(), x = this.x(), y = this.y(), rotation = Global_1._getGlobalKonva().getAngle(this.rotation()), scaleX = this.scaleX(), scaleY = this.scaleY(), skewX = this.skewX(), skewY = this.skewY(), offsetX = this.offsetX(), offsetY = this.offsetY();
        if (x !== 0 || y !== 0) {
            m.translate(x, y);
        }
        if (rotation !== 0) {
    ...
    Node.prototype.getDragDistance = function () {
        if (this.attrs.dragDistance !== undefined) {
            ...
            return Global_1._getGlobalKonva().dragDistance;
        }
    };
    ...
    Node.prototype.setAttr = function (attr, val) {
        var method = SET + Util_1.Util._capitalize(attr), func = this[method];
    ...
    Node.prototype._setAttr = function (key, val) {
        ...
        var same = oldVal === val;
        if (same && !Util_1.Util.isObject(val)) {
            return;
        }
    ...
    Node.prototype._listenDrag = function () {
        ...
        this.on('mousedown.konva touchstart.konva', function (evt) {
            ...
            var canDrag = !shouldCheckButton ||
                Global_1._getGlobalKonva().dragButtons.indexOf(evt.evt.button) >= 0;
            if (!canDrag) {
                return;
            }
            if (!DragAndDrop_1.DD.node) {
...
var Stage = (function (_super) {
    ...
    Stage.prototype.setContainer = function (container) {
        if (typeof container === STRING) {
            if (container.charAt(0) === '.') {
                ...
                container = Global_1.document.getElementsByClassName(className)[0];
            }
            else {
                var id;
                if (container.charAt(0) !== '#') {
                ...
                container = Global_1.document.getElementById(id);
            }
            if (!container) {
    ...
    Stage.prototype.clone = function (obj) {
        ...
        obj.container = Global_1.document.createElement(DIV);
    ...
    Stage.prototype._mousedown = function (evt) {
        ...
        Global_1._getGlobalKonva().listenClickTap = true;
        if (shape && shape.isListening()) {
    ...
    Stage.prototype._mouseup = function (evt) {
        ...
        this.setPointersPositions(evt);
        var shape = this.getIntersection(this.getPointerPosition()), clickStartShape = this.clickStartShape, clickEndShape = this.clickEndShape, fireDblClick = false, dd = Global_1._getGlobalKonva().DD;
        if (Global_1._getGlobalKonva().inDblClickWindow) {
            fireDblClick = true;
            clearTimeout(this.dblTimeout);
        }
        else if (!dd || !dd.justDragged) {
            Global_1._getGlobalKonva().inDblClickWindow = true;
            clearTimeout(this.dblTimeout);
        }
        else if (dd) {
        ...
        this.dblTimeout = setTimeout(function () {
            Global_1._getGlobalKonva().inDblClickWindow = false;
        }, Global_1._getGlobalKonva().dblClickWindow);
        if (shape && shape.isListening()) {
            this.clickEndShape = shape;
            shape._fireAndBubble(MOUSEUP, { evt: evt });
            if (Global_1._getGlobalKonva().listenClickTap &&
                clickStartShape &&
    ...
    Stage.prototype._touchmove = function (evt) {
        this.setPointersPositions(evt);
        var dd = Global_1._getGlobalKonva().DD, shape;
        if (!DragAndDrop_1.DD.isDragging) {
            shape = this.getIntersection(this.getPointerPosition());
            if (shape && shape.isListening()) {
        ...
        if (dd) {
            if (DragAndDrop_1.DD.isDragging &&
                Global_1._getGlobalKonva().DD.node.preventDefault() &&
                evt.cancelable) {
                evt.preventDefault();
            }
        }
    ...
    Stage.prototype._buildDOM = function () {
        ...
        this.content = Global_1.document.createElement(DIV);
...
var Tween = (function () {
    function Tween(config) {
        ...
        var layers = node.getLayer() ||
            (node instanceof Global_1._getGlobalKonva().Stage ? node.getLayers() : null);
        if (!layers) {
...
exports.Util = {
    ...
    createCanvasElement: function () {
        var canvas = Global_1.isBrowser
            ? Global_1.document.createElement('canvas')
            : new (Global_1._getGlobalKonva()._nodeCanvas())();
        try {
    ...
    createImageElement: function () {
        return Global_1.document.createElement('img');
    },
    _isInDocument: function (el) {
        while ((el = el.parentNode)) {
            if (el == Global_1.document) {
                return true;
            }
        }
        return false;
    ...
    warn: function (str) {
        if (!Global_1._getGlobalKonva().showWarnings) {
            return;
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(_dereq_("./_CoreInternals"));
...
var Konva = _dereq_('./_FullInternals');
...
var Arc = (function (_super) {
    ...
    Arc.prototype._sceneFunc = function (context) {
        var angle = Global_1.getAngle(this.angle()), clockwise = this.clockwise();
        context.beginPath();
...
var Transformer = (function (_super) {
    ...
    Transformer.prototype.__getNodeRect = function () {
        ...
        var rotation = Global_1.getAngle(node.rotation());
    ...
    Transformer.prototype._createAnchor = function (name) {
        ...
        anchor.on('mouseenter', function () {
            ...
            var rad = Global_1.getAngle(tr.rotation());
    ...
    Transformer.prototype._handleMouseMove = function (e) {
        ...
        if (this.movingResizer === 'top-left') {
            ...
            var dy = padding;
            this._fitNodeInto({
                rotation: Global_1._getGlobalKonva().angleDeg
                    ? newRotation
...
var Wedge = (function (_super) {
    ...
    Wedge.prototype._sceneFunc = function (context) {
        context.beginPath();
        context.arc(0, 0, this.radius(), 0, Global_1.getAngle(this.angle()), this.clockwise());
        context.lineTo(0, 0);
        context.closePath();
        context.fillStrokeShape(this);
    };
...
},{"EventEmitter":2,"colors.css":1,"peaks/markers/waveform.points":74,"peaks/markers/waveform.segments":75,"peaks/player/player":76,"peaks/player/player.keyboard":77,"peaks/views/waveform.timecontroller":84,"peaks/views/waveform.zoomcontroller":85,"peaks/waveform/waveform.core":90,"peaks/waveform/waveform.mixins":91,"peaks/waveform/waveform.utils":92}],72:[function(_dereq_,module,exports){
...
},{"peaks/markers/point":72,"peaks/waveform/waveform.utils":92}],75:[function(_dereq_,module,exports){
...
},{"colors.css":1,"peaks/markers/segment":73,"peaks/waveform/waveform.utils":92}],76:[function(_dereq_,module,exports){
...
},{"peaks/waveform/waveform.utils":92}],77:[function(_dereq_,module,exports){
module.exports = function () {
    'use strict';
    var nodes = [
        'OBJECT',
...
},{"konva":42,"peaks/waveform/waveform.utils":92}],80:[function(_dereq_,module,exports){
module.exports = function (Utils, Konva) {
    'use strict';
...
},{"konva":42,"peaks/waveform/waveform.utils":92}],81:[function(_dereq_,module,exports){
...
},{"konva":42,"peaks/views/waveform-shape":82,"peaks/waveform/waveform.utils":92}],82:[function(_dereq_,module,exports){
...
},{"konva":42}],83:[function(_dereq_,module,exports){
...
},{"konva":42,"peaks/views/helpers/mousedraghandler":78,"peaks/views/playhead-layer":79,"peaks/views/points-layer":80,"peaks/views/segments-layer":81,"peaks/views/waveform-shape":82,"peaks/waveform/waveform.axis":89,"peaks/waveform/waveform.utils":92}],84:[function(_dereq_,module,exports){
module.exports = function () {
    'use strict';
...
},{"konva":42,"peaks/views/helpers/mousedraghandler":78,"peaks/views/playhead-layer":79,"peaks/views/points-layer":80,"peaks/views/segments-layer":81,"peaks/views/waveform-shape":82,"peaks/views/zooms/animated":87,"peaks/views/zooms/static":88,"peaks/waveform/waveform.axis":89,"peaks/waveform/waveform.utils":92}],87:[function(_dereq_,module,exports){
module.exports = function (Konva) {
    'use strict';
    return {
...
},{"konva":42}],88:[function(_dereq_,module,exports){
module.exports = function (Utils) {
    'use strict';
    return {
        create: function (currentScale, previousScale, view) {
...
},{"peaks/waveform/waveform.utils":92}],89:[function(_dereq_,module,exports){
module.exports = function (Utils, Konva) {
    'use strict';
...
},{"konva":42,"peaks/waveform/waveform.utils":92}],90:[function(_dereq_,module,exports){
...
},{"peaks/views/waveform.overview":83,"peaks/views/waveform.zoomview":86,"peaks/waveform/waveform.utils":92,"waveform-data":69,"waveform-data/webaudio":70}],91:[function(_dereq_,module,exports){
module.exports = function (Konva) {
    'use strict';
...
},{"konva":42}],92:[function(_dereq_,module,exports){
module.exports = function () {
    'use strict';
