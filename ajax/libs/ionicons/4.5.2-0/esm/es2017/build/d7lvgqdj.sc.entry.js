...
import { a as getName, b as getSrc, c as getIconMap, d as isValid } from './chunk-70621d20.js';
...
class Icon {
    ...
    hostData() {
        ...
        return {
            'role': 'img',
            class: Object.assign({}, createColorClasses(this.color), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': flipRtl && hostContext('[dir=rtl]', this.el) })
        };
    }
    render() {
