import { notUndef, func, object, iterator, array, buffer, pattern, multicast, channel, undef, string, task, promise, stringableFunc, symbol } from '@redux-saga/is';
import { a as kTrue, c as check, d as remove, e as once, f as internalErr, g as _extends, h as TAKE, i as PUT, j as ALL, k as RACE, l as CALL, m as CPS, n as FORK, o as JOIN, p as CANCEL$1, q as SELECT, r as ACTION_CHANNEL, s as CANCELLED, t as FLUSH, u as GET_CONTEXT, v as SET_CONTEXT, b as noop, w as uid, x as array$1, y as object$1, z as makeIterator, A as createSetContextWarning, B as shouldCancel, C as shouldTerminate, D as createAllStyleChildCallbacks, E as shouldComplete, F as wrapSagaDispatch, G as log, H as _objectWithoutProperties, I as identity } from './chunk-70f0280b.js';
export { Q as detach } from './chunk-70f0280b.js';
...
import { a as none, b as fixed, c as dropping, d as sliding, e as expanding, f as buffers } from './chunk-a790d707.js';
export { f as buffers } from './chunk-a790d707.js';
...
function runSaga(options, saga) {
  ...
  if ((process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'test') && notUndef(effectMiddlewares)) {
