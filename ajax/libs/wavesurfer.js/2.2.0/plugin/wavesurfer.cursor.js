/*!
 * wavesurfer.js cursor plugin 2.2.0 (2019-03-09)
  ...
  _createClass(CursorPlugin, [{
    ...
    value: function updateCursorPosition(pos) {
      ...
      if (this.params.showTime) {
        ...
        var elementWidth = this.wavesurfer.drawer.getWidth() / this.wavesurfer.params.pixelRatio;
        var timeValue = Math.max(0, pos / elementWidth * duration);
