...
var VALID_ATTRIBUTE_NAME_CHAR = VALID_ATTRIBUTE_NAME_START_CHAR + '\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040';
var VALID_ATTRIBUTE_NAME_RE = new RegExp('^[' + VALID_ATTRIBUTE_NAME_START_CHAR + '][' + VALID_ATTRIBUTE_NAME_CHAR + ']*$');
...
var BOOLEAN_ATTR_CFG = _extends({}, DEFAULT_ATTR_CFG, {
    set: setBooleanAttr,
    toString: booleanAttrToString
});
var OVERLOADED_BOOLEAN_ATTR_CFG = _extends({}, BOOLEAN_ATTR_CFG, {
...
var BOOLEAN_PROP_CFG = _extends({}, DEFAULT_PROP_CFG, {
    toString: booleanAttrToString
});
...
function nodeToElements(node) {
    ...
    return normalizedNode === null ? [] : typeof normalizedNode === 'string' ? [createElement('plaintext', null, null, normalizedNode)] : Array.isArray(normalizedNode) ? normalizedNode : [normalizedNode];
}
