 ...
 */
!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports["pnp.config-store"]=t():e["pnp.config-store"]=t()}("undefined"!=typeof self?self:this,function(){return function(e){function t(n){if(i[n])return i[n].exports;var o=i[n]={i:n,l:!1,exports:{}};return e[n].call(o.exports,o,o.exports,t),o.l=!0,o.exports}var i={};return t.m=e,t.c=i,t.d=function(e,i,n){t.o(e,i)||Object.defineProperty(e,i,{configurable:!1,enumerable:!0,get:n})},t.n=function(e){var i=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(i,"a",i),i},t.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},t.p="",t(t.s=2)}([function(e,t,i){"use strict";(function(e){function n(e,t){for(var i=[],n=2;n<arguments.length;n++)i[n-2]=arguments[n];return function(){t.apply(e,i)}}function o(e,t,i){var n=new Date(e);switch(t.toLowerCase()){case"year":n.setFullYear(n.getFullYear()+i);break;case"quarter":n.setMonth(n.getMonth()+3*i);break;case"month":n.setMonth(n.getMonth()+i);break;case"week":n.setDate(n.getDate()+7*i);break;case"day":n.setDate(n.getDate()+i);break;case"hour":n.setTime(n.getTime()+36e5*i);break;case"minute":n.setTime(n.getTime()+6e4*i);break;case"second":n.setTime(n.getTime()+1e3*i);break;default:n=void 0}return n}function r(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];return e.filter(function(e){return!c(e)}).map(function(e){return e.replace(/^[\\|\/]/,"").replace(/[\\|\/]$/,"")}).join("/").replace(/\\/g,"/")}function s(e){return void 0!==e&&null!==e}function a(e){return/^https?:\/\/|^\/\//i.test(e)}function c(e){return void 0===e||null===e||e.length<1}function h(e){return JSON.stringify(e)}function u(e,t){if(void 0!==t&&null!==t){new Request("",{headers:t}).headers.forEach(function(t,i){e.append(i,t)})}}function l(e){return void 0!==e&&null!==e?new Map(E(e)):new Map}function p(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];for(var n=0;n<t.length;n++)t[n].forEach(function(t,i){e.set(i,t)});return e}i.d(t,"d",function(){return l}),i.d(t,"c",function(){return p}),i.d(t,"a",function(){return I}),i.d(t,"b",function(){return h});var d=i(6),T=i(7),_=(i.n(T),void 0!==e?e:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{}),f=function(){function e(){}return e.prototype.fetch=function(e,t){return _.fetch(e,t)},e}(),S=function(e){function t(t){var i=e.call(this)||this;return i._token=t,i}return Object(d.a)(t,e),Object.defineProperty(t.prototype,"token",{get:function(){return this._token},set:function(e){this._token=e},enumerable:!0,configurable:!0}),t.prototype.fetch=function(t,i){void 0===i&&(i={});var n=new Headers;return u(n,i.headers),n.set("Authorization","Bearer "+this._token),i.headers=n,e.prototype.fetch.call(this,t,i)},t}(f),E=(function(e){function t(t,i,n){var o=e.call(this,null)||this;return o.clientId=t,o.tenant=i,o.redirectUri=n,o}Object(d.a)(t,e),t.fromSPFxContext=function(e,i){return void 0===i&&(i="c58637bb-e2e1-4312-8a00-04b5ffcd3403"),new t(i,e.pageContext.aadInfo.tenantId.toString(),r(window.location.origin,"/_forms/spfxsinglesignon.aspx"))},t.prototype.fetch=function(t,i){var n=this;if(!a(t))throw Error("You must supply absolute urls to AdalClient.fetch.");return this.getToken(this.getResource(t)).then(function(o){return n.token=o,e.prototype.fetch.call(n,t,i)})},t.prototype.getToken=function(e){var i=this;return new Promise(function(n,o){i.ensureAuthContext().then(function(e){return i.login()}).then(function(i){t._authContext.acquireToken(e,function(e,t){if(e)return o(Error(e));n(t)})}).catch(o)})},t.prototype.ensureAuthContext=function(){var e=this;return new Promise(function(i){null===t._authContext&&(t._authContext=Object(T.inject)({clientId:e.clientId,displayCall:function(t){e._displayCallback&&e._displayCallback(t)},navigateToLoginRequestUrl:!1,redirectUri:e.redirectUri,tenant:e.tenant})),i()})},t.prototype.login=function(){var e=this;return this._loginPromise?this._loginPromise:(this._loginPromise=new Promise(function(i,n){if(t._authContext.getCachedUser())return i();e._displayCallback=function(o){var r=window.open(o,"login","width=483, height=600");if(!r)return n(Error("Could not open pop-up window for auth. Likely pop-ups are blocked by the browser."));r&&r.focus&&r.focus();var s=window.setInterval(function(){r&&!r.closed&&void 0!==r.closed||window.clearInterval(s);try{-1!==r.document.URL.indexOf(e.redirectUri)&&(window.clearInterval(s),t._authContext.handleWindowCallback(r.location.hash),r.close(),i())}catch(e){n(e)}},30)},e.ensureAuthContext().then(function(i){t._authContext._loginInProgress=!1,t._authContext.login(),e._displayCallback=null})}),this._loginPromise)},t.prototype.getResource=function(e){var t=document.createElement("a");return t.href=e,t.protocol+"//"+t.hostname},t._authContext=null}(S),function(e){return"function"==typeof e}(Object.entries)?Object.entries:function(e){return Object.keys(e).map(function(t){return[t,e[t]]})}),g=["defaultCachingStore","defaultCachingTimeoutSeconds","globalCacheDisable","enableCacheExpiration","cacheExpirationIntervalMilliseconds","spfxContext"],N=function(){function e(e){void 0===e&&(e=new Map),this._v=e,this._v.set(g[0],"session"),this._v.set(g[1],60),this._v.set(g[2],!1),this._v.set(g[3],!1),this._v.set(g[4],750),this._v.set(g[5],null)}return e.prototype.extend=function(e){this._v=p(this._v,l(e))},e.prototype.get=function(e){return this._v.get(e)},Object.defineProperty(e.prototype,"defaultCachingStore",{get:function(){return this.get(g[0])},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"defaultCachingTimeoutSeconds",{get:function(){return this.get(g[1])},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"globalCacheDisable",{get:function(){return this.get(g[2])},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"enableCacheExpiration",{get:function(){return this.get(g[3])},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"cacheExpirationIntervalMilliseconds",{get:function(){return this.get(g[4])},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"spfxContext",{get:function(){return this.get(g[5])},enumerable:!0,configurable:!0}),e}(),O=new N,R=O,m=function(){function e(e,t){void 0===t&&(t=-1),this.store=e,this.defaultTimeoutMinutes=t,this.enabled=this.test(),R.enableCacheExpiration&&this.cacheExpirationHandler()}return e.prototype.get=function(e){if(!this.enabled)return null;var t=this.store.getItem(e);if(!s(t))return null;var i=JSON.parse(t);return new Date(i.expiration)<=new Date?(this.delete(e),null):i.value},e.prototype.put=function(e,t,i){this.enabled&&this.store.setItem(e,this.createPersistable(t,i))},e.prototype.delete=function(e){this.enabled&&this.store.removeItem(e)},e.prototype.getOrPut=function(e,t,i){var n=this;return this.enabled?new Promise(function(o){var r=n.get(e);null==r?t().then(function(t){n.put(e,t,i),o(t)}):o(r)}):t()},e.prototype.deleteExpired=function(){var e=this;return new Promise(function(t,i){e.enabled||t();try{for(var n=0;n<e.store.length;n++){var o=e.store.key(n);null!==o&&/["|']?pnp["|']? ?: ?1/i.test(e.store.getItem(o))&&e.get(o)}t()}catch(e){i(e)}})},e.prototype.test=function(){try{return this.store.setItem("t","t"),this.store.removeItem("t"),!0}catch(e){return!1}},e.prototype.createPersistable=function(e,t){if(void 0===t){var i=R.defaultCachingTimeoutSeconds;this.defaultTimeoutMinutes>0&&(i=60*this.defaultTimeoutMinutes),t=o(new Date,"second",i)}return h({pnp:1,expiration:t,value:e})},e.prototype.cacheExpirationHandler=function(){var e=this;this.deleteExpired().then(function(t){setTimeout(n(e,e.cacheExpirationHandler),R.cacheExpirationIntervalMilliseconds)}).catch(function(e){console.error(e)})},e}(),v=function(){function e(e){void 0===e&&(e=new Map),this._store=e}return Object.defineProperty(e.prototype,"length",{get:function(){return this._store.size},enumerable:!0,configurable:!0}),e.prototype.clear=function(){this._store.clear()},e.prototype.getItem=function(e){return this._store.get(e)},e.prototype.key=function(e){return Array.from(this._store)[e][0]},e.prototype.removeItem=function(e){this._store.delete(e)},e.prototype.setItem=function(e,t){this._store.set(e,t)},e}(),I=function(){function e(e,t){void 0===e&&(e=null),void 0===t&&(t=null),this._local=e,this._session=t}return Object.defineProperty(e.prototype,"local",{get:function(){return null===this._local&&(this._local=this.getStore("local")),this._local},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"session",{get:function(){return null===this._session&&(this._session=this.getStore("session")),this._session},enumerable:!0,configurable:!0}),e.prototype.getStore=function(e){return new m("local"===e?"undefined"==typeof localStorage?new v:localStorage:"undefined"==typeof sessionStorage?new v:sessionStorage)},e}()}).call(t,i(5))},function(e,t,i){"use strict";var n=i(0),o=function(){function e(e,t,i){this.wrappedProvider=e,this.cacheKey=t,this.wrappedProvider=e,this.store=i||this.selectPnPCache()}return e.prototype.getWrappedProvider=function(){return this.wrappedProvider},e.prototype.getConfiguration=function(){var e=this;return this.store&&this.store.enabled?this.store.getOrPut(this.cacheKey,function(){return e.wrappedProvider.getConfiguration().then(function(t){return e.store.put(e.cacheKey,t),t})}):this.wrappedProvider.getConfiguration()},e.prototype.selectPnPCache=function(){var e=new n.a;if(e.local&&e.local.enabled)return e.local;if(e.session&&e.session.enabled)return e.session;throw Error("Cannot create a caching configuration provider since cache is not available.")},e}();t.a=o},function(e,t,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=i(3);i.d(t,"Settings",function(){return n.c}),i.d(t,"CachingConfigurationProvider",function(){return n.a}),i.d(t,"SPListConfigurationProvider",function(){return n.b})},function(e,t,i){"use strict";var n=i(4);i.d(t,"c",function(){return n.a});var o=i(8);i.d(t,"a",function(){return o.a}),i.d(t,"b",function(){return o.b})},function(e,t,i){"use strict";i.d(t,"a",function(){return o});var n=i(0),o=function(){function e(e){void 0===e&&(e=new Map),this._settings=e}return e.prototype.add=function(e,t){this._settings.set(e,t)},e.prototype.addJSON=function(e,t){this._settings.set(e,Object(n.b)(t))},e.prototype.apply=function(e){var t=this;return new Promise(function(i,o){try{t._settings=Object(n.c)(t._settings,Object(n.d)(e)),i()}catch(e){o(e)}})},e.prototype.load=function(e){var t=this;return new Promise(function(i,o){e.getConfiguration().then(function(e){t._settings=Object(n.c)(t._settings,Object(n.d)(e)),i()}).catch(o)})},e.prototype.get=function(e){return this._settings.get(e)},e.prototype.getJSON=function(e){var t=this.get(e);return void 0===t||null===t?t:JSON.parse(t)},e}()},function(e,t){var i;i=function(){return this}();try{i=i||Function("return this")()||(0,eval)("this")}catch(e){"object"==typeof window&&(i=window)}e.exports=i},function(e,t,i){"use strict";function n(e,t){function i(){this.constructor=e}o(e,t),e.prototype=null===t?Object.create(t):(i.prototype=t.prototype,new i)}t.a=n;/*! *****************************************************************************
