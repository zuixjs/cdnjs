/**
@license
 * @pnp/config-store v1.2.2-0 - pnp - provides a way to manage configuration within your application
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pnp/common')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pnp/common'], factory) :
    (factory((global.pnp = global.pnp || {}, global.pnp['config-store'] = {}),global.pnp.common));
    ...
    var Settings = /** @class */ (function () {
        ...
        Settings.prototype.addJSON = function (key, value) {
            this._settings.set(key, common.jsS(value));
        };
        /**
        ...
        Settings.prototype.apply = function (hash) {
            ...
            return new Promise(function (resolve, reject) {
                try {
                    _this._settings = common.mergeMaps(_this._settings, common.objectToMap(hash));
                    resolve();
                }
                catch (e) {
                    reject(e);
        ...
        Settings.prototype.load = function (provider) {
            ...
            return new Promise(function (resolve, reject) {
                provider.getConfiguration().then(function (value) {
                    _this._settings = common.mergeMaps(_this._settings, common.objectToMap(value));
                    resolve();
                }).catch(reject);
            });
        };
