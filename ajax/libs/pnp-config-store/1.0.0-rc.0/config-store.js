/**
@license
 * @pnp/config-store v1.0.0-rc.0 - pnp - provides a way to manage configuration within your application
...
class SPListConfigurationProvider {
     ...
     */
    constructor(sourceWeb, sourceListTitle = "config", keyFieldName = "Title", valueFieldName = "Value") {
    ...
    getConfiguration() {
        return this.web.lists.getByTitle(this.listTitle).items.select(this.keyFieldName, this.valueFieldName)
            .get().then((data) => data.reduce((c, item) => {
