(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["britecharts"] = root["britecharts"] || {}, root["britecharts"]["scatterPlot"] = factory();
})(this, function() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_color__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__define__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_time__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_array__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_interpolate__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_time__ = __webpack_require__(22);
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    ...
    var d3Time = __webpack_require__(22);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_array__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_format__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Beach__ = __webpack_require__(316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Cell__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Circle__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Edge__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RedBlackTree__ = __webpack_require__(287);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Diagram__ = __webpack_require__(286);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Edge__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Diagram__ = __webpack_require__(286);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__RedBlackTree__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Diagram__ = __webpack_require__(286);
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    var d3Collection = __webpack_require__(109);
    ...
    var d3TimeFormat = __webpack_require__(51);
    var d3Voronoi = __webpack_require__(312);
    ...
    var _require2 = __webpack_require__(285),
        createFilterContainer = _require2.createFilterContainer,
        createGlowWithMatrix = _require2.createGlowWithMatrix,
        bounceCircleHighlight = _require2.bounceCircleHighlight;
    ...
    return function module() {
        ...
        var margin = {
            ...
            chartWidth = void 0,
            chartHeight = void 0,
            dispatcher = d3Dispatch.dispatch('customClick', 'customMouseMove', 'customMouseOver', 'customMouseOut'),
            getName = function getName(_ref) {
            var name = _ref.name;
            return name;
        },
            getPointData = function getPointData(_ref2) {
            var data = _ref2.data;
            return data;
        };
        ...
        */
        function buildAxis() {
            xAxis = d3Axis.axisBottom(xScale).ticks(xTicks).tickPadding(tickPadding).tickFormat(d3Format.format(xAxisFormat));

            yAxis = d3Axis.axisLeft(yScale).ticks(yTicks).tickPadding(tickPadding).tickFormat(d3Format.format(yAxisFormat));
        }
        ...
        */
        ...
        function buildVoronoi() {
            voronoi = d3Voronoi.voronoi().x(function (d) {
                return xScale(d.x);
            }).y(function (d) {
                return yScale(d.y);
            }).extent([[0, 0], [chartWidth, chartHeight]])(dataPoints);
        }
        ...
        function buildScales() {
            var _ref3 = [d3Array.min(dataPoints, function (_ref4) {
                var x = _ref4.x;
                return x;
            }), d3Array.min(dataPoints, function (_ref5) {
                var y = _ref5.y;
                return y;
            })],
                minX = _ref3[0],
                minY = _ref3[1];
            var _ref6 = [d3Array.max(dataPoints, function (_ref7) {
                var x = _ref7.x;
                return x;
            }), d3Array.max(dataPoints, function (_ref8) {
                var y = _ref8.y;
                return y;
            })],
                maxX = _ref6[0],
            ...
            xScale = d3Scale.scaleLinear().domain([minX, maxX]).rangeRound([0, chartWidth]).nice();

            yScale = d3Scale.scaleLinear().domain([yScaleBottomValue, maxY]).rangeRound([chartHeight, 0]).nice();

            colorScale = d3Scale.scaleOrdinal().domain(dataPoints.map(getName)).range(colorSchema);

            areaScale = d3Scale.scaleSqrt().domain([yScaleBottomValue, maxY]).range([0, maxCircleArea]);
             ...
             * @private
             */
            nameColorMap = colorScale.domain().reduce(function (accum, item, i) {
        ...
        function buildSVG(container) {
            if (!svg) {
                svg = d3Selection.select(container).append('svg').classed('britechart scatter-plot', true);
        ...
        function drawAxisLabels() {
            ...
            if (yAxisLabel) {
                ...
                yAxisLabelEl = svg.select('.axis-labels-group').append('g').attr('class', 'y-axis-label').append('text').classed('y-axis-label-text', true).attr('x', -chartHeight / 2).attr('y', yAxisLabelOffset - xAxisPadding.left).attr('text-anchor', 'middle').attr('transform', 'rotate(270 0 0)').text(yAxisLabel);
            }
            ...
            if (xAxisLabel) {
                ...
                xAxisLabelEl = svg.selectAll('.axis-labels-group').append('g').attr('class', 'x-axis-label').append('text').classed('x-axis-label-text', true).attr('x', chartWidth / 2).attr('y', chartHeight - xAxisLabelOffset).attr('text-anchor', 'middle').text(xAxisLabel);
            }
        }
        ...
        function drawMaskingClip() {
            maskingRectangle = svg.selectAll('.chart-group').append('clipPath').attr('id', maskingRectangleId).append('rect').attr('width', chartWidth).attr('height', chartHeight).attr('x', 0).attr('y', 0);
        }
        ...
        function drawTrendline(linearData) {
            ...
            var params = [{ x: linearData.x1, y: linearData.y1 }, { x: linearData.x2, y: linearData.y2 }];

            var line = d3Shape.line().curve(trendLineCurve).x(function (_ref9) {
                var x = _ref9.x;
                return xScale(x);
            }).y(function (_ref10) {
                var y = _ref10.y;
            ...
            trendLinePath = svg.selectAll('.chart-group').append('path').attr('class', 'scatter-trendline').attr('d', line(params)).attr('stroke', colorSchema[0]).attr('stroke-width', trendLineStrokWidth).attr('fill', 'none');

            var totalLength = trendLinePath.node().getTotalLength();

            trendLinePath.attr('stroke-dasharray', totalLength + ' ' + totalLength).attr('stroke-dashoffset', totalLength).transition().delay(trendLineDelay).duration(trendLineDuration).ease(ease).attr('stroke-dashoffset', 0);
        }
        ...
        function drawVerticalGridLines() {
            maskGridLines = svg.select('.grid-lines-group').selectAll('line.vertical-grid-line').data(xScale.ticks(xTicks)).enter().append('line').attr('class', 'vertical-grid-line').attr('y1', xAxisPadding.left).attr('y2', chartHeight).attr('x1', function (d) {
                return xScale(d);
            }).attr('x2', function (d) {
                return xScale(d);
            });
        ...
        */
        function drawDataPoints() {
            var circles = svg.select('.chart-group').attr('clip-path', 'url(#' + maskingRectangleId + ')').selectAll('circle').data(dataPoints).enter();

            if (isAnimated) {
                circles.append('circle').attr('class', 'data-point data-point-highlighter').transition().delay(delay).duration(duration).ease(ease).style('stroke', function (d) {
                    return nameColorMap[d.name];
                }).attr('fill', function (d) {
                    return hasHollowCircles ? hollowColor : nameColorMap[d.name];
                }).attr('fill-opacity', circleOpacity).attr('r', function (d) {
                    return areaScale(d.y);
                }).attr('cx', function (d) {
                    return xScale(d.x);
                }).attr('cy', function (d) {
                    return yScale(d.y);
                ...
                circles.append('circle').attr('class', 'point').attr('class', 'data-point-highlighter').style('stroke', function (d) {
                    return nameColorMap[d.name];
                }).attr('fill', function (d) {
                    return hasHollowCircles ? hollowColor : nameColorMap[d.name];
                }).attr('fill-opacity', circleOpacity).attr('r', function (d) {
        ...
        */
        function drawDataPointsValueHighlights(data) {
            ...
            highlightCrossHairContainer.selectAll('line.highlight-y-line').attr('stroke', nameColorMap[data.name]).attr('class', 'highlight-y-line').attr('x1', xScale(data.x) - areaScale(data.y)).attr('x2', 0).attr('y1', yScale(data.y)).attr('y2', yScale(data.y));

            // Draw line perpendicular to x-axis
            highlightCrossHairContainer.selectAll('line.highlight-x-line').attr('stroke', nameColorMap[data.name]).attr('class', 'highlight-x-line').attr('x1', xScale(data.x)).attr('x2', xScale(data.x)).attr('y1', yScale(data.y) + areaScale(data.y)).attr('y2', chartHeight);

            // Draw data label for y value
            highlightCrossHairLabelsContainer.selectAll('text.highlight-y-legend').attr('text-anchor', 'middle').attr('fill', nameColorMap[data.name]).attr('class', 'highlight-y-legend').attr('y', yScale(data.y) + areaScale(data.y) / 2).attr('x', highlightTextLegendOffset).text('' + d3Format.format(yAxisFormat)(data.y));

            // Draw data label for x value
            highlightCrossHairLabelsContainer.selectAll('text.highlight-x-legend').attr('text-anchor', 'middle').attr('fill', nameColorMap[data.name]).attr('class', 'highlight-x-legend').attr('transform', 'translate(0, ' + (chartHeight - highlightTextLegendOffset) + ')').attr('x', xScale(data.x) - areaScale(data.y) / 2).text('' + d3Format.format(xAxisFormat)(data.x));
        }
        ...
        function calcLinearRegression() {
            ...
            var denominator = n * x2 - x * x;
            var intercept = (y * x2 - x * xy) / denominator;
            var slope = (n * xy - x * y) / denominator;
            var minX = d3Array.min(dataPoints, function (_ref11) {
                var x = _ref11.x;
                return x;
            });
            var maxX = d3Array.max(dataPoints, function (_ref12) {
                var x = _ref12.x;
                return x;
            });
        ...
        function getPointProps(svg) {
            var mousePos = d3Selection.mouse(svg);
        ...
        function handleMouseMove(e) {
            var _getPointProps = getPointProps(e),
                mousePos = _getPointProps.mousePos,
                closestPoint = _getPointProps.closestPoint;

            var pointData = getPointData(closestPoint);
        ...
        function handleClick(e) {
            var _getPointProps2 = getPointProps(e),
                closestPoint = _getPointProps2.closestPoint;

            var d = getPointData(closestPoint);
        ...
        function handleClickAnimation(dataPoint) {
            bounceCircleHighlight(highlightCircle, ease, areaScale(dataPoint.y), areaScale(dataPoint.y * 2));
        }
        ...
        function highlightDataPoint(data) {
            ...
            highlightCircle.attr('opacity', 1).attr('stroke', function () {
                return nameColorMap[data.name];
            }).attr('fill', function () {
                return nameColorMap[data.name];
            }).attr('fill-opacity', circleOpacity).attr('cx', function () {
                return xScale(data.x);
            }).attr('cy', function () {
                return yScale(data.y);
            }).attr('r', function () {
                return areaScale(data.y);
            }).style('stroke-width', highlightStrokeWidth).style('stroke-opacity', highlightCircleOpacity);
        ...
        */
        function initHighlightComponents() {
            highlightCircle = svg.select('.metadata-group').selectAll('circle.highlight-circle').data([1]).enter().append('circle').attr('class', 'highlight-circle').attr('cursor', 'pointer');

            if (hasCrossHairs) {
                // initialize cross hair lines container
                highlightCrossHairContainer = svg.select('.chart-group').append('g').attr('class', 'crosshair-lines-container');

                // initialize corss hair labels container
                highlightCrossHairLabelsContainer = svg.select('.metadata-group').append('g').attr('class', 'crosshair-labels-container');

                highlightCrossHairContainer.selectAll('line.highlight-y-line').data([1]).enter().append('line').attr('class', 'highlight-y-line');

                highlightCrossHairContainer.selectAll('line.highlight-x-line').data([1]).enter().append('line').attr('class', 'highlight-x-line');

                highlightCrossHairLabelsContainer.selectAll('text.highlight-y-legend').data([1]).enter().append('text').attr('class', 'highlight-y-legend');

                highlightCrossHairLabelsContainer.selectAll('text.highlight-x-legend').data([1]).enter().append('text').attr('class', 'highlight-x-legend');
            }
        }
         ...
         * @private
         */
        function showCrossHairComponentsWithLabels() {
            var status = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

            var opacityIndex = status ? 1 : 0;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_voronoi__ = __webpack_require__(313);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constant__ = __webpack_require__(314);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__point__ = __webpack_require__(315);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Diagram__ = __webpack_require__(286);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Circle__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Edge__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Diagram__ = __webpack_require__(286);
...
//# sourceMappingURL=scatterPlot.min.js.map