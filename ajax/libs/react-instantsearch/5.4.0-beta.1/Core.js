/*! React InstantSearch 5.4.0-beta.1 | © Algolia, inc. | https://community.algolia.com/react-instantsearch */
              ...
              return function (Composed) {
                ...
                return _temp = _class = function (_Component) {
                  ...
                  function Connector() {
                    ...
                    var _this = _possibleConstructorReturn(this, (_ref = Connector.__proto__ || Object.getPrototypeOf(Connector)).call.apply(_ref, [this].concat(args)));
                  ...
                  _createClass(Connector, [{
                    ...
                    value: function componentDidMount() {
                      ...
                      this.unsubscribe = this.context.ais.store.subscribe(function () {
                        if (!_this2.unmounting) {
                          _this2.setState({
                            props: _this2.getProvidedProps(_extends$1({}, _this2.props, {
                    ...
                    value: function componentWillReceiveProps(nextProps) {
                      if (!isEqual_1(this.props, nextProps)) {
                        this.setState({
                          props: this.getProvidedProps(_extends$1({}, nextProps, {
                            // @MAJOR: see constructor
                    ...
                    value: function getProvidedProps(props) {
                      var _context$ais$store$ge = this.context.ais.store.getState(),
                          widgets = _context$ais$store$ge.widgets,
                          results = _context$ais$store$ge.results,
                          resultsFacetValues = _context$ais$store$ge.resultsFacetValues,
                          searching = _context$ais$store$ge.searching,
                          searchingForFacetValues = _context$ais$store$ge.searchingForFacetValues,
                          isSearchStalled = _context$ais$store$ge.isSearchStalled,
                          metadata = _context$ais$store$ge.metadata,
                          error = _context$ais$store$ge.error;
