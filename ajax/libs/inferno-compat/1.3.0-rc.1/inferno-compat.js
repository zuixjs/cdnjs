...
(function (global, factory) {
	...
	(factory((global['inferno-compat'] = global['inferno-compat'] || {}),global.Inferno.Component,global.Inferno));
}(this, (function (exports,CoreComponent,inferno) { 'use strict';

CoreComponent = 'default' in CoreComponent ? CoreComponent['default'] : CoreComponent;
...
function extend(base, props, all) {
    for (var key in props) {
        if (all === true || !isNullOrUndef$2(props[key])) {
            base[key] = props[key];
        }
    }
    return base;
...
function createClass(obj) {
    ...
    Cl.getInitialState = isUndefined$1(Cl.getInitialState) ? undefined : Cl.getInitialState;
    Cl.defaultProps = isUndefined$1(Cl.getDefaultProps) ? undefined : Cl.getDefaultProps();
    return Cl;
}
...
function isNullOrUndef$$1(children) {
...
var Component = (function (CoreComponent$$1) {
    function Component() {
        CoreComponent$$1.apply(this, arguments);
        this.isReactComponent = {};
    }

    if ( CoreComponent$$1 ) Component.__proto__ = CoreComponent$$1;
    Component.prototype = Object.create( CoreComponent$$1 && CoreComponent$$1.prototype );
...
inferno.options.createVNode = function (vNode) {
    ...
    if (isNullOrUndef$$1(vNode.props)) {
        props = vNode.props = {};
    }
