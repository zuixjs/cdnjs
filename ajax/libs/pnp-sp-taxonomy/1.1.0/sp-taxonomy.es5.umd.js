/**
@license
 * @pnp/sp-taxonomy v1.1.0 - pnp - Provides a fluent API to work with SharePoint taxonomy
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@pnp/sp-clientsvc'), require('@pnp/common'), require('@pnp/sp')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@pnp/sp-clientsvc', '@pnp/common', '@pnp/sp'], factory) :
    (factory((global.pnp = global.pnp || {}, global.pnp['sp-taxonomy'] = {}),global.tslib_1,global.spClientsvc,global.common,global.sp));
}(this, (function (exports,tslib_1,spClientsvc,common,sp) { 'use strict';
    ...
    var TermSet = /** @class */ (function (_super) {
        ...
        TermSet.prototype.addTerm = function (name, lcid, isAvailableForTagging, id) {
            var _this = this;
            if (isAvailableForTagging === void 0) { isAvailableForTagging = false; }
