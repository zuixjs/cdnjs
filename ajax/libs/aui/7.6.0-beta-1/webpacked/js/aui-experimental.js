...
(0, _skate2.default)('aui-toggle', {
    template: (0, _skatejsTemplateHtml2.default)('<input type="checkbox" class="aui-toggle-input">', '<span class="aui-toggle-view">', '<span class="aui-toggle-tick aui-icon aui-icon-small aui-iconfont-check"></span>', '<span class="aui-toggle-cross aui-icon aui-icon-small aui-iconfont-cross"></span>', '</span>'),
    created: function created(element) {
