	...
	selectorFactory) {
	  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
	    ...
	    return 'ConnectAdvanced(' + name + ')';
	      ...
	      connectOptions = objectWithoutProperties(_ref, ['getDisplayName', 'methodName', 'renderCountProp', 'shouldHandleStateChanges', 'storeKey', 'withRef', 'consumer']);
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    invariant_1(!withRef || withRef === 'forwardRef', 'withRef must be set to the text "forwardRef." Reference uses React.forwardRef and you may now access ref ' + ('directly instead of using getWrappedInstance() in component ' + wrappedComponentName));
