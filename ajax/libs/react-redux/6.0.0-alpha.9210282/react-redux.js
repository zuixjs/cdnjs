	...
	*/
	selectorFactory) {
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    var OuterBaseComponent = connectOptions.pure ? React.PureComponent : React.Component;
	    ...
	    var ConnectInner = function (_Component) {
	      inherits(ConnectInner, _Component);

	      function ConnectInner(props) {
	        classCallCheck(this, ConnectInner);
	      ...
	      ConnectInner.prototype.render = function render() {
	        ...
	        return React__default.createElement(WrappedComponent, _extends({}, this.state.childProps, { ref: this.props.forwardRef }));
	      };
	    ...
	    function createWrapperPropsMemoizer() {
	      ...
	      return function wrapperPropsMemoizer(props) {
	        ...
	        var contextConsumer = props.contextConsumer,
	            ...
	            wrapperProps = objectWithoutProperties(props, ['contextConsumer', 'forwardRef']);
	    ...
	    var Connect = function (_OuterBaseComponent) {
	      inherits(Connect, _OuterBaseComponent);

	      function Connect(props) {
	        classCallCheck(this, Connect);

	        var _this2 = possibleConstructorReturn(this, _OuterBaseComponent.call(this, props));
	      ...
	      Connect.prototype.renderInner = function renderInner(providerValue) {
	        ...
	        return React__default.createElement(ConnectInner, {
	          key: this.version,
	    ...
	    if (forwardRef) {
	      var forwarded = React__default.forwardRef(function (props, ref) {
	        return React__default.createElement(Connect, _extends({}, props, { forwardRef: ref }));
	      });

	      wrapperComponent = forwarded;
	    }

	    return hoistNonReactStatics_cjs(wrapperComponent, WrappedComponent);
	  };
	}
