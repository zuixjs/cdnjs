 ...
 * LICENSE file in the root directory of this source tree.
 */
var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};"production"!==t.env.NODE_ENV&&function(){function t(t){return"string"==typeof t||"function"==typeof t||t===b||t===T||t===N||t===E||t===_||"object"===(void 0===t?"undefined":n(t))&&null!==t&&(t.$$typeof===C||t.$$typeof===M||t.$$typeof===D||t.$$typeof===w||t.$$typeof===S)}function r(t){if("object"===(void 0===t?"undefined":n(t))&&null!==t){var e=t.$$typeof;switch(e){case g:var r=t.type;switch(r){case O:case T:case b:case N:case E:case _:return r;default:var o=r&&r.$$typeof;switch(o){case w:case S:case D:return o;default:return e}}case C:case M:case x:return e}}}function o(t){return H||(H=!0,P(!1,"The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")),i(t)||r(t)===O}function i(t){return r(t)===T}function a(t){return r(t)===w}function u(t){return r(t)===D}function s(t){return"object"===(void 0===t?"undefined":n(t))&&null!==t&&t.$$typeof===g}function c(t){return r(t)===S}function f(t){return r(t)===b}function l(t){return r(t)===C}function p(t){return r(t)===M}function d(t){return r(t)===x}function h(t){return r(t)===N}function m(t){return r(t)===E}function y(t){return r(t)===_}Object.defineProperty(e,"__esModule",{value:!0});var v="function"==typeof Symbol&&Symbol.for,g=v?Symbol.for("react.element"):60103,x=v?Symbol.for("react.portal"):60106,b=v?Symbol.for("react.fragment"):60107,E=v?Symbol.for("react.strict_mode"):60108,N=v?Symbol.for("react.profiler"):60114,D=v?Symbol.for("react.provider"):60109,w=v?Symbol.for("react.context"):60110,O=v?Symbol.for("react.async_mode"):60111,T=v?Symbol.for("react.concurrent_mode"):60111,S=v?Symbol.for("react.forward_ref"):60112,_=v?Symbol.for("react.suspense"):60113,M=v?Symbol.for("react.memo"):60115,C=v?Symbol.for("react.lazy"):60116,A=function(){},I=function(t){for(var e=arguments.length,n=Array(e>1?e-1:0),r=1;r<e;r++)n[r-1]=arguments[r];var o=0,i="Warning: "+t.replace(/%s/g,function(){return n[o++]});"undefined"!=typeof console&&console.warn(i);try{throw new Error(i)}catch(t){}};A=function(t,e){if(void 0===e)throw new Error("`lowPriorityWarning(condition, format, ...args)` requires a warning message argument");if(!t){for(var n=arguments.length,r=Array(n>2?n-2:0),o=2;o<n;o++)r[o-2]=arguments[o];I.apply(void 0,[e].concat(r))}};var P=A,F=O,$=T,R=w,j=D,k=g,L=S,q=b,B=C,V=M,Y=x,U=N,W=E,G=_,H=!1;e.typeOf=r,e.AsyncMode=F,e.ConcurrentMode=$,e.ContextConsumer=R,e.ContextProvider=j,e.Element=k,e.ForwardRef=L,e.Fragment=q,e.Lazy=B,e.Memo=V,e.Portal=Y,e.Profiler=U,e.StrictMode=W,e.Suspense=G,e.isValidElementType=t,e.isAsyncMode=o,e.isConcurrentMode=i,e.isContextConsumer=a,e.isContextProvider=u,e.isElement=s,e.isForwardRef=c,e.isFragment=f,e.isLazy=l,e.isMemo=p,e.isPortal=d,e.isProfiler=h,e.isStrictMode=m,e.isSuspense=y}()}).call(e,n(0))}])});